...
local npcdienum = {}
local kezhi_order = {}
local kezhi_order_thd = { -- 优先级设置，数值约大优先级越高
    ["正"] = 9,
    ["奇"] = 8,
    ["刚"] = 7,
    ["柔"] = 5,
...
pk_valuecmd3 = { -- mush的pk变量名称，对应武功使用哪种克制
    ["正"] = 'smy_pmiao', -- p版mush请改pmiao
    ["奇"] = 'smy_pxian', -- p版mush请改pxian
    ["刚"] = 'smy_pkuai', -- p版mush请改pkuai
    ["柔"] = 'smy_pman', -- p版mush请改pman
    ["快"] = 'smy_prou', -- p版mush请改prou
    ["慢"] = 'smy_pgang', -- p版mush请改pgang
    ["妙"] = 'smy_pqi', -- p版mush请改pqi
    ["险"] = 'smy_pzhen', -- p版mush请改pzhen
    ["空"] = 'smy_pkong',
    ["无"] = 'smy_pwu'
}
...
kezhiDesc["刚"] = {
    ...
    ["玄铁剑法"] = {
        ...
        "身在大海般暗流汹涌难以抗拒",
        "风声越来越响，竟如同暴风之中一般",
        "独孤求败的至高境界", "已入无剑胜有剑的境界",
        "急如飞虹闪电却无丝毫声息",
        "泛起淡淡海蓝，无声无息", "招式毫无征兆随意而创",
        "心中竟无半点波澜，纯以意运剑",
        "招式越是平平威力却是越大",
        "剑法已然反璞归真而无招自胜",
...
kezhiDesc["柔"] = {
    ...
    ["太极拳"] = {
        ...
        "右手虚划，手背", "流云翻舞", "双手随意划弧",
        "双手一翻，连消", "右掌挥出，一拒一迎",
        "左手凭空划了", "右掌划个圈子", "双掌轻翻，柔",
        "走一虚步，右手", "双掌一摆一抄", "双手自然挥动",
        "双手内旋，如", "左掌阳，右掌阴", "右手突从圈中",
        "划个圆圈，右臂一伸", "左手从右至左",
        "双手划弧止于", "左手高，右手低", "右脚实，左脚虚",
        "身前上下连划", "身前左右连划", "虚灵顶劲、涵胸",
        "似松非松，将展", "「揽雀尾", "「单鞭", "「提手上势",
        "「白鹤亮翅", "「搂膝勾步", "「手挥琶琶",
        "「进步搬拦锤", "「指裆锤", "「双风贯耳",
        "「白蛇吐信", "「高探马", "「伏虎式", "「肘底看锤",
...
kezhiDesc["慢"] = {
    ...
    ["太极剑法"] = {
        "「手挥五弦", "捏了个剑诀，剑尖虚指",
        "送远方翩鸿孤飞", "剑法吞吐开合", "剑劲之柔韧",
        "剑法中最精要之处", "登峰造极的剑术",
        "漫步扬长而步", "出剑以蜿蜒之势", "剑法中破绽之少",
        "太极剑「剑意」", "剑势犹如浪潮一般",
        "剑招古朴浑厚", "剑刃平刺，锋口向",
        "脚走八卦，拔剑", "神在剑先、绵绵不绝",
        "画剑成圈，一点", "缓缓伸出，随手画",
        "一阵尖锐的破空声出", "右手剑诀戳出", "三环套月",
        "左手持剑缓缓向上提起", "一剑刺到，青光闪闪",
        "剑尖急颤，看不出攻", "左手剑诀斜引，",
        "剑势绵绵不绝，", "剑招精奇，轻翔灵动",
        "以己之钝，挡敌之无锋", "以意驭剑，千变万化",
        "每一招均是以弧形刺出", "以意驭剑，神在剑先",
        "剑法纵横变化，奇幻无方", "半点渣滓，以意运剑",
        "出剑递招，可说", "剑法吞吐开合",
        "只觉一股森森寒气，直逼", "突然平刺，剑尖急颤",
        "剑招未曾使老，已然圈转", "「宿鸟投林」",
        "「大魁星」", "「天马行空」", "「黄峰入洞」",
        "「射雁式」", "「燕子抄水」", "「小魁星」",
        "「挑帘式」", "「风扫梅花」", "「车轮剑」",
...
kezhiDesc["妙"] = {
    ...
    ["独孤九剑"] = {
        ...
        "竟然是华山「玉女十九剑」",
        "「雁回祝融」衡山五神剑",
        "松风剑法的「鸿飞冥冥」", "衡山的「一剑落九雁」",
        "运使「太极剑」剑意", "竟化「泰山十八盘」为一剑",
        "「伏魔剑」剑意表露无遗", "恒山剑法为一剑",
        "一手关外的「乱披风剑法」", "尽括嵩山剑势击向",
        "衡山的「百变千幻云雾十三式」",
        "吐气开声，一招似是「独劈华山」",
        "泰山剑法的「来鹤清泉」",
        "华山剑法「有凤来仪」的趋势",
...
kezhiDesc["空"] = {
    ...
    ["千蛛万毒手"] = {
        "「万蛛吸血」",
        "身形纵起，十指轻弹，只见缕缕内劲犹如飞瀑般向",
        "阴喝一声，双手向前舞动，突然一股内劲顺指尖破空而出，疾射",
        "深吸口气，身体急纵而上，右手食指疾伸，直戳"
    }
...
function kezhiwugong()
    ...
    flag.pfm = true
    flag.yun_roar = 0
    for i = 1, 4 do npc_order[i] = 0 end
    pk_pfm_set()
    -- print("检测变量")
end
...
function kezhiwugongAddTarget(t_name, t_id)
    local tflag = true
    for i = 1, 4 do if npc_id[i] == t_id then tflag = false end end
    if tflag then
...
function kezhiwugongRemoveTarget(t_name)
    ...
    for i = 1, 4 do
        if npc_name[i] == t_name then
            table.remove(npc_order, i, -1)
            table.insert(npc_order, i, -1)
        end
    end
...
function kezhiwugongStart()
    ...
    for i = 1, 4 do
        if (npc_name[i] ~= nil) then
            ...
            kflag[i] = 1
            npc_num = npc_num + 1
            create_trigger_t('afight1' .. i, '^(> )*(\\D*)' .. npc_name[i] ..
                                 '(\\D*)' .. '！$', '', 'kezhiwugongcheck' .. i)
            create_trigger_t('afight2' .. i, '^(> )*(\\D*)' .. npc_name[i] ..
                                 '见势不妙，(便拿出\\D*做武器|招式一变，改用\\D*向你发起攻击)。$',
                             '', 'kezhiwugongReStart' .. i)
            create_trigger_t('afight3' .. i, '^(> )*(\\D*)' .. npc_name[i] ..
                                 '(\\D*)' .. '(青|伤害)。$', '',
                             'kezhiwugongcheck' .. i)
            create_trigger_t('afight4',
                             '^(> )*(你现在不能激发特殊技能|你上一个动作还没有完成|你正忙着呢|你合气度不足无法|你捡起一柄)\\D*',
                             '', 'fight_busy')
            create_trigger_t('afight101',
                             '^(> )*你一套狂风绝技施展完毕，身形慢了下来',
                             '', 'kuangfeng_done')
...
function kezhiwugongkill(p_num)
    ...
    for v in pairs(npcdienum) do
        if npcdienum[v] == npc_name[p_num] then tempv = true end
    end
    if job.name == 'songmoya' then
        if tempv then
            if p_num == 1 then p_pum = 2 end
            if p_num == 2 then p_pum = 1 end
            kflag[p_num] = 2
            tempv = false
        end
    end
...
function kezhiwugongValue(kzValue, i, kezhiwugongName)
    local tflag = true
    if flag.yuxiao == true and kezhiwugongName == '玉箫剑法' then
        kzValue = '险'
    end
    if job.name == 'songmoya' then
        if i == 1 then
            if sxjob.skills1 ~= nil and sxjob.skills1 == '散花掌' and
                kezhiwugongName == '般若掌' then kzValue = '正' end
        end
        if i == 2 then
            if sxjob.skills2 ~= nil and sxjob.skills2 == '散花掌' and
                kezhiwugongName == '般若掌' then kzValue = '正' end
        end
    end
    ...
    if tflag then
        if kezhiwugongName ~= '五虎断门刀' then
            if (job.name == 'diemenglou' or job.name == 'pk') and
                kezhiwugongName == '空明拳' then
                print('假空属性，不变招！')
            else
...
function kezhiwugongcheck3(n, l, w) kezhiwugongcheck(3, n, l, w) end
function kezhiwugongcheck4(n, l, w) kezhiwugongcheck(4, n, l, w) end
function kezhiwugongcheck(i, n, l, w)
    pk_pfm_set()
    local tmpdes = ""
    if string.find(w[2], "猛听得你“呜哗”一声大喝") then
        print("----------检测到天龙寺狮子吼-----------")
        flag.yun_roar = 1
    end
    if job.name == 'pk' then
        ...
        if flag.ushape == false then
            if string.find(w[3], "箫向") or string.find(w[3], "箫斜") or
                string.find(w[3], "箫轻") or string.find(w[3], "箫虚") or
                string.find(w[3], "箫蓦") then flag.yuxiao = true end
            if string.find(w[3], "剑向") or string.find(w[3], "剑斜") or
                string.find(w[3], "剑轻") or string.find(w[3], "剑虚") or
                string.find(w[3], "剑蓦") then flag.yuxiao = false end
        end
    end
    if job.name == 'hubiao' and
        (string.find(w[2], tostring(partner)) or
            string.find(w[2], tostring(zbt_name)) or string.find(w[2], "镖师")) then
        return
    end

    -- 天地会临时加入，防止同伙招式误判为克制武功
    if job.name == 'tdh' and ((job.target2 and
        (string.find(w[2], job.target2) or string.find(w[3], job.target2))) or
        (job.target3 and
            (string.find(w[2], job.target3) or string.find(w[3], job.target3)))) then
        return
    end
    if string.find(w[2], "蓦地里一股力道飞来，将") or
        string.find(w[2], "当下一股内力冲向") or
        string.find(w[3], "双手前探，左臂搭上") or
        string.find(w[3], "星移斗转，") or string.find(w[3],
                                                            "作壁上观，双手与对方相交数掌，谈笑间竟使出") or
        string.find(w[3], "使出的招数好") or string.find(w[3],
                                                               "身如飘风，恰似漫天星移，诡异地一式，双掌动向无定不可捉摸地拍向") or
    ...
    if w[2] ~= nil then
        if string.find(w[2], "你") and
            string.find(w[2], "使出桃花岛「狂风绝技」") then
            exe('jiali max')
        end
    ...
    if string.find(w[2],
        ...
        string.find(w[3],
                    "对着你的背部踢去，正是一招「神龙追逝") then
        return kezhiwugongValue("刚", i, "神龙腿法")
    end
    if string.find(w[3], "从四面八方射向你") then
        return kezhiwugongValue("险", i, "弹指神通")
    end
    if string.find(w[2], "一道如烟似雾的掌气在") or
        string.find(w[3], "一道如烟似雾的掌气在") then
        return kezhiwugongValue("柔", i, "化骨绵掌")
    end
    if string.find(w[2], "掌印就如追魂跗骨般，眨眼就印到了") or
        string.find(w[3], "掌印就如追魂跗骨般，眨眼就印到了") then
        return kezhiwugongValue("柔", i, "化骨绵掌")
    end
    if string.find(w[2], "太极圆圈套") or
        string.find(w[3], "太极圆圈套") then
        return kezhiwugongValue("柔", i, "太极拳")
    end
    if string.find(w[2], "无相劫") or string.find(w[3], "无相劫") then
        return kezhiwugongValue("无", i, "无相劫指")
    end
    if string.find(w[2], "满场游走，东刺一剑，西刺一剑") or
        string.find(w[3], "满场游走，东刺一剑，西刺一剑") then
        return kezhiwugongValue("妙", i, "独孤九剑")
    end
    if string.find(w[2], "一式「想入非非」") or
        string.find(w[3], "一式「想入非非」") then
        return kezhiwugongValue("慢", i, "黯然销魂掌")
    end
    if string.find(w[2], "一招「饮恨吞声」") or
        string.find(w[3], "一招「饮恨吞声」") then
        return kezhiwugongValue("慢", i, "黯然销魂掌")
    end
    ...
    -- print(tmpdes)
    -- print("----------正在检测-----------")
    if string.find(tmpdes, "「摘星换斗」") and
        string.find(tmpdes, "的后背斫去") then
    ...
    if string.find(tmpdes,
                   "对着你的背部踢去，正是一招「神龙追逝") then
        return kezhiwugongValue("刚", i, "神龙腿法")
    end
    -------华山独孤九剑set po 判断---------
    if score.party == '华山派' then
        if string.find(tmpdes, "掌") then
            print('tmpdes=' .. tmpdes)
            exe('set po 掌')
        end
        if string.find(tmpdes, "剑") then
            print('tmpdes=' .. tmpdes)
            exe('set po 剑')
        end
        if string.find(tmpdes, "枪") then
            print('tmpdes=' .. tmpdes)
            exe('set po 枪')
        end
        if string.find(tmpdes, "刀") then
            print('tmpdes=' .. tmpdes)
            exe('set po 刀')
        end
    end
...
function kezhiwugongAttribue(kezhiSkillName)
    for v, p in pairs(kezhiDesc) do
        for j, k in pairs(p) do if j == kezhiSkillName then return v end end
    end
end
    ...
    elseif job.name == 'songmoya' then
        if score.party == '桃花岛' then
            ...
            if yptteam > 18 and yptteam < 23 then
                exe('jiali 1;set jybgz 1;set hmg 逆转')
                create_alias('kezhiwugongpfm', 'kezhiwugongpfm',
                             'alias pppp' .. i .. ' ' ..
                                 GetVariable(pk_valuecmd[tempatt]) .. ';' ..
                                 GetVariable("smybuff") .. ';' ..
...
function kezhiwugongsuccess(kezhi_cmd, k_order, npci)
    ...
    for i = 1, npc_num do
        ...
        if npc_name[i] ~= nil and kflag[i] > 0 and npc_name[i] == npc_name[npci] then
            ...
            if i == npc_num then break end
        end
    end
    if job.name == 'songmoya' then
        if npc_order[1] ~= nil then
            print('npc_order[1]=' .. npc_order[1])
        end
        if npc_order[2] ~= nil then
            print('npc_order[2]=' .. npc_order[2])
        end
    ...
    if kezhisuccess >= npc_num or table.getn(npcdienum) > 0 then
        local tflag = 1
        for i = 2, npc_num do
            if npc_order[i] ~= nil and npc_order[tflag] ~= nil and npc_order[i] >
                npc_order[tflag] then
                print(npc_order[i], npc_order[tflag])
                tflag = i
            end
        end
        if job.name == 'songmoya' and yptteam >= smyteam and flag.shoot then
            flag.shoot = false
            if tflag == 1 then exe('shoot ' .. npc_id[2]) end
            if tflag == 2 then exe('shoot ' .. npc_id[1]) end
        end
        kflag[tflag] = 2
...
function kuangfeng_done() exe('jiali 1') end
function pk_heqi_control()
    if flag.buff then

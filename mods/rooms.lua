...
function isCity(p_city)
    ...
    for k, v in pairs(citys) do if v == p_city then l_result = true end end
    for k, v in pairs(lookCitys) do if v == p_city then l_result = true end end
    for k, v in pairs(otherCitys) do if v == p_city then l_result = true end end
    return l_result
end
...
function getCityRooms(city)
    ...
    for id, room in pairs(map.rooms) do
        local lookCity = isCityFw and getFirstWord(getLookCity(room.id)) or
                             getLookCity(room.id)
        local taskCity = isCityFw and getFirstWord(getCity(room.id)) or
                             getCity(room.id)
        if (city == lookCity) or (city == taskCity) or
            (room.outdoor and room.outdoor == city) then
    ...
    for id, room in pairs(map.rooms) do
        ...
        if roomName == name then
            if not city then
                ...
                local lookCity =
                    isCityFw and getFirstWord(getLookCity(room.id)) or
                        getLookCity(room.id)
                local taskCity = isCityFw and getFirstWord(getCity(room.id)) or
                                     getCity(room.id)
                if (isLookCity and city == lookCity) or
                    (isTaskCity and city == taskCity) or
                    (room.outdoor and room.outdoor == city) then
                    -- print('rooms.id='..id)
                    table.insert(rooms, id)
                end
...
function getFindPath(from, name, city, length)
    ...
    for id in pairs(rooms) do table.insert(to, id) end
...
function getNearRoom(from, to)
    if type(from) == "table" then from = from[1] end
    if countTab(to) == 1 then return to[1] end
...
function SjMap:room(id) return self.rooms[id] end
...
function SjMap:getMinRoom(pending)
    ...
    if processRoomId then pending[processRoomId] = nil end
    ...
    for route, to in pairs(fromRoom.ways) do
        ...
        if routeLength then
            ...
            if distance == nil or length < distance then
                distances[to] = length
                if red[to] == nil then pending[to] = length end
...
function Cache:get(key)
    ...
    for k, v in pairs(self) do
        if type(k) == "number" and v.key == key and os.time() - v.time <=
            self.time then
...
function Cache:add(key, value)
    ...
    v.time = os.time()
    table.insert(self, 1, v)
    if table.getn(self) > self.size then table.remove(self, self.size + 1) end
end
...
function SjMap:getAroundRooms(path, length)
    ...
    for k, v in pairs(distances) do
        ...
        if string.find(path, 'yanziwu/') and string.find(k, 'yanziwu/') and v <=
            length then table.insert(rooms, k) end
        if string.find(path, 'mtl/') and string.find(k, 'mtl/') and v <= length then
            table.insert(rooms, k)
        end
        if not string.find(path, 'mr/') and not string.find(path, 'yanziwu/') and
            not string.find(path, 'mtl/') and v <= length then
            table.insert(rooms, k)
        end
    end
    return rooms
...
function Room(room)
    ...
    if group == 1 then r.nolook = true end
    map:addRoom(r)
end
...
Room {
    id = "baituo/btshan",
    name = "白驼山",
    ways = {["westup"] = "baituo/shanmen", ["east"] = "hj/gebin"}
}
Room {
    id = "baituo/chucang",
    name = "储藏室",
    ways = {["east"] = "baituo/kongdi"}
}
Room {
    id = "baituo/fengxi",
    name = "缝隙",
    ways = {["north"] = "baituo/fengxi1", ["out"] = "baituo/yuanzi2"}
}
Room {
    id = "baituo/fengxi1",
    name = "缝隙",
...
Room {
    id = "baituo/fengxi2",
    name = "缝隙",
    ways = {["east"] = "baituo/fengxi1", ["out"] = "baituo/yuanzi4"}
}
Room {
    id = "baituo/kongdi",
    name = "空地",
...
Room {id = "baituo/midao", name = "秘道", ways = {["west"] = "baituo/midao1"}}
Room {
    id = "baituo/midao1",
    name = "秘道",
    ways = {["westdown"] = "baituo/midao2", ["east"] = "baituo/midao"}
}
Room {
    id = "baituo/midao2",
    name = "秘道",
...
Room {
    id = "baituo/midao5",
    name = "秘道",
    ways = {["eastdown"] = "baituo/midao6", ["westup"] = "baituo/midao2"}
}
Room {
    id = "baituo/midao6",
    name = "秘道",
...
Room {
    id = "baituo/shanmen",
    name = "白驼山庄山门",
    ways = {["northup"] = "baituo/kongdi", ["eastdown"] = "baituo/btshan"}
}
Room {id = "baituo/shetan", name = "蛇潭"}
Room {
    id = "baituo/shuifang",
    name = "睡房",
    no_fight = true,
    ways = {["west"] = "baituo/tangwu"}
}
Room {
    id = "baituo/tangwu",
    name = "堂屋",
...
Room {
    id = "baituo/yaofang",
    name = "药房",
    ways = {["east"] = "baituo/tangwu"}
}
Room {
    id = "baituo/yuanzi",
    name = "花园",
    ways = {["south"] = "baituo/tuitang"}
}
Room {
    id = "baituo/yuanzi1",
    name = "院子",
    ways = {["northwest"] = "baituo/yuanzi2", ["jumpdown"] = "baituo/shetan"}
}
Room {
    id = "baituo/yuanzi2",
    name = "院子",
...
Room {
    id = "baituo/yuanzi5",
    name = "院子",
    ways = {["southeast"] = "baituo/yuanzi3", ["southwest"] = "baituo/yuanzi4"}
}
Room {id = "beijing/jiuguan1", name = "小酒馆"}
Room {
    id = "beijing/road1",
    name = "长安街",
    ways = {["south"] = "beijing/jiuguan1"}
}
Room {
    id = "cangzhou/bank",
    name = "天音阁",
    ways = {["west"] = "cangzhou/beijie1"},
    objs = {["蒋调侯"] = "jiang tiaohou"}
}
Room {
    id = "cangzhou/beijie1",
    name = "北街",
...
Room {
    id = "cangzhou/beimen",
    name = "北门",
    ways = {["south"] = "cangzhou/beijie1", ["north"] = "cangzhou/dyd1"}
}
Room {
    id = "cangzhou/dyd1",
    name = "大驿道",
    ways = {["south"] = "cangzhou/beimen", ["north"] = "cangzhou/dyd2"},
    room_relative = "大驿道｜大驿道｜北门大驿道"
}
Room {
    id = "cangzhou/dyd2",
    name = "大驿道",
    ways = {["northwest"] = "cangzhou/dyd3", ["south"] = "cangzhou/dyd1"},
    room_relative = "大驿道↖大驿道｜大驿道大驿道"
}
Room {
    id = "cangzhou/dyd3",
    name = "大驿道",
    ways = {["southeast"] = "cangzhou/dyd2"},
    room_relative = "大驿道↘大驿道大驿道"
}
Room {
    id = "cangzhou/changku",
    name = "仓库",
    ways = {["north"] = "cangzhou/mihang"}
}
Room {
    id = "cangzhou/dangpu",
    name = "沧州当铺",
    no_fight = true,
    ways = {["north"] = "cangzhou/xijie1"},
    objs = {["黄老板"] = "huang laoban"}
}
Room {
...
Room {
    id = "cangzhou/dongmen",
    name = "东门",
    ways = {["east"] = "cangzhou/eroad1", ["west"] = "cangzhou/dongjie1"}
}
Room {
    id = "cangzhou/eroad1",
    name = "大驿道",
    ways = {["east"] = "cangzhou/eroad2", ["west"] = "cangzhou/dongmen"},
...
Room {
    ...
    objs = {["江北大盗"] = "jiangbei dadao"},
    room_relative = "大驿道↗大驿道↙大驿道大驿道"
}
Room {
    id = "cangzhou/feiyuan",
    name = "废园",
    ways = {["enter"] = "cangzhou/tingtang", ["west"] = "cangzhou/beijie3"},
    objs = {["方舵主"] = "fang duozhu", ["简长老"] = "jian zhanglao"}
}
Room {
    id = "cangzhou/fuya",
    name = "沧州府衙",
    ways = {["east"] = "cangzhou/beijie2", ["west"] = "cangzhou/zhenting"},
    blocks = {["west"] = {{id = "ya yi", exp = 17500}}}
}
Room {
    id = "cangzhou/gongdi",
    name = "工地",
    ways = {["west"] = "cangzhou/beijie2"}
}
Room {
    id = "cangzhou/huadian",
    name = "花店",
    ways = {["west"] = "cangzhou/nanjie1"}
}
Room {
    id = "cangzhou/kezhan",
    name = "大客栈",
    ...
    lengths = {["#cangzhoukedian"] = 5},
    objs = {["苗若兰"] = "miao ruolan"}
}
Room {
    id = "cangzhou/kezhan2",
    name = "客栈二楼",
    no_fight = true,
    ways = {["enter"] = "cangzhou/sleeproom", ["down"] = "cangzhou/kezhan"},
    room_relative = "客店二楼∧客栈二楼〓大客栈客栈二楼"
}
Room {
    id = "cangzhou/mihang",
    name = "米行",
    ways = {["south"] = "cangzhou/changku", ["east"] = "cangzhou/beijie1"},
    objs = {["王大米"] = "wang dami"}
}
Room {
    id = "cangzhou/mingju",
    name = "民居",
    ways = {["east"] = "cangzhou/beijie3"}
}
Room {
    id = "cangzhou/nanjie1",
    name = "南街",
...
Room {
    id = "cangzhou/nanmen",
    name = "南门",
    ways = {["south"] = "cangzhou/sroad1", ["north"] = "cangzhou/nanjie1"}
}
Room {
    id = "cangzhou/sancakou",
    name = "三岔路",
    ways = {["southeast"] = "cangzhou/wroad4", ["west"] = "hmy/pingding/road9"}
}
Room {
    id = "cangzhou/sleeproom",
    name = "客店二楼",
    no_fight = true,
    ways = {["out"] = "cangzhou/kezhan2"},
    room_relative = "客店二楼∨客栈二楼客店二楼"
}
Room {
    id = "cangzhou/sroad1",
    name = "官道",
    ways = {["south"] = "cangzhou/sroad2", ["north"] = "cangzhou/nanmen"},
    room_relative = "南门｜官道｜官道官道"
}
Room {
    id = "cangzhou/sroad2",
    name = "官道",
    ways = {["southeast"] = "cangzhou/sroad3", ["north"] = "cangzhou/sroad1"},
...
Room {
    id = "cangzhou/sroad4",
    name = "官道",
    ways = {["south"] = "huanghe/road3", ["northwest"] = "cangzhou/sroad3"},
...
Room {
    ...
    name = "厅堂",
    no_fight = true,
    ways = {["out"] = "cangzhou/feiyuan"}
}
Room {
    id = "cangzhou/wroad1",
    name = "驿道",
    ways = {["east"] = "cangzhou/ximen", ["west"] = "group/entry/czwroad2"},
...
Room {
    id = "cangzhou/wroad4",
    name = "驿道",
    ways = {["northwest"] = "cangzhou/sancakou", ["east"] = "cangzhou/wroad3"},
...
Room {
    id = "cangzhou/ximen",
    name = "西门",
    ways = {["east"] = "cangzhou/xijie1", ["west"] = "cangzhou/wroad1"}
}
Room {
    id = "cangzhou/xiyuanzi",
    name = "戏园",
    ways = {["east"] = "cangzhou/nanjie1"}
}
Room {
    id = "cangzhou/yizhan",
    name = "驿站",
    ways = {["south"] = "cangzhou/xijie1"}
}
Room {
    id = "cangzhou/zhenting",
    name = "府衙正厅",
    ways = {["east"] = "cangzhou/fuya"}
}
Room {
...
Room {
    id = "changan/beilin",
    name = "碑林",
    ways = {["east"] = "changan/baishulin1"}
}
Room {
    id = "changan/biaoju",
    name = "虎威镖局",
    ways = {["south"] = "changan/biaoju2", ["north"] = "changan/westjie3"}
}
Room {
    id = "changan/biaoju2",
    name = "镖局大厅",
    ways = {["north"] = "changan/biaoju"},
    objs = {["周虎威"] = "zhou huwei"}
}
Room {
    id = "changan/bingqipu",
    name = "兵器铺",
    ways = {["west"] = "changan/southjie2"}
}
Room {
    id = "changan/bingying",
    name = "兵营大门",
    ways = {["south"] = "changan/bingying2", ["north"] = "changan/eastjie4"},
    blocks = {["south"] = {{id = "guan bing", exp = 10000}}}
}
Room {
    id = "changan/bingying2",
    name = "兵营",
    ways = {["north"] = "changan/bingying"}
}
Room {
    id = "changan/chaguan",
    name = "茶馆",
    ways = {["south"] = "changan/eastjie2"}
}
Room {
...
Room {
    id = "changan/chm",
    name = "城隍庙",
    ways = {["north"] = "changan/westjie4"}
}
Room {
    id = "changan/ciensi",
    name = "慈恩寺",
    ways = {["northwest"] = "changan/changjie2", ["east"] = "changan/dayanta1"}
}
Room {
    id = "changan/dadian",
    name = "大殿",
    ways = {["south"] = "changan/qingzhensi", ["north"] = "changan/houdian"}
}
Room {
    id = "changan/dangpu",
    name = "当铺",
    no_fight = true,
    ways = {["west"] = "changan/southjie1"}
}
Room {
    id = "changan/dayanta1",
    name = "大雁塔",
    ways = {["west"] = "changan/ciensi", ["up"] = "changan/dayanta2"}
}
Room {
    id = "changan/dayanta2",
    name = "大雁塔二层",
    ways = {["down"] = "changan/dayanta1", ["up"] = "changan/dayanta3"}
}
Room {
    id = "changan/dayanta3",
    name = "大雁塔三层",
    ways = {["down"] = "changan/dayanta2", ["up"] = "changan/dayanta4"}
}
Room {
    id = "changan/dayanta4",
    name = "大雁塔四层",
    ways = {["down"] = "changan/dayanta3", ["up"] = "changan/dayanta5"}
}
Room {
    id = "changan/dayanta5",
    name = "大雁塔五层",
    ways = {["down"] = "changan/dayanta4", ["up"] = "changan/dayanta6"}
}
Room {
    id = "changan/dayanta6",
    name = "大雁塔六层",
    ways = {["down"] = "changan/dayanta5", ["up"] = "changan/dayanta7"}
}
Room {
    id = "changan/dayanta7",
    name = "大雁塔七层",
    ways = {["down"] = "changan/dayanta6"}
}
Room {
    id = "changan/dewentang",
    name = "德文堂",
    ways = {["east"] = "changan/southjie2"},
    objs = {["唐文德"] = "tang wende"}
}
Room {
    id = "changan/duchang",
    name = "赌场",
    ways = {["north"] = "changan/eastjie1"}
}
Room {
    id = "changan/eastchl",
    name = "东门城楼",
...
Room {
    id = "changan/eastchq1",
    name = "东城墙",
    ways = {["south"] = "changan/eastchq2", ["north"] = "changan/lwtne"},
    room_relative = "了望台｜东城墙｜东城墙东城墙"
}
Room {
    id = "changan/eastchq2",
    name = "东城墙",
    ways = {["south"] = "changan/eastjl1", ["north"] = "changan/eastchq1"},
    room_relative = "东城墙｜东城墙｜箭楼东城墙"
}
Room {
    id = "changan/eastchq3",
    name = "东城墙",
    ways = {["south"] = "changan/eastchq4", ["north"] = "changan/eastjl2"},
    room_relative = "箭楼｜东城墙｜东城墙东城墙"
}
Room {
    id = "changan/eastchq4",
    name = "东城墙",
    ways = {["south"] = "changan/lwtse", ["north"] = "changan/eastchq3"},
...
Room {
    id = "changan/eastjl1",
    name = "箭楼",
    ways = {["south"] = "changan/eastchl", ["north"] = "changan/eastchq2"},
    room_relative = "东城墙｜箭楼｜东门城楼箭楼"
}
Room {
    id = "changan/eastjl2",
    name = "箭楼",
    ways = {["south"] = "changan/eastchq3", ["north"] = "changan/eastchl"},
...
Room {
    ...
    blocks = {
        ["up"] = {
            {id = "guan bing", exp = 10000}, {id = "wu jiang", exp = 75000}
        }
    }
}
Room {
    ...
    name = "官道",
    ways = {["east"] = "changan/eastroad2", ["west"] = "changan/eastmen"},
...
Room {
    ...
    name = "官道",
    ways = {["east"] = "group/entry/caeroad3", ["west"] = "changan/eastroad1"},
...
Room {
    ...
    name = "凤池",
    no_fight = true,
    ways = {["west"] = "changan/qingchi"}
}
Room {
    id = "changan/gulou",
    name = "鼓楼",
    ways = {["southeast"] = "changan/zhonglou", ["south"] = "changan/westjie1"}
}
Room {
    id = "changan/heishi",
    name = "黑市",
    ways = {["east"] = "changan/shiji"}
}
Room {
    id = "changan/houdian",
    name = "后殿",
    ways = {["south"] = "changan/dadian"}
}
Room {
    id = "changan/huadian",
    name = "花店",
    ways = {["north"] = "changan/eastjie3"}
}
Room {
...
Room {
    id = "changan/jiashan",
    name = "假山",
    ways = {["east"] = "changan/jinghu"}
}
Room {
    id = "changan/jinghu",
    name = "镜湖",
    ways = {["east"] = "changan/southjie3", ["west"] = "changan/jiashan"}
}
Room {
    id = "changan/jiuguan",
    name = "酒馆",
    ways = {["north"] = "changan/neijie1"}
}
Room {
    id = "changan/jjfhhy",
    name = "后花园",
    ways = {["north"] = "changan/jjfhm", ["west"] = "changan/jjflt"}
}
Room {
    id = "changan/jjfhm",
    name = "后门",
    ways = {["south"] = "changan/jjfhhy", ["north"] = "changan/jjfzht"}
}
Room {
    id = "changan/jjflt",
    name = "凉亭",
    ways = {["east"] = "changan/jjfhhy"}
}
Room {
    id = "changan/jjfws",
    name = "卧室",
    no_fight = true,
    ways = {["east"] = "changan/jjfzht"}
}
Room {
    id = "changan/jjfxf",
    name = "厢房",
    ways = {["east"] = "changan/jiangjunfu"}
}
Room {
    id = "changan/jjfyt",
    name = "宴厅",
    ways = {["west"] = "changan/jjfzht"}
}
Room {
    id = "changan/jjfzht",
    name = "正厅",
    ...
    blocks = {
        ["west"] = {{id = "guan jia", exp = 10000}},
        ["south"] = {{id = "guan jia", exp = 10000}},
        ["east"] = {{id = "guan jia", exp = 10000}}
    }
}
Room {
    id = "changan/juhao",
    name = "聚豪酒楼",
    ways = {["west"] = "changan/northjie1", ["up"] = "changan/juhao2"}
}
Room {
    id = "changan/juhao2",
    name = "酒楼二楼",
    no_fight = true,
    ways = {["down"] = "changan/juhao"}
}
Room {
    id = "changan/kezhan",
    name = "聚豪客栈",
    no_fight = true,
    ways = {["#jhkzout"] = "changan/northjie1", ["#jhkz"] = "changan/kezhan2"},
    nolooks = {["up"] = true},
    lengths = {["#jhkz"] = 5}
}
Room {
    id = "changan/kezhan2",
    name = "走廊",
    ways = {["north"] = "changan/kezhan3", ["down"] = "changan/kezhan"}
}
Room {
    id = "changan/kezhan3",
    name = "客房",
    no_fight = true,
    ways = {["south"] = "changan/kezhan2"}
}
Room {
    id = "changan/lijia",
    name = "李家大院",
...
Room {
    ...
    name = "卧室",
    no_fight = true,
    ways = {["east"] = "changan/ljzt"}
}
Room {
    id = "changan/ljyanting",
    name = "宴厅",
    ways = {["south"] = "changan/ljzt"}
}
Room {
    id = "changan/ljzhangfang",
    name = "帐房",
    ways = {["south"] = "changan/lijia"}
}
Room {
    id = "changan/ljzt",
    name = "正厅",
...
Room {
    ...
    name = "龙池",
    no_fight = true,
    ways = {["east"] = "changan/qingchi"}
}
Room {
    id = "changan/lwtne",
    name = "了望台",
    ways = {["south"] = "changan/eastchq1", ["west"] = "changan/northchq6"},
    room_relative = "北城墙----了望台｜东城墙了望台",
    blocks = {
        ["south"] = {{id = "zhiqin bing", exp = 10000}},
        ["west"] = {{id = "zhiqin bing", exp = 10000}}
    },
    objs = {["值勤兵"] = "zhiqin bing"}
}
Room {
    id = "changan/lwtnw",
    name = "了望台",
    ways = {["south"] = "changan/westchq1", ["east"] = "changan/northchq1"},
    room_relative = "了望台----北城墙｜西城墙了望台",
    blocks = {
        ["south"] = {{id = "zhiqin bing", exp = 10000}},
        ["east"] = {{id = "zhiqin bing", exp = 10000}}
    },
    objs = {["值勤兵"] = "zhiqin bing"}
}
Room {
    id = "changan/lwtse",
    name = "了望台",
    ways = {["north"] = "changan/eastchq4", ["west"] = "changan/southchq6"},
    room_relative = "东城墙｜南城墙----了望台了望台",
    blocks = {
        ["north"] = {{id = "zhiqin bing", exp = 10000}},
        ["west"] = {{id = "zhiqin bing", exp = 10000}}
    },
    objs = {["值勤兵"] = "zhiqin bing"}
}
Room {
    id = "changan/lwtsw",
    name = "了望台",
    ways = {["north"] = "changan/westchq4", ["east"] = "changan/southchq1"},
...
Room {
    id = "changan/minju1",
    name = "民居",
    ways = {["south"] = "changan/shiji"},
    room_relative = "民居｜市集民居"
}
Room {
    id = "changan/minju2",
    name = "民居",
    ways = {["north"] = "changan/shiji"},
    objs = {["大老鼠"] = "da laoshu"},
...
Room {
    id = "changan/minju3",
    name = "民居",
    ways = {["south"] = "changan/neijie1"}
}
Room {
    id = "changan/minju4",
    name = "民居",
    ways = {["south"] = "changan/neijie2"}
}
Room {
    id = "changan/minju5",
    name = "民居",
    ways = {["south"] = "changan/neijie3"}
}
Room {
    id = "changan/minju6",
    name = "民居",
    ways = {["south"] = "changan/neijie4"}
}
Room {
    id = "changan/minju7",
    name = "民居",
    ways = {["south"] = "changan/neijie5"}
}
Room {
    id = "changan/neijie1",
    name = "内街",
...
Room {
    id = "changan/neijie6",
    name = "内街",
    ways = {["south"] = "changan/neijie7", ["north"] = "changan/neijie5"},
...
Room {
    ...
    name = "北城墙",
    ways = {["east"] = "changan/northchq2", ["west"] = "changan/lwtnw"},
    room_relative = "了望台----北城墙----北城墙北城墙"
}
Room {
    id = "changan/northchq2",
    name = "北城墙",
    ways = {["east"] = "changan/northchq3", ["west"] = "changan/northchq1"},
    room_relative = "北城墙----北城墙----北城墙北城墙"
}
Room {
    id = "changan/northchq3",
    name = "北城墙",
    ways = {["east"] = "changan/northjl1", ["west"] = "changan/northchq2"},
    room_relative = "北城墙----北城墙----箭楼北城墙"
}
Room {
    id = "changan/northchq4",
    name = "北城墙",
    ways = {["east"] = "changan/northchq5", ["west"] = "changan/northjl2"},
    room_relative = "箭楼----北城墙----北城墙北城墙"
}
Room {
    id = "changan/northchq5",
    name = "北城墙",
    ways = {["east"] = "changan/northchq6", ["west"] = "changan/northchq4"},
    room_relative = "北城墙----北城墙----北城墙北城墙"
}
Room {
    id = "changan/northchq6",
    name = "北城墙",
    ways = {["east"] = "changan/lwtne", ["west"] = "changan/northchq5"},
...
Room {
    id = "changan/northjl1",
    name = "箭楼",
    ways = {["east"] = "changan/northchl", ["west"] = "changan/northchq3"},
    room_relative = "北城墙-----箭楼-----北门城楼箭楼"
}
Room {
    id = "changan/northjl2",
    name = "箭楼",
    ways = {["east"] = "changan/northchq4", ["west"] = "changan/northchl"},
...
Room {
    ...
    name = "官道",
    ways = {["south"] = "changan/northmen", ["north"] = "changan/northroad2"},
...
Room {
    ...
    name = "官道",
    ways = {["south"] = "changan/northroad1", ["north"] = "changan/northroad3"},
...
Room {
    ...
    room_relative = "土路↗土路↓土路土路",
    objs = {["长安客商"] = "changan keshang"}
}
Room {
    id = "changan/northroad8",
    name = "土路",
    ways = {["southwest"] = "changan/northroad7", ["north"] = "changan/road2"},
    room_relative = "陕晋渡口｜土路↙土路土路"
}
Room {
    id = "changan/northroad9",
    name = "大道",
    ways = {["south"] = "changan/road3", ["north"] = "changan/northroad10"},
    room_relative = "大道｜大道｜陕晋渡口大道"
}
Room {
    id = "changan/qianzhuang",
    name = "威信钱庄",
    ways = {["east"] = "changan/southjie1"},
    objs = {["钱眼开"] = "qian yankai"}
}
Room {
    id = "changan/qingchi",
    name = "清池",
    ...
    nolooks = {["east"] = true, ["west"] = true}
}
Room {
    id = "changan/qingzhensi",
    name = "清真寺",
    ways = {["south"] = "changan/westjie4", ["north"] = "changan/dadian"}
}
Room {
    id = "changan/road2",
    name = "陕晋渡口",
...
Room {
    ...
    name = "南城墙",
    ways = {["east"] = "changan/southchq2", ["west"] = "changan/lwtsw"},
    room_relative = "了望台----南城墙----南城墙南城墙"
}
Room {
    id = "changan/southchq2",
    name = "南城墙",
    ways = {["east"] = "changan/southchq3", ["west"] = "changan/southchq1"},
    room_relative = "南城墙----南城墙----南城墙南城墙"
}
Room {
    id = "changan/southchq3",
    name = "南城墙",
    ways = {["east"] = "changan/southjl1", ["west"] = "changan/southchq2"},
    room_relative = "南城墙----南城墙----箭楼南城墙"
}
Room {
    id = "changan/southchq4",
    name = "南城墙",
    ways = {["east"] = "changan/southchq5", ["west"] = "changan/southjl2"},
    room_relative = "箭楼----南城墙----南城墙南城墙"
}
Room {
    id = "changan/southchq5",
    name = "南城墙",
    ways = {["east"] = "changan/southchq6", ["west"] = "changan/southchq4"},
    room_relative = "南城墙----南城墙----南城墙南城墙"
}
Room {
    id = "changan/southchq6",
    name = "南城墙",
    ways = {["east"] = "changan/lwtse", ["west"] = "changan/southchq5"},
...
Room {
    id = "changan/southjl1",
    name = "箭楼",
    ways = {["east"] = "changan/southchl", ["west"] = "changan/southchq3"},
    room_relative = "南城墙-----箭楼-----南门城楼箭楼"
}
Room {
    id = "changan/southjl2",
    name = "箭楼",
    ways = {["east"] = "changan/southchq4", ["west"] = "changan/southchl"},
...
Room {
    ...
    blocks = {
        ["up"] = {
            {id = "wu jiang", exp = 75000}, {id = "guan bing", exp = 10000}
        }
    }
}
Room {
    ...
    name = "官道",
    ways = {["south"] = "changan/southroad2", ["north"] = "changan/southmen"},
    room_relative = "永宁门｜官道｜官道官道"
}
Room {
    id = "changan/southroad2",
    name = "官道",
    ways = {["south"] = "changan/southroad3", ["north"] = "changan/southroad1"},
    room_relative = "官道｜官道｜官道官道"
}
Room {
...
Room {
    ...
    name = "土嫖馆",
    ways = {["north"] = "changan/neijie3"}
}
Room {
    id = "changan/wanhonglou",
    name = "万红楼",
    ways = {["south"] = "changan/eastjie1"},
    objs = {["雪仙儿"] = "xue xianer"}
}
Room {
    id = "changan/wenquan",
    name = "温泉",
    ways = {["west"] = "changan/baishulin2"}
}
Room {
    id = "changan/westchl",
    name = "西门城楼",
...
Room {
    id = "changan/westchq1",
    name = "西城墙",
    ways = {["south"] = "changan/westchq2", ["north"] = "changan/lwtnw"},
    room_relative = "了望台｜西城墙｜西城墙西城墙"
}
Room {
    id = "changan/westchq2",
    name = "西城墙",
    ways = {["south"] = "changan/westjl1", ["north"] = "changan/westchq1"},
    room_relative = "西城墙｜西城墙｜箭楼西城墙"
}
Room {
    id = "changan/westchq3",
    name = "西城墙",
    ways = {["south"] = "changan/westchq4", ["north"] = "changan/westjl2"},
    room_relative = "箭楼｜西城墙｜西城墙西城墙"
}
Room {
    id = "changan/westchq4",
    name = "西城墙",
    ways = {["south"] = "changan/lwtsw", ["north"] = "changan/westchq3"},
...
Room {
    id = "changan/westjl1",
    name = "箭楼",
    ways = {["south"] = "changan/westchl", ["north"] = "changan/westchq2"},
    room_relative = "西城墙｜箭楼｜西门城楼箭楼"
}
Room {
    id = "changan/westjl2",
    name = "箭楼",
    ways = {["south"] = "changan/westchq3", ["north"] = "changan/westchl"},
...
Room {
    ...
    name = "官道",
    ways = {["east"] = "changan/westmen", ["west"] = "changan/westroad2"},
    room_relative = "官道-----官道-----安定门官道"
}
Room {
    id = "changan/westroad2",
    name = "官道",
    ways = {["northwest"] = "lanzhou/lpshan", ["east"] = "changan/westroad1"},
    room_relative = "六盘山↖官道-----官道官道"
}
Room {
    id = "changan/xiaoyanta1",
    name = "小雁塔",
    ways = {["south"] = "changan/baishulin1", ["up"] = "changan/xiaoyanta2"}
}
Room {
    id = "changan/xiaoyanta10",
    name = "小雁塔十层",
    ways = {["down"] = "changan/xiaoyanta9", ["up"] = "changan/xiaoyanta11"}
}
Room {
    id = "changan/xiaoyanta11",
    name = "小雁塔十一层",
    ways = {["down"] = "changan/xiaoyanta10", ["up"] = "changan/xiaoyanta12"}
}
Room {
    id = "changan/xiaoyanta12",
    name = "小雁塔十二层",
    ways = {["down"] = "changan/xiaoyanta11", ["up"] = "changan/xiaoyanta13"}
}
Room {
    id = "changan/xiaoyanta13",
    name = "小雁塔十三层",
    ways = {["down"] = "changan/xiaoyanta12", ["up"] = "changan/xiaoyanta14"}
}
Room {
    id = "changan/xiaoyanta14",
    name = "小雁塔十四层",
    ways = {["down"] = "changan/xiaoyanta13", ["up"] = "changan/xiaoyanta15"}
}
Room {
    id = "changan/xiaoyanta15",
    name = "小雁塔十五层",
    ways = {["down"] = "changan/xiaoyanta14"}
}
Room {
    id = "changan/xiaoyanta2",
    name = "小雁塔二层",
    ways = {["down"] = "changan/xiaoyanta1", ["up"] = "changan/xiaoyanta3"}
}
Room {
    id = "changan/xiaoyanta3",
    name = "小雁塔三层",
    ways = {["down"] = "changan/xiaoyanta2", ["up"] = "changan/xiaoyanta4"}
}
Room {
    id = "changan/xiaoyanta4",
    name = "小雁塔四层",
    ways = {["down"] = "changan/xiaoyanta3", ["up"] = "changan/xiaoyanta5"}
}
Room {
    id = "changan/xiaoyanta5",
    name = "小雁塔五层",
    ways = {["down"] = "changan/xiaoyanta4", ["up"] = "changan/xiaoyanta6"}
}
Room {
    id = "changan/xiaoyanta6",
    name = "小雁塔六层",
    ways = {["down"] = "changan/xiaoyanta5", ["up"] = "changan/xiaoyanta7"}
}
Room {
    id = "changan/xiaoyanta7",
    name = "小雁塔七层",
    ways = {["down"] = "changan/xiaoyanta6", ["up"] = "changan/xiaoyanta8"}
}
Room {
    id = "changan/xiaoyanta8",
    name = "小雁塔八层",
    ways = {["down"] = "changan/xiaoyanta7", ["up"] = "changan/xiaoyanta9"}
}
Room {
    id = "changan/xiaoyanta9",
    name = "小雁塔九层",
    ways = {["down"] = "changan/xiaoyanta8", ["up"] = "changan/xiaoyanta10"}
}
Room {
    id = "changan/xiyuan",
    name = "戏院",
    ways = {["north"] = "changan/neijie2"}
}
Room {
    id = "changan/yamen",
    name = "衙门大门",
    ways = {["south"] = "changan/westjie2", ["north"] = "changan/yamen2"},
    blocks = {["north"] = {{id = "ya yi", exp = 17500}}}
}
Room {
    id = "changan/yamen2",
    name = "衙门正厅",
    ways = {["south"] = "changan/yamen"}
}
Room {
    id = "changan/yizhan",
    name = "驿站",
    ways = {["south"] = "changan/westjie3"}
}
Room {
    id = "changan/yongkeng1",
    name = "兵马俑坑",
    ways = {["south"] = "changan/shihuangling"}
}
Room {
    id = "changan/yongkeng2",
    name = "兵马俑坑",
    ways = {["west"] = "changan/shihuangling"}
}
Room {
    id = "changan/zahuopu",
    name = "杂货铺",
    ways = {["north"] = "changan/neijie4"},
    objs = {["刘老实"] = "liu laoshi"}
}
Room {
    id = "changan/zhonglou",
...
Room {
    ...
    name = "珠宝行",
    ways = {["north"] = "changan/westjie1"}
}
Room {
    id = "changle/bajiao",
    name = "八角亭",
    ways = {["west"] = "changle/huayuan"},
    objs = {["丁当"] = "ding dang"}
}
Room {
    id = "changle/chaifang",
    name = "柴房",
    ways = {["north"] = "changle/zoulang3"}
}
Room {
    id = "changle/chufang",
    name = "厨房",
    no_fight = true,
    ways = {["north"] = "changle/zoulang2"},
    precmds = {["north"] = "drop cha;drop rice"},
    objs = {["香茶"] = "xiang cha", ["米饭"] = "mi fan"}
}
Room {
    id = "changle/damen",
    name = "大门",
    ways = {["south"] = "changle/xiaolu", ["enter"] = "changle/dating"}
}
Room {
    id = "changle/dating",
    name = "大厅",
    ways = {["north"] = "changle/zoulang4", ["out"] = "changle/damen"}
}
Room {
    id = "changle/huayuan",
    name = "花园",
...
Room {
    id = "changle/road2",
    name = "青石路",
    ways = {["northwest"] = "changle/road1", ["east"] = "changle/xiaolu"}

}
Room {
    id = "changle/road3",
    name = "大驿道",
    ways = {["southwest"] = "changle/road1"},
    room_relative = "大驿道↙大驿道大驿道"
}
...
Room {
    id = "changle/shishi",
    name = "石室",
    ways = {["west"] = "changle/yongdao"}
}
Room {
    id = "changle/shuifang",
    name = "睡房",
    no_fight = true,
    ways = {["south"] = "changle/zoulang3"}
}
Room {
    id = "changle/woshi",
    name = "卧室",
    ways = {["south"] = "changle/xiaoting"}
}
Room {
    id = "changle/xiaolu",
    name = "青石路",
    ways = {["north"] = "changle/damen", ["west"] = "changle/road2"}
}
Room {
    id = "changle/xiaoting",
    name = "小厅",
    ...
    objs = {["米横野"] = "mi hengye", ["贝海石"] = "bei haishi"}
}
Room {
    id = "changle/xiaowu",
    name = "小屋",
    ways = {["north"] = "changle/zoulang1"}
}
Room {
    id = "changle/yongdao",
    name = "甬道",
    ways = {["south"] = "changle/huayuan", ["east"] = "changle/shishi"}
}
Room {
    id = "changle/zoulang1",
    name = "东走廊",
...
Room {
    id = "changle/zoulang2",
    name = "东走廊",
    ways = {["south"] = "changle/chufang", ["west"] = "changle/zoulang1"},
    objs = {["陈冲之"] = "chen chongzhi"}
}
Room {
    id = "changle/zoulang3",
    name = "西走廊",
...
Room {
    id = "chengdu/bank",
    name = "墨玉斋",
    ways = {["east"] = "chengdu/nandajie2"},
    objs = {["王掌柜"] = "wang zhanggui"}
}
Room {
    id = "chengdu/beidajie1",
    name = "北大街",
    ways = {["south"] = "chengdu/center", ["north"] = "chengdu/beidajie2"},
...
Room {
    ...
    name = "北大街",
    ways = {["south"] = "chengdu/beidajie2", ["north"] = "chengdu/beidajie4"},
...
Room {
    id = "chengdu/cgenlu1",
    name = "城跟路",
    ways = {["east"] = "chengdu/cgenlu2", ["west"] = "chengdu/beidajie4"},
    room_relative = "北大街----城跟路----城跟路城跟路"
}
Room {
    id = "chengdu/cgenlu2",
    name = "城跟路",
    ways = {["southeast"] = "chengdu/cgenlu3", ["west"] = "chengdu/cgenlu1"},
...
Room {
    id = "chengdu/cgenlu4",
    name = "城跟路",
    ways = {["south"] = "chengdu/cgenlu5", ["northwest"] = "chengdu/cgenlu3"},
    room_relative = "城跟路↖城跟路｜城跟路城跟路"
}
Room {
    id = "chengdu/cgenlu5",
    name = "城跟路",
    ways = {["south"] = "chengdu/ddajie4", ["north"] = "chengdu/cgenlu4"},
    room_relative = "城跟路｜城跟路｜东大街城跟路"
}
Room {
    id = "chengdu/dabeimen",
    name = "大北门",
    ways = {["south"] = "chengdu/beidajie4", ["north"] = "chengdu/road4"}
}
Room {
    id = "chengdu/dadongmen",
    name = "大东门",
    ways = {["east"] = "chengdu/eroad1", ["west"] = "chengdu/ddajie4"}
}
Room {
    id = "chengdu/dananmen",
    name = "大南门",
    ways = {["south"] = "chengdu/sroad1", ["north"] = "chengdu/nandajie2"}
}
Room {
    id = "chengdu/daximen",
    name = "大西门",
    ways = {["east"] = "chengdu/xidajie2", ["west"] = "chengdu/wroad1"}
}
Room {
    id = "chengdu/ddajie1",
    name = "东大街",
...
Room {
    id = "chengdu/eroad1",
    name = "大道",
    ways = {["northeast"] = "chengdu/eroad2", ["west"] = "chengdu/dadongmen"},
    room_relative = "大道↗大东门-----大道大道",
    objs = {["刘竹庄"] = "liu zhuzhuang"}
}
Room {
    id = "chengdu/eroad2",
    name = "大道",
    ways = {["southwest"] = "chengdu/eroad1", ["northeast"] = "chengdu/eroad3"},
    room_relative = "大道↗大道↙大道大道"
}
Room {
    id = "chengdu/eroad3",
    name = "大道",
    ways = {["southwest"] = "chengdu/eroad2", ["east"] = "group/entry/cderoad4"},
    room_relative = "大道-----大道↙大道大道"
}
Room {
    id = "chengdu/guandm",
    name = "关帝庙",
    ways = {["south"] = "chengdu/xidajie2", ["north"] = "chengdu/houyuan"},
    objs = {["全冠清"] = "quan guanqing", ["李春来"] = "li chunlai"}
}
Room {
    id = "chengdu/houyuan",
    name = "后院",
    no_fight = true,
    ways = {["south"] = "chengdu/guandm"},
    objs = {["馒头"] = "man tou"}
}
Room {
    id = "chengdu/nancejie1",
    name = "南侧街",
    ways = {["south"] = "chengdu/nancejie2", ["north"] = "chengdu/ddajie3"},
    room_relative = "东大街｜南侧街｜南侧街南侧街"
}
Room {
    id = "chengdu/nancejie2",
    name = "南侧街",
    ways = {["south"] = "chengdu/nanmen", ["north"] = "chengdu/nancejie1"},
    room_relative = "南侧街｜南侧街｜小南门南侧街"
}
Room {
    id = "chengdu/nandajie1",
    name = "南大街",
    ways = {["south"] = "chengdu/nandajie2", ["north"] = "chengdu/center"},
...
Room {
    id = "chengdu/nanmen",
    name = "小南门",
    ways = {["south"] = "dali/shanlu2", ["north"] = "chengdu/nancejie2"}
}
Room {
    id = "chengdu/road1",
    name = "大道",
...
Room {
    id = "chengdu/road4",
    name = "大道",
    ways = {["south"] = "chengdu/dabeimen", ["northeast"] = "chengdu/road1"},
    room_relative = "大道↗大道｜大北门大道"
}
Room {
    id = "chengdu/shufang",
    name = "书房",
    ways = {["east"] = "chengdu/zjhall"}
}
Room {
    id = "chengdu/sroad1",
    name = "南门外",
    ways = {["southwest"] = "chengdu/tulu3", ["north"] = "chengdu/dananmen"}
}
Room {
    id = "chengdu/tulu1",
    name = "峨嵋山脚下",
    ways = {["northeast"] = "group/entry/cdtulu2", ["west"] = "emei/qingshijie"}
}
Room {
    id = "chengdu/tulu3",
    name = "土路",
...
Room {
    id = "chengdu/wroad1",
    name = "大道",
    ways = {["east"] = "chengdu/daximen", ["west"] = "chengdu/wroad2"},
    room_relative = "大道-----大道-----大西门大道"
}
Room {
    id = "chengdu/wroad2",
    name = "大道",
    ways = {["east"] = "chengdu/wroad1", ["west"] = "xueshan/tulu1"},
    room_relative = "川西土路-----大道-----大道大道"
}
Room {
    id = "chengdu/xidajie1",
    name = "西大街",
    ways = {["east"] = "chengdu/center", ["west"] = "chengdu/xidajie2"},
...
Room {
    id = "chengdu/zjmen",
    name = "子爵府门",
    ways = {["south"] = "chengdu/zjhall", ["north"] = "chengdu/ddajie2"}
}
Room {id = "city/banfang", name = "班房", ways = {["west"] = "city/menlang"}}
Room {
    id = "city/beidajie1",
    name = "北大街",
    ways = {
...
Room {
    ...
    objs = {["京城客"] = "jingcheng ke"}
}
Room {
    id = "city/beimen",
    name = "北门",
    ways = {["south"] = "city/beidajie1", ["north"] = "city/hsroad1"},
    lengths = {
...
Room {
    id = "city/bingqiku",
    name = "兵器库",
    ways = {["north"] = "city/bingying"}
}
Room {
    id = "city/bingying",
    name = "兵营",
    ways = {["east"] = "city/bingyingmen", ["south"] = "city/bingqiku"},
    blocks = {
        ["south"] = {
            {id = "guan bing", exp = 10000}, {id = "guan bing", exp = 10000},
            {id = "guan bing", exp = 10000}
        }
    },
    objs = {["史青山"] = "shi qingshan"}
}
Room {
    id = "city/bingyingmen",
    name = "兵营大门",
    ways = {["east"] = "city/guangchangxi", ["west"] = "city/bingying"}
}
Room {
    id = "city/chaguan",
    name = "茶馆",
    ways = {["east"] = "city/nandajie2"}
}
Room {
    id = "city/chemahang",
    name = "车马行",
    ways = {["west"] = "city/guangchangdong"}
}
Room {
    id = "city/chmiao",
    name = "城隍庙",
    no_fight = true,
    ways = {["northwest"] = "wizard/guest_room", ["east"] = "city/beidajie1"},
    objs = {
        ["功德箱"] = "gongde xiang",
        ["管理员处理玩家事务公告板"] = "board"
    }
...
Room {
    id = "city/damingsi",
    name = "大明寺",
    ways = {["north"] = "city/xidajie2"}
}
Room {
    id = "city/dangpu",
    name = "当铺",
    no_fight = true,
    ways = {["north"] = "city/guangchangnan"}
}
Room {
    id = "city/dating1",
    name = "赌场大厅",
    ...
    precmds = {["down"] = "give 1 gold to ping wei"},
    lengths = {["down"] = 10},
    objs = {["平威"] = "ping wei"}
}
...
Room {
    id = "city/diemenglou1",
    name = "蝶梦楼一楼",
    ways = {["up"] = "city/diemenglou2"}
}

Room {
    id = "city/laofang",
    name = "牢房",
    ways = {["give 2 silver to yu zu;wear all"] = "city/dilao"},
    nolooks = {["give 2 silver to yu zu;wear all"] = true}
}
Room {
    id = "city/dilao",
    name = "地牢",
    ways = {["southup"] = "city/fyhouyuan"}
}
Room {
    id = "city/dixiashi",
    name = "地下黑拳市",
    no_fight = true,
    ways = {["up"] = "city/dating1"}
}
Room {
    id = "city/dongdajie0",
    name = "东大街",
...
Room {
    ...
    name = "东厅",
    no_fight = true,
    ways = {["west"] = "city/ymzhengting"},
    objs = {["张帐房"] = "zhang zhangfang"}
}
Room {
    id = "city/dongting2",
    name = "盐局东厅",
    no_fight = true,
    ways = {["west"] = "city/yanju"}
}
Room {
    id = "city/dongxiangfang",
    name = "东厢房",
    ways = {["west"] = "city/lichunyuan"},
    objs = {["茅十八"] = "mao shiba"}
}
Room {
    id = "city/duchang",
...
Room {
    ...
    objs = {["拱猪交流站"] = "board", ["钱老本"] = "qian laoben"}
}
Room {
    id = "city/eproom",
    name = "拱猪东房",
    no_fight = true,
    ways = {["west"] = "city/duchang2"}
}
Room {
    id = "city/nproom",
    name = "拱猪北房",
    no_fight = true,
    ways = {["south"] = "city/duchang2"}
}
Room {
    id = "city/wproom",
    name = "拱猪西房",
    no_fight = true,
    ways = {["east"] = "city/duchang2"}
}
Room {
    id = "city/sproom",
    name = "拱猪南房",
    no_fight = true,
    ways = {["north"] = "city/duchang2"}
}
Room {
    id = "city/duchang4",
    name = "赛龟房",
    ways = {["south"] = "city/dating1"},
    objs = {
        ["千年龟"] = "sai gui",
        ["不老龟"] = "sai gui",
        ["长寿龟"] = "sai gui",
...
Room {
    id = "city/eroad2",
    name = "大驿道",
    ways = {["southeast"] = "changle/road1", ["west"] = "group/entry/yzeroad1"},
    objs = {["蒙面男子"] = "mn", ["王公公"] = "wang gonggong"},
    room_relative = "大驿道----大驿道↘大驿道大驿道"
}
Room {
    id = "city/fenduo2",
    name = "墓室",
    ways = {["jump well"] = "city/shangang", ["north"] = "city/mszoulang"},
    nolooks = {["up"] = true, ["jump well"] = true},
    objs = {
        ["奚长老"] = "xi zhanglao",
        ["马舵主"] = "ma duozhu",
        ["丐帮-扬州大勇分舵留言板"] = "board"
...
Room {
    id = "city/fyhouyuan",
    name = "府衙后院",
    ways = {["southeast"] = "city/ymzhengting", ["northdown"] = "city/dilao"},
    objs = {["大狼狗"] = "lang gou", ["敖翁"] = "ao weng"}
}

Room {
    id = "city/geyuan",
    name = "个园",
    ways = {["east"] = "city/nandajie1", ["west"] = "city/jiashan"}
}
Room {
    id = "city/guandimiao",
    name = "关帝庙",
    ways = {["southwest"] = "city/dongmen"}
}
Room {
    id = "city/guangchang",
    name = "中央广场",
...
Room {
    ...
    name = "鲜花店",
    no_fight = true,
    ways = {["south"] = "city/yizhan"},
    objs = {["紫竹"] = "zi zhu"}
}
Room {
    id = "city/hubian",
    name = "湖畔",
    ways = {["south"] = "city/xidajie2", ["north"] = "city/sxh"}
}
Room {
    id = "city/hubian1",
    name = "瘦西湖边",
    ways = {["south"] = "city/dhq", ["west"] = "city/lxs"}
}
Room {
    id = "city/jiangbei",
    name = "长江北岸",
    ...
    lengths = {["#duCjiang"] = 5000},
    nolooks = {["#duCjiang"] = true, ["enter"] = true},
    room_relative = "南门｜长江北岸---长江北岸---长江北岸长江北岸"
}
Room {
    id = "city/jiangbei1",
    name = "长江北岸",
    ways = {["east"] = "city/jiangbei"},
    nolooks = {["enter"] = true}
}
Room {
    id = "city/jiangbei2",
    name = "长江北岸",
    ways = {["west"] = "city/jiangbei"},
    nolooks = {["enter"] = true}
}
Room {
    id = "city/jiangnan",
...
Room {
    id = "city/jiangnan1",
    name = "长江南岸",
    ways = {["east"] = "city/jiangnan"},
    nolooks = {["enter"] = true}
}
Room {
    id = "city/jiangnan2",
    name = "长江南岸",
    ways = {["west"] = "city/jiangnan"},
    nolooks = {["enter"] = true}
}
Room {id = "city/jiashan", name = "假山", ways = {["east"] = "city/geyuan"}}
Room {
    id = "city/jiulou",
    name = "瘦西湖酒馆",
    ways = {["stand;up"] = "city/jiulou2", ["stand;south"] = "city/xidajie1"},
    objs = {["冼掌柜"] = "xian zhanggui", ["贾老六"] = "jia laolu"}
}
Room {
    id = "city/jiulou2",
    name = "瘦西湖雅楼",
    ways = {["down"] = "city/jiulou"},
    nolooks = {["up"] = true}
}
Room {
    id = "city/kedian",
...
Room {
    id = "city/kedian2",
    name = "客店二楼",
    ways = {["enter"] = "city/kedian3", ["down"] = "city/kedian"}
}
Room {
    id = "city/kedian3",
    name = "客店二楼",
    no_fight = true,
    ways = {["out"] = "city/kedian2"}
}
Room {
    id = "city/kongchang",
    name = "广场",
    ways = {["southwest"] = "city/guangchangbei"}
}
Room {
    id = "city/lichunyuan",
    name = "丽春院",
    ...
    objs = {["韦春芳"] = "wei chunfang"}
}
Room {
    id = "city/lxs",
    name = "莲性寺白塔",
    ways = {["east"] = "city/hubian1"}
}
Room {
    id = "city/menlang",
    name = "门廊",
...
Room {
    ...
    lengths = {
        ["north"] = "if score.gender and score.gender == '无性' then return false else return 1 end"
    }
}
Room {
    id = "city/ml1",
...
Room {
    id = "city/mszoulang",
    name = "墓室通道",
    ways = {["south"] = "city/fenduo2", ["west"] = "city/xmushi"}
}
Room {
    id = "city/nandajie1",
    name = "南大街",
...
Room {
    id = "city/nanmen",
    name = "南门",
    ways = {["south"] = "city/jiangbei", ["north"] = "city/nandajie1"}
}

Room {
    id = "city/pinqiting",
    name = "品棋亭",
    ways = {["north"] = "city/yueqidian"}
}

Room {
    id = "city/qianzhuang",
    name = "天阁斋",
    ways = {["east"] = "city/beidajie2"},
    objs = {["钱缝"] = "qian feng"}
}
Room {
    id = "city/shangang",
    name = "山冈",
    ways = {["southeast"] = "city/hsroad1", ["north"] = "city/tomb"}
}
Room {
    id = "city/shuyuan",
    name = "书院",
    ways = {["south"] = "city/dongdajie2", ["up"] = "city/wizroom"},
    objs = {["顾炎武"] = "gu yanwu"}
}
Room {
    id = "city/sroad1",
    name = "江南官道",
    ways = {["southeast"] = "suzhou/qsgdao6", ["north"] = "city/jiangnan"}
}
Room {
    id = "city/sxh",
    name = "瘦西湖",
    ways = {["south"] = "city/hubian", ["north"] = "city/dhq"}
}
Room {
    id = "city/tomb",
    name = "坟墓",
    ways = {["south"] = "city/shangang", ["pull huan;d"] = "city/fenduo2"},
    nolooks = {["pull huan;d"] = true, ["down"] = true}
}
Room {
    id = "city/winmo",
    name = "得胜山",
    ways = {["southeast"] = "city/wroad1", ["west"] = "city/miao"},
    objs = {["王潭"] = "wang tan", ["吴大鹏"] = "wu dapeng"}
}
Room {
    id = "city/wizroom",
    name = "巫师雕像陈列室",
    ways = {["down"] = "city/shuyuan"},
    objs = {["杀手的雕像"] = "statuary", ["闪电的雕像"] = "statuary"}
}
Room {
    id = "city/wroad1",
    name = "西郊",
...
Room {
    id = "city/wroad2",
    name = "青石大道",
    ways = {["east"] = "city/wroad1", ["west"] = "city/wroad3"}
}
Room {
    id = "city/wroad3",
    name = "土路",
...
Room {
    id = "city/xiaochidian",
    name = "小吃店",
    ways = {["west"] = "city/beidajie1"}
}
Room {
    id = "city/xiaopangu",
    name = "小盘古",
    ways = {["west"] = "city/nandajie1"},
    objs = {["菊友"] = "ju you"}
}
Room {
    id = "city/xidajie1",
...
Room {
    id = "city/ximen",
    name = "西门",
    ways = {["east"] = "city/xidajie1", ["west"] = "city/wroad1"},
    lengths = {
...
Room {
    id = "city/xiting",
    name = "西厅",
    ways = {["east"] = "city/ymzhengting"}
}

Room {
    id = "city/xixiangfang",
    name = "西厢房",
    ways = {["east"] = "city/lichunyuan"}
}
Room {
    id = "city/xjs",
    name = "小金山",
...
Room {
    ...
    name = "小墓室",
    no_fight = true,
    ways = {["east"] = "city/mszoulang"},
    objs = {["馒头"] = "man tou"}
}
Room {
    id = "city/yamen",
    name = "衙门大门",
    ways = {["south"] = "city/guangchangbei", ["north"] = "city/menlang"},
    blocks = {["north"] = {{id = "ya yi", exp = 17500}}},
    objs = {["百姓鸣冤板"] = "board"}
}
Room {
    id = "city/yanju",
    name = "扬州盐局",
    ways = {["east"] = "city/dongting2", ["west"] = "city/nandajie2"}
}
Room {
    id = "city/yaopu",
    name = "药铺",
    ways = {["south"] = "city/dongdajie1"}
}
Room {
    id = "city/yizhan",
    name = "驿站",
    ways = {["north"] = "city/huadian", ["west"] = "city/beidajie3"}
}
Room {
    id = "city/yltw",
    name = "月老亭外",
    ways = {["south"] = "city/yuelaoting", ["northwest"] = "city/dongdajie1"}
}
Room {
    id = "city/ymzhengting",
    name = "衙门正厅",
    ...
    blocks = {["northwest"] = {{id = "da yayi", exp = 800000}}},
    objs = {["赵城之"] = "zhao chengzhi", ["王坏水"] = "wang huaishui"}
}
Room {
    id = "city/yuelaoting",
    name = "月老亭",
    no_fight = true,
    ways = {["north"] = "city/yltw", ["west"] = "city/yueqidian"},
    objs = {
        ["双儿"] = "shuang er",
        ["天若有情天亦老"] = "board",
        ["月下老人"] = "yuexia laoren"
...
Room {
    ...
    objs = {["萧老板"] = "xiao laoban"}
}
Room {id = "city/yzyunhe", name = "码头", ways = {["north"] = "city/dongmen"}}
Room {
    id = "city/zahuopu",
    name = "杂货铺",
    ways = {["north"] = "city/dongdajie2"}
}
Room {
    id = "city/zhubaodian",
    name = "珠宝店",
    ways = {["north"] = "city/xidajie1"},
    objs = {["朱老板"] = "zhu laoban"}
}
Room {
    id = "dali/beijie1",
...
Room {
    id = "dali/beimen",
    name = "北门",
    ways = {["south"] = "dali/beijie3", ["north"] = "dali/dadao4"}
}
Room {
    id = "dali/bingying",
    name = "兵营",
    ways = {["west"] = "dali/dongjie3"},
    objs = {["黄大雄"] = "huang daxiong", ["张泉"] = "zhang quan"}
}
Room {
    id = "dali/caifeng",
    name = "裁缝店",
    no_fight = true,
    ways = {["east"] = "dali/xijie1"},
    objs = {["裁缝桌"] = "caifeng zhuo"}
}
Room {
    id = "dali/chaguan",
    name = "茶馆",
    ways = {["east"] = "dali/beijie1"},
    objs = {["瑛姑"] = "ying gu"}
}
Room {
    id = "dali/chouduan",
    name = "绸缎庄",
    ways = {["east"] = "dali/xijie3"},
    objs = {["女店主"] = "nv dianzhu"}
}
Room {
    id = "dali/chyuan",
    name = "茶花园",
    ways = {["northup"] = "dali/chyuan2", ["west"] = "dali/dongjie6"},
    precmds = {["northup"] = "give 5 silver to yizu xiaohuo"}
}
Room {
    id = "dali/chyuan2",
    name = "茶花园",
    ways = {["northup"] = "dali/chyuan3", ["southdown"] = "dali/chyuan"},
    objs = {["八仙过海"] = "baxian guohai"}
}
Room {
    id = "dali/chyuan3",
    name = "茶花园",
    ...
    objs = {["落第秀才"] = "luodi xiucai"}
}
Room {
    id = "dali/chyuan4",
    name = "茶花园",
    ways = {["southeast"] = "dali/chyuan3"},
    objs = {["红装素裹"] = "hongzhuang suguo"}
}
Room {
    id = "dali/chyuan5",
    name = "茶花园",
    ways = {["southwest"] = "dali/chyuan3"},
    objs = {
        ["十八学士"] = "shiba xueshi",
        ["抓破美人脸"] = "mei renlian"
    }
...
Room {
    id = "dali/dadao4",
    name = "大道",
    ways = {["south"] = "dali/beimen", ["north"] = "dali/dadao3"},
    room_relative = "大道｜大道｜北门大道"
}
Room {
    id = "dali/dafujia",
    name = "大富之家",
    ways = {["north"] = "dali/nanjie4"},
    objs = {["马五德"] = "ma wude"}
}
Room {
    id = "dali/dalics",
...
Room {
    ...
    name = "后院",
    ways = {["south"] = "dali/dalieast/dadian"},
    objs = {["黄眉和尚"] = "huangmei heshang"}
}
Room {
...
Room {
    ...
    name = "寺间小路",
    ways = {["north"] = "dali/dalieast/yuan1", ["out"] = "dali/dalieast/simen"}
}
Room {
...
Room {
    ...
    objs = {["松鼠"] = "song shu", ["野兔"] = "ye tu"}
}
Room {
    id = "dali/dalieast/xs2",
    name = "望海楼",
    ways = {["south"] = "dali/dalieast/xs1"}
}
Room {
    id = "dali/dalieast/ydk",
    name = "燕子洞口",
    ways = {["down"] = "dali/dalieast/ydn", ["out"] = "group/entry/dleyd"}
}
Room {
    id = "dali/dalieast/ydn",
    name = "第一天",
    ways = {["down"] = "dali/dalieast/ydx", ["up"] = "dali/dalieast/ydk"}
}
Room {
    id = "dali/dalieast/ydx",
    name = "第二天",
    ways = {["down"] = "dali/dalieast/ydxx", ["up"] = "dali/dalieast/ydn"}
}
Room {
    id = "dali/dalieast/ydxx",
    name = "第三天",
    ways = {["east"] = "dali/dalieast/ydxxx", ["up"] = "dali/dalieast/ydx"}
}
Room {
    id = "dali/dalieast/ydxxx",
    name = "观景楼",
    ways = {["east"] = "dali/dalieast/ydxxxx", ["west"] = "dali/dalieast/ydxx"}
}
Room {
    id = "dali/dalieast/ydxxxx",
    name = "观景楼边",
    ways = {["west"] = "dali/dalieast/ydxxx", ["up"] = "dali/dalieast/ydxxxxx"}
}
Room {
...
Room {
    ...
    name = "燕子窝",
    ways = {["west"] = "dali/dalieast/ydxxxxx"}
}
Room {
...
Room {
    ...
    name = "阳宗海",
    ways = {["west"] = "dali/dalieast/chengj"}
}
Room {
    id = "dali/dalisouth/anning",
    name = "安宁温泉",
    ways = {["west"] = "dali/dalisouth/xgf"},
    objs = {
        ["野兔"] = "ye tu",
        ["岭南大侠"] = "lingnan daxia",
        ["菜花蛇"] = "caihua she"
...
Room {
    ...
    name = "荷花池",
    ways = {["east"] = "dali/dalisouth/dg1", ["west"] = "dali/dalisouth/dg3"}
}
Room {
    id = "dali/dalisouth/dg3",
    name = "游园会",
    ways = {["east"] = "dali/dalisouth/dg2"}
}
Room {
...
Room {
    ...
    name = "海埂南",
    ways = {["north"] = "dali/dalisouth/hg1"}
}
Room {
    id = "dali/dalisouth/hg3",
    name = "海埂北",
    ways = {["south"] = "dali/dalisouth/hg1"}
}
Room {
...
Room {
    ...
    name = "山路",
    ways = {["southup"] = "dali/dalisouth/xgf", ["north"] = "dali/nanmen"}
}
Room {
...
Room {
    ...
    name = "天池半山",
    ways = {["down"] = "dali/daliwest/tianchi1"}
}
Room {
    id = "dali/daliwest/xueshan",
    name = "轿子雪山",
    ways = {["northdown"] = "dali/daliwest/nj"}
}
Room {
    id = "dali/daliwest/yuelong",
    name = "玉龙雪山",
    ways = {["northdown"] = "dali/daliwest/ninglang"}
}
Room {
    id = "dali/dangpu",
    name = "当铺",
    no_fight = true,
    ways = {["west"] = "dali/dongjie1"},
    objs = {["沈老板"] = "shen laoban"}
}
Room {
    id = "dali/datiepu",
    name = "打铁铺",
    no_fight = true,
    ways = {["east"] = "dali/nanjie1"}
}
Room {
    id = "dali/dinganfu",
    name = "定安府",
    no_fight = true,
    ways = {["north"] = "dali/nanjie2"}
}
Room {
...
Room {
    ...
    name = "御膳房",
    ways = {["east"] = "dali/dlhg/huating"},
    objs = {["过桥米线"] = "guoqiao mixian"}
}
Room {
    id = "dali/dlhg/dadian",
    name = "大殿",
    ways = {["east"] = "dali/dlhg/zoulang2"}
}
Room {
    id = "dali/dlhg/houyuan",
    name = "后院",
    ways = {["south"] = "dali/dlhg/xiaoqiao", ["north"] = "dali/dlhg/qingong"}
}
Room {
    ...
    nolooks = {["north"] = true},
    objs = {["段正明"] = "duan zhengming"}
}
Room {
    id = "dali/dlhg/jiashan",
    name = "大山石",
    ways = {["southeast"] = "dali/dlhg/chitang"}
}
Room {
    id = "dali/dlhg/qingong",
    name = "寝宫",
    ways = {["south"] = "dali/dlhg/houyuan"}
}
Room {
    id = "dali/dlhg/shufang",
    name = "书房",
    ways = {["west"] = "dali/dlhg/huating"}
}
Room {
    id = "dali/dlhg/xiangfang",
    name = "厢房",
    ways = {["west"] = "dali/dlhg/zoulang2"}
}
Room {
...
Room {
    ...
    name = "皇宫正门",
    ways = {["south"] = "dali/qsjie2", ["north"] = "dali/dlhg/zoulang1"},
    blocks = {
        ["north"] = {
            {id = "huanggong shiwei", exp = 500000, party = "天龙寺"}
        }
    },
    objs = {["皇宫侍卫"] = "huanggong shiwei"}
}
Room {
    id = "dali/dlhg/zoulang1",
    name = "走廊",
    ways = {["south"] = "dali/dlhg/zhengmen", ["north"] = "dali/dlhg/huating"}
}
Room {
...
Room {
    id = "dali/dongmen",
    name = "东门",
    ways = {["east"] = "dali/dalieast/shanlu7", ["west"] = "dali/dongjie4"}
}
Room {
    id = "dali/doufufang",
    name = "豆腐坊",
    ...
    objs = {["豆腐西施"] = "doufu xishi"}
}
Room {id = "dali/duchang", name = "赌场", ways = {["south"] = "dali/beijie5"}}
Room {
    id = "dali/erhai",
    name = "洱海园",
    ways = {["eastup"] = "dali/jzs3", ["west"] = "dali/hth"}
}
Room {
    id = "dali/fengwei",
    name = "风味小吃店",
...
Room {
    id = "dali/hth",
    name = "蝴蝶会",
    ways = {["east"] = "dali/erhai", ["west"] = "dali/htq"}
}
Room {
    id = "dali/htq",
    name = "蝴蝶泉",
    ways = {["southwest"] = "dali/dadao3", ["east"] = "dali/hth"}
}
Room {id = "dali/huadian", name = "花店", ways = {["west"] = "dali/dongjie7"}}
Room {
    id = "dali/jiulou",
    name = "云雪楼",
    ways = {
    ...
    objs = {["欧阳老板"] = "ouyang laoban"}
}
Room {id = "dali/jzs1", name = "鸡足山", ways = {["westdown"] = "dali/jzs2"}}
Room {
    id = "dali/jzs2",
    name = "鸡足山上",
    ways = {["westdown"] = "dali/jzs3", ["eastup"] = "dali/jzs1"}
}
Room {
    id = "dali/jzs3",
    name = "灵山一会",
    ways = {["eastup"] = "dali/jzs2", ["westdown"] = "dali/erhai"}
}
Room {
    id = "dali/kedian",
    name = "迎宾馆",
...
Room {
    id = "dali/kedian2",
    name = "走廊",
    ways = {["north"] = "dali/kedian3", ["out"] = "dali/kedian"}
}
Room {
    id = "dali/kedian3",
    name = "客房",
    no_fight = true,
    ways = {["south"] = "dali/kedian2"}
}
Room {
    id = "dali/mafang",
    name = "马房",
    ways = {["east"] = "dali/qsjie2"},
    objs = {["马夫子"] = "ma fuzi"}
}
Room {
    id = "dali/nanjie1",
...
Room {
    id = "dali/nanmen",
    name = "南门",
    ways = {["south"] = "dali/dalisouth/shanlu6", ["north"] = "dali/nanjie3"}
}
Room {
    id = "dali/qian",
    name = "大理钱庄",
    ways = {["south"] = "dali/beijie4"},
    objs = {["严掌柜"] = "yan zhanggui"}
}
Room {
    id = "dali/qsjie1",
    name = "青石街",
...
Room {
    id = "dali/shanhou",
    name = "善阐侯府",
    ways = {["east"] = "dali/xijie5"},
    objs = {["高升泰"] = "gao shengtai"}
}
Room {
    id = "dali/shanlu2",
    name = "山路",
    ways = {["south"] = "dali/shanlu3", ["north"] = "chengdu/nanmen"},
...
Room {
    id = "dali/shanlu4",
    name = "山路",
    ways = {["south"] = "dali/dadao1", ["north"] = "dali/shanlu3"},
    room_relative = "山路｜山路｜大道山路"
}
Room {id = "dali/shudian", name = "书肆", ways = {["north"] = "dali/nanjie1"}}
Room {id = "dali/shuyuan", name = "书院", ways = {["west"] = "dali/nanjie5"}}
Room {
    id = "dali/sikong",
    name = "司空堂",
    ways = {["south"] = "dali/yamen"},
    objs = {["巴天石"] = "ba tianshi"}
}
Room {
    id = "dali/sima",
    name = "司马堂",
    ways = {["east"] = "dali/yamen"},
    objs = {["范晔"] = "fan ye"}
}
Room {
    id = "dali/situ",
    name = "司徒堂",
    ways = {["west"] = "dali/yamen"},
    objs = {["华赫艮"] = "hua hegen"}
}
Room {
    id = "dali/wangfu/chufang",
    name = "王府厨房",
    ways = {["west"] = "dali/wangfu/lang4"},
    objs = {["细磁酒瓶"] = "jiu ping", ["炸山鸡"] = "zha shanji"}
}
Room {
    id = "dali/wangfu/damen",
    name = "镇南王府大门",
    ways = {["south"] = "dali/wangfu/dating", ["west"] = "dali/dongjie5"},
    objs = {["大理留言板"] = "board"}
}
Room {
    ...
    blocks = {
        ["east"] = {{id = "dali guanbing", exp = 10000, party = "天龙寺"}},
        ["west"] = {{id = "dali guanbing", exp = 10000, party = "天龙寺"}}
    },
    objs = {["傅思归"] = "fu sigui"}
}
Room {
    ...
    name = "花园",
    ways = {["east"] = "dali/wangfu/lang8", ["west"] = "dali/wangfu/lang7"},
    objs = {["古笃诚"] = "gu ducheng"}
}
Room {
    id = "dali/wangfu/lang1",
    name = "长廊",
    ways = {["south"] = "dali/wangfu/lang3", ["east"] = "dali/wangfu/dating"},
    room_relative = "长廊-----王府大厅｜长廊长廊"
}
Room {
    id = "dali/wangfu/lang2",
    name = "长廊",
    ways = {["south"] = "dali/wangfu/lang4", ["west"] = "dali/wangfu/dating"},
...
Room {
    ...
    name = "暖阁",
    ways = {["west"] = "dali/wangfu/lang3"},
    objs = {["段正淳"] = "duan zhengchun"}
}
Room {
    id = "dali/wangfu/shufang",
    name = "书房",
    ways = {["west"] = "dali/wangfu/lang5"},
    objs = {["大乘佛经"] = "dacheng fojing"}
}
Room {
    id = "dali/wangfu/woshi1",
    name = "卧室",
    ways = {["east"] = "dali/wangfu/lang5"}
}
Room {
    id = "dali/wangfu/woshi2",
    name = "卧室",
    ways = {["east"] = "dali/wangfu/lang6"}
}
Room {
    id = "dali/wangfu/wupinfang",
    name = "兵器房",
    ways = {["west"] = "dali/wangfu/lang6"}
}
Room {
    id = "dali/wangfu/yizheng",
    name = "议政厅",
    ways = {["east"] = "dali/wangfu/lang3"}
}
Room {
    id = "dali/wangfu/zhangfang",
    name = "帐房",
    ways = {["east"] = "dali/wangfu/lang4"}
}
Room {
    id = "dali/wuliang/anbian",
    name = "澜沧江边",
    ways = {["eastup"] = "dali/wuliang/gaoshan"}
}
Room {
...
Room {
    ...
    name = "半山",
    ways = {["down"] = "dali/wuliang/banshan2"}
}
Room {
    id = "dali/wuliang/banshan2",
    name = "半山",
    ways = {["down"] = "dali/wuliang/banshan3"}
}
Room {
    id = "dali/wuliang/banshan3",
    name = "半山",
    ways = {["down"] = "dali/wuliang/banshan4"}
}
Room {
    id = "dali/wuliang/banshan4",
    name = "半山",
    ways = {["down"] = "dali/wuliang/gudi"}
}
Room {
...
Room {
    ...
    name = "万劫谷谷口",
    ways = {["south"] = "dali/wuliang/xiaojing", ["out"] = "dali/wuliang/hslin"}
}
Room {
    id = "dali/wuliang/dlgong",
    name = "东练武厅",
    ways = {["west"] = "dali/wuliang/jhg"}
}
Room {
...
Room {
    ...
    name = "山谷底部",
    ways = {["west"] = "dali/wuliang/donghubian"}
}
Room {
    ...
    objs = {["来福儿"] = "laifu er", ["进喜儿"] = "jinxi er"}
}
Room {
    id = "dali/wuliang/houyuan",
    name = "后院",
    ways = {["south"] = "dali/wuliang/jhg", ["north"] = "dali/wuliang/songlin1"},
    nolooks = {["north"] = true},
    lengths = {["north"] = 100}
}
Room {
...
Room {
    ...
    blocks = {["east"] = {{id = "zhong wanchou", exp = 400000}}}
}
Room {
    id = "dali/wuliang/lsdui",
    name = "乱石堆",
    ways = {["southwest"] = "dali/wuliang/xiaolu2"},
    objs = {["司空玄"] = "sikong xuan"}
}
Room {
    id = "dali/wuliang/midao1",
    name = "密道",
    ways = {["southdown"] = "dali/wuliang/midao2"}
}
Room {
...
Room {
    ...
    name = "密道",
    ways = {["east"] = "dali/wuliang/midao4", ["north"] = "dali/wuliang/midao2"}
}
Room {
...
Room {
    ...
    name = "密道",
    ways = {["northup"] = "dali/wuliang/midao4", ["out"] = "dali/shanlu3"}
}
Room {
    id = "dali/wuliang/muwu1",
    name = "空地",
    ways = {["north"] = "dali/wuliang/muwu2"}
}
Room {
    id = "dali/wuliang/muwu2",
    name = "石屋",
    ways = {["south"] = "dali/wuliang/muwu1"}
}
Room {
...
Room {
    ...
    name = "森林",
    ways = {["south"] = "dali/wuliang/shanlin-5"}
}
Room {
...
Room {
    ...
    name = "山路",
    ways = {["#outJjl"] = "dali/wuliang/xiaoxi"},
    nolooks = {
        ["#outJjl"] = true,
        ["south"] = true,
        ["east"] = true,
...
Room {
    ...
    name = "山中密林",
    ways = {["south"] = "dali/wuliang/xihubian"},
    objs = {["野果"] = "ye guo"}
}
Room {
    id = "dali/wuliang/shulin3",
    name = "山中密林",
    ways = {["south"] = "dali/wuliang/nanhubian"},
    objs = {["野果"] = "ye guo"}
}
Room {
    id = "dali/wuliang/shulin4",
    name = "山中密林",
    ways = {["south"] = "dali/wuliang/beihubian"},
    objs = {["野果"] = "ye guo"}
}
Room {
    ...
    lengths = {["#songlinIn"] = 100, ["#songlinOut"] = 10}
}
Room {
    id = "dali/wuliang/taijie",
    name = "台阶",
    ways = {["down"] = "dali/wuliang/dong1", ["out"] = "dali/wuliang/jiangpan"}
}
Room {
...
Room {
    ...
    blocks = {
        ["north"] = {{id = "rong ziju", exp = 350000}},
        ["east"] = {{id = "rong ziju", exp = 350000}},
        ["west"] = {{id = "rong ziju", exp = 350000}}
    },
    objs = {["容子矩"] = "rong ziju"}
}
Room {
    ...
    objs = {["郁光标"] = "yu guangbiao", ["吴光胜"] = "wu guangsheng"}
}
Room {
    id = "dali/wuliang/xiangfang",
    name = "厢房",
    ways = {["west"] = "dali/wuliang/keting"},
    objs = {["甘宝宝"] = "gan baobao"}
}
Room {
...
Room {
    ...
    name = "小厅",
    ways = {["east"] = "dali/wuliang/guzhong"},
    objs = {["钟灵"] = "zhong ling"}
}
Room {
...
Room {
    ...
    name = "西练武厅",
    ways = {["east"] = "dali/wuliang/jhg"}
}
Room {
    id = "dali/wuliang/xting",
    name = "西厅",
    ways = {["east"] = "dali/wuliang/wlj"}
}
Room {
    id = "dali/xijie1",
    name = "西大街",
...
Room {
    ...
    name = "西门",
    no_fight = true,
    ways = {["westup"] = "tls/diancang", ["east"] = "dali/xijie4"},
    objs = {["朱丹臣"] = "zhu danchen"}
}
Room {
    id = "dali/xiulou",
    name = "绣楼",
    no_fight = true,
    ways = {["east"] = "dali/xijie2"}
}
Room {id = "dali/xiyuan", name = "戏园子", ways = {["east"] = "dali/xijie6"}}
Room {
    id = "dali/yamen",
    name = "府衙前厅",
    ways = {
...
Room {
    ...
    name = "作坊",
    no_fight = true,
    ways = {["west"] = "dali/beijie5"}
}
Room {
    id = "dali/yanzhi",
    name = "铸剑房",
    no_fight = true,
    ways = {["east"] = "dali/xijie7"}
}
Room {
    id = "dali/yaopu",
    name = "药铺",
    no_fight = true,
    ways = {["west"] = "dali/dongjie2"}
}
Room {
...
Room {
    ...
    name = "石梁尽头",
    ways = {["#duZi"] = "dali/yideng/hetang"},
    lengths = {["#duZi"] = 10}
}
Room {
    id = "dali/yideng/liangong",
    name = "练功房",
    ways = {["west"] = "dali/yideng/houyuan"}
}
Room {
    id = "dali/yideng/pubu",
    name = "山谷瀑布",
...
Room {
    ...
    name = "山顶",
    ways = {["eastup"] = "dali/yideng/shanpo"}
}
Room {
    id = "dali/yideng/shandong",
    name = "山洞",
    ways = {["out"] = "dali/yideng/anbian"}
}
Room {
...
Room {
    ...
    name = "小石桥",
    ways = {["south"] = "dali/yideng/hetang", ["north"] = "dali/yideng/dadian"}
}
Room {
    ...
    objs = {["一灯大师"] = "yideng dashi"}
}
Room {
    id = "dali/yideng/xfang",
    name = "西厢房",
    ways = {["east"] = "dali/yideng/dadian"}
}
Room {
    id = "dali/yideng/xiangfang",
    name = "石屋厢房",
    ways = {["west"] = "dali/yideng/shiwu"}
}
Room {
...
Room {
    ...
    name = "青石小径",
    ways = {["east"] = "dali/yideng/xiaojing2", ["west"] = "dali/yideng/zhulin"}
}
Room {
...
Room {
    ...
    name = "竹林",
    ways = {["east"] = "dali/yideng/xiaojing3", ["north"] = "dali/yideng/shiwu"}
}
Room {
    id = "dali/yizhan",
    name = "驿站",
    no_fight = true,
    ways = {["west"] = "dali/qsjie2"},
    objs = {["褚万里"] = "zhu wanli"}
}
Room {
    id = "dali/yuxu/guanmen",
    name = "玉虚观门",
    ways = {["enter"] = "dali/yuxu/yuxuguan", ["east"] = "group/entry/dlndao5"}
}
Room {
    ...
    objs = {["岭南大盗"] = "lingnan dadao"}
}
Room {
    id = "dali/yuxu/shufang1",
    name = "书房",
    ways = {["east"] = "dali/yuxu/yuxuguan"}
}
Room {
    id = "dali/yuxu/shuifang",
    name = "睡房",
    ways = {["west"] = "dali/yuxu/yuxuguan"}
}
Room {
    id = "dali/yuxu/xiaodao1",
    name = "道旁田野",
    ways = {["northeast"] = "dali/dadao1", ["west"] = "dali/yuxu/xiaodao2"}
}
Room {
    id = "dali/yuxu/xiaodao2",
    name = "道旁田野",
    ways = {["east"] = "dali/yuxu/xiaodao1", ["west"] = "dali/yuxu/shangang"}
}
Room {
    ...
    objs = {["玉虚散人"] = "yuxu sanren"}
}
Room {
    id = "dali/zahuopu",
    name = "杂货铺",
    ways = {["north"] = "dali/nanjie5"},
    objs = {["赵老板"] = "zhao laoban"}
}
Room {
    id = "death/gate",
    name = "鬼门关",
    ways = {["enter"] = "death/gateway"}
}
Room {
    id = "death/gateway",
    name = "阎罗大殿",
...
Room {id = "death/mpting", name = "孟婆亭", ways = {["out"] = "death/gate"}}
Room {
    id = "death/pusadian",
    name = "地藏王菩萨殿",
    ways = {["out"] = "death/gate"}
...
Room {
    id = "emei/baoguosicf",
    name = "报国寺禅房",
    ways = {["east"] = "emei/daxiongdian"}
}
Room {
    id = "emei/baoguosixq",
    name = "报国寺西墙",
    ways = {["east"] = "emei/baoguosi"}
}
Room {
    id = "emei/baoguosm",
    name = "报国寺山门",
    ways = {["northdown"] = "emei/qingshijie", ["west"] = "emei/baoguosi"}
}
Room {
    id = "emei/basipan1",
    name = "八十四盘",
...
Room {
    id = "emei/caopeng",
    name = "草棚",
    ways = {["east"] = "emei/qingshijie"}
}
Room {
    id = "emei/chanfang",
    name = "禅房",
    no_fight = true,
    ways = {["west"] = "emei/lingwenge"}
}
Room {
    id = "emei/chanfang2",
    name = "禅房",
    no_fight = true,
    ways = {["west"] = "emei/qianfoandd"}
}
Room {
    id = "emei/chanfang3",
    name = "禅房",
    no_fight = true,
    ways = {["west"] = "emei/wanniananzd"},
    nolooks = {["west"] = true},
    precmds = {["west"] = "open door"}
}
Room {
    id = "emei/chunyangdian",
    name = "纯阳殿",
    ways = {["eastdown"] = "emei/guiyunge", ["westup"] = "emei/shenshuian"},
    objs = {["丁敏君"] = "ding minjun"}
}
Room {
    id = "emei/chuwujian",
    name = "储物间",
    ways = {["north"] = "emei/huazanganzt", ["up"] = "emei/huazangancj"},
    objs = {["静风师太"] = "jingfeng shitai"},
    blocks = {["up"] = {{id = "jingfeng shitai", exp = 2000000}}}
}
Room {
    id = "emei/daxiong",
    name = "华藏庵大雄宝殿",
...
Room {
    id = "emei/dcedian",
    name = "东侧殿",
    ways = {["west"] = "emei/huazanganzd"},
    objs = {["文晖小师太"] = "wen hui", ["静和师太"] = "jinghe shitai"}
}
Room {
    id = "emei/dcelang",
    name = "东侧廊",
    ways = {["south"] = "emei/huazanganzt", ["west"] = "emei/huazangangc"}
}
Room {
    id = "emei/dongkou",
    name = "九老洞口",
    ways = {["enter"] = "emei/jiulaodong1", ["out"] = "emei/jiulaodong"}
}
Room {
    id = "emei/duguangtai",
    name = "睹光台",
...
Room {
    id = "emei/fuhusi",
    name = "伏虎寺",
    ways = {["westup"] = "emei/milin2", ["east"] = "emei/milin"}
}
Room {
    id = "emei/fushouan",
    name = "福寿庵",
    ways = {["enter"] = "emei/lingwenge", ["north"] = "emei/shenshuian"}
}
Room {
    id = "emei/fushouanxxs",
    name = "休息室",
...
Room {
    id = "emei/fushouanzt",
    name = "福寿庵斋堂",
    ways = {["east"] = "emei/lingwenge"},
    nolooks = {["northup"] = true}
}
Room {
    id = "emei/guanyinqiao",
    name = "观音桥",
    ways = {["east"] = "emei/jietuopo", ["west"] = "emei/guanyintang"}
}
Room {
    id = "emei/guanyintang",
    name = "观音堂",
    ways = {["westup"] = "emei/guiyunge", ["east"] = "emei/guanyinqiao"}
}
Room {
    id = "emei/gudelin",
    name = "古德林",
...
Room {
    ...
    name = "黑龙江栈道",
    ways = {["south"] = "emei/qianfoan", ["north"] = "emei/heilongjiangzd"},
    room_relative = "黑龙江栈道｜黑龙江栈道｜千佛庵黑龙江栈道"
}
Room {
    id = "emei/houdian",
    name = "后殿",
    ways = {["north"] = "emei/daxiong"},
    nolooks = {["north"] = true},
    precmds = {["north"] = "open door"},
    objs = {["灭绝师太"] = "miejue shitai"}
}
Room {
    id = "emei/houshan",
    name = "后山",
...
Room {
    ...
    nolooks = {["#outemgmc"] = true},
    room_relative = "灌木丛↗灌木丛←灌木丛←灌木丛↙灌木丛灌木丛"
}
Room {
    id = "emei/houshangm1",
    name = "灌木丛",
    ways = {["westup"] = "emei/houshangm", ["yue qiaobi"] = "emei/houshandk"},
    nolooks = {["yue qiaobi"] = true},
    room_relative = "灌木丛←灌木丛灌木丛"
}
Room {
    id = "emei/houshansd",
    name = "山洞",
    ways = {["eastdown"] = "emei/qingyinge", ["out"] = "emei/houshandk"},
    objs = {["孤鸿子"] = "guhong zi"}
}
Room {
    id = "emei/shuitan",
    name = "水潭",
    ways = {["#emeishuitan"] = "emei/qingyinge"},
    nolooks = {["#emeishuitan"] = true}
}
Room {
    id = "emei/houshansl",
    name = "后山树林",
    ways = {["northdown"] = "emei/houshanxl3", ["west"] = "emei/houshan"}
}
Room {
    id = "emei/houshanty",
    name = "炭窑",
    ways = {["southwest"] = "emei/houshan"}
}
Room {
    id = "emei/houshanxl",
    name = "后山小路",
    ways = {["northeast"] = "emei/houshanxl2"}
}
Room {
    id = "emei/houshanxl2",
    name = "后山小路",
    ways = {["southwest"] = "emei/houshanxl", ["northdown"] = "emei/houshan"}
}
Room {
    id = "emei/houshanxl3",
    name = "后山小路",
...
Room {
    id = "emei/jietuopo",
    name = "解脱坡",
    ways = {["eastdown"] = "emei/milin2", ["west"] = "emei/guanyinqiao"}
}
Room {
    id = "emei/jieyindian",
    name = "接引殿",
    ways = {["westup"] = "emei/wanxingan", ["northwest"] = "emei/basipan3"}
}
Room {
    id = "emei/jinding",
    name = "金顶",
...
Room {
    id = "emei/jiudaoguai1",
    name = "九十九道拐",
    ways = {["westup"] = "emei/jiudaoguai2", ["northeast"] = "emei/qianfoan"},
...
Room {
    id = "emei/jiudaoguai3",
    name = "九十九道拐",
    ways = {["westup"] = "emei/jiudaoguai4", ["northeast"] = "emei/jiudaoguai2"}
}
Room {
    id = "emei/jiudaoguai4",
    name = "九十九道拐",
...
Room {
    id = "emei/jiulaodong1",
    name = "九老洞",
    ways = {["#jldout"] = "emei/dongkou", ["#jldin"] = "emei/shanpo"},
    lengths = {
...
Room {
    id = "emei/leidongping",
    name = "雷洞坪",
    ways = {["southup"] = "emei/basipan1", ["northdown"] = "emei/lingyunti"}
}
Room {
    id = "emei/lengshanlin",
    name = "冷杉林",
...
Room {
    ...
    objs = {["赵灵珠"] = "zhao lingzhu", ["苏梦清"] = "su mengqing"}
}
Room {
    id = "emei/lingwenge",
    name = "灵文阁",
...
Room {
    ...
    nolooks = {["move gancao;zuan dong"] = true},
    lengths = {["move gancao;zuan dong"] = 2}
}
Room {
    id = "emei/milin",
    name = "密林",
    ways = {["northeast"] = "emei/baoguosi", ["west"] = "emei/fuhusi"}
}
Room {
    id = "emei/milin2",
    name = "密林",
    ways = {["eastdown"] = "emei/fuhusi", ["westup"] = "emei/jietuopo"}
}
Room {
    id = "emei/mu",
    name = "郭襄之墓",
    ways = {["south"] = "emei/caodi", ["east"] = "emei/xiaojing2"}
}
Room {id = "emei/mu2", name = "墓室", ways = {["up"] = "emei/mu"}}
Room {
    id = "emei/mupeng",
    name = "木棚",
    ways = {["south"] = "emei/wanfoding"}
}
Room {
    id = "emei/muzhuang",
    name = "梅花桩",
    ways = {["down"] = "emei/gudelin3"}
}
Room {
    id = "emei/podao1",
    name = "坡道",
    ways = {["westup"] = "emei/podao2", ["east"] = "emei/lianhuashi"}
}
Room {
    id = "emei/podao2",
    name = "坡道",
    ways = {["eastdown"] = "emei/podao1"}
}
Room {
    id = "emei/qianfoan",
    name = "千佛庵",
...
Room {
    id = "emei/qianfoandd",
    name = "千佛庵大殿",
    ways = {["east"] = "emei/chanfang2", ["out"] = "emei/qianfoan"},
    nolooks = {["east"] = true},
    precmds = {["east"] = "open door"}
}
Room {
    id = "emei/qingshijie",
    name = "青石阶",
...
Room {
    ...
    objs = {["静闲师太"] = "jingxian shitai"}
}
Room {id = "emei/shangu", name = "山谷", ways = {["east"] = "emei/xiaojing"}}
Room {
    id = "emei/shanpo",
    name = "山坡",
    ways = {["enter"] = "emei/jiulaodong1"},
    objs = {["周芷若"] = "zhou zhiruo"}
}
Room {
    id = "emei/shenshuian",
    name = "神水庵",
...
Room {
    id = "emei/sheshenya",
    name = "睹光台舍身崖",
    ways = {["east"] = "emei/duguangtai"}
}
Room {
    id = "emei/shierpan",
    name = "十二盘",
    ways = {["eastdown"] = "emei/wannianan", ["southwest"] = "emei/shierpan2"},
    room_relative = "十二盘←万年庵↙十二盘十二盘"
}
Room {
    id = "emei/shierpan2",
    name = "十二盘",
    ways = {["westup"] = "emei/shierpan3", ["northeast"] = "emei/shierpan"},
    room_relative = "十二盘↗十二盘←十二盘十二盘"
}
Room {
    id = "emei/shierpan3",
    name = "十二盘",
    ways = {["eastdown"] = "emei/shierpan2", ["southwest"] = "emei/shierpan4"},
    room_relative = "十二盘←十二盘↙十二盘十二盘"
}
Room {
    id = "emei/shierpan4",
    name = "十二盘",
    ways = {["northeast"] = "emei/shierpan3", ["up"] = "emei/huayanding"},
    room_relative = "华严顶十二盘〓↗十二盘十二盘"
}
Room {
    id = "emei/shushang",
    name = "树上",
    ways = {["down"] = "emei/jiudaoguai3"},
    blocks = {["down"] = {{id = "ju mang", exp = 0}}}
}
Room {
    id = "emei/wanfoding",
    name = "万佛顶",
...
Room {
    id = "emei/wanniananzd",
    name = "万年庵砖殿",
    ways = {["east"] = "emei/chanfang3", ["out"] = "emei/wannianan"},
    nolooks = {["east"] = true},
    precmds = {["east"] = "open door"}
}
Room {
    id = "emei/wanxingan",
    name = "万行庵",
    ways = {["southup"] = "emei/jinding", ["eastdown"] = "emei/jieyindian"},
    objs = {["静迦师太"] = "jingjia shitai"}
}
Room {
    id = "emei/woyunan",
    name = "卧云庵",
    ways = {["southup"] = "emei/duguangtai", ["northeast"] = "emei/jinding"},
    objs = {["静玄师太"] = "jingxuan shitai"}
}
Room {
    id = "emei/xcedian",
    name = "西侧殿",
    ways = {["east"] = "emei/huazanganzd"},
    objs = {
        ["文清小师太"] = "wen qing",
...
Room {
    id = "emei/xcelang",
    name = "西侧廊",
    ways = {["south"] = "emei/huazangancf", ["east"] = "emei/huazangangc"}
}
Room {
    id = "emei/xianfengsi",
    name = "仙峰寺",
    ways = {["westdown"] = "emei/huayanding"}
}
Room {
    id = "emei/xiaojing",
    name = "山谷小径",
    ways = {["northeast"] = "emei/caodi", ["west"] = "emei/shangu"}
}
Room {
    id = "emei/xiaojing2",
    name = "小径",
...
Room {id = "emei/xiaowu", name = "小屋", ways = {["west"] = "emei/caodi"}}
Room {
    id = "emei/xiuxishi",
    name = "休息室",
    no_fight = true,
    ways = {["north"] = "emei/huazangancf"}
}
Room {
    id = "emei/xiuxishi2",
    name = "休息室",
    no_fight = true,
    ways = {["west"] = "emei/daxiongdian"}
}
Room {
    id = "emei/yunvfeng",
    name = "玉女峰",
    ways = {["northdown"] = "emei/guiyunge"},
    objs = {["方碧琳"] = "fang bilin"}
}
Room {
    id = "emei/zhongfengsi",
    name = "中峰寺",
    ways = {["eastdown"] = "emei/shenshuian", ["northwest"] = "emei/qingyinge"}
}
Room {
    id = "emei/zhulin",
    name = "小竹林",
...
Room {
    id = "emei/zuantianpo",
    name = "钻天坡",
    ways = {["eastdown"] = "emei/lianhuashi", ["westup"] = "emei/zuantianpo2"},
...
Room {
    id = "fairyland/cuigu1",
    name = "翠谷",
    ways = {["south"] = "fairyland/shanlu6"}
}
Room {
    id = "fairyland/cuigu3",
    name = "翠谷",
    ways = {["north"] = "fairyland/cuigu"}
}
Room {
    id = "fairyland/dapingtai",
    name = "大平台",
    ways = {["west"] = "fairyland/dashibi"}
}
Room {
    id = "fairyland/dashibi",
    name = "大石壁",
    ways = {["east"] = "fairyland/dapingtai"}
}
Room {
    id = "fairyland/dating",
    name = "大厅",
...
Room {
    ...
    name = "后院",
    ways = {["north"] = "fairyland/lggong", ["west"] = "fairyland/dating"}
}
Room {
    id = "fairyland/lggong",
    name = "灵獒宫",
    ways = {["south"] = "fairyland/houyuan"},
    objs = {
...
Room {
    id = "fairyland/nuange",
    name = "暖阁",
    ways = {["south"] = "fairyland/dating"}
}
Room {
    id = "fairyland/pubu",
    name = "瀑布",
    ways = {["east"] = "fairyland/shanlu4", ["southdown"] = "fairyland/tanbian"}
}
Room {
    id = "fairyland/shanbi",
    name = "山壁",
...
Room {
    ...
    name = "山路",
    ways = {["east"] = "fairyland/shanlu1", ["west"] = "fairyland/hmzhuang"}
}
Room {
    id = "fairyland/shanlu3",
    name = "翠谷",
    ways = {["east"] = "fairyland/cuigu", ["west"] = "fairyland/shanlu4"}
}
Room {
    id = "fairyland/shanlu4",
    name = "翠谷",
    ways = {["east"] = "fairyland/shanlu3", ["west"] = "fairyland/pubu"}
}
Room {
    id = "fairyland/shanlu5",
    name = "翠谷",
    ways = {["south"] = "fairyland/cuigu", ["north"] = "fairyland/shanlu6"}
}
Room {
    id = "fairyland/shanlu6",
    name = "翠谷",
    ways = {["south"] = "fairyland/shanlu5", ["north"] = "fairyland/cuigu1"}
}
Room {
    id = "fairyland/shanxi",
    name = "山溪边",
...
Room {
    ...
    name = "翠谷",
    no_fight = true,
    ways = {["northup"] = "fairyland/pubu"}
}
Room {
    id = "fairyland/xuanya",
    name = "悬崖",
    ways = {["eastdown"] = "fairyland/conglin2"}
}
Room {
    id = "fairyland/xuedi",
    name = "雪地",
    ways = {["northeast"] = "fairyland/xuedi1"}
}
Room {
    id = "fairyland/xuedi1",
    name = "雪地",
...
Room {
    id = "foshan/alleyway",
    name = "小巷",
    ways = {["south"] = "foshan/zhongjia", ["west"] = "foshan/nanjie2"}
}
Room {
    id = "foshan/beidimiao",
    name = "北帝庙",
    ways = {["south"] = "foshan/xijie2"},
    objs = {["凤一鸣"] = "feng yiming"}
}
Room {
    id = "foshan/beijie",
    name = "佛山北街",
    ways = {["south"] = "foshan/guangchang", ["north"] = "foshan/beimen"}
}
Room {
    id = "foshan/beimen",
    name = "佛山北门",
    ways = {["south"] = "foshan/beijie", ["north"] = "foshan/lingnan"}
}
Room {
    id = "foshan/caidi",
    name = "菜地",
    ways = {["west"] = "foshan/zhongjia"}
}
Room {
    id = "foshan/caomeidi",
    name = "草莓地",
...
Room {
    ...
    name = "当铺",
    no_fight = true,
    ways = {["north"] = "foshan/dongjie3"},
    objs = {["俞朝奉"] = "yu chaofeng"}
}
Room {
    id = "foshan/dating",
    name = "凤府大厅",
    ways = {["south"] = "foshan/shufang", ["west"] = "foshan/dayuan"},
    objs = {["公孙盈"] = "gongsun ying", ["何师爷"] = "he shiye"}
}
Room {
    id = "foshan/dayuan",
    name = "凤府大院",
    ways = {["east"] = "foshan/dating", ["west"] = "foshan/villa-gate"}
}
Room {
    id = "foshan/dongjie",
    name = "佛山东街",
...
Room {
    id = "foshan/dongmen",
    name = "佛山东门",
    ways = {["east"] = "foshan/road8", ["west"] = "foshan/dongjie3"}
}
Room {
    id = "foshan/duchang",
    name = "英雄会馆",
    ways = {["north"] = "foshan/xijie"},
    objs = {["邝宝官"] = "kuang baoguan"}
}
Room {
    id = "foshan/dukou",
    name = "老渡口",
    ...
    lengths = {["southwest"] = "if false then return 1 else return false end"}
}

Room {
    id = "foshan/haibing",
    name = "海滨",
    ways = {["west"] = "foshan/dukou"}
}
...
Room {
    ...
    name = "老渡口",
    no_fight = true,
    ways = {["north"] = "foshan/caomeidi"}
}
Room {
    id = "foshan/fenchang",
    name = "坟场",
    ways = {["southwest"] = "foshan/xiaolu1"}
}
Room {
    id = "foshan/grocer",
    name = "杂货店",
    ways = {["south"] = "foshan/dongjie"},
    objs = {["李老板"] = "li"}
}
Room {
...
Room {
    ...
    name = "英雄楼二楼",
    ways = {["down"] = "foshan/herohotel"}
}
Room {
    id = "foshan/ironsmith",
    name = "铁匠铺",
    ways = {["north"] = "foshan/dongjie2"},
    objs = {["沈铁匠"] = "shen tiejiang"}
}
Room {
    id = "foshan/kedian",
    name = "英雄客栈",
    ...
    nolooks = {["up"] = true},
    lengths = {["#yingxiongkedian"] = 5}
}
Room {
    id = "foshan/kedian2",
    name = "客栈二楼",
    ways = {["enter"] = "foshan/kedian3", ["down"] = "foshan/kedian"}
}
Room {
    id = "foshan/kedian3",
    name = "客店二楼",
    no_fight = true,
    ways = {["out"] = "foshan/kedian2"}
}
Room {
    id = "foshan/lingnan",
    name = "岭南",
    ways = {["south"] = "foshan/beimen", ["north"] = "foshan/xiaolu1"}
}
Room {
    id = "foshan/milin",
    name = "密林",
    ways = {["southwest"] = "foshan/xiaolu3"},
    blocks = {["southwest"] = {{id = "ma zei", exp = 150000}}}
}
Room {id = "foshan/mishi", name = "密室", ways = {["up"] = "foshan/shufang"}}
Room {
    id = "foshan/nanjie",
    name = "佛山南街",
    ways = {
...
Room {
    id = "foshan/nanmen",
    name = "南门",
    ways = {["south"] = "foshan/shulin1", ["north"] = "foshan/nanjie2"}
}
Room {
    id = "foshan/noshery",
    name = "小吃店",
    ways = {["east"] = "foshan/nanjie2"},
    objs = {["宋老板"] = "song"}
}
Room {
    id = "foshan/road1",
    name = "林间道",
    ways = {["east"] = "foshan/ximen", ["west"] = "foshan/road2"},
    objs = {["小树枝"] = "shu zhi"},
...
Room {
    ...
    objs = {["石块"] = "shi kuai", ["土匪"] = "tu fei"},
    room_relative = "林间道↗林间道↙林间道林间道"
}
Room {
    id = "foshan/road12",
    name = "林间道",
    ways = {["northwest"] = "foshan/road10"},
    room_relative = "林间道↖林间道林间道"
}
Room {
    id = "foshan/road14",
    name = "林间道",
    ways = {["southwest"] = "group/entry/fsroad13", ["north"] = "fuzhou/bridge"},
    objs = {["蕙兰花"] = "huilan hua"},
...
Room {
    id = "foshan/road2",
    name = "林间道",
    ways = {["east"] = "foshan/road1", ["west"] = "foshan/road3"},
    objs = {["石块"] = "shi kuai"},
    room_relative = "林间道----林间道----林间道林间道"
}
Room {
    id = "foshan/road3",
    name = "林间道",
    ways = {["northwest"] = "foshan/road4", ["east"] = "foshan/road2"},
    room_relative = "林间道↖林间道----林间道林间道"
}
Room {
    id = "foshan/road4",
...
Room {
    ...
    objs = {["蜜蜂"] = "mi feng", ["白合花"] = "baihe hua"},
    room_relative = "澜沧江边----林间道----林间道林间道"
}
Room {
    id = "foshan/road8",
    name = "林间道",
    ways = {["east"] = "foshan/road9", ["west"] = "foshan/dongmen"},
    objs = {["张朝唐"] = "zhang chaotang", ["张康"] = "zhang kang"},
    room_relative = "佛山东门----林间道----林间道林间道"
}
Room {
    id = "foshan/road9",
    name = "林间道",
    ways = {["east"] = "foshan/road10", ["west"] = "foshan/road8"},
    objs = {["莎椤花"] = "shaluo huaflower"},
    room_relative = "林间道----林间道----林间道林间道"
}
Room {
    id = "foshan/shaobing",
    name = "烧饼摊",
    ways = {["south"] = "foshan/dongjie2"},
    objs = {["王老汉"] = "wang laohan"}
}
Room {
    id = "foshan/shufang",
    name = "书房",
    ways = {["north"] = "foshan/dating"}
}
Room {
    id = "foshan/shulin1",
    name = "树林",
...
Room {
    id = "foshan/shulin2",
    name = "树林",
    ways = {["east"] = "foshan/caomeidi"},
    objs = {["老虎"] = "lao hu"}
}
Room {
    id = "foshan/shulin_dzd",
    name = "树林",
    ways = {["south"] = "foshan/dukou", ["northwest"] = "foshan/shulin1"}
}
Room {
    id = "foshan/villa-gate",
    name = "凤府大门",
    ways = {["east"] = "foshan/dayuan", ["west"] = "foshan/nanjie"}
}
Room {
    id = "foshan/xiaolu1",
    name = "小路",
...
Room {
    id = "foshan/xiaolu2",
    name = "小路",
    ways = {["northup"] = "foshan/xiaolu3", ["southdown"] = "foshan/xiaolu1"},
...
Room {
    id = "foshan/ximen",
    name = "西门",
    ways = {["east"] = "foshan/xijie2", ["west"] = "foshan/road1"}
}
Room {
    id = "foshan/zhongjia",
    name = "钟家",
    ways = {["east"] = "foshan/caidi", ["north"] = "foshan/alleyway"},
    nolooks = {["east"] = true},
    precmds = {["east"] = "open door"},
    objs = {
        ["钟阿四"] = "zhong asi",
...
Room {
    id = "foshan/zumiao",
    name = "佛山祖庙",
    ways = {["southeast"] = "foshan/xiaolu1"}
}
-- add by xieky@sj 20170809
Room {
    id = "foshan/pingyuanxiaolu",
    name = "平原小路",
    ways = {["west"] = "foshan/shulin1", ["south"] = "foshan/nanhaiyucun"}
}
Room {
...
Room {
    id = "foshan/yugang",
    name = "渔港",
    ways = {["east"] = "foshan/nanhaiyucun"},
    objs = {["黄衣使者"] = "shi zhe"}
}
Room {
    id = "foshan/shaiwangchang",
    name = "渔村晒网场",
    ways = {["west"] = "foshan/nanhaiyucun", ["north"] = "foshan/yucunxiaowu"},
    objs = {["男孩"] = "boy", ["女孩"] = "girl", ["渔夫"] = "yu fu"}
}
Room {
    id = "foshan/yucunxiaowu",
    name = "渔村小屋",
    ways = {["south"] = "foshan/shaiwangchang"},
    objs = {["小孩"] = "kid"}
}
-- add end
Room {
    id = "fuzhou/bank",
    name = "通宝斋",
    ways = {["west"] = "fuzhou/dongxiang2"},
    objs = {["刘老板"] = "liu laoban"}
}
Room {
    id = "fuzhou/beijie",
    name = "北街",
    ways = {["south"] = "fuzhou/zhongxin", ["north"] = "fuzhou/beimen"}
}
Room {
    id = "fuzhou/beimen",
    name = "北门",
    ways = {["south"] = "fuzhou/beijie", ["north"] = "fuzhou/road5"}
}
Room {
    id = "fuzhou/biaoju",
    name = "福威镖局",
...
Room {
    id = "fuzhou/chalou",
    name = "茶楼",
    ways = {["east"] = "fuzhou/xixiang4", ["up"] = "fuzhou/chalou2"}
}
Room {
    id = "fuzhou/chalou2",
    name = "茶楼",
    ways = {["down"] = "fuzhou/chalou"}
}
Room {
    id = "fuzhou/dangpu",
    name = "当铺",
    no_fight = true,
    ways = {["south"] = "fuzhou/xijie"},
    objs = {["张老板"] = "lao ban"}
}
Room {
    id = "fuzhou/dongjie",
...
Room {
    ...
    name = "东巷",
    ways = {["south"] = "fuzhou/dongxiang", ["east"] = "fuzhou/bank"},
    room_relative = "东巷-----通宝斋｜东巷东巷"
}
Room {
    id = "fuzhou/feiyuan",
    name = "废园",
    ways = {["west"] = "fuzhou/xyxiang"}
}
Room {
    id = "fuzhou/fenduo1",
    name = "船舱",
    ways = {["out"] = "fuzhou/yuchuan5"},
    objs = {
        ["蒋舵主"] = "jiang duozhu",
        ["丐帮弟子及任务留言板"] = "board",
        ["吴长老"] = "wu zhanglao"
...
Room {
    id = "fuzhou/houyuan",
    name = "老宅后院",
    ways = {["down"] = "fuzhou/well"}
}
Room {
    id = "fuzhou/huadian",
    name = "花店",
    ways = {["east"] = "fuzhou/xixiang3"}
}
Room {
    id = "fuzhou/island1",
    name = "小岛",
    ways = {["north"] = "fuzhou/island3", ["swim"] = "fuzhou/haigang"},
    nolooks = {
        ["swim"] = true,
        ["east"] = true,
        ["west"] = true,
...
Room {
    id = "fuzhou/island2",
    name = "沙滩",
    ways = {["west"] = "fuzhou/island1"},
    nolooks = {["east"] = true, ["south"] = true, ["north"] = true}
}
Room {
    id = "fuzhou/island3",
    name = "沙滩",
...
Room {
    id = "fuzhou/island5",
    name = "沙滩",
    ways = {["eastup"] = "fuzhou/lagoon", ["north"] = "fuzhou/island4"}
}
Room {
    id = "fuzhou/jiuguan",
    name = "酒馆",
    ways = {["west"] = "fuzhou/dongxiang"}
}
Room {
    id = "fuzhou/kezhan",
    name = "吉祥客栈",
...
Room {
    ...
    name = "客栈二楼",
    no_fight = true,
    ways = {["down"] = "fuzhou/kezhan"}
}
Room {
    id = "fuzhou/lagoon",
    name = "礁石",
    ways = {["westdown"] = "fuzhou/island5"},
    objs = {["扇贝"] = "bei ke"}
}
Room {
    id = "fuzhou/laozhai",
    name = "向阳老宅",
    ways = {["west"] = "fuzhou/xyxiang2"}
}
Room {
    id = "fuzhou/liang",
    name = "密室房梁",
    ways = {["down"] = "fuzhou/mishi"}
}
Room {id = "fuzhou/midao", name = "密道", ways = {["out"] = "fuzhou/well"}}
Room {
    id = "fuzhou/minzhai",
    name = "民宅",
    ways = {["east"] = "fuzhou/xixiang"}
}
Room {id = "fuzhou/mishi", name = "密室", ways = {["out"] = "fuzhou/midao"}}
Room {
    id = "fuzhou/mupeng",
    name = "小木棚",
    ways = {["out"] = "fuzhou/rock"}
}
Room {
    id = "fuzhou/nanjie",
    name = "南街",
    ways = {["south"] = "fuzhou/nanmen", ["north"] = "fuzhou/zhongxin"}
}
Room {
    id = "fuzhou/nanmen",
    name = "南门",
...
Room {
    id = "fuzhou/road1",
    name = "山路",
    ways = {["southwest"] = "fuzhou/road2", ["northeast"] = "ningbo/ttcsi"},
...
Room {
    id = "fuzhou/road4",
    name = "山路",
    ways = {["south"] = "fuzhou/road5", ["north"] = "group/entry/fzroad3"},
    room_relative = "山路｜山路｜武夷山路山路"
}
Room {
    id = "fuzhou/road5",
    name = "武夷山路",
    ways = {["south"] = "fuzhou/beimen", ["north"] = "fuzhou/road4"},
    objs = {["野兔"] = "ye tu", ["白袍剑侠"] = "baipao jianxia"}
}
Room {
    id = "fuzhou/rock",
    name = "巨岩",
    ways = {["south"] = "fuzhou/island3", ["enter"] = "fuzhou/mupeng"}
}
Room {
    id = "fuzhou/shanpo",
    name = "山坡",
    ways = {["south"] = "fuzhou/wroad2"},
    objs = {["野兔"] = "ye tu"}
}
Room {
    id = "fuzhou/shiqiao",
    name = "石桥",
    ways = {["south"] = "fuzhou/xyxiang", ["north"] = "fuzhou/dongjie"}
}
Room {
    id = "fuzhou/well",
    name = "井中",
    ways = {["down"] = "fuzhou/well1", ["up"] = "fuzhou/houyuan"}
}
Room {id = "fuzhou/well1", name = "井底", ways = {["up"] = "fuzhou/well"}}
Room {
    id = "fuzhou/wjiuguan",
    name = "小酒馆",
    ways = {["east"] = "fuzhou/wroad2"},
    objs = {["萨老板"] = "sa laoban"}
}
Room {
    id = "fuzhou/wroad",
    name = "山路",
    ways = {["northwest"] = "fuzhou/wroad2", ["east"] = "fuzhou/ximen"},
    nolooks = {["east"] = true},
...
Room {
    id = "fuzhou/wroad10",
    name = "山路",
    ways = {["south"] = "foshan/xiaolu3", ["east"] = "fuzhou/wroad9"},
...
Room {
    id = "fuzhou/wroad3",
    name = "山路",
    ways = {["southwest"] = "fuzhou/wroad4", ["northeast"] = "fuzhou/wroad2"},
...
Room {
    id = "fuzhou/wroad7",
    name = "山路",
    ways = {["southwest"] = "fuzhou/wroad8", ["northeast"] = "fuzhou/wroad6"},
    room_relative = "山路↗山路↙山路山路"
}
Room {
    id = "fuzhou/wroad8",
    name = "山路",
    ways = {["southwest"] = "fuzhou/wroad9", ["northeast"] = "fuzhou/wroad7"},
    room_relative = "山路↗山路↙山路山路"
}
Room {
    id = "fuzhou/wroad9",
    name = "山路",
    ways = {["northeast"] = "fuzhou/wroad8", ["west"] = "fuzhou/wroad10"},
    room_relative = "山路↗山路-----山路山路"
}
Room {
    id = "fuzhou/xijie",
...
Room {
    id = "fuzhou/ximen",
    name = "西门",
    ways = {["east"] = "fuzhou/xijie2", ["west"] = "fuzhou/wroad"},
    nolooks = {["west"] = true}
}
Room {
    id = "fuzhou/xixiang",
...
Room {
    id = "fuzhou/xyxiang2",
    name = "向阳巷",
    ways = {["north"] = "fuzhou/xyxiang", ["east"] = "fuzhou/laozhai"}
}
Room {
    id = "fuzhou/yaopu",
    name = "药铺",
    ways = {["east"] = "fuzhou/xixiang2"}
}
Room {
    id = "fuzhou/yuchuan1",
    name = "渔船",
...
Room {
    id = "fuzhou/zahuopu",
    name = "杂货铺",
    ways = {["west"] = "fuzhou/xixiang"},
    objs = {["陈阿婆"] = "chen apo"}
}
Room {
    id = "fuzhou/zhangfang",
    name = "镖局帐房",
    ways = {["west"] = "fuzhou/biaoju"},
    objs = {["董帐房"] = "zhang fang"}
}
Room {
    id = "fuzhou/zhengting",
    name = "镖局正厅",
    no_fight = true,
    ways = {["north"] = "fuzhou/biaoju"},
    objs = {["林震南"] = "lin zhennan"}
}
Room {
    id = "fuzhou/zhongxin",
    name = "城中心",
...
Room {
    id = "gb/houyuan",
    name = "后院",
    ways = {["south"] = "gb/pomiao"},
    nolooks = {["south"] = true},
    precmds = {["south"] = "open door"},
    objs = {["洪七公"] = "hong qigong"}
}
Room {id = "gb/island1", name = "小岛", ways = {["north"] = "gb/island3"}}
Room {id = "gb/island2", name = "小岛", ways = {["west"] = "gb/island1"}}
Room {
    id = "gb/island3",
    name = "沙滩",
    ways = {
...
Room {
    id = "gb/island5",
    name = "沙滩",
    ways = {["eastup"] = "gb/lagoon", ["north"] = "gb/island4"}
}
Room {
    id = "gb/kongdi2",
    name = "空地",
    ways = {["east"] = "gb/xinglin9"},
    objs = {["陈长老"] = "chen zhanglao"},
    room_relative = "空地-----杏子林空地"
}
Room {id = "gb/lagoon", name = "礁石", ways = {["westdown"] = "gb/island5"}}
Room {
    id = "gb/liangcang1",
    name = "后仓",
    ways = {["northup"] = "gb/xiaodao", ["south"] = "gb/liangcang2"}
}
Room {
    id = "gb/liangcang2",
    name = "中仓",
...
Room {
    id = "gb/liangcang3",
    name = "前仓",
    ways = {["north"] = "gb/liangcang2"}
}
Room {
    id = "gb/liangcang4",
    name = "左仓",
    ways = {["west"] = "gb/liangcang2"}
}
Room {
    id = "gb/liangcang5",
    name = "右仓",
    ways = {["east"] = "gb/liangcang2"}
}
Room {id = "gb/mupeng", name = "小木棚", ways = {["out"] = "gb/rock"}}
Room {
    id = "gb/pomiao",
    name = "土地庙",
    ways = {["south"] = "gb/xinglin9", ["north"] = "gb/houyuan"},
    nolooks = {["north"] = true},
    precmds = {["north"] = "open door"},
    objs = {["鲁有脚"] = "lu youjiao"}
}
Room {
    id = "gb/rock",
    name = "巨岩",
    ways = {["south"] = "gb/island3", ["enter"] = "gb/mupeng"}
}
Room {
    id = "gb/tianjing",
    name = "田径",
    ways = {["east"] = "suzhou/qsgdao6", ["north"] = "gb/xinglin1"}
}
Room {
    id = "gb/xiaodao",
    name = "小路",
    ways = {["northup"] = "gb/yading", ["southdown"] = "gb/liangcang1"}
}
Room {
    id = "gb/xinglin1",
    name = "杏子林",
...
Room {
    id = "gb/xinglin8",
    name = "杏子林",
    ways = {["south"] = "gb/xinglin7", ["north"] = "gb/xinglin9"},
    objs = {["白世镜"] = "bai shijing", ["宋长老"] = "song zhanglao"}
}
Room {
    id = "gb/xinglin9",
    name = "杏子林",
    ...
    objs = {["梁长老"] = "liang zhanglao"}
}
Room {
    id = "gb/yading",
    name = "崖顶",
    ways = {["down"] = "nanyang/duanya", ["southdown"] = "gb/xiaodao"}
}
Room {
    id = "gb/zhongjun1",
    name = "中军辕门",
    ways = {["north"] = "gb/zhongjun2"}
}
Room {
    id = "gb/zhongjun2",
    name = "中军",
    ways = {["south"] = "gb/zhongjun1", ["north"] = "gb/zhongjun3"}
}
Room {
    id = "gb/zhongjun3",
    name = "中军",
    ways = {["south"] = "gb/zhongjun2", ["north"] = "gb/zhongjun4"}
}
Room {
    id = "gb/zhongjun4",
    name = "中军",
    ways = {["south"] = "gb/zhongjun3", ["north"] = "gb/zhongjun5"}
}
Room {
    id = "gb/zhongjun5",
    name = "中军大帐",
    ways = {["south"] = "gb/zhongjun4"}
}
Room {
    id = "group/cailiao-hang",
    outdoor = "成都城",
    name = "材料行",
    ways = {["south"] = "chengdu/ddajie1"},
    objs = {["王掌柜"] = "wang zhanggui"}
}
Room {
    ...
    name = "土路",
    outdoor = "长安城",
    ways = {["southeast"] = "village/shilu5", ["west"] = "changan/eastroad2"},
...
Room {
    ...
    name = "大道",
    outdoor = "成都城",
    ways = {["east"] = "xiangyang/xiaolu2", ["west"] = "chengdu/eroad3"},
...
Room {
    ...
    name = "土路",
    outdoor = "峨嵋山",
    ways = {["southwest"] = "chengdu/tulu1", ["northeast"] = "chengdu/tulu3"}
}
Room {
...
Room {
    ...
    name = "驿道",
    outdoor = "沧州城",
    ways = {["southwest"] = "cangzhou/wroad3", ["east"] = "cangzhou/wroad1"}
}
Room {
...
Room {
    ...
    name = "大道",
    outdoor = "大理城北",
    ways = {["south"] = "dali/dadao3", ["north"] = "dali/dadao1"},
    room_relative = "大道｜大道｜大道大道"
}
Room {
...
Room {
    ...
    name = "林间道",
    outdoor = "佛山镇",
    ways = {["southwest"] = "foshan/road11", ["northeast"] = "foshan/road14"}
}
Room {
    id = "group/entry/fsroad5",
    name = "林间道",
    outdoor = "佛山镇",
    ways = {["northeast"] = "foshan/road4", ["west"] = "foshan/road6"}
}
Room {
    id = "group/entry/fzroad3",
    name = "山路",
    outdoor = "福州城",
    ways = {["south"] = "fuzhou/road4", ["northeast"] = "fuzhou/road2"},
    room_relative = "山路↗山路｜山路山路"
}
Room {
    ...
    name = "山路",
    outdoor = "福州城",
    ways = {["southwest"] = "fuzhou/wroad6", ["east"] = "fuzhou/wroad4"},
...
Room {
    ...
    name = "终南广场",
    outdoor = "终南山",
    ways = {["southeast"] = "gumu/jishi", ["northwest"] = "gumu/xiaolu2"}
}
Room {
...
Room {
    ...
    name = "青石大道",
    outdoor = "杭州城",
    ways = {["south"] = "hz/beimen", ["north"] = "hz/shanlu3"}
}
Room {
...
Room {
    ...
    name = "大沙漠",
    outdoor = "丝绸之路",
    ways = {["northeast"] = "xingxiu/silk6", ["west"] = "mingjiao/shaqiu1"}
}
Room {
...
Room {
    ...
    name = "藏边土路",
    outdoor = "大雪山",
    ways = {["southwest"] = "xueshan/tulu3", ["northeast"] = "xueshan/tulu1"}
}
Room {
    id = "group/entry/xsxiao2",
    name = "湖边小路",
    outdoor = "大雪山",
    ways = {["northwest"] = "xueshan/xiaolu1", ["east"] = "xueshan/xiaolu3"}
}
Room {
...
Room {
    id = "gumu/bzy",
    name = "抱子岩",
    ways = {["southup"] = "gumu/lyy", ["eastdown"] = "gumu/ryy"}
}
Room {id = "gumu/dongkou", name = "洞口", ways = {["out"] = "gumu/shanxia"}}
Room {
    id = "gumu/fang",
    name = "石室",
    ways = {
...
Room {
    id = "gumu/fchuan",
    name = "樊川",
    ways = {["east"] = "xiangyang/shanxiroad1", ["west"] = "gumu/xiaolu1"}
}
Room {
    id = "gumu/gmanhe1",
    name = "暗河",
    ways = {["northup"] = "gumu/sshi1", ["westdown"] = "gumu/gmql1"}
}
Room {
    id = "gumu/gmanhe2",
    name = "暗河",
    ways = {["northup"] = "gumu/dongkou", ["eastdown"] = "gumu/gmql2"}
}
Room {
    id = "gumu/gmcc",
    name = "储藏室",
    ways = {["open door;north"] = "gumu/fang"}
}
Room {
    id = "gumu/gmht",
    name = "后堂",
...
Room {id = "gumu/gmlg2", name = "练功房", ways = {["south"] = "gumu/gmzt"}}
Room {
    id = "gumu/gmlg4",
    name = "石室",
    ways = {["south"] = "gumu/gmlg5", ["out"] = "gumu/gmlg1"}
}
Room {id = "gumu/gmlg5", name = "石室", ways = {["north"] = "gumu/gmlg4"}}
Room {
    id = "gumu/gmlw",
    name = "领悟室",
    ways = {["open door;south"] = "gumu/gmqt"}
}
Room {
    id = "gumu/gmqc",
    name = "切磋室",
    no_fight = true,
    ways = {["open door;north"] = "gumu/gmqt"}
}
Room {
    id = "gumu/gmql1",
    name = "潜流",
    ways = {["eastup"] = "gumu/gmanhe1", ["west"] = "gumu/gmql2"}
}
Room {
    id = "gumu/gmql2",
    name = "潜流",
    ways = {["westup"] = "gumu/gmanhe2", ["east"] = "gumu/gmql1"}
}
Room {
    id = "gumu/gmqs",
    name = "琴室",
...
Room {
    ...
    name = "休息室",
    no_fight = true,
    ways = {["north"] = "gumu/gmht"}
}
Room {
    id = "gumu/gmws1",
    name = "卧室",
    ways = {["south"] = "gumu/gmht", ["tang bed;ban shiban"] = "gumu/ss0"},
    nolooks = {["tang bed;ban shiban"] = true}
}
Room {
    id = "gumu/gmzt",
    name = "中堂",
    ...
    nolooks = {["zong bian"] = true}
}
Room {
    id = "gumu/bianhou",
    name = "匾后",
    ways = {["jump down"] = "gumu/gmzt"},
    nolooks = {["jump down"] = true}
}
Room {
    id = "gumu/guolin1",
    name = "果林",
...
Room {id = "gumu/guolin5", name = "果林", ways = {["east"] = "gumu/guoyuan"}}
Room {
    id = "gumu/guoyuan",
    name = "果园",
    ways = {
...
Room {
    ...
    name = "红花丛",
    no_fight = true,
    ways = {["south"] = "gumu/guolin5", ["west"] = "gumu/guolin4"}
}
Room {id = "gumu/jianshi", name = "剑室", ways = {["south"] = "gumu/gmqs"}}
Room {
    id = "gumu/jishi",
    name = "集市",
    ways = {["northwest"] = "group/entry/gmchang"}
}
Room {
    id = "gumu/jlg",
    name = "金莲阁",
    ways = {["northup"] = "gumu/ztm", ["southup"] = "gumu/ryy"},
    objs = {["马钰"] = "ma yu"}
}
Room {
    id = "gumu/jqg/boat2",
    name = "小舟",
    ways = {["out"] = "gumu/jqg/xiaoxi"}
}
Room {
    id = "gumu/jqg/boat5",
    name = "小舟",
    ways = {["out"] = "gumu/jqg/xibian"}
}
Room {
    id = "gumu/jqg/cave3",
    name = "隧洞",
    ways = {["west"] = "gumu/jqg/shiyao"}
}
Room {
    id = "gumu/jqg/danfang",
    name = "丹房",
    ...
    nolooks = {["#weaponUnWalk;tui middlelu;#walkBusy"] = true},
    lengths = {
...
Room {
    ...
    name = "丹房",
    ways = {["tui eastlu middle;#walkBusy"] = "gumu/jqg/danfang2"},
    nolooks = {["tui eastlu middle;#walkBusy"] = true},
    lengths = {["tui eastlu middle;#walkBusy"] = 10}
}
Room {
    id = "gumu/jqg/danfang2",
    name = "丹房",
    ways = {["tui westlu east;#walkBusy"] = "gumu/jqg/danfang3"},
    nolooks = {["tui westlu east;#walkBusy"] = true},
    lengths = {["tui westlu east;#walkBusy"] = 10}
}
Room {
    id = "gumu/jqg/danfang3",
    name = "丹房",
    ways = {["tui middlelu west;#walkBusy"] = "gumu/jqg/eytan"},
    nolooks = {["tui middlelu west;#walkBusy"] = true},
    lengths = {["tui middlelu west;#walkBusy"] = 10}
}
Room {
    id = "gumu/jqg/eytan",
    name = "鳄鱼潭",
    ways = {["ta corpse"] = "gumu/jqg/cave1"},
    blocks = {["ta corpse"] = {{id = "e yu", exp = 350000}}},
    objs = {["鳄鱼"] = "e yu"}
}
Room {
    id = "gumu/jqg/cave1",
    name = "洞口",
    ways = {["zuan dong;#walkBusy;zuan dong"] = "gumu/jqg/cave2"},
    nolooks = {["zuan dong;#walkBusy;zuan dong"] = true},
    lengths = {["zuan dong;#walkBusy;zuan dong"] = 10}
}
Room {
    id = "gumu/jqg/cave2",
    name = "山洞",
    ways = {["pa down;#walkBusy"] = "gumu/jqg/cave3"}
}
Room {
    id = "gumu/jqg/cave3",
    name = "隧洞",
...
Room {
    id = "gumu/jqg/shiyao",
    name = "石窟",
    ways = {["east"] = "gumu/jqg/cave3", ["#outJqg"] = "gumu/jqg/shibi"},
    objs = {["裘千尺"] = "qiu qianchi"},
    nolooks = {["#outJqg"] = true},
    lengths = {["#outJqg"] = 10000}
}
Room {
    id = "gumu/jqg/shibi",
    name = "石壁",
    ways = {["pa down"] = "gumu/jqg/shiyao", ["pa up"] = "gumu/jqg/shanlu6"},
    nolooks = {["pa down"] = true, ["pa up"] = true}
}
Room {
    id = "gumu/jqg/dashi",
    name = "大室",
    ways = {["west"] = "gumu/jqg/xiaoshi"},
    objs = {["小龙女"] = "xiao longnv"}
}
Room {
    id = "gumu/jqg/dating",
    name = "大厅",
    ways = {["out"] = "gumu/jqg/shiwu", ["#goHt"] = "gumu/jqg/houtang"},
    nolooks = {["#goHt"] = true},
    lengths = {
...
Room {
    id = "gumu/jqg/fyy",
    name = "飞云岩",
    ways = {["northup"] = "gumu/jqg/shanjing", ["southdown"] = "gumu/jqg/xqx"}
}
Room {
    id = "gumu/jqg/glt",
    name = "观澜亭",
    ways = {["east"] = "gumu/jqg/xqx", ["southdown"] = "gumu/jqg/xiaoxi"}
}
Room {
    id = "gumu/jqg/houtang",
    name = "后堂",
    no_fight = true,
    ways = {["south"] = "gumu/jqg/dating", ["north"] = "gumu/jqg/lang1"}
}
Room {
    id = "gumu/jqg/huacong",
    name = "花丛",
    no_fight = true,
    ways = {["west"] = "gumu/jqg/xiaolu"}
}
Room {
    id = "gumu/jqg/huayuan",
    name = "花园",
    ways = {["south"] = "gumu/jqg/lang1"}
}
Room {
    id = "gumu/jqg/jianshi",
    name = "剑室",
    ways = {["south"] = "gumu/jqg/lang5"},
    postcmds = {["south"] = "#walkBusy"}
}
Room {
    id = "gumu/jqg/lang1",
    name = "长廊",
...
Room {
    id = "gumu/jqg/lang3",
    name = "东厢长廊",
    ways = {["east"] = "gumu/jqg/shufang", ["west"] = "gumu/jqg/lang2"},
...
Room {
    id = "gumu/jqg/lgf",
    name = "练功房",
    ways = {["north"] = "gumu/jqg/lang2"}
}
Room {
    id = "gumu/jqg/qsroad",
    name = "青石板路",
    ways = {["eastup"] = "gumu/jqg/shuitang", ["north"] = "gumu/jqg/shiwu"}
}
Room {
...
Room {
    ...
    name = "山径",
    ways = {["northup"] = "gumu/jqg/shanjing1", ["southdown"] = "gumu/jqg/fyy"}
}
Room {
...
Room {
    id = "gumu/jqg/shanlu1",
    name = "山间小路",
    ways = {["southeast"] = "gumu/jqg/shanlu2", ["north"] = "gumu/jqg/xibian"}
}
Room {
    ...
    nolooks = {["l ya;jump qiaobi;xiao"] = true, ["l ya;jump qiaobi"] = true},
    lengths = {
...
Room {
    id = "gumu/jqg/qiaobi",
    name = "峭壁",
    ways = {["#Togudi"] = "gumu/jqg/gudi", ["jump back"] = "gumu/jqg/shanlu10"},
    nolooks = {["#Togudi"] = true, ["jump back"] = true},
    lengths = {["#Togudi"] = 100, ["jump back"] = 100}
}
Room {
    id = "gumu/jqg/yabi",
    name = "崖壁",
    ways = {["#Goyadi"] = "gumu/jqg/gudi", ["#Goqiaobi"] = "gumu/jqg/qiaobi"},
    nolooks = {["#Goyadi"] = true, ["#Goqiaobi"] = true},
    lengths = {["#Goyadi"] = 100, ["#Goqiaobi"] = 100}
}
Room {
    id = "gumu/jqg/gudishuitan",
    name = "谷底水潭",
    ways = {["#Hyadi"] = "gumu/jqg/gudi"},
    nolooks = {["#Hyadi"] = true},
    lengths = {["#Hyadi"] = 100}
}
Room {
...
Room {
    id = "gumu/jqg/gudi",
    name = "谷底",
    ways = {["#Toqiaobi"] = "gumu/jqg/qiaobi", ["#Totanan"] = "gumu/jqg/tanan"},
    nolooks = {["#Toqiaobi"] = true, ["#Totanan"] = true},
    lengths = {["#Toqiaobi"] = 100, ["#Totanan"] = 100}
}
Room {
    id = "gumu/jqg/shanlu2",
    name = "山间小路",
...
Room {
    id = "gumu/jqg/shanlu4",
    name = "山路",
    ways = {["east"] = "gumu/jqg/shanlu5", ["west"] = "gumu/jqg/shanding"}
}
Room {
    id = "gumu/jqg/shanlu5",
    name = "山路",
...
Room {
    id = "gumu/jqg/shanlu6",
    name = "厉鬼峰",
    ways = {["southdown"] = "gumu/jqg/shanlu5"}
}
Room {
    id = "gumu/jqg/shanlu9",
    name = "山路",
    ways = {["westdown"] = "gumu/jqg/shanlu5", ["eastup"] = "gumu/jqg/shanlu10"}
}
Room {
    id = "gumu/jqg/shiwu",
    name = "大石屋",
    ways = {["south"] = "gumu/jqg/qsroad", ["enter"] = "gumu/jqg/dating"},
    blocks = {["enter"] = {{id = "fan yiweng", exp = 400000}}}
}
Room {
    id = "gumu/jqg/shufang",
    name = "书房",
    ways = {["west"] = "gumu/jqg/lang3"}
}
Room {
    ...
    nolooks = {["#jqgzlout"] = true, ["eastup"] = true},
    lengths = {["#jqgzlout"] = 100}
}
Room {
    id = "gumu/jqg/sleep1",
    name = "休息室",
    no_fight = true,
    ways = {["south"] = "gumu/jqg/lang4"}
}
Room {
    id = "gumu/jqg/sleep2",
    name = "休息室",
...
Room {
    ...
    nolooks = {["xiao;jump back"] = true, ["#Hgudi"] = true},
    lengths = {
...
Room {
    id = "gumu/jqg/xiaoshi",
    name = "小室",
    ways = {["east"] = "gumu/jqg/dashi", ["west"] = "gumu/jqg/zhongtang"},
    objs = {["杨过"] = "yang guo"}
}
Room {
    id = "gumu/jqg/xiaoxi",
    name = "独峰岭",
    ways = {["northup"] = "gumu/jqg/glt", ["#jqgout"] = "gumu/jqg/xibian"},
    nolooks = {["#jqgout"] = true},
    lengths = {["#jqgout"] = 200}
}
Room {
    id = "gumu/jqg/xibian",
    name = "小溪边",
    ways = {["south"] = "gumu/jqg/shanlu1", ["#jqgin"] = "gumu/jqg/xiaoxi"},
    nolooks = {["#jqgin"] = true},
    lengths = {["#jqgin"] = 200}
}
Room {
    id = "gumu/jqg/xqx",
    name = "响琴榭",
    ways = {["northup"] = "gumu/jqg/fyy", ["west"] = "gumu/jqg/glt"}
}
Room {
    id = "gumu/jqg/xshiwu",
    name = "小石屋",
    no_fight = true,
    ways = {["east"] = "gumu/jqg/shanding"}
}
Room {
    id = "gumu/jqg/zhifang",
    name = "芝房",
    ways = {["north"] = "gumu/jqg/lang5"}
}
Room {
...
Room {
    ...
    lengths = {["#jqgzlin"] = 50, ["#jqgzlout"] = 50}
}
Room {id = "gumu/lgf", name = "练功房", ways = {["south"] = "gumu/shitou"}}
Room {
    id = "gumu/lingshi",
    name = "灵室",
    ways = {
...
Room {
    id = "gumu/lyy",
    name = "老妪岩",
    ways = {["east"] = "gumu/shulin1", ["northdown"] = "gumu/bzy"}
}
Room {
    id = "gumu/rukou",
    name = "古墓",
...
Room {
    id = "gumu/ryy",
    name = "日月岩",
    ways = {["westup"] = "gumu/bzy", ["northdown"] = "gumu/jlg"}
}
Room {
    id = "gumu/shanlu1",
    name = "山麓",
    ways = {["southup"] = "gumu/shanlu2", ["northdown"] = "gumu/xiaolu3"}
}
Room {
    id = "gumu/shanlu2",
    name = "岗顶",
    ways = {["southup"] = "gumu/shanlu3", ["northdown"] = "gumu/shanlu1"}
}
Room {
    id = "gumu/shanlu3",
    name = "山路",
    ways = {["eastup"] = "gumu/ztm", ["northdown"] = "gumu/shanlu2"}
}
Room {
    id = "gumu/shanpo",
    name = "山坡",
    ways = {["westdown"] = "gumu/guoyuan", ["northeast"] = "gumu/shanpo1"}
}
Room {
    id = "gumu/shanpo1",
    name = "山坡",
    ways = {["southwest"] = "gumu/shanpo"}
}
Room {
    id = "gumu/shanxia",
    name = "终南山下",
    ways = {["northwest"] = "gumu/xiaolu3", ["enter"] = "gumu/dongkou"}
}

Room {
    id = "gumu/shengou",
    name = "深沟",
    ways = {["west"] = "gumu/shulin2", ["tiao gou"] = "gumu/rukou"},
    nolooks = {["tiao gou"] = true},
    lengths = {
...
Room {id = "gumu/shulin", name = "树林", ways = {["out"] = "gumu/shulin2"}}
Room {
    id = "gumu/shulin1",
    name = "树林",
    ways = {["east"] = "gumu/sln", ["west"] = "gumu/lyy"}
}
Room {
    id = "gumu/shulin2",
    name = "灌木丛",
    ways = {["east"] = "gumu/shengou", ["west"] = "gumu/sln"}
}
--[[
Room {
	id = "gumu/sln",
...
--]]
Room {id = "gumu/sln", name = "黑林", ways = {["south"] = "gumu/sl3"}}
Room {id = "gumu/sl3", name = "黑林", ways = {["north"] = "gumu/sl2"}}
Room {
    id = "gumu/sl2",
    name = "黑林",
    ways = {["south"] = "gumu/sl4"},
...
Room {id = "gumu/ss0", name = "石室", ways = {["out"] = "gumu/ss4"}}
Room {id = "gumu/ss1", name = "石室", ways = {["out"] = "gumu/ss1"}}
Room {
    id = "gumu/ss4",
    name = "石室",
    ways = {
...
Room {
    id = "gumu/ss5",
    name = "石室",
    ways = {["enter"] = "gumu/lingshi", ["west"] = "gumu/ss4"}
}
Room {
    id = "gumu/sshi1",
    name = "石室",
...
Room {
    id = "gumu/xiaolu1",
    name = "田间小路",
    ways = {["south"] = "gumu/xiaolu2", ["east"] = "gumu/fchuan"}
}
Room {
    id = "gumu/xiaolu2",
    name = "终南小道",
...
Room {
    ...
    blocks = {["enter"] = {{id = "shen diao", exp = 100000}}},
    objs = {["神雕"] = "shen diao"}
}
Room {
    id = "gumu/xuantie/pubu",
    name = "瀑布",
    ways = {["west"] = "gumu/xuantie/xiaolu3"}
}
Room {
...
Room {
    ...
    nolooks = {["tiao down"] = true, ["enter"] = true},
    precmds = {["enter"] = "move stone"}
}
Room {
    id = "gumu/xuantie/jianzhong",
    name = "剑冢",
    ways = {["out"] = "gumu/xuantie/pingtai"},
    nolooks = {["out"] = true},
    precmds = {["out"] = "tui shi"}
}
Room {
...
Room {
    ...
    name = "树上",
    ways = {["down"] = "gumu/xuantie/shanlu7"}
}
Room {
...
Room {id = "gumu/xuanya", name = "悬崖", ways = {["north"] = "gumu/rukou"}}
Room {
    id = "gumu/yaofang",
    name = "药房",
    ways = {["north"] = "gumu/shitou", ["west"] = "gumu/fang"}
}
Room {
    id = "gumu/ztm",
    name = "中天门",
    ways = {["westdown"] = "gumu/shanlu3", ["southdown"] = "gumu/jlg"}
}
Room {
    id = "hengshan/baiyunan",
    name = "白云庵",
    ways = {["south"] = "hengshan/square"},
    objs = {
...
Room {
    ...
    objs = {["仪和"] = "yi he", ["仪琳"] = "yi lin"}
}
Room {
    id = "hengshan/cuiping1",
    name = "翠屏山道",
    ways = {["westup"] = "hengshan/cuiping2", ["down"] = "hengshan/cuipinggu2"}
}
Room {
...
Room {
    ...
    name = "翠屏谷",
    ways = {["northwest"] = "hengshan/cuipinggu1", ["up"] = "hengshan/cuiping1"}
}
Room {
    id = "hengshan/daziling",
    name = "大字岭",
    ways = {["northeast"] = "hengshan/hufengkou", ["west"] = "hengshan/yunge"}
}
Room {
...
Room {
    ...
    name = "会仙台",
    ways = {["eastdown"] = "hengshan/beiyuedian"}
}
Room {
    id = "hengshan/jijiaoshi",
    name = "鸡叫石",
    ways = {["east"] = "hengshan/beiyuemiao"}
}
Room {
    ...
    objs = {["定静师太"] = "dingjing shitai"}
}
Room {
    id = "hengshan/kutianjing",
    name = "苦甜井",
    ways = {["west"] = "hengshan/beiyuemiao"}
}
Room {
...
Room {
    ...
    name = "见性峰山道",
    ways = {["eastup"] = "hengshan/square", ["southdown"] = "hengshan/shandao1"}
}
Room {
    id = "hengshan/sjdian",
    name = "三教殿",
    ways = {["down"] = "hengshan/xuankong1"}
}
Room {
    id = "hengshan/square",
    name = "见性峰广场",
    ways = {["westdown"] = "hengshan/shandao2", ["north"] = "hengshan/baiyunan"},
    objs = {["定逸师太"] = "dingyi shitai", ["仪清"] = "yi qing"}
}
Room {
    id = "hengshan/tongyuangu",
    name = "通元谷",
    ways = {["eastup"] = "hengshan/guolaoling"}
}
Room {
    id = "hengshan/xgsong",
    name = "悬根松",
    ways = {["east"] = "hengshan/hufengkou"}
}
Room {
...
Room {
    ...
    name = "悬空寺南楼",
    ways = {["southup"] = "hengshan/zhandao", ["north"] = "hengshan/zhanqiao"}
}
Room {
    id = "hengshan/yunge",
    name = "云阁虹桥",
    ways = {["east"] = "hengshan/daziling", ["northdown"] = "hengshan/zhandao"},
    objs = {["仪质"] = "yi zhi"}
}
Room {
    id = "hengshan/yuyang",
    name = "玉羊游云",
    ways = {["westdown"] = "hengshan/beiyuedian"}
}
Room {
    id = "hengshan/zhandao",
    name = "梯式栈道",
...
Room {
    ...
    name = "悬空栈桥",
    ways = {["south"] = "hengshan/xuankong2", ["north"] = "hengshan/xuankong1"}
}
-- add by xieky@sj 20170809
Room {
    id = "hengshan/mtroad",
    name = "山路",
    ways = {["south"] = "hengshan/mtyadi", ["east"] = "hengshan/mtroad1"},
    objs = {["丁当"] = "ding dang"}
}
Room {
    id = "hengshan/mtyadi",
...
Room {
    ...
    nolooks = {["s;s;s;s"] = true, ["n;n;n;n"] = true},
    lengths = {["s;s;s;s"] = 4, ["n;n;n;n"] = 4},
    objs = {["潇湘子"] = "xiaoxiang zi"}
}
Room {
    id = "hj/caoyuan1",
    name = "大草原",
...
Room {
    ...
    objs = {["绵羊"] = "mian yang", ["天铃鸟"] = "tianlin niao"}
}
Room {
    id = "hj/caoyuan6",
    name = "大草原",
...
Room {
    ...
    name = "哈萨克帐篷",
    ways = {
        ["get rulao;southwest"] = "hj/room-che",
        ["get rulao;east"] = "hj/caoyuan",
        ["get rulao;west"] = "hj/majiu"
    },
    objs = {
        ["天铃鸟"] = "tianlin niao",
        ["乳酪"] = "ru lao",
...
Room {
    ...
    lengths = {["north"] = "if tmp.find then return 1 else return 10 end"}
}
Room {
    id = "hj/luzhou",
    name = "回疆绿洲",
...
Room {
    id = "hj/mg-door",
    name = "高昌迷宫",
    ways = {["eastdown"] = "hj/shulin1"}
}
Room {
    id = "hj/mg-indoor",
    name = "高昌迷宫",
    ways = {["east"] = "hj/mg3", ["west"] = "hj/mg4"}
}
Room {
    id = "hj/mg-room1",
    name = "迷宫房舍",
...
Room {
    id = "hj/mg-room2",
    name = "迷宫房舍",
    ways = {["south"] = "hj/mg-room1"}
}
Room {
    id = "hj/mg-room3",
    name = "迷宫房舍",
    ways = {["southeast"] = "hj/mg-room1", ["northeast"] = "hj/mg-room5"}
}
Room {
    id = "hj/mg-room4",
    name = "迷宫房舍",
    ways = {["southwest"] = "hj/mg-room1", ["northwest"] = "hj/mg-room5"}
}
Room {
    id = "hj/mg-room5",
    name = "迷宫房舍",
    ways = {["southeast"] = "hj/mg-room4", ["southwest"] = "hj/mg-room3"}
}
Room {id = "hj/mg1", name = "高昌迷宫", ways = {["north"] = "hj/mg2"}}
Room {
    id = "hj/mg2",
    name = "高昌迷宫",
    ways = {["south"] = "hj/mg1", ["north"] = "hj/mg4"}
}
Room {
    id = "hj/mg3",
    name = "高昌迷宫",
...
Room {
    ...
    objs = {["陈达海"] = "chen dahai", ["绵羊"] = "mian yang"}
}
Room {
    id = "hj/road1",
    name = "小路",
...
Room {
    ...
    lengths = {["northwest"] = 10}
}
Room {
    id = "hj/room-ji1",
    name = "小屋",
    ways = {["out"] = "hj/room-ji"},
    objs = {["计老人"] = "ji laoren", ["李文秀"] = "li wenxiu"}
}
Room {
    id = "hj/room-su",
    name = "苏鲁克的家",
...
--]]
Room {id = "hj/senlinn", name = "针叶林", ways = {["east"] = "hj/senlin2"}}
Room {id = "hj/senlin2", name = "针叶林", ways = {["south"] = "hj/senlin3"}}
Room {id = "hj/senlin3", name = "针叶林", ways = {["west"] = "hj/senlin4"}}
Room {id = "hj/senlin4", name = "针叶林", ways = {["north"] = "hj/senlin5"}}
Room {id = "hj/senlin5", name = "针叶林", ways = {["east"] = "hj/senlin6"}}
Room {id = "hj/senlin6", name = "针叶林", ways = {["south"] = "hj/senlin7"}}
Room {id = "hj/senlin7", name = "针叶林", ways = {["west"] = "hj/senlin8"}}
Room {id = "hj/senlin8", name = "针叶林", ways = {["north"] = "hj/senlin9"}}

Room {id = "hj/senlin9", name = "针叶林", ways = {["north"] = "hj/senlin10"}}
Room {id = "hj/senlin10", name = "针叶林", ways = {["east"] = "hj/senlin11"}}
Room {
    id = "hj/senlin11",
    name = "针叶林",
    ways = {["#outZyl"] = "hj/senlin"},
    nolooks = {
        ["#outZyl"] = true,
        ["east"] = true,
        ["west"] = true,
...
Room {
    id = "hj/shulin1",
    name = "山谷",
    ways = {["southeast"] = "hj/shulin", ["westup"] = "hj/mg-door"}
}
Room {
    id = "hj/sroom",
    name = "哈萨克帐篷",
    no_fight = true,
    ways = {["southeast"] = "hj/shop"}
}
Room {id = "hj/tianjin", name = "天井", ways = {["north"] = "hj/mg-room1"}}
Room {
    id = "hmy/andao1",
    name = "暗道",
    ways = {["north"] = "hmy/andao2", ["west"] = "hmy/houdian"}
}
Room {
    id = "hmy/andao2",
    name = "暗道",
    ways = {["south"] = "hmy/andao1", ["east"] = "hmy/andao3"}
}
Room {
    id = "hmy/andao3",
    name = "暗道",
    ways = {["north"] = "hmy/andao4", ["west"] = "hmy/andao2"}
}
Room {
    id = "hmy/andao4",
    name = "暗道",
    ways = {["south"] = "hmy/andao3", ["west"] = "hmy/andao5"}
}
Room {
    id = "hmy/andao5",
    name = "暗道",
    ways = {["east"] = "hmy/andao4", ["northeast"] = "hmy/andao6"}
}
Room {
    id = "hmy/andao6",
    name = "暗道",
    ways = {["southwest"] = "hmy/andao5", ["northwest"] = "hmy/andao7"}
}
Room {
    id = "hmy/andao7",
    name = "暗道",
    ways = {["southeast"] = "hmy/andao6", ["north"] = "hmy/andao8"}
}
Room {
    id = "hmy/andao8",
    name = "暗道",
    ways = {["southeast"] = "hmy/andao7", ["enter"] = "hmy/jail_gate"}
}
Room {
    id = "hmy/baichi",
    name = "三岔口",
...
Room {
    id = "hmy/baihutang",
    name = "白虎堂",
    ways = {["south"] = "hmy/changlang", ["east"] = "hmy/zhuquetang"},
    objs = {["桑三娘"] = "sang sanniang"}
}
Room {
    id = "hmy/baizhang",
    name = "百丈泉",
    ways = {["eastup"] = "hmy/yupingpu", ["south"] = "hmy/qiangu"}
}
Room {
    id = "hmy/cddian",
    name = "成德殿",
...
Room {
    id = "hmy/changtan",
    name = "长滩",
    ways = {["east"] = "hmy/shandao", ["dutan"] = "hmy/xxtan"}
}
Room {
    id = "hmy/chengdedian",
    name = "成德殿",
...
Room {
    id = "hmy/dedao",
    name = "地道",
    ways = {["down"] = "hmy/xhuayuan", ["up"] = "hmy/shiwu"}
}
Room {
    id = "hmy/fengleitang",
    name = "风雷堂",
    ways = {["east"] = "hmy/changlang5", ["north"] = "hmy/changlang"}
}
Room {
    id = "hmy/fleitang",
    name = "风雷堂",
...
Room {
    id = "hmy/guanpu",
    name = "观瀑亭",
    ways = {["northup"] = "hmy/moyun", ["south"] = "hmy/yupingpu"}
}
Room {
    id = "hmy/houdian",
    name = "后殿",
    ways = {["north"] = "hmy/changlang6", ["west"] = "hmy/changlang5"},
    objs = {["周孤桐"] = "zhou gutong", ["吴柏英"] = "wu baiying"}
}
Room {
    id = "hmy/houhuayen",
    name = "后花园",
    ways = {["north"] = "hmy/changlang5", ["west"] = "hmy/shiwu"}
}
Room {
    id = "hmy/jail_gate",
    name = "监狱大门",
...
Room {
    id = "hmy/lgfang",
    name = "练功房",
    ways = {["south"] = "hmy/changlang3"}
}
Room {
    id = "hmy/liangting",
    name = "凉亭",
    ways = {["west"] = "hmy/shidao2"},
    objs = {["向问天"] = "xiang wentian"}
}
Room {
    id = "hmy/lianhua",
    name = "碧血崖",
    ...
    objs = {["野狼"] = "ye lang", ["蜜蜂"] = "mi feng"}
}
Room {
    id = "hmy/meimao",
    name = "眉毛崖",
    ways = {["north"] = "hmy/baichi", ["southdown"] = "hmy/taohua"},
    objs = {["小猴"] = "xiao hou"}
}
Room {
    id = "hmy/midao6",
    name = "地道",
    ways = {["north"] = "hmy/suo", ["west"] = "hmy/suo"}
}
Room {
    id = "hmy/moyun",
    name = "卧云崖",
    ways = {["southdown"] = "hmy/guanpu"}
}
Room {
    id = "hmy/pailou",
    name = "牌楼",
...
Room {
    id = "hmy/pingding/cj1",
    name = "长街",
    ways = {["east"] = "hmy/pingding/cj2", ["west"] = "hmy/pingding/gate1"},
...
Room {
    id = "hmy/pingding/cj4",
    name = "长街",
    ways = {["south"] = "hmy/pingding/cj3", ["north"] = "hmy/pingding/gate2"},
    room_relative = "北门｜长街｜长街长街"
}
Room {
    id = "hmy/pingding/cj5",
    name = "长街",
    ways = {["east"] = "hmy/pingding/dongmen", ["west"] = "hmy/pingding/cj3"},
    room_relative = "长街-----长街-----东门长街"
}
Room {
    id = "hmy/pingding/dongmen",
    name = "东门",
    ways = {["east"] = "hmy/pingding/road6", ["west"] = "hmy/pingding/cj5"}
}
Room {
    id = "hmy/pingding/gate1",
    name = "西门",
    ways = {["east"] = "hmy/pingding/cj1", ["west"] = "hmy/pingding/road3"}
}
Room {
    id = "hmy/pingding/gate2",
    name = "北门",
    ways = {["south"] = "hmy/pingding/cj4", ["north"] = "hmy/pingding/road4"}
}
Room {
...
Room {
    ...
    name = "客店二楼",
    no_fight = true,
    ways = {["out"] = "hmy/pingding/kedian2"}
}
Room {
    id = "hmy/pingding/kefang",
    name = "客房",
    no_fight = true,
    ways = {["south"] = "hmy/pingding/kedian"}
}
Room {
...
Room {
    ...
    name = "土路",
    ways = {["northwest"] = "hmy/shidao", ["southeast"] = "hmy/pingding/road4"},
...
Room {
    ...
    name = "小吃店",
    ways = {["north"] = "hmy/pingding/cj2"}
}
Room {
    id = "hmy/pingding/yaopu",
    name = "药铺",
    ways = {["east"] = "hmy/pingding/cj3"}
}
Room {
    id = "hmy/qiandian",
    name = "前殿",
    ways = {["east"] = "hmy/changlang", ["west"] = "hmy/shibanlu"},
    blocks = {["east"] = {{id = "shi zhe", exp = 1500000}}}
}
Room {
    id = "hmy/qiangu",
    name = "千古石",
    ways = {["north"] = "hmy/baizhang"},
    objs = {["野狼"] = "ye lang"}
}
Room {
    id = "hmy/qlongtang",
    name = "青龙堂",
    ways = {["east"] = "hmy/changlang2"},
    objs = {["上官云"] = "shangguan yun"}
}
Room {
    id = "hmy/qqiudian",
    name = "千秋殿",
    ways = {["east"] = "hmy/changlang3", ["west"] = "hmy/changlang2"},
    objs = {["曲洋"] = "qu yang"}
}
Room {
    id = "hmy/rusheng",
    name = "入胜亭",
    ways = {["north"] = "hmy/wulao"},
    objs = {["小猴"] = "xiao hou"}
}
Room {
    id = "hmy/ryping",
    name = "日月坪",
    ways = {["eastdown"] = "hmy/shimen", ["#hmyUp"] = "hmy/yading"},
    lengths = {
...
Room {
    id = "hmy/shandao",
    name = "山道",
    ways = {["westup"] = "hmy/shandao2", ["west"] = "hmy/changtan"}
}
Room {
    id = "hmy/shandao2",
    name = "山道",
    ways = {["eastdown"] = "hmy/shandao", ["westup"] = "hmy/baichi"}
}
Room {
    id = "hmy/shibanlu",
    name = "石板路",
    ways = {["south"] = "hmy/pailou", ["east"] = "hmy/qiandian"},
    lengths = {
...
Room {
    id = "hmy/shidao",
    name = "石道",
    ways = {["southeast"] = "hmy/pingding/road5", ["north"] = "hmy/shidao2"}
}
Room {
    id = "hmy/shidao2",
    name = "石道",
...
Room {
    id = "hmy/shijie",
    name = "石阶",
    ways = {["eastdown"] = "hmy/baichi", ["westup"] = "hmy/shijie2"}
}
Room {
    id = "hmy/shijie2",
    name = "石阶",
    ways = {["eastdown"] = "hmy/shijie", ["westup"] = "hmy/shimen"}
}
Room {
    id = "hmy/shimen",
    name = "石门",
    ways = {["eastdown"] = "hmy/shijie2", ["#toRyp"] = "hmy/ryping"},
    nolooks = {["#toRyp"] = true, ["westup"] = true},
    lengths = {["#toRyp"] = 50},
    objs = {["贾布"] = "jia bu"}
}
Room {id = "hmy/shiwu", name = "小石屋", ways = {["east"] = "hmy/houhuayen"}}
Room {
    id = "hmy/shufang",
    name = "书房",
    ways = {["north"] = "hmy/changlang3"}
}
Room {id = "hmy/suo", name = "索道", ways = {["westdown"] = "hmy/baichi"}}
Room {
    id = "hmy/taohua",
    name = "桃花川",
    ways = {
...
Room {
    ...
    objs = {["野狼"] = "ye lang", ["小猴"] = "xiao hou"}
}
Room {
    id = "hmy/xhuayuan",
    name = "小花园",
    ways = {["west"] = "hmy/xiaoshe", ["up"] = "hmy/dedao"}
}
Room {
    id = "hmy/xian",
    name = "仙人洞",
    ways = {["westdown"] = "hmy/xianren"}
}
Room {
    id = "hmy/xiangfang",
    name = "厢房",
    no_fight = true,
    ways = {["west"] = "hmy/pailou"}
}
Room {
    id = "hmy/xianren",
    name = "仙人指路",
    ways = {["eastup"] = "hmy/xian", ["westup"] = "hmy/lianhua"},
    objs = {["蝴蝶"] = "hu die"}
}
Room {id = "hmy/xiaoshe", name = "小舍", ways = {["east"] = "hmy/xhuayuan"}}
Room {
    id = "hmy/xiuxishi",
    name = "休息室",
    no_fight = true,
    ways = {["south"] = "hmy/changlang4"}
}
Room {
    id = "hmy/xxtan",
    name = "猩猩滩",
...
Room {
    id = "hmy/yading",
    name = "崖顶",
    ways = {["east"] = "hmy/pailou", ["#hmyDown"] = "hmy/ryping"},
    lengths = {
        ["#hmyDown"] = "if hp.neili_max>4000 then return 10 else return false end"
    },
    objs = {["护法使者"] = "shi zhe"}
}
Room {id = "hmy/yiping", name = "一品崖", ways = {["south"] = "hmy/wulao"}}
Room {
    id = "hmy/yiting",
    name = "议事厅",
    ways = {["west"] = "hmy/changlang6"}
}
Room {
    id = "hmy/yupingpu",
    name = "玉屏瀑",
...
Room {
    id = "hmy/zhuquetang",
    name = "朱雀堂",
    ways = {["east"] = "hmy/cddian", ["west"] = "hmy/baihutang"},
    objs = {["鲍大楚"] = "bao dachu"}
}
Room {
    id = "hmy/zisi",
    name = "紫石崖",
    ways = {["eastdown"] = "hmy/taohua"},
    objs = {["蜜蜂"] = "mi feng"}
}
Room {
    id = "hmy/ziyun",
    name = "紫云崖",
    ways = {["east"] = "hmy/taohua", ["west"] = "hmy/wulao"}
}
Room {
    id = "huanghe/bingcao",
    name = "冰草湾",
...
Room {
    id = "huanghe/caodi1",
    name = "草地",
    ways = {["south"] = "city/hsroad1", ["west"] = "huanghe/caodi2"},
    room_relative = "草地-----草地｜北门外草地"
}
Room {
    id = "huanghe/caodi2",
    name = "草地",
    ways = {["east"] = "huanghe/caodi1", ["west"] = "huanghe/shulin1"},
    objs = {["石块"] = "shi kuai"},
...
Room {
    ...
    name = "采石场",
    no_fight = true,
    ways = {["northup"] = "huanghe/hhgate"},
    objs = {["李公公"] = "li gonggong"}
}
Room {
    id = "huanghe/daba",
    name = "黄河大堤",
    no_fight = true,
    ways = {["southdown"] = "huanghe/huanghe7"}
}
Room {
    id = "huanghe/dacaigou",
    name = "打柴沟",
    ways = {["southwest"] = "huanghe/gulang", ["north"] = "huanghe/wuqiao"}
}
Room {
    id = "huanghe/fendi",
    name = "墓地",
    no_fight = true,
    ways = {["south"] = "huanghe/shulin6"},
    objs = {["胡斐"] = "hu fei"}
}
Room {
    id = "huanghe/gchang",
    name = "广场",
    ways = {["east"] = "huanghe/hhgate", ["west"] = "huanghe/xyting"},
    objs = {["钱青健"] = "qian qingjian", ["吴青烈"] = "wu qinglie"}
}
Room {
...
Room {
    id = "huanghe/hetao",
    name = "河套",
    ways = {["south"] = "huanghe/weifen", ["northwest"] = "huanghe/huanghe_1"}
}
Room {
    id = "huanghe/hhgate",
    name = "黄河帮寨门",
    ...
    objs = {["沈青刚"] = "shen qinggang", ["马青雄"] = "ma qingxiong"}
}
Room {
    id = "huanghe/hongshanxia",
    name = "红山峡",
    ways = {["south"] = "huanghe/jingyuan", ["north"] = "huanghe/shimen"}
}
Room {
    id = "huanghe/huanghe1",
    name = "黄河岸边",
    ...
    objs = {["侯通海"] = "hou tonghai"},
    room_relative = "渭汾流域｜黄河帮寨门---黄河岸边---黄河岸边｜田地黄河岸边"
}
Room {
    id = "huanghe/huanghe2",
    name = "黄河岸边",
    ways = {["east"] = "huanghe/huanghe3", ["west"] = "huanghe/huanghe1"},
    room_relative = "黄河岸边---黄河岸边---黄河岸边黄河岸边"
}
Room {
    id = "huanghe/huanghe3",
    name = "黄河岸边",
    ways = {["east"] = "huanghe/huanghe4", ["west"] = "huanghe/huanghe2"},
    objs = {["大汉"] = "da han"},
    room_relative = "黄河岸边---黄河岸边---黄河岸边黄河岸边"
}
Room {
    id = "huanghe/huanghe4",
    name = "黄河岸边",
    ways = {["northeast"] = "huanghe/huanghe5", ["west"] = "huanghe/huanghe3"},
    room_relative = "黄河岸边↗黄河岸边---黄河岸边黄河岸边"
}
Room {
    id = "huanghe/huanghe5",
...
Room {
    ...
    objs = {["林玉龙"] = "lin yulong", ["任飞燕"] = "ren feiyan"},
    room_relative = "黄河岸边↗黄河岸边↙黄河岸边黄河岸边"
}
Room {
    id = "huanghe/huanghe7",
...
Room {
    id = "huanghe/huanghe8",
    name = "黄河入海口",
    ways = {["southwest"] = "huanghe/huanghe7", ["north"] = "huanghe/road2"}
}
Room {
    id = "huanghe/huanghe_1",
    name = "黄河",
    ways = {["southeast"] = "huanghe/hetao", ["northwest"] = "huanghe/huangtu"}
}
Room {
    id = "huanghe/huanghe_2",
    name = "黄河",
    ways = {["northeast"] = "huanghe/huangtu", ["west"] = "huanghe/huanghe_3"}
}
Room {
    id = "huanghe/huanghe_3",
    name = "黄河",
    ways = {["east"] = "huanghe/huanghe_2"}
}
Room {
    id = "huanghe/huangtu",
    name = "黄土高原",
...
Room {
    id = "huanghe/jingyuan",
    name = "靖远",
    ways = {["south"] = "huanghe/shamo", ["north"] = "huanghe/hongshanxia"}
}
Room {
    id = "huanghe/kedian",
    name = "客店",
    no_fight = true,
    ways = {["up"] = "huanghe/kedian2"}
}
Room {
    id = "huanghe/kedian2",
    name = "客店二楼",
    ways = {["enter"] = "huanghe/kedian3", ["down"] = "huanghe/kedian"}
}
Room {
    id = "huanghe/kedian3",
    name = "客店二楼",
    no_fight = true,
    ways = {["out"] = "huanghe/kedian2"}
}
Room {
    id = "huanghe/road2",
    name = "大渡口",
    ...
    nolooks = {["enter"] = true, ["#duHhe"] = true, ["#ptoSld"] = true},
    lengths = {
        ["#duHhe"] = 10000,
...
Room {
    id = "huanghe/road3",
    name = "大渡口",
    ways = {["north"] = "cangzhou/sroad4", ["#duHhe"] = "huanghe/road2"},
    lengths = {["#duHhe"] = 10000},
    nolooks = {["enter"] = true, ["#duHhe"] = true}
}
Room {
...
Room {
    ...
    objs = {["大黄牛"] = "da huangniu"},
    room_relative = "田地-----田地↙树林田地"
}
Room {
    id = "huanghe/tiandi3",
    name = "田地",
    ways = {["northeast"] = "huanghe/tiandi4", ["west"] = "huanghe/tiandi1"},
...
Room {
    id = "huanghe/wufosi",
    name = "五佛寺",
    ways = {["south"] = "huanghe/shimen"}
}
Room {
    id = "huanghe/wuqiao",
    name = "乌鞘岭",
    ways = {["south"] = "huanghe/dacaigou", ["northwest"] = "huanghe/wuwei"}
}
Room {
    id = "huanghe/wuwei",
    name = "武威",
    ways = {["southeast"] = "huanghe/wuqiao", ["north"] = "huanghe/tumenzi"}
}
Room {
    id = "huanghe/xiaojiaqiao",
    name = "萧家桥",
    ways = {["east"] = "huanghe/gulang"}
}
Room {
    id = "huanghe/xyting",
    name = "侠义厅",
    ways = {["east"] = "huanghe/gchang"},
    objs = {
        ["彭连虎"] = "peng lianhu",
        ["梁子翁"] = "liang ziweng",
        ["沙通天"] = "sha tongtian"
...
Room {
    ...
    name = "后山",
    ways = {["south"] = "huanghe/yyd/houyuan"}
}
Room {
    id = "huanghe/yyd/houyuan",
    name = "后院",
    ways = {["south"] = "huanghe/yyd/dating"}
}
Room {
    id = "huanghe/yyd/shufang",
    name = "书房",
    ways = {["west"] = "huanghe/yyd/dating"}
}
Room {
    id = "huashan/baichi",
    name = "百尺峡",
    ways = {["eastup"] = "huashan/laojun", ["northdown"] = "huashan/qianchi"}
}
Room {
    id = "huashan/canglong",
    name = "苍龙岭",
    ways = {
        ...
        ["north;southdown"] = "huashan/zhenyue"
    },
    objs = {["猴子"] = "hou zi"}
}
Room {
    id = "huashan/cave",
    name = "密洞",
    ways = {["right"] = "huashan/rukou"}
}
Room {
    id = "huashan/celang1",
    name = "侧廊",
    ways = {["east"] = "huashan/qianting", ["west"] = "huashan/lianwu1"},
    room_relative = "练武场-----侧廊-----前厅侧廊"
}
Room {
    id = "huashan/celang2",
    name = "侧廊",
    ways = {["east"] = "huashan/lianwu2", ["west"] = "huashan/qianting"},
...
Room {
    ...
    objs = {["清水葫芦"] = "qingshui hulu"}
}
Room {
    id = "huashan/hole",
    name = "思过崖洞口",
    ways = {["out"] = "huashan/siguoya"}
}
Room {id = "huashan/hole2", name = "石洞", ways = {["out"] = "huashan/song"}}
Room {
    id = "huashan/houshan",
    name = "后山",
    ways = {["northdown"] = "huashan/midong"}
}
Room {
    id = "huashan/houtang",
    name = "后堂",
...
Room {
    id = "huashan/husun",
    name = "猢狲愁",
    ways = {["southup"] = "huashan/canglong", ["northdown"] = "huashan/laojun"},
    objs = {["猴子"] = "hou zi"}
}
Room {
    id = "huashan/jiabi",
    name = "夹山壁",
    ways = {["west"] = "huashan/shiwu1", ["out"] = "huashan/siguoya"}
}
Room {
    id = "huashan/jinshe/biding",
    name = "壁顶",
    ways = {["down"] = "huashan/husun"}
}
Room {
    id = "huashan/jitan",
    name = "祭坛",
    ways = {["out"] = "huashan/yunuci"},
    objs = {["岳灵珊"] = "yue lingshan"}
}
Room {
    id = "huashan/kongdi",
    name = "空地",
    ways = {["north"] = "huashan/shulin1", ["southdown"] = "huashan/v-road-1"},
    room_relative = '松树林｜空地↑山涧空地'
}
Room {
    id = "huashan/laojun",
    name = "老君沟",
    ways = {["southup"] = "huashan/husun", ["westdown"] = "huashan/baichi"},
    objs = {["猴子"] = "hou zi"}
}
Room {
    id = "huashan/lianwu1",
    name = "练武场",
    ways = {["south"] = "huashan/yaofang", ["east"] = "huashan/celang1"},
...
Room {
    id = "huashan/lianwu2",
    name = "练武场",
    ways = {["south"] = "huashan/wuqiku", ["west"] = "huashan/celang2"},
...
Room {
    id = "huashan/maowu",
    name = "茅屋",
    ways = {["southeast"] = "huashan/v-road-1"}
}
Room {
    id = "huashan/midao",
    name = "密道",
    ways = {["south"] = "huashan/midong", ["left"] = "huashan/rukou"}
}
Room {
    id = "huashan/midong",
    name = "秘洞",
...
Room {
    ...
    nolooks = {["tiao tan;#walkBusy"] = true},
    lengths = {["tiao tan;#walkBusy"] = 20},
    objs = {["青蛙"] = "qing wa"}
}
Room {
    id = "huashan/shuitan",
    name = "瀑布底",
    ways = {["qian up"] = "huashan/pubu"},
    nolooks = {["qian up"] = true},
    objs = {["鳄鱼"] = "e yu"}
}
Room {
    id = "huashan/qianchi",
    name = "千尺幢",
    ways = {["southup"] = "huashan/baichi", ["westdown"] = "huashan/qingke"}
}
Room {
    id = "huashan/qianting",
    name = "前厅",
...
Room {
    id = "huashan/qingke",
    name = "青柯坪",
    ways = {["eastup"] = "huashan/qianchi", ["northdown"] = "huashan/shaluo"}
}
Room {
    id = "huashan/qinshi",
    name = "寝室",
    ways = {["north"] = "huashan/houtang"},
    objs = {["绳子"] = "sheng zi"}
}
Room {id = "huashan/rukou", name = "山洞"}
Room {
    id = "huashan/shaluo",
    name = "莎萝坪",
    ways = {
...
Room {
    id = "huashan/shanhong",
    name = "山洪瀑布",
    ways = {["southwest"] = "huashan/shaluo"}
}
Room {
    id = "huashan/shanlu1",
    name = "山路",
    ways = {["southeast"] = "huashan/shanlu2", ["north"] = "huashan/yunu"},
    objs = {["猴子"] = "hou zi"}
}
Room {
    id = "huashan/shanlu2",
...
Room {
    id = "huashan/sheshen",
    name = "舍身崖",
    ways = {["eastdown"] = "huashan/canglong"}
}
Room {
    id = "huashan/shiwu",
    name = "石屋",
    ways = {["west"] = "huashan/shulin4"},
    objs = {["穆人清"] = "mu renqing"}
}
Room {
    id = "huashan/shiwu1",
    name = "石屋",
    ways = {["east"] = "huashan/jiabi"}
}
Room {
    id = "huashan/shulin",
    name = "树林",
...
Room {
    id = "huashan/shulinn",
    name = "松树林",
    ways = {["west"] = "huashan/shulinn1"}
}
Room {
    id = "huashan/shulinn1",
    name = "松树林",
    ways = {["west"] = "huashan/shulinn2"}
}
Room {
    id = "huashan/shulinn2",
    name = "松树林",
    ways = {["west"] = "huashan/shulinn3"}
}
Room {
    id = "huashan/shulinn3",
    name = "松树林",
    ways = {["west"] = "huashan/shulinn4"}
}
Room {
    id = "huashan/shulinn4",
    name = "松树林",
    ways = {["west"] = "huashan/shulinn5"}
}
Room {
    id = "huashan/shulinn5",
    name = "松树林",
    ways = {["west"] = "huashan/shulinn6"}
}
Room {
    id = "huashan/shulinn6",
    name = "松树林",
    ways = {["west"] = "huashan/shulinn7"}
}
Room {
    id = "huashan/shulinn7",
    name = "松树林",
    ways = {["west"] = "huashan/shulinn8"}
}
Room {
    id = "huashan/shulinn8",
    name = "松树林",
    ways = {["west"] = "huashan/shulinn9"}
}
Room {
    id = "huashan/shulinn9",
    name = "松树林",
    ways = {["west"] = "huashan/shulinnn"}
}
Room {
    id = "huashan/shulinnn",
    name = "松树林",
    ways = {["#hsssl"] = "huashan/shiwu"},
    nolooks = {
        ["#hsssl"] = true,
        ["south"] = true,
        ["east"] = true,
...
Room {
    id = "huashan/shuyuan",
    name = "书院",
    ways = {["north"] = "huashan/wuqiku", ["west"] = "huashan/celang4"},
    objs = {["正气诀要"] = "shu"}
}
Room {
    id = "huashan/siguoya",
    ...
    nolooks = {["#Fqy"] = true, ["enter"] = true},
    objs = {["令狐冲"] = "linghu chong"},
    lengths = {
...
Room {
    ...
    name = "夹山壁",
    ways = {["out"] = "huashan/siguoya"},
    objs = {["风清扬"] = "feng qingyang"}
}
Room {
    id = "huashan/taijie",
    name = "台阶",
    ways = {["southup"] = "huashan/qianting", ["northdown"] = "huashan/shanlu2"},
    objs = {["梁发"] = "liang fa"}
    --[[lengths = {
...
Room {
    id = "huashan/shentan",
    name = "山涧",
    ways = {["northeast"] = "huashan/v-road-1"},
...
Room {
    ...
    nolooks = {["bo guanmu"] = true},
    room_relative = "山涧↗山涧↙↘山涧山涧山涧"
}
Room {
    id = "huashan/v-road-2",
    name = "山涧",
    ways = {["eastup"] = "huashan/v-road-3", ["southwest"] = "huashan/v-road-1"},
...
Room {
    ...
    nolooks = {["bang shengzi;pa up"] = true},
    lengths = {
...
Room {
    id = "huashan/song",
    name = "万年松",
    ways = {["enter"] = "huashan/hole2", ["down"] = "huashan/v-road-5"}
}
Room {
    id = "huashan/wuqiku",
    name = "剑房",
    ways = {["south"] = "huashan/shuyuan", ["north"] = "huashan/lianwu2"}
}
Room {
    id = "huashan/xiaolu1",
    name = "小山路",
    ways = {["southeast"] = "huashan/yunu", ["northwest"] = "huashan/xiaolu2"},
    room_relative = "小山路↖小山路↘玉女峰小山路"
}
Room {
    id = "huashan/xiaolu2",
    name = "小山路",
    ways = {["southeast"] = "huashan/xiaolu1", ["westup"] = "huashan/siguoya"},
    room_relative = "思过崖←小山路↘小山路小山路"
}
Room {
    id = "huashan/xiaoxi",
    name = "小溪",
    ways = {["northeast"] = "huashan/shanlu2"}
}
Room {
    id = "huashan/xiuxi1",
    name = "女休息室",
    no_fight = true,
    ways = {["north"] = "huashan/celang3"}
}
Room {
    id = "huashan/xiuxi2",
    name = "男休息室",
    no_fight = true,
    ways = {["north"] = "huashan/celang4"}
}
Room {
    id = "huashan/yaofang",
    name = "药房",
    ways = {["south"] = "huashan/fanting", ["north"] = "huashan/lianwu1"},
    lengths = {
...
Room {
    id = "huashan/yunuci",
    name = "玉女祠",
    ways = {["enter"] = "huashan/jitan", ["west"] = "huashan/yunu"}
}
Room {
    id = "huashan/yuquan",
    name = "玉泉院",
    ways = {["south"] = "huashan/path1"},
    objs = {["李铁嘴"] = "li tiezui"}
}
Room {
    id = "huashan/zhengqi",
    name = "正气堂",
    ways = {["south"] = "huashan/houtang", ["north"] = "huashan/qianting"},
    objs = {["岳不群"] = "yue buqun", ["宁中则"] = "ning zhongze"}
}
Room {
    id = "huashan/zhenyue",
    name = "镇岳宫",
...
Room {
    id = "hz/baoshuta",
    name = "宝淑塔",
    ways = {["northdown"] = "hz/shanlu", ["southdown"] = "hz/qsddao1"}
}
Room {
    id = "hz/beimen",
    name = "北门",
    ways = {["south"] = "hz/qsddao6", ["north"] = "group/entry/hzqsd7"}
}
Room {
    id = "hz/changlang1",
    name = "长廊",
...
Room {
    ...
    name = "翠合斋",
    no_fight = true,
    ways = {["west"] = "hz/qsddao4"},
    objs = {["张算盘"] = "zhang suanpan"}
}
Room {
    id = "hz/duanqiao",
    name = "断桥残雪",
    ways = {["southeast"] = "hz/baidi"}
}
Room {
    id = "hz/dxbdian",
    name = "大雄宝殿",
    ways = {["south"] = "hz/tianwang"}
}
Room {
    id = "hz/fangheting",
    name = "放鹤亭",
    ways = {["south"] = "hz/gushan"}
}
Room {
    id = "hz/feilaifeng",
    name = "飞来峰",
    ways = {["southeast"] = "hz/yxsdong", ["west"] = "hz/qsddao3"},
    objs = {["归辛树"] = "gui xinshu", ["归二娘"] = "gui erniang"}
}
Room {
    id = "hz/gushan",
    name = "孤山",
...
Room {id = "hz/hongyuchi", name = "红鱼池", ways = {["west"] = "hz/hggyu"}}
Room {
    id = "hz/huanglong",
    name = "黄龙洞",
    ways = {["southeast"] = "hz/shuichi", ["southdown"] = "hz/shanlu"}
}
Room {
    id = "hz/hubian",
    name = "西湖边",
    ways = {["southwest"] = "hz/baidi", ["south"] = "hz/llwying"},
...
Room {
    id = "hz/hubian3",
    name = "西湖边",
    ways = {["northwest"] = "hz/baidi", ["east"] = "hz/yuemiao"},
    room_relative = "白堤↖西湖边----岳王庙西湖边",
    objs = {["欧阳克"] = "ouyang ke", ["白衣少女"] = "shao nv"}
}
Room {
    id = "hz/hupao",
    name = "虎跑",
...
Room {
    id = "hz/huxinting",
    name = "湖心亭",
    ways = {["east"] = "hz/santan", ["west"] = "hz/ruangong"}
}
Room {
    id = "hz/jingcisi",
    name = "净慈寺",
    ways = {["southeast"] = "hz/yuhuang", ["northwest"] = "hz/hubian1"}
}
Room {
    id = "hz/jingzhong",
    name = "精忠柏",
    ways = {["south"] = "hz/mu", ["west"] = "hz/yuanmen"}
}
Room {
    id = "hz/jinhuazhai",
    name = "金华斋",
    ways = {["east"] = "hz/qsddao4"},
    objs = {["崔算盘"] = "cui suanpan"}
}
Room {id = "hz/jiulou", name = "天香楼", ways = {["east"] = "hz/qsddao6"}}
Room {
    id = "hz/juquqiao",
    name = "九曲桥",
    ways = {["south"] = "hz/santan", ["north"] = "hz/xiaoying"}
}
Room {
    id = "hz/kedian2",
    name = "客店二楼",
    ways = {["enter"] = "hz/kedian3", ["down"] = "hz/tianxiang"}
}
Room {
    id = "hz/kedian3",
    name = "客店二楼",
...
Room {
    id = "hz/leifengta",
    name = "雷峰塔",
    ways = {["westdown"] = "hz/shanlu"}
}
Room {
    id = "hz/lingyinsi",
    name = "灵隐寺",
    ways = {["east"] = "hz/qsddao3", ["west"] = "hz/tianwang"}
}
Room {
    id = "hz/liulin",
    name = "柳林",
...
Room {
    id = "hz/llwying",
    name = "柳浪闻莺",
    ways = {["south"] = "hz/hubian1", ["north"] = "hz/hubian"}
}
Room {
    id = "hz/longjing",
    name = "龙井",
    ways = {["southeast"] = "hz/hupao", ["northwest"] = "hz/yxsdong2"}
}
Room {id = "hz/majiu", name = "马厩", ways = {["west"] = "hz/tianxiang"}}
Room {id = "hz/maoshe", name = "没做好", ways = {["out"] = "hz/shanquan"}}
Room {id = "hz/mu", name = "岳飞墓", ways = {["north"] = "hz/jingzhong"}}
Room {id = "hz/mudanyuan", name = "牡丹园", ways = {["east"] = "hz/hggyu"}}
Room {id = "hz/pinghu", name = "平湖秋月", ways = {["east"] = "hz/baidi"}}
Room {
    id = "hz/qsddao1",
    name = "青石大道",
    ways = {["northup"] = "hz/baoshuta", ["south"] = "hz/baidi"},
...
Room {id = "hz/quanwu", name = "泉屋", ways = {["south"] = "hz/yuquan"}}
Room {
    id = "hz/quyuan",
    name = "曲园风荷",
    ways = {["southeast"] = "hz/kuahong", ["east"] = "hz/yingxunge"}
}
Room {
    id = "hz/ruangong",
    name = "阮公墩",
    ways = {["east"] = "hz/huxinting"}
}
Room {
    id = "hz/santan",
    name = "三潭映月",
    ways = {["north"] = "hz/juquqiao", ["west"] = "hz/huxinting"}
}
Room {
    id = "hz/shanlu",
    name = "山路",
...
Room {
    id = "hz/shanlu2",
    name = "山路",
    ways = {["eastdown"] = "ningbo/qsddao1", ["northdown"] = "hz/zilaidong"},
...
Room {
    id = "hz/shuichi",
    name = "水池",
    ways = {["northwest"] = "hz/huanglong", ["west"] = "hz/xiaozhu"}
}
Room {id = "hz/shuyuan", name = "书院", ways = {["west"] = "hz/qsddao6"}}
Room {
    id = "hz/sudi",
    name = "苏堤",
    ways = {
...
Room {
    id = "hz/tianwang",
    name = "天王殿",
    ways = {["east"] = "hz/lingyinsi", ["north"] = "hz/dxbdian"}
}
Room {
    id = "hz/tianxiang",
    name = "鸿昌客栈",
...
Room {id = "hz/wenlange", name = "文澜阁", ways = {["north"] = "hz/gushan"}}
Room {
    id = "hz/xiaoying",
    name = "小赢洲",
    ways = {["south"] = "hz/juquqiao"}
}
Room {
    id = "hz/xiaozhu",
    name = "小筑",
    ways = {["southwest"] = "hz/changlang1", ["east"] = "hz/shuichi"}
}
Room {id = "hz/xilengqiao", name = "西冷桥", ways = {["east"] = "hz/gushan"}}
Room {id = "hz/yaopu", name = "万年春", ways = {["west"] = "hz/qsddao5"}}
Room {
    id = "hz/yingboqiao",
    name = "映波桥",
    ways = {["south"] = "hz/kuahong", ["east"] = "hz/sudi"}
}
Room {id = "hz/yingxunge", name = "迎熏阁", ways = {["west"] = "hz/quyuan"}}
Room {
    id = "hz/yuanmen",
    name = "园门",
    ways = {["east"] = "hz/jingzhong", ["out"] = "hz/yuemiao"}
}
Room {
    id = "hz/yuemiao",
    name = "岳王庙",
...
Room {
    id = "hz/yuquan",
    name = "玉泉",
    ways = {["north"] = "hz/quanwu", ["east"] = "hz/qsddao2"}
}
Room {
    id = "hz/yxsdong",
    name = "石屋洞",
    ways = {["southeast"] = "hz/yxsdong1", ["northwest"] = "hz/feilaifeng"}
}
Room {
    id = "hz/yxsdong1",
    name = "水乐洞",
    ways = {["northwest"] = "hz/yxsdong", ["west"] = "hz/yxsdong2"}
}
Room {
    id = "hz/yxsdong2",
    name = "烟霞洞",
    ways = {["southeast"] = "hz/longjing", ["east"] = "hz/yxsdong1"}
}
Room {
    id = "hz/zahuopu",
    name = "杂货铺",
    ways = {["east"] = "hz/qsddao5"},
    objs = {["李老板"] = "li laoban"}
}
Room {
    id = "hz/zilaidong",
    name = "紫来洞",
    ways = {["southup"] = "hz/shanlu2", ["north"] = "hz/yuhuang"}
}

Room {
    id = "jiaxing/road2",
    name = "青石官道",
    ways = {["southeast"] = "jiaxing/road1", ["northwest"] = "suzhou/qsgdao2"}
}
Room {
    id = "jiaxing/road1",
    name = "青石官道",
    ways = {["southeast"] = "jiaxing/beimen", ["northwest"] = "jiaxing/road2"},
    room_relative = "青石官道↖青石官道↘北门青石官道"
}
Room {
    id = "jiaxing/beimen",
    name = "北门",
    ways = {["south"] = "jiaxing/jiaxing", ["northwest"] = "jiaxing/road1"}
}
Room {
    id = "jiaxing/beijie",
    name = "北街",
    ways = {["north"] = "jiaxing/beimen", ["south"] = "jiaxing/jiaxing"}
}
Room {
    id = "jiaxing/jiaxing",
    name = "市集",
...
Room {
    id = "jiaxing/dongjie",
    name = "东街",
    ways = {["west"] = "jiaxing/jiaxing", ["east"] = "jiaxing/dbianmen"}
}
Room {
    id = "jiaxing/dbianmen",
    name = "东边门",
...
Room {
    id = "jiaxing/nanhu1",
    name = "南湖",
    ways = {["south"] = "jiaxing/jxyanyu", ["northwest"] = "jiaxing/nanhu"}
}
Room {
    id = "jiaxing/yanyu",
    name = "烟雨楼",
    ways = {["down"] = "jiaxing/jxyanyu"}
}
Room {
    id = "jiaxing/jxyanyu",
    name = "烟雨楼",
    outdoor = "嘉兴城",
    ways = {["north"] = "jiaxing/nanhu1"},
    objs = {["杨康"] = "yang kang"}
}
Room {
    id = "jiaxing/hubian",
    name = "湖边",
    ways = {["west"] = "jiaxing/nanhu"}
}
Room {
    id = "jiaxing/zahuopu",
    name = "杂货铺",
    ways = {["south"] = "jiaxing/dbianmen"}
}
Room {
    id = "jiaxing/xijie1",
    name = "西街",
    ways = {["east"] = "jiaxing/jiaxing", ["west"] = "jiaxing/xijie2"}
}
Room {
    id = "jiaxing/xijie2",
    name = "西街",
...
Room {
    id = "jiaxing/kedian2",
    name = "客店二楼",
    ways = {["down"] = "jiaxing/kedian", ["enter"] = "jiaxing/kefang"}
}
Room {
    id = "jiaxing/kefang",
    name = "客房",
    ways = {["out"] = "jiaxing/xijie2"}
}
Room {
    id = "jiaxing/ximen",
    name = "西门",
    ways = {["east"] = "jiaxing/xijie2"}
}
Room {
...
Room {
    ...
    name = "小巷",
    ways = {["west"] = "jiaxing/xiaoxiang1", ["east"] = "jiaxing/nanjie"}
}
Room {
    id = "jiaxing/jiuyuan",
    name = "旧园",
    ways = {["north"] = "jiaxing/xiaoxiang1"}
}
Room {
    id = "jiaxing/nanjie",
    name = "南街",
...
Room {
    id = "jiaxing/tieqiang",
    name = "铁枪庙",
    ways = {["west"] = "jiaxing/jxnanmen", ["north"] = "jiaxing/dbianmen"},
    objs = {["李莫愁"] = "li mochou", ["乌鸦"] = "wu ya"}
}
Room {
...
Room {
    id = "jiaxing/lumu",
    name = "坟墓",
    ways = {["west"] = "jiaxing/shulin1"},
    objs = {["武三通"] = "wu santong"}
}
Room {
    id = "jiaxing/luzhuang",
    name = "陆家庄",
    ways = {["north"] = "jiaxing/shulin1", ["west"] = "jiaxing/tianjing"}
}
Room {
    id = "jiaxing/tianjing",
    name = "天井",
    ways = {["east"] = "jiaxing/luzhuang", ["west"] = "jiaxing/dating"},
    objs = {["阿根"] = "pu ren"}
}
Room {
    id = "jiaxing/dating",
    name = "大厅",
    ways = {["south"] = "jiaxing/houyuan", ["east"] = "jiaxing/tianjing"},
    objs = {["陆立鼎"] = "lu liding"}
}
Room {
    id = "jiaxing/houyuan",
    name = "後院",
    ways = {["north"] = "jiaxing/dating"}
}

Room {
    id = "kunlun/bainiushan",
    name = "白牛山",
    ways = {["southwest"] = "kunlun/fufengshan"}
}
Room {
    id = "kunlun/bayankala",
    name = "巴颜喀拉山",
    ways = {["northdown"] = "kunlun/shanlu2", ["west"] = "kunlun/kekexili"},
    objs = {["大石头"] = "da shitou"}
}
Room {
    id = "kunlun/chufang",
    name = "厨房",
    no_fight = true,
    ways = {["west"] = "kunlun/shilu2"}
}
Room {
    id = "kunlun/conglinggu",
    name = "葱岭谷",
    ways = {["out"] = "kunlun/shanlinn5"},
    objs = {["冬虫草"] = "dongchong cao", ["黄芪"] = "huang qi"}
}
Room {
    id = "kunlun/elang01",
    name = "东走廊",
    ways = {["east"] = "kunlun/keting1", ["west"] = "kunlun/qianting"}
}
Room {
    ...
    precmds = {["enter"] = "open door"}
}
Room {
    id = "kunlun/gate",
    name = "后院门",
    ways = {["east"] = "kunlun/shilu2", ["west"] = "kunlun/lang"},
    lengths = {
...
Room {
    ...
    objs = {["高则成"] = "gao zecheng"}
}
Room {
    id = "kunlun/guangchange",
    name = "广场东",
    ways = {["northwest"] = "kunlun/shanlu04", ["west"] = "kunlun/guangchang"},
    objs = {["玉灵子"] = "yuling zi"}
}
Room {
    id = "kunlun/guangchangw",
    name = "广场西",
    ways = {["east"] = "kunlun/guangchang", ["northeast"] = "kunlun/shanlu04"}
}
Room {
    id = "kunlun/houyuan",
    name = "后院",
...
Room {
    ...
    name = "惊神峰",
    ways = {["south"] = "kunlun/sanshengao"},
    objs = {["何足道"] = "he zudao"}
}
Room {
    id = "kunlun/jingxiushi",
    name = "静修室",
    ways = {["south"] = "kunlun/shiqiao", ["east"] = "kunlun/shilu1"}
}
Room {
    id = "kunlun/jiuqulang1",
    name = "九曲廊",
    ways = {["southwest"] = "kunlun/tieqinju", ["east"] = "kunlun/shiqiao"}
}
Room {
...
Room {
    id = "kunlun/kekexili",
    name = "可可西里山",
    ways = {["northwest"] = "kunlun/shankou", ["east"] = "kunlun/bayankala"}
}
Room {
    id = "kunlun/keting1",
    name = "客厅",
    ways = {["west"] = "kunlun/elang01"}
}
Room {
    id = "kunlun/keting2",
    name = "客厅",
    no_fight = true,
    ways = {["east"] = "kunlun/wlang01"}
}
Room {
    id = "kunlun/klshanlu",
    name = "昆仑山麓",
...
Room {
    id = "kunlun/kuhanlou1",
    name = "苦寒楼一层",
    ways = {["out"] = "kunlun/shanlinn", ["up"] = "kunlun/kuhanlou2"}
}
Room {
    id = "kunlun/kuhanlou2",
    name = "苦寒楼二层",
    ways = {["down"] = "kunlun/kuhanlou1", ["up"] = "kunlun/kuhanlou3"}
}
Room {
    id = "kunlun/kuhanlou3",
    name = "苦寒楼三层",
    ways = {["down"] = "kunlun/kuhanlou2"}
}
Room {
    id = "kunlun/lang",
    name = "走廊",
...
Room {
    id = "kunlun/liangong",
    name = "练功房",
    ways = {["west"] = "kunlun/lang2"}
}
Room {
    id = "kunlun/pingfeng",
    name = "石屏风",
    ways = {["south"] = "kunlun/qianting", ["north"] = "kunlun/guangchang"}
}
Room {
    id = "kunlun/qianting",
    name = "前厅",
...
Room {
    ...
    name = "三圣坳",
    ways = {["north"] = "kunlun/jingshenfeng", ["down"] = "kunlun/fufengshan"}
}
Room {
    id = "kunlun/sanshengtang",
    name = "三圣堂",
    ways = {["southwest"] = "kunlun/jiuqulang2", ["north"] = "kunlun/lang1"},
    objs = {["班淑娴"] = "ban shuxian", ["杏芳"] = "xing fang"}
}
Room {
    id = "kunlun/shankou",
    name = "昆仑山垭口",
    ways = {["southeast"] = "kunlun/kekexili", ["west"] = "kunlun/klshanlu"}
}
--[[Room {
	id = "kunlun/shanlinn",
	name = "云杉林",
...
Room {
    id = "kunlun/shanlinn3",
    name = "云杉林",
    ways = {["east"] = "kunlun/shanlinn", ["north"] = "kunlun/houyuan"},
    room_relative = "后院｜云杉林----云杉林----云杉林｜云杉林云杉林"
}
Room {
    id = "kunlun/shanlinn2",
    name = "云杉林",
    ways = {["east"] = "kunlun/shanlinn4"}
}
Room {
    id = "kunlun/shanlinn4",
    name = "云杉林",
    ways = {["south"] = "kunlun/shanlinn5"}
}
Room {
    id = "kunlun/shanlinn5",
    name = "云杉林",
    ways = {["west"] = "kunlun/shanlinn6", ["south"] = "kunlun/conglinggu"},
    room_relative = "云杉林｜云杉林----云杉林----云杉林｜葱岭谷云杉林"
}
Room {
    id = "kunlun/shanlinn6",
    name = "云杉林",
    ways = {["east"] = "kunlun/kuhanlou1"},
    room_relative = "云杉林｜云杉林----云杉林----苦寒楼一层｜云杉林云杉林"
}
Room {
    id = "kunlun/shanlu",
    name = "西域山路",
    ways = {["east"] = "kunlun/zhenyuanqiao", ["west"] = "kunlun/shanlu1"}
}
Room {
    id = "kunlun/shanlu01",
    name = "山路",
    ways = {["southup"] = "kunlun/shanlu02", ["westdown"] = "kunlun/shanmen"}
}
Room {
    id = "kunlun/shanlu02",
    name = "山路",
    ways = {["southup"] = "kunlun/shanlu03", ["northdown"] = "kunlun/shanlu01"}
}
Room {
    id = "kunlun/shanlu03",
    name = "山路",
    ways = {["southup"] = "kunlun/shanlu04", ["northdown"] = "kunlun/shanlu02"}
}
Room {
    id = "kunlun/shanlu04",
    name = "山路",
...
Room {
    id = "kunlun/shanlu1",
    name = "西域山路",
    ways = {["westup"] = "kunlun/shanlu2", ["east"] = "kunlun/shanlu"}
}
Room {
    id = "kunlun/shanlu2",
    name = "西域山路",
    ways = {["southup"] = "kunlun/bayankala", ["eastdown"] = "kunlun/shanlu1"}
}
Room {
    id = "kunlun/shanmen",
    name = "昆仑派山门",
    ways = {["eastup"] = "kunlun/shanlu01", ["southdown"] = "kunlun/klshanlu"},
    objs = {["蒋涛"] = "jiang tao"}
}
Room {
    id = "kunlun/shilu1",
...
Room {
    id = "kunlun/shufang",
    name = "书房",
    ways = {["south"] = "kunlun/lang", ["west"] = "kunlun/shilu1"},
    objs = {["『琴技入门』"] = "art's book"}
}
Room {
    id = "kunlun/sleeproom",
    name = "卧室",
    ways = {["east"] = "kunlun/tieqinju"},
    nolooks = {["east"] = true},
    precmds = {["east"] = "open door"},
    objs = {["詹春"] = "zhan chun"}
}
Room {
    ...
    precmds = {["west"] = "open door"},
    objs = {["何太冲"] = "he taichong"}
}
Room {
    id = "kunlun/tieqinju2",
    name = "铁琴居二楼",
    ways = {["down"] = "kunlun/tieqinju"}
}
Room {
    id = "kunlun/wlang01",
    name = "西走廊",
    ways = {["east"] = "kunlun/qianting", ["west"] = "kunlun/keting2"}
}
Room {
    id = "kunlun/xiuxishi",
    name = "休息室",
    no_fight = true,
    ways = {["south"] = "kunlun/shilu2"}
}
Room {
    id = "kunlun/zhenyuanqiao",
    name = "镇远桥",
    ways = {["eastdown"] = "mingjiao/shanjiao", ["west"] = "kunlun/shanlu"}
}
Room {
    id = "lanzhou/bingcao",
    name = "冰草湾",
...
Room {
    id = "lanzhou/dacaigou",
    name = "打柴沟",
    ways = {["southeast"] = "lanzhou/gulang", ["north"] = "lanzhou/wuqiao"},
    objs = {["樵夫"] = "qiao fu"}
}
Room {
    id = "lanzhou/dukou2",
    name = "西夏渡口",
    ways = {["southeast"] = "lanzhou/shanlu1", ["#duHhe"] = "lanzhou/dukou3"},
    nolooks = {["#duHhe"] = true, ["enter"] = true},
    lengths = {["#duHhe"] = 10000}
}
Room {
    id = "lanzhou/dukou3",
    name = "西夏渡口",
    ways = {["northwest"] = "lanzhou/huanghe_3", ["#duHhe"] = "lanzhou/dukou2"},
    nolooks = {["#duHhe"] = true, ["enter"] = true},
    lengths = {["#duHhe"] = 10000}
}
Room {
    id = "lanzhou/gccheng",
    name = "古长城",
    ways = {["east"] = "lanzhou/shimen", ["west"] = "lanzhou/yinpanshui"},
    nolooks = {["down"] = true}
}
Room {
    id = "lanzhou/gulang",
...
Room {
    id = "lanzhou/hongsx",
    name = "红山峡",
    ways = {["southeast"] = "lanzhou/jintai", ["north"] = "lanzhou/shimen"}
}
Room {
    id = "lanzhou/houyuan",
    name = "后院",
    ways = {["south"] = "lanzhou/zhenting"},
    postcmds = {["south"] = "#walkBusy"}
}
Room {
    id = "lanzhou/huanghe_2",
    name = "黄河",
    ways = {["northwest"] = "lanzhou/jintai", ["east"] = "lanzhou/huanghe_3"}
}
Room {
    id = "lanzhou/huanghe_3",
    name = "黄河",
    ways = {["southeast"] = "lanzhou/dukou3", ["west"] = "lanzhou/huanghe_2"}
}
Room {
    id = "lanzhou/jingyuan",
    name = "靖远",
...
Room {
    ...
    lengths = {["#lanzhoukedian"] = 5}
}
Room {
    id = "lanzhou/kedian2",
    name = "客店二楼",
    ways = {["enter"] = "lanzhou/kedian3", ["down"] = "lanzhou/kedian"},
...
Room {
    id = "lanzhou/lanzhoue",
    name = "东城门",
    ways = {["east"] = "lanzhou/road5", ["west"] = "lanzhou/lanzhou"}
}
Room {
    id = "lanzhou/lanzhous",
    name = "南城门",
    ways = {["south"] = "lanzhou/sroad1", ["north"] = "lanzhou/lanzhou"}
}
Room {
    id = "lanzhou/lanzhouw",
    name = "西城门",
    ways = {["northwest"] = "lanzhou/road6", ["east"] = "lanzhou/lanzhou"}
}
Room {
    id = "lanzhou/lpshan",
    name = "六盘山",
...
Room {
    id = "lanzhou/qianting",
    name = "前厅",
    ways = {["north"] = "lanzhou/zhenting", ["east"] = "lanzhou/zhengmen"},
    postcmds = {["north"] = "#walkBusy"}
}
Room {
...
Room {
    id = "lanzhou/road2",
    name = "大渡口",
    ways = {["#duHhe"] = "lanzhou/road3", ["east"] = "lanzhou/road6"},
    lengths = {["#duHhe"] = 10000},
    nolooks = {["enter"] = true, ["#duHhe"] = true}
}
Room {
    id = "lanzhou/road3",
    name = "大渡口",
    ways = {["#duHhe"] = "lanzhou/road2", ["northwest"] = "lanzhou/road4"},
    lengths = {["#duHhe"] = 10000},
    nolooks = {["#duHhe"] = true, ["enter"] = true}
}
Room {
    id = "lanzhou/road4",
    name = "大道",
    ways = {["southeast"] = "lanzhou/road3", ["west"] = "lanzhou/yongdeng"},
...
Room {
    id = "lanzhou/road6",
    name = "大道",
    ways = {["southeast"] = "lanzhou/lanzhouw", ["west"] = "lanzhou/road2"},
...
Room {
    id = "lanzhou/shanlu1",
    name = "山脚下",
    ways = {["southup"] = "lanzhou/kongdong", ["northwest"] = "lanzhou/dukou2"}
}
Room {
    id = "lanzhou/shidong",
    name = "石洞",
    ways = {["out"] = "lanzhou/shamo1"},
    objs = {["梅超风"] = "mei chaofeng", ["陈玄风"] = "chen xuanfeng"}
}
Room {
    id = "lanzhou/shimen",
    name = "石门",
...
Room {
    id = "lanzhou/tumenzi",
    name = "土门子",
    ways = {["northeast"] = "group/entry/lzshixia", ["west"] = "lanzhou/wuwei"},
    nolooks = {["down"] = true}
}
Room {
    id = "lanzhou/wufosi",
    name = "五佛寺",
    ways = {["south"] = "lanzhou/shimen"},
    nolooks = {["down"] = true}
}
Room {
    id = "lanzhou/wuqiao",
    name = "乌鞘岭",
    ways = {["south"] = "lanzhou/dacaigou", ["northwest"] = "lanzhou/wuwei"}
}
Room {
    id = "lanzhou/wuwei",
    name = "武威",
...
Room {
    ...
    name = "皮货药材店",
    ways = {["west"] = "lanzhou/gulang"}
}
Room {
    id = "lanzhou/yinpanshui",
    name = "营盘水",
    ways = {["southwest"] = "lanzhou/bingcao", ["east"] = "lanzhou/gccheng"}
}
Room {
    id = "lanzhou/yongdeng",
    name = "永登",
...
Room {
    ...
    name = "苗家庄门口",
    no_fight = true,
    ways = {["east"] = "lanzhou/sroad1", ["west"] = "lanzhou/qianting"},
    precmds = {["east"] = "#walkBusy", ["west"] = "#walkBusy"}
}
Room {
    id = "lanzhou/zhenting",
    name = "正厅",
    no_fight = true,
    ways = {["south"] = "lanzhou/qianting", ["north"] = "lanzhou/houyuan"},
    objs = {["苗人凤"] = "miao renfeng"}
}
Room {
    id = "meizhuang/ceting2",
    name = "侧厅",
    ways = {["west"] = "meizhuang/huilang20"}
}
Room {
    id = "meizhuang/ceting3",
    name = "侧厅",
    ways = {["east"] = "meizhuang/huilang21"}
}
Room {
    id = "meizhuang/door",
    name = "庄院大门",
    ways = {["north"] = "meizhuang/road3", ["mzDoor"] = "meizhuang/tianjing"},
    lengths = {
...
Room {
    id = "meizhuang/gushan",
    name = "孤山",
    ways = {["east"] = "meizhuang/hubian"}
}
Room {
    id = "meizhuang/hall",
    name = "大厅",
    ways = {["south"] = "meizhuang/huilang", ["north"] = "meizhuang/tianjing"}
}
Room {
    id = "meizhuang/houtang2",
    name = "后堂",
    ways = {["north"] = "meizhuang/huilang12"}
}
Room {
    id = "meizhuang/houtang3",
    name = "后堂",
    ways = {["north"] = "meizhuang/huilang13"}
}
Room {
    id = "meizhuang/huashi",
    name = "画室",
    ways = {["east"] = "meizhuang/huilang6"}
}
Room {
    id = "meizhuang/hubian",
    name = "西湖边",
    ways = {["east"] = "meizhuang/shiji", ["west"] = "hz/gushan"},
...
Room {
    ...
    name = "回廊",
    ways = {["south"] = "meizhuang/huilang12", ["east"] = "meizhuang/huilang8"}
}
Room {
    id = "meizhuang/huilang11",
    name = "回廊",
    ways = {["south"] = "meizhuang/huilang13", ["west"] = "meizhuang/huilang9"}
}
Room {
...
Room {
    ...
    name = "回廊",
    ways = {["east"] = "meizhuang/huilang16", ["west"] = "meizhuang/huilang12"}
}
Room {
    id = "meizhuang/huilang15",
    name = "回廊",
    ways = {["east"] = "meizhuang/huilang13", ["west"] = "meizhuang/huilang17"}
}
Room {
    id = "meizhuang/huilang16",
    name = "回廊",
    ways = {["east"] = "meizhuang/huilang19", ["west"] = "meizhuang/huilang14"}
}
Room {
    id = "meizhuang/huilang17",
    name = "回廊",
    ways = {["east"] = "meizhuang/huilang15", ["west"] = "meizhuang/huilang19"}
}
Room {
...
Room {
    ...
    name = "回廊",
    ways = {["east"] = "meizhuang/huilang", ["west"] = "meizhuang/huilang4"}
}
Room {
...
Room {
    ...
    name = "回廊",
    ways = {["east"] = "meizhuang/tianjing", ["west"] = "meizhuang/huilang22"}
}
Room {
    id = "meizhuang/huilang25",
    name = "回廊",
    ways = {["east"] = "meizhuang/huilang23", ["west"] = "meizhuang/tianjing"}
}
Room {
    id = "meizhuang/huilang3",
    name = "回廊",
    ways = {["east"] = "meizhuang/huilang5", ["west"] = "meizhuang/huilang"}
}
Room {
...
Room {
    ...
    name = "回廊",
    ways = {["north"] = "meizhuang/huilang6", ["west"] = "meizhuang/huilang10"}
}
Room {
    id = "meizhuang/huilang9",
    name = "回廊",
    ways = {["north"] = "meizhuang/huilang7", ["east"] = "meizhuang/huilang11"}
}
Room {
    id = "meizhuang/jiushi",
    name = "酒室",
    ways = {["east"] = "meizhuang/huilang4"}
}
Room {
    id = "meizhuang/neishi",
    name = "内室",
    ways = {["south"] = "meizhuang/qinshi"}
}
Room {
...
Room {
    id = "meizhuang/qinshi",
    name = "琴室",
    ways = {["south"] = "meizhuang/huilang19", ["north"] = "meizhuang/neishi"}
}
Room {
    id = "meizhuang/qishi",
    name = "棋室",
    ways = {["west"] = "meizhuang/huilang5"}
}
Room {
    id = "meizhuang/road1",
    name = "小路",
    ways = {["south"] = "meizhuang/road2", ["west"] = "meizhuang/shiji"},
    room_relative = "石级-----小路｜小路小路"
}
Room {
    id = "meizhuang/road2",
    name = "小路",
    ways = {["#inmz"] = "meizhuang/plum_maze", ["north"] = "meizhuang/road1"},
...
Room {
    id = "meizhuang/road3",
    name = "青石板大路",
    ways = {["south"] = "meizhuang/door", ["north"] = "meizhuang/plum_maze"}
}
Room {
    id = "meizhuang/shiji",
    name = "石级",
    ways = {["east"] = "meizhuang/road1", ["west"] = "meizhuang/hubian"}
}
Room {
    id = "meizhuang/shufang",
    name = "书房",
    ways = {["west"] = "meizhuang/huilang7"}
}
Room {
...
Room {
    ...
    name = "厢房",
    ways = {["east"] = "meizhuang/huilang22"}
}
Room {
    id = "meizhuang/xiangfang3",
    name = "厢房",
    ways = {["west"] = "meizhuang/huilang23"}
}
Room {
    id = "miaojiang/bingqif",
    name = "兵器房",
    ways = {["west"] = "miaojiang/qiant"}
}
Room {
    id = "miaojiang/chufang",
    name = "厨房",
    ways = {["east"] = "miaojiang/qiant"}
}
Room {
    id = "miaojiang/guoyuan",
    name = "果园",
    ways = {["west"] = "miaojiang/jiedao5"}
}
Room {
    id = "miaojiang/haozhai",
    name = "苗居",
    ways = {["north"] = "miaojiang/jiedao3"},
    objs = {["陈清"] = "chen qing"}
}
Room {
    id = "miaojiang/houshan",
    name = "后山",
    ways = {["southeast"] = "miaojiang/shanlu"},
    objs = {["阎基"] = "yan ji"}
}
Room {
...
Room {
    ...
    name = "练武场",
    ways = {["northwest"] = "miaojiang/jiedao5"},
    objs = {["苗族青年"] = "miaozu qingnian"}
}
Room {
    id = "miaojiang/myp",
    name = "明月屏",
...
Room {
    id = "miaojiang/myt",
    name = "明月厅",
    ways = {["south"] = "miaojiang/qiant", ["northwest"] = "miaojiang/shef"},
    objs = {["何红药"] = "he hongyao"}
}
Room {
    id = "miaojiang/mzhai",
    name = "苗屋",
    ways = {["south"] = "miaojiang/jiedao4"},
    objs = {["苗族老汉"] = "miaozu laohan"}
}
Room {
    id = "miaojiang/qiant",
    name = "前厅",
...
Room {
    ...
    name = "山道",
    ways = {["southwest"] = "miaojiang/myp", ["west"] = "miaojiang/shandao2"},
    room_relative = "山道-----山道↙明月屏山道"
}
Room {
    id = "miaojiang/shandao2",
    name = "山道",
    ways = {["east"] = "miaojiang/shandao1", ["north"] = "group/entry/mjshan2"},
    room_relative = "山路｜山道-----山道山道"
}
Room {
    id = "miaojiang/shandong",
    name = "山洞",
    ways = {["out"] = "miaojiang/slu9"}
}
Room {
    id = "miaojiang/shanlu",
    name = "山路",
    ...
    nolooks = {["northwest"] = true},
    precmds = {["northwest"] = "push grass"}
}
Room {
    id = "miaojiang/shanlu1",
    name = "小路",
    ways = {["southeast"] = "miaojiang/xiaolu1"},
    room_relative = "山路山路↖↑山脚-----小镇山脚"
}
Room {
    id = "miaojiang/shanya2",
    name = "山坡",
    ways = {["west"] = "miaojiang/wddamen"}
}
Room {
    id = "miaojiang/shef",
    name = "蛇房",
    ways = {["southeast"] = "miaojiang/myt", ["south"] = "miaojiang/woshi"},
    objs = {["黑色毒蛇"] = "heise dushe"}
}
Room {
    id = "miaojiang/slu1",
    name = "山脚",
    ...
    blocks = {["#Inwdj"] = {{id = "wudujiao dizi", exp = 150000}}},
    lengths = {["#Inwdj"] = "if inwdj==0 then return false else return 1 end"}
}
Room {
    id = "miaojiang/slu2",
    name = "山路",
...
Room {
    id = "miaojiang/slu4",
    name = "山路",
    ways = {["northup"] = "miaojiang/wddamen", ["southdown"] = "miaojiang/slu2"},
    room_relative = "大门↑山路↑山路山路"
}
Room {
    id = "miaojiang/slu5",
    name = "山路",
    ways = {["northup"] = "miaojiang/slu7", ["westup"] = "miaojiang/slu3"},
    room_relative = "山路↑山路←山路山路",
    objs = {["毒蛇"] = "du she"}
}
Room {
    id = "miaojiang/slu6",
    name = "山路",
    ways = {["southdown"] = "miaojiang/slu3"},
    room_relative = "山路↑山路山路"
}
Room {
    id = "miaojiang/slu7",
    name = "山路",
    ways = {["northwest"] = "miaojiang/slu8", ["southdown"] = "miaojiang/slu5"},
    room_relative = "山路↖山路↑山路山路"
}
Room {
    id = "miaojiang/slu8",
    name = "山路",
    ways = {["southeast"] = "miaojiang/slu7", ["east"] = "miaojiang/slu9"},
    room_relative = "山路-----山路↘山路山路"
}
Room {
    id = "miaojiang/slu9",
    name = "山路",
    ways = {["enter"] = "miaojiang/shandong", ["west"] = "miaojiang/slu8"},
...
Room {
    ...
    objs = {["五毒教弟子"] = "wudujiao dizi"}
}
Room {
    id = "miaojiang/woshi",
    name = "卧室",
    ways = {["north"] = "miaojiang/shef"},
    objs = {["何铁手"] = "he tieshou"}
}
Room {
...
Room {
    ...
    name = "小路",
    ways = {["south"] = "miaojiang/jiedao1", ["west"] = "miaojiang/xiaolu1"},
    room_relative = "小路-----小路｜小镇小路"
}
Room {
    id = "miaojiang/xiaotan",
    name = "小摊",
    ways = {["west"] = "miaojiang/jiedao2"},
    objs = {["苗家女子"] = "miaojia nuzi"}
}
Room {
    id = "miaojiang/yaofang1",
    name = "药王局",
    no_fight = true,
    ways = {["south"] = "miaojiang/ywj"},
    objs = {["丹炉"] = "dan lu"}
}
Room {
    id = "miaojiang/ywj",
    ...
    objs = {["程灵素"] = "cheng lingsu"}
}
Room {
    id = "miaojiang/zhd",
    name = "杂货店",
    ways = {["west"] = "miaojiang/jiedao1"}
}
Room {
    id = "mingjiao/bank",
    name = "勒马斋",
    ways = {["east"] = "mingjiao/shejing"},
    objs = {["龙卷风"] = "long juanfeng"}
}
Room {
    id = "mingjiao/baota",
    name = "光明宝塔",
    ways = {["enter"] = "mingjiao/baota0", ["southdown"] = "mingjiao/sht"}
}
Room {
    id = "mingjiao/baota0",
    name = "宝塔一楼",
    ways = {["out"] = "mingjiao/baota"}
}
Room {
...
Room {
    ...
    name = "丛林",
    ways = {["south"] = "mingjiao/bhd/cling"}
}
Room {
    id = "mingjiao/bhd/dbshan",
    name = "冰山",
    ways = {["east"] = "mingjiao/bhd/dbshan1"}
}
Room {
    id = "mingjiao/bhd/dbshan1",
    name = "冰山",
    ways = {["west"] = "mingjiao/bhd/dbshan"}
}
Room {
...
Room {
    ...
    name = "火山口",
    ways = {["southdown"] = "mingjiao/bhd/huoshan1"}
}
Room {
...
Room {
    ...
    name = "小石山",
    ways = {["west"] = "mingjiao/bhd/shishan"}
}
Room {
    id = "mingjiao/bhd/xdong",
    name = "石洞",
    ways = {["out"] = "mingjiao/bhd/shishan1"}
}
Room {
    id = "mingjiao/bhd/xiongdong",
    name = "熊洞",
    ways = {["out"] = "mingjiao/bhd/shishan"}
}
Room {
    id = "mingjiao/bhd/yanshi",
    name = "岩石",
    ways = {["north"] = "mingjiao/bhd/pingyan1"}
}
Room {
...
Room {
    ...
    name = "岩石路",
    ways = {["east"] = "mingjiao/bhd/ysroad1", ["west"] = "mingjiao/bhd/hsjiao"}
}
Room {
    id = "mingjiao/bingqi",
    name = "兵器库",
    ways = {["north"] = "mingjiao/huoqi"},
    postcmds = {["north"] = "#walkBusy"},
    objs = {["吴劲草"] = "wu jincao"}
}
Room {
    id = "mingjiao/bishui",
    name = "碧水寒潭",
    ways = {["west"] = "mingjiao/shanlu2", ["jump down"] = "mingjiao/tandi"},
    nolooks = {["jump down"] = true},
    precmds = {["west"] = "#walkBusy", ["jump down"] = "#walkBusy"}
}
Room {
    id = "mingjiao/cl1",
    name = "长廊",
    ways = {["east"] = "mingjiao/wu3", ["west"] = "mingjiao/huoqi"},
    room_relative = "烈火旗-----长廊-----练武场长廊"
}
Room {
    id = "mingjiao/cl2",
    name = "长廊",
    ways = {["east"] = "mingjiao/shuiqi", ["west"] = "mingjiao/wu3"},
    room_relative = "练武场-----长廊-----洪水旗长廊"
}
Room {
    id = "mingjiao/dashaqiu",
    name = "大沙丘",
    ways = {["east"] = "mingjiao/htping", ["west"] = "mingjiao/shejing"}
}
Room {
    id = "mingjiao/didao/bidao1",
    name = "秘道入口",
    ways = {["north"] = "mingjiao/didao/bidao2", ["out"] = "mingjiao/wxiang"}
}
Room {
...
Room {
    ...
    name = "藏金室",
    ways = {["north"] = "mingjiao/didao/bidao12"}
}
Room {
...
Room {
    ...
    name = "秘道",
    ways = {["west"] = "mingjiao/didao/bidao20", ["out"] = "mingjiao/tuqi"}
}
Room {
    id = "mingjiao/didao/bidao22",
    name = "秘室",
    ways = {["south"] = "mingjiao/didao/bidao15"}
}
Room {
...
Room {
    ...
    name = "秘道",
    ways = {["northdown"] = "mingjiao/didao/bidao6"}
}
Room {
...
Room {
    ...
    name = "秘道",
    ways = {["westup"] = "mingjiao/didao/bidao6"}
}
Room {
...
Room {
    ...
    name = "秘道",
    ways = {["west"] = "mingjiao/didao/mbidao2"}
}
Room {
...
Room {
    ...
    nolooks = {["north"] = true},
    objs = {["大石头"] = "da shitou", ["小石头"] = "xiao shitou"},
...
Room {
    ...
    name = "树林",
    ways = {["#mjSlout1"] = "mingjiao/didao/shenchu1"}
}
Room {
...
Room {
    ...
    name = "树林",
    ways = {["#mjSlout4"] = "mingjiao/didao/shenchu4"},
    objs = {["朱元璋"] = "zhu yuanzhang"}
}
Room {
    ...
    objs = {["常遇春"] = "chang yuchun"}
}
Room {
    id = "mingjiao/eatroom",
    name = "厨房",
    no_fight = true,
    ways = {["east"] = "mingjiao/xting"},
    objs = {["粽子"] = "zong zi", ["酸梅汤"] = "suanmei tang"}
}
Room {
    id = "mingjiao/gmd",
    name = "光明顶",
    ways = {["northup"] = "mingjiao/wu3", ["southdown"] = "mingjiao/muqi"},
    objs = {["光明圣火碑"] = "board", ["殷无禄"] = "yin wulu"}
}
Room {
    id = "mingjiao/guangc",
    name = "广场",
...
Room {
    ...
    name = "后山",
    ways = {["south"] = "mingjiao/hdg/huapu4"}
}
Room {
...
Room {
    ...
    name = "花圃",
    ways = {["west"] = "mingjiao/hdg/xfang1"}
}
Room {
    id = "mingjiao/hdg/huapu3",
    name = "花圃",
    ways = {["east"] = "mingjiao/hdg/maopeng"}
}
Room {
...
Room {
    ...
    name = "厢房",
    ways = {["out"] = "mingjiao/hdg/caotang"},
    nolooks = {["out"] = true},
    precmds = {["out"] = "open door"}
}
Room {
...
Room {
    id = "mingjiao/htping",
    name = "黄土坪",
    ways = {["southeast"] = "mingjiao/shaqiu4", ["west"] = "mingjiao/dashaqiu"},
    nolooks = {["south"] = true, ["east"] = true},
    objs = {["殷无福"] = "yin wufu"}
...
Room {
    ...
    name = "岸边",
    ways = {["eastup"] = "mingjiao/lsd/shanguang"}
}
Room {
...
Room {
    ...
    name = "山峰",
    ways = {["southdown"] = "mingjiao/lsd/sfjiao"}
}
Room {
...
Room {
    ...
    objs = {["闻苍松"] = "wen cangsong"},
    blocks = {
        ["northup"] = {{id = "jiao zhong", exp = 100000, party = "明教"}},
        ["south"] = {{id = "jiao zhong", exp = 100000, party = "明教"}},
        ["east"] = {{id = "jiao zhong", exp = 100000, party = "明教"}},
        ["west"] = {{id = "jiao zhong", exp = 100000, party = "明教"}}
    }
}
Room {
    id = "mingjiao/qianting",
    name = "总坛前厅",
    ways = {["north"] = "mingjiao/tingtang", ["southdown"] = "mingjiao/ljroad3"},
    objs = {["殷野王"] = "yin yewang"}
}
Room {
    id = "mingjiao/rukou",
    name = "监狱入口",
    ways = {["southwest"] = "mingjiao/zl7", ["northwest"] = "mingjiao/jinqi"},
    objs = {["冷谦"] = "leng qian"}
}
Room {
...
Room {
    id = "mingjiao/shanlu1",
    name = "山间小路",
    ways = {["eastdown"] = "mingjiao/shanlu2", ["westup"] = "mingjiao/shuiqi"},
    room_relative = "洪水旗←山间小路←山间小路山间小路"
}
Room {
    id = "mingjiao/shanlu2",
    name = "山间小路",
    ways = {["westup"] = "mingjiao/shanlu1", ["east"] = "mingjiao/bishui"},
    blocks = {["east"] = {{id = "jiao zhong", exp = 1000000}}},
    room_relative = "山间小路←山间小路---碧水寒潭山间小路"
}
Room {
...
Room {
    id = "mingjiao/shaqiu1",
    name = "小沙丘",
    ways = {["east"] = "group/entry/mjshamo1", ["west"] = "mingjiao/shaqiu2"},
    room_relative = "小沙丘｜小沙丘----小沙丘----大沙漠｜小沙丘小沙丘",
    nolooks = {["south"] = true, ["north"] = true}
}
Room {
    id = "mingjiao/shaqiu2",
    name = "小沙丘",
    ways = {["east"] = "mingjiao/shaqiu1", ["west"] = "mingjiao/shaqiu3"},
    nolooks = {["south"] = true, ["north"] = true}
}
Room {
    id = "mingjiao/shaqiu3",
    name = "小沙丘",
    ways = {["east"] = "mingjiao/shaqiu2", ["west"] = "mingjiao/shaqiu4"},
    nolooks = {["south"] = true, ["north"] = true}
}
Room {
    id = "mingjiao/shaqiu4",
    name = "小沙丘",
    ways = {["northwest"] = "mingjiao/htping", ["east"] = "mingjiao/shaqiu3"},
...
Room {
    id = "mingjiao/shiwang",
    name = "狮王殿",
    ways = {["east"] = "mingjiao/jinqi", ["west"] = "mingjiao/jyt"}
}
Room {
    id = "mingjiao/sht",
    name = "圣火堂",
    ways = {["northup"] = "mingjiao/baota", ["southdown"] = "mingjiao/jyt"},
    objs = {["张无忌"] = "zhang wuji"}
}
Room {
    id = "mingjiao/shuiqi",
...
Room {
    ...
    name = "山路",
    ways = {["north"] = "mingjiao/xuanya1", ["southdown"] = "mingjiao/sshanlu3"},
...
Room {
    id = "mingjiao/tandi",
    name = "潭底",
    ways = {["up"] = "mingjiao/bishui"}
}
Room {
    id = "mingjiao/tearoom",
    name = "茶室",
    no_fight = true,
    ways = {["east"] = "mingjiao/tingtang"},
    objs = {["酸梅汤"] = "suanmei tang", ["侍茶小僮"] = "xiao tong"}
}
Room {
...
Room {
    id = "mingjiao/wxiang",
    name = "西厢房",
    ways = {["east"] = "mingjiao/yuanzi"}
}
Room {
    id = "mingjiao/xiangfang",
    name = "厢房",
    no_fight = true,
    ways = {["#walkBusy;west"] = "mingjiao/tingtang"}
}
Room {
    id = "mingjiao/xting",
    name = "小厅",
...
Room {
    id = "mingjiao/yaofang",
    name = "药房",
    ways = {["west"] = "mingjiao/wu1"},
    objs = {["药师"] = "yao shi"}
}
Room {
    id = "mingjiao/yuanzi",
    name = "小院子",
    ways = {["southeast"] = "mingjiao/longwang", ["west"] = "mingjiao/wxiang"}
}
Room {
    id = "mingjiao/zl1",
    name = "长廊",
    ways = {["east"] = "mingjiao/guangc", ["west"] = "mingjiao/wu2"},
    room_relative = "练武场-----长廊-----广场长廊"
}
Room {
    id = "mingjiao/zl2",
    name = "长廊",
    ways = {["east"] = "mingjiao/wu4", ["west"] = "mingjiao/guangc"},
    room_relative = "广场-----长廊-----练武场长廊"
}
Room {
    id = "mingjiao/zl6",
    name = "长廊",
    ways = {["south"] = "mingjiao/wu2", ["north"] = "mingjiao/tuqi"},
    objs = {["说不得"] = "shuo bude"},
...
Room {
    ...
    name = "藏书阁",
    no_fight = true,
    ways = {["down"] = "mr/yunjinlou"}
}
Room {
    id = "mr/chufang",
    name = "厨房",
    ways = {["south"] = "mr/xiaoting"},
    objs = {
        ["菏叶冬笋汤"] = "dongsun-tang",
        ["菱白虾仁"] = "lingbai xiaren",
        ["樱桃火腿"] = "yingtao huotui"
...
--	},
-- }
Room {id = "mr/cufang", name = "厨房", ways = {["east"] = "mr/didao1"}}
Room {
    id = "mr/didao",
    name = "地道",
    ways = {
...
Room {id = "mr/didao2", name = "地道", ways = {["north"] = "mr/migong1"}}
Room {id = "mr/duchuan3", name = "渡船", ways = {["out"] = "mr/xiaodao"}}
Room {
    id = "mr/houtang",
    name = "后堂",
    ways = {["north"] = "mr/xiaoting", ["zuan didao"] = "mr/didao"},
    nolooks = {["zuan didao"] = true},
    lengths = {
...
Room {
    id = "mr/hubian",
    name = "湖边",
    ways = {["east"] = "mr/hubian1", ["west"] = "suzhou/qingshidadao"}
}
Room {
    id = "mr/hubian1",
    name = "湖边",
    ways = {["east"] = "mr/hubian2", ["west"] = "mr/hubian"}
}
Room {
    id = "mr/hubian2",
    name = "湖边",
    ways = {["southeast"] = "mr/shiqiao", ["west"] = "mr/hubian1"}
}
Room {id = "mr/kongfang", name = "空房间", ways = {["west"] = "mr/migong2"}}
Room {
    id = "mr/migong1",
    name = "迷宫",
    ways = {
...
Room {id = "mr/mishi", name = "密室", ways = {["south"] = "mr/fenmu"}}
Room {id = "mr/mishi1", name = "密室", ways = {["up"] = "mr/mishi"}}
Room {
    id = "mtl/anbian",
    name = "岸边",
    ways = {["south"] = "mtl/hc", ["east"] = "mtl/hc1", ["west"] = "mtl/hc2"},
...
Room {
    id = "mtl/cangshuge",
    name = "藏书阁",
    ways = {["down"] = "mtl/yunjinlou"}
}
Room {
    id = "mtl/cl",
    name = "长廊",
    ways = {["north"] = "mtl/qianyuan", ["east"] = "mtl/cl1"},
    room_relative = "前院｜长廊-----长廊长廊"
}
Room {
    id = "mtl/cl1",
    name = "长廊",
    ways = {["east"] = "mtl/cl2", ["west"] = "mtl/cl"},
...
Room {
    id = "mtl/cl3-1",
    name = "长廊",
    ways = {["south"] = "mtl/cl3-2", ["east"] = "mtl/cl3"},
    room_relative = "长廊-----长廊｜长廊长廊"
}
Room {
    id = "mtl/cl3-2",
...
Room {
    id = "mtl/cl3-3",
    name = "长廊",
    ways = {["east"] = "mtl/hffang", ["north"] = "mtl/cl3-2"},
...
Room {
    id = "mtl/cl4-1",
    name = "长廊",
    ways = {["eastup"] = "mtl/tingzi", ["west"] = "mtl/cl4"},
...
Room {
    ...
    blocks = {
        ["east"] = {{id = "jia ding", exp = 30000, party = "姑苏慕容"}}
    }
}
Room {
    id = "mtl/cl4-4",
    ...
    blocks = {["east"] = {{id = "ya huan", exp = 5000}}}
}
Room {
    id = "mtl/cl4-5",
    name = "长廊",
    ways = {["north"] = "mtl/cl4-4", ["west"] = "mtl/zahuoshi"},
...
Room {
    id = "mtl/guifang",
    name = "闺房",
    ways = {["west"] = "mtl/cl4-4", ["jump window"] = "mtl/ytyuan1"},
    nolooks = {["jump window"] = true}
}
Room {
    id = "mtl/hc",
    name = "花丛中",
...
Room {
    id = "mtl/hc2",
    name = "花丛中",
    ways = {["south"] = "mtl/hc3", ["east"] = "mtl/anbian"}
}
Room {
    id = "mtl/hc3",
    name = "花丛中",
    ways = {["north"] = "mtl/hc2", ["east"] = "mtl/hc"}
}
Room {
    id = "mtl/hc4",
    name = "花丛中",
    ways = {["south"] = "mtl/qianyuan", ["west"] = "mtl/hc1"}
}
Room {
    id = "mtl/hffang",
    name = "花肥房",
    ways = {["east"] = "mtl/hhyuan", ["west"] = "mtl/cl3-3"},
    objs = {["唐光雄"] = "tang guangxiong", ["严妈妈"] = "yan mama"}
}
Room {
    id = "mtl/hhyuan",
    name = "后花园",
...
Room {
    id = "mtl/liulin",
    name = "柳树林",
    ways = {["south"] = "mtl/xiaojing5", ["east"] = "mtl/liulin1"},
    objs = {["柳条"] = "liu tiao"}
}
Room {
    id = "mtl/liulin1",
...
Room {
    id = "mtl/liulin2",
    name = "柳树林",
    ways = {["south"] = "mtl/xiaojing7", ["west"] = "mtl/liulin1"}
}
Room {
    id = "mtl/liulin3",
    name = "柳树林",
    ways = {["south"] = "mtl/liulin1", ["yue tree"] = "mtl/shushang"},
    objs = {["小树枝"] = "xiao shuzhi"}
}
Room {
    id = "mtl/shushang",
    name = "树上",
    ways = {["jump down"] = "mtl/liulin3"}
}
Room {
    id = "mtl/midao",
    name = "秘道",
    ways = {["south"] = "mtl/ytyuan", ["north"] = "mtl/hhyuan"}
}
Room {
    id = "mtl/qianyuan",
    name = "前院",
...
Room {id = "mtl/shuichi", name = "水池", ways = {["west"] = "mtl/xiaojing7"}}
Room {id = "mtl/tingzi", name = "亭子", ways = {["westdown"] = "mtl/cl4-1"}}
Room {
    id = "mtl/xiangfang1",
    name = "厢房",
    ways = {
...
Room {
    id = "mtl/xiaojing10",
    name = "小径",
    ways = {["south"] = "mtl/xiaojing11", ["north"] = "mtl/zhuangmen"}
}
Room {
    id = "mtl/xiaojing11",
    name = "小径",
    ways = {["south"] = "mtl/anbian1", ["north"] = "mtl/xiaojing10"}
}
Room {
    id = "mtl/xiaojing5",
    name = "小径",
...
Room {
    id = "mtl/xiaojing8",
    name = "小径",
    ways = {["south"] = "mtl/houyuan", ["north"] = "mtl/xiaojing6"}
}
Room {
    id = "mtl/ytyuan",
    name = "樱桃园",
...
Room {
    id = "mtl/zahuoshi",
    name = "杂货室",
    ways = {["east"] = "mtl/cl4-5", ["west"] = "mtl/hhyuan"},
    objs = {["兵器架"] = "bingqi jia"}
}
Room {
    id = "mtl/zhuangmen",
...
Room {
    ...
    nolooks = {["qu mr;#boatWait"] = true, ["qu yanziwu;#boatWait"] = true},
    lengths = {
...
Room {
    ...
    nolooks = {["tan qin;#boatWait"] = true},
    lengths = {
        ["tan qin;#boatWait"] = "if score.party and score.party=='姑苏慕容' then return false else return 1 end"
    }
}
Room {id = "mr/tingzi", name = "亭子", ways = {["westdown"] = "mr/cl4-1"}}
Room {
    id = "mr/xiangfang",
    name = "厢房",
    no_fight = true,
    ways = {["west"] = "mr/xiaoting"}
}
Room {
    id = "mr/xiaodao",
    name = "小岛边",
    ways = {["south"] = "mr/xiaoshe", ["#boatYell"] = "mr/testmatou1"},
    nolooks = {["#boatYell"] = true, ["enter"] = true},
    lengths = {
...
Room {
    id = "mr/xiaojing1",
    name = "小径",
    ways = {["east"] = "mr/xiaoshe", ["west"] = "mr/xiaojing2"}
}
Room {
    id = "mr/xiaojing2",
    name = "小径",
    ways = {["northwest"] = "mr/tingyuju", ["east"] = "mr/xiaojing1"}
}
Room {
    id = "mr/xiaojing3",
    name = "小径",
    ways = {["northeast"] = "mr/xiaojing4", ["west"] = "mr/xiaoshe"}
}
Room {
    id = "mr/xiaojing4",
    name = "小径",
    ways = {["southwest"] = "mr/xiaojing3", ["east"] = "mr/xiaoting"}
}
Room {
    id = "mr/xiaoshe",
    name = "小舍",
...
Room {
    ...
    blocks = {["north"] = {{id = "a bi", exp = 50000, party = "姑苏慕容"}}},
    objs = {["香茶"] = "xiang cha", ["阿碧"] = "a bi"}
}
Room {id = "mr/xiaozhou3", name = "渡船", ways = {["out"] = "mtl/anbian"}}
Room {
    id = "yanziwu/anbian2",
    name = "岸边",
    ways = {["south"] = "yanziwu/shuixie"},
    room_relative = "岸边｜听香水榭岸边"
}
Room {
    id = "yanziwu/anbian3",
    name = "岸边",
    ways = {["north"] = "yanziwu/houyuan1", ["#boatYell"] = "mr/hubian2"},
    nolooks = {["#boatYell"] = true, ["enter"] = true},
    lengths = {
        ["#boatYell"] = "if score.party and score.party=='姑苏慕容' then return false else return 1 end"
    }
...
Room {
    id = "yanziwu/anbian4",
    name = "岸边",
    ways = {["east"] = "yanziwu/shuixie", ["#boatYell"] = "mtl/anbian1"},
    nolooks = {["#boatYell"] = true, ["enter"] = true},
    lengths = {
        ["#boatYell"] = "if score.party and score.party=='姑苏慕容' then return false else return 1 end"
    },
...
Room {
    ...
    name = "碧水亭",
    ways = {["east"] = "yanziwu/muqiao", ["jump liang"] = "yanziwu/lianshang"}
}
Room {
    id = "yanziwu/lianshang",
    name = "梁上",
    ways = {["jump down"] = "yanziwu/bishuiting"}
}
Room {
    id = "yanziwu/cl5-0",
    name = "长廊",
    ...
    blocks = {["east"] = {{id = "guan jia", exp = 50000}}}
}
Room {
    id = "yanziwu/cl5-1",
    name = "长廊",
...
Room {
    id = "yanziwu/cl5-2",
    name = "长廊",
    ways = {["north"] = "yanziwu/cl5-1", ["west"] = "yanziwu/shangyue"},
    room_relative = "长廊｜赏月斋-----长廊长廊"
}
Room {
    id = "yanziwu/cl5-3",
    name = "长廊",
    ways = {["south"] = "yanziwu/xiaomen", ["west"] = "yanziwu/cl5-1"},
...
Room {
    id = "yanziwu/cl5-6",
    name = "长廊",
    ways = {["east"] = "yanziwu/cl5-5", ["west"] = "yanziwu/cl6-5"},
    room_relative = "长廊-----长廊-----长廊长廊"
}
Room {
    id = "yanziwu/cl6-0",
    name = "长廊",
    ways = {["south"] = "yanziwu/cl6-1", ["east"] = "yanziwu/jushi"},
...
Room {
    id = "yanziwu/cl6-2",
    name = "长廊",
    ways = {["east"] = "yanziwu/jingyinge", ["north"] = "yanziwu/cl6-1"},
    room_relative = "长廊｜长廊-----静音阁长廊"
}
Room {
    id = "yanziwu/cl6-3",
    name = "长廊",
    ways = {["south"] = "yanziwu/xiaomen1", ["east"] = "yanziwu/cl6-1"},
    room_relative = "长廊-----长廊｜小门长廊"
}
Room {
    id = "yanziwu/cl6-4",
    name = "长廊",
    ways = {["north"] = "yanziwu/xiaomen1", ["east"] = "yanziwu/cl6-5"},
...
Room {
    ...
    objs = {["香茶"] = "xiang cha", ["公冶乾"] = "gongye gan"}
}
Room {
    id = "yanziwu/fanting1",
    name = "厨房",
    ways = {["west"] = "yanziwu/cl5-0"}
}
Room {
    id = "yanziwu/fenmu",
    name = "墓地",
    ways = {["west"] = "yanziwu/xiaojing4"}
}
Room {
    id = "yanziwu/guanxing",
    name = "观星台",
    ways = {["south"] = "yanziwu/xiaojing4"}
}
Room {
    id = "yanziwu/houting",
    name = "后厅",
...
Room {
    id = "yanziwu/mishi",
    name = "密室",
    ways = {["south"] = "yanziwu/fenmu"}
}
Room {id = "yanziwu/mishi1", name = "密室", ways = {["up"] = "yanziwu/mishi"}}
Room {
    id = "yanziwu/muqiao",
    name = "木桥",
    ways = {["east"] = "yanziwu/houyuan1", ["west"] = "yanziwu/bishuiting"}
}
Room {
    id = "yanziwu/neitang",
    name = "内堂",
...
Room {
    id = "yanziwu/hssg",
    name = "还施水阁",
    ways = {["south"] = "yanziwu/jiabi"}
}
Room {
    id = "yanziwu/jiabi",
    name = "夹壁",
    ways = {["north"] = "yanziwu/hssg", ["push shujia"] = "yanziwu/shufang"}
}
Room {
    id = "yanziwu/shuixie",
    name = "听香水榭",
...
Room {
    ...
    name = "小径",
    ways = {["south"] = "yanziwu/dating", ["north"] = "yanziwu/yanziwu"},
    room_relative = "院门｜小径｜大厅小径"
}
Room {
    id = "yanziwu/xiaojing3",
    name = "小径",
    ways = {["east"] = "yanziwu/xiaojing4", ["west"] = "yanziwu/cl5-4"},
...
Room {
    ...
    objs = {["邓百川"] = "deng baichuan"},
    room_relative = "观星台｜小径-----小径-----墓地小径"
}
Room {
    id = "yanziwu/xiaomen",
    name = "小门",
    ways = {["south"] = "yanziwu/cl5-4", ["north"] = "yanziwu/cl5-3"}
}
Room {
    id = "yanziwu/xiaomen1",
    name = "小门",
    ways = {["south"] = "yanziwu/cl6-4", ["north"] = "yanziwu/cl6-3"}
}
Room {
    id = "yanziwu/yanziwu",
    name = "院门",
    ...
    objs = {["慕容复"] = "murong fu", ["慕容世袭图谱"] = "board"}
}
Room {
    id = "yanziwu/zishu",
    name = "私塾",
    ways = {["south"] = "yanziwu/shufang"}
}
Room {id = "mr/zhou3", name = "小舟", ways = {["out"] = "yanziwu/anbian2"}}
Room {id = "mr/zhou9", name = "小舟", ways = {["out"] = "mr/xiaodao"}}
Room {
    id = "nanyang/dating",
    name = "聚贤庄大厅",
    no_fight = true,
    ways = {["south"] = "nanyang/jxzhuang", ["east"] = "nanyang/houyuan"},
    objs = {["游驹"] = "you ju", ["游骥"] = "you ji"}
}
Room {
    id = "nanyang/duanya",
    name = "断崖",
    ways = {["north"] = "nanyang/yidao4"}
}
Room {
    id = "nanyang/houyuan",
    name = "聚贤庄后院",
    ways = {["west"] = "nanyang/dating"}
}
Room {
    id = "nanyang/jiulou1",
    name = "迎宾楼",
    ways = {["east"] = "nanyang/nanyang", ["up"] = "nanyang/jiulou2"}
}
Room {
    id = "nanyang/jiulou2",
    name = "迎宾楼二楼",
    ways = {["down"] = "nanyang/jiulou1"}
}
Room {
    id = "nanyang/jxzhuang",
    name = "聚贤庄大门",
    ways = {["southwest"] = "nanyang/xiaolu3", ["north"] = "nanyang/dating"}
}
Room {
    id = "nanyang/kedian1",
    name = "客栈",
...
Room {
    id = "nanyang/qslu2",
    name = "青石路",
    ways = {["north"] = "nanyang/xujiaji"},
    room_relative = "许家集｜青石路青石路"
}
Room {
    id = "nanyang/xiaolu",
    name = "小路",
    ways = {["east"] = "nanyang/qslu", ["west"] = "nanyang/yidao2"}
}
Room {
    id = "nanyang/xiaolu2",
    name = "岔路",
    ways = {["northeast"] = "nanyang/xujiaji", ["west"] = "nanyang/yidao"}
}
Room {
    id = "nanyang/xiaolu3",
    name = "小路",
    ways = {["northeast"] = "nanyang/jxzhuang", ["west"] = "nanyang/qslu"},
    objs = {["萧峰"] = "xiao feng"}
}
Room {
    id = "nanyang/xujiaji",
...
Room {
    id = "nanyang/yidao1",
    name = "南门",
    ways = {["south"] = "nanyang/yidao", ["north"] = "nanyang/yidao2"}
}
Room {
    id = "nanyang/yidao2",
    name = "石板路",
...
Room {
    id = "ningbo/kedian2",
    name = "客店二楼",
    ways = {["enter"] = "ningbo/kedian3", ["down"] = "ningbo/kedian"}
}
Room {
    id = "ningbo/kedian3",
    name = "客店二楼",
    ways = {["out"] = "ningbo/kedian2"}
}
Room {
    id = "ningbo/majiu",
    name = "马厩",
    ways = {["east"] = "ningbo/kedian", ["northeast"] = "ningbo/ningbo"}
}
Room {
    id = "ningbo/ningbo",
    name = "城中心",
...
Room {
    id = "ningbo/tianyige",
    name = "天一阁",
    ways = {["southeast"] = "ningbo/aywsi", ["west"] = "ningbo/shilu"}
}
Room {
    id = "ningbo/ttcsi",
    name = "天童禅寺",
...
Room {
    id = "ningbo/xikou",
    name = "溪口",
    ways = {["south"] = "ningbo/dongqianhu", ["west"] = "ningbo/aywsi"},
    objs = {["艄公"] = "shao gong"}
}
Room {
    id = "ningbo/xuedoushan",
    name = "雪窦山",
    ways = {["north"] = "ningbo/dongqianhu"}
}
Room {
    id = "putian/cb-dian",
    name = "慈悲殿",
    ways = {["south"] = "putian/guangchang", ["north"] = "putian/qianyuan"},
    objs = {["元决尊者"] = "yuanjue zunzhe"}
}
Room {
    id = "putian/celang2",
    name = "侧廊",
    ways = {["south"] = "putian/xiaoyuan4", ["north"] = "putian/xiaoyuan2"}
}
Room {
    id = "putian/celang3",
    name = "侧廊",
    ways = {["south"] = "putian/xiaoyuan5", ["north"] = "putian/xiaoyuan3"}
}
Room {
    id = "putian/celang4",
    name = "侧廊",
...
Room {
    ...
    name = "长廊",
    ways = {["east"] = "putian/jcyuan", ["west"] = "putian/fzshi"},
    room_relative = "方丈室-----长廊-----戒持院长廊"
}
Room {
    id = "putian/changlang3",
    name = "长廊",
    ways = {["east"] = "putian/nuange", ["west"] = "putian/jcyuan"},
    room_relative = "戒持院-----长廊-----暖阁长廊"
}
Room {
    id = "putian/chufang",
    name = "饭厅",
    ways = {["south"] = "putian/celang5"}
}
Room {
    id = "putian/cjg",
    name = "藏经阁",
    ways = {["northdown"] = "putian/mf-dian"},
    objs = {
        ["风云手谱"] = "shaolin wuji",
        ["罗汉拳谱"] = "shaolin wuji",
        ["大痴大师"] = "dachi dashi"
...
Room {
    id = "putian/dmyuan",
    name = "达摩院",
    ways = {["west"] = "putian/mf-dian"},
    objs = {["天镜禅师"] = "tianjing chanshi"}
}
Room {
    id = "putian/dxb-dian",
    name = "大雄宝殿",
    ...
    objs = {["大苦大师"] = "daku dashi"}
}
Room {
    id = "putian/fatang2",
    name = "法堂",
    ways = {["east"] = "putian/houdian"}
}
Room {
    id = "putian/fatang3",
    name = "法堂",
    ways = {["west"] = "putian/houdian"}
}
Room {
    id = "putian/fzshi",
    name = "方丈室",
    ways = {["east"] = "putian/changlang2"}
}
Room {
...
Room {
    ...
    blocks = {["south"] = {{id = "dadian dashi", exp = 2200000}}},
    objs = {["大颠大师"] = "dadian dashi"}
}
Room {
    id = "putian/jingshi",
    name = "静室",
    ways = {["north"] = "putian/jcyuan"},
    objs = {["天虹禅师"] = "tianhong chanshi"}
}
Room {
    id = "putian/jnlw-dian",
    name = "紧那罗王殿",
    ways = {["north"] = "putian/xiaoyuan5"},
    objs = {["元怒尊者"] = "yuannu zunzhe"}
}
Room {
    id = "putian/lhtang",
    name = "罗汉堂",
    ways = {["east"] = "putian/dc-dian"},
    objs = {["元痛尊者"] = "yuantong zunzhe"}
}
Room {
    id = "putian/liangt",
    name = "凉亭",
    no_fight = true,
    ways = {["stand;out"] = "putian/road07"}
}
Room {
    id = "putian/lz-dian",
    name = "六祖殿",
    ways = {["north"] = "putian/xiaoyuan4"},
    objs = {["元哀尊者"] = "yuanai zunzhe"}
}
Room {
    id = "putian/mf-dian",
    name = "妙法殿",
    ...
    blocks = {["southup"] = {{id = "wu seng", exp = 200000}}}
}
Room {
    id = "putian/mtd1",
    name = "麻田地",
    ways = {["northup"] = "putian/mtd2"},
    objs = {["元悔尊者"] = "yuanhui zunzhe"},
    room_relative = "麻田地↑麻田地麻田地"
}
Room {
    id = "putian/mtd2",
    name = "麻田地",
    ways = {["north"] = "putian/xl8", ["southdown"] = "putian/mtd1"},
    room_relative = "小路｜麻田地↑麻田地麻田地"
}
Room {
    id = "putian/nuange",
    name = "暖阁",
    ways = {["west"] = "putian/changlang3"}
}
Room {
    id = "putian/qiandian",
    name = "前殿",
    ways = {["northup"] = "putian/dxb-dian", ["south"] = "putian/zhongdian"}
}
Room {
    id = "putian/qianyuan",
    name = "前院",
    ...
    nolooks = {["north"] = true},
    precmds = {["north"] = "open gate"}
}
Room {
    id = "putian/road01",
    name = "山路",
    ways = {["south"] = "putian/road02", ["northwest"] = "fuzhou/road2"},
    room_relative = "山路↖山路｜山路山路"
}
Room {
    id = "putian/road02",
...
Room {
    id = "putian/road03",
    name = "山路",
    ways = {["northwest"] = "putian/road02", ["east"] = "putian/road04"},
    room_relative = "山路↖山路-----山路山路"
}
Room {
    id = "putian/road04",
    name = "山路",
    ways = {["northeast"] = "putian/road05", ["west"] = "putian/road03"},
    room_relative = "山路↗山路-----山路山路"
}
Room {
    id = "putian/road05",
    name = "山路",
    ways = {["eastup"] = "putian/road06", ["southwest"] = "putian/road04"},
    room_relative = "山路→石阶↙山路山路"
}
Room {
    id = "putian/road06",
    name = "石阶",
    ways = {["southup"] = "putian/road07", ["westdown"] = "putian/road05"},
...
Room {
    id = "putian/road08",
    name = "石阶",
    ways = {["southup"] = "putian/shanmen", ["northdown"] = "putian/road07"},
...
Room {
    ...
    nolooks = {["south"] = true},
    precmds = {["south"] = "knock gate"}
}
Room {
    id = "putian/wgg",
    name = "武功阁",
    ways = {["northdown"] = "putian/dc-dian"},
    objs = {["元悲尊者"] = "yuanbei zunzhe"}
}
Room {
    id = "putian/xiaoyuan2",
    name = "小院",
    ways = {["south"] = "putian/celang2", ["west"] = "putian/qianyuan"},
    room_relative = "前院-----小院｜侧廊小院"
}
Room {
    id = "putian/xiaoyuan3",
    name = "小院",
    ways = {["south"] = "putian/celang3", ["east"] = "putian/qianyuan"},
...
Room {
    id = "putian/xj3",
    name = "小径",
    ways = {["south"] = "putian/mf-dian", ["north"] = "putian/celang5"},
    room_relative = "侧廊｜小径｜妙法殿小径"
}
Room {
    id = "putian/xj4",
    name = "小径",
    ways = {["south"] = "putian/dc-dian", ["north"] = "putian/celang4"},
    room_relative = "侧廊｜小径｜大乘殿小径"
}
Room {
    id = "putian/xl2",
    name = "小路",
    ways = {["east"] = "putian/shanmen", ["west"] = "putian/xl4"},
    room_relative = "小路-----小路-----山门小路"
}
Room {
    id = "putian/xl3",
    name = "小路",
    ways = {["east"] = "putian/xl5", ["west"] = "putian/shanmen"},
    room_relative = "山门-----小路-----小路小路"
}
Room {
    id = "putian/xl4",
    name = "小路",
    ways = {["east"] = "putian/xl2", ["west"] = "putian/xl6"},
    room_relative = "小路-----小路-----小路小路"
}
Room {
    id = "putian/xl5",
    name = "小路",
    ways = {["eastdown"] = "putian/xl7", ["west"] = "putian/xl3"},
    room_relative = "小路-----小路←小路小路"
}
Room {
    id = "putian/xl6",
    name = "小路",
    ways = {["southwest"] = "putian/xl8", ["east"] = "putian/xl4"},
    room_relative = "小路-----小路↙小路小路"
}
Room {
    id = "putian/xl7",
    name = "小路",
    ways = {["westup"] = "putian/xl5", ["north"] = "putian/youcaidi"},
    objs = {["金丝雀"] = "jinsi que"},
...
Room {
    id = "putian/xl8",
    name = "小路",
    ways = {["south"] = "putian/mtd2", ["northeast"] = "putian/xl6"},
    room_relative = "小路↗小路｜麻田地小路"
}
Room {
    id = "putian/xm-dian",
    name = "须弥殿",
    ways = {["south"] = "putian/jcyuan", ["north"] = "putian/houdian"}
}
Room {
    id = "putian/youcaidi",
    name = "油菜地",
    ways = {["south"] = "putian/xl7"}
}
Room {
    id = "putian/zhongdian",
    name = "中殿",
    ways = {["south"] = "putian/houdian", ["north"] = "putian/qiandian"}
}
Room {
    id = "shaolin/andao1",
    name = "暗道",
    ways = {["south"] = "shaolin/rukou", ["north"] = "shaolin/jianyu1"}
}
Room {
    id = "shaolin/andao2",
    name = "暗道",
    ways = {["up"] = "shaolin/gulou1"}
}
-- Room {
--	id = "shaolin/bamboon",
--	name = "竹林",
...
Room {
    id = "shaolin/bamboo3",
    name = "竹林",
    ways = {["north"] = "shaolin/bamboo4"}
}
Room {
    id = "shaolin/bamboo4",
    name = "竹林",
    ways = {["south"] = "shaolin/bamboo5"}
}
Room {
    id = "shaolin/bamboo5",
    name = "竹林",
    ways = {["west"] = "shaolin/bamboo6"}
}
Room {
    id = "shaolin/bamboo6",
    name = "竹林",
    ways = {["east"] = "shaolin/bamboo7"}
}
Room {
    id = "shaolin/bamboo7",
    name = "竹林",
    ways = {["west"] = "shaolin/bamboo8"}
}
Room {
    id = "shaolin/bamboo8",
    name = "竹林",
    ways = {["east"] = "shaolin/bamboo9"}
}
Room {
    id = "shaolin/bamboo9",
    name = "竹林",
    ways = {["east"] = "shaolin/bamboo10"}
}
Room {
    id = "shaolin/bamboo10",
    name = "竹林",
    ways = {["south"] = "shaolin/bamboo11"}
}
Room {
    id = "shaolin/bamboo11",
    name = "竹林",
    ways = {["west"] = "shaolin/bamboo12"}
}
Room {
    id = "shaolin/bamboo12",
    name = "竹林",
    ways = {["north"] = "shaolin/bamboo13"}
}
Room {
    id = "shaolin/bamboo13",
    name = "竹林",
    ways = {["northwest"] = "shaolin/bamboo14"}
}
Room {
    id = "shaolin/bamboo14",
    name = "竹林",
    ways = {["north"] = "shaolin/damodong"}
}
Room {
    id = "shaolin/banruo1",
    name = "般若堂一部",
    ways = {["north"] = "shaolin/banruo2"},
    objs = {["澄心"] = "chengxin luohan"}
}
Room {
    id = "shaolin/banruo2",
    name = "般若堂二部",
    ways = {["south"] = "shaolin/banruo1", ["north"] = "shaolin/banruo3"},
    objs = {["澄意"] = "chengyi luohan"}
}
Room {
    id = "shaolin/banruo3",
    name = "般若堂三部",
    ways = {["south"] = "shaolin/banruo2", ["north"] = "shaolin/banruo4"},
    objs = {["澄思"] = "chengsi luohan"}
}
Room {
    id = "shaolin/banruo4",
    name = "般若堂四部",
    ways = {["south"] = "shaolin/banruo3", ["north"] = "shaolin/banruo5"},
    objs = {["澄识"] = "chengshi luohan"}
}
Room {
    id = "shaolin/banruo5",
    name = "般若堂五部",
    ...
    objs = {["澄志"] = "chengzhi luohan"}
}
Room {
    id = "shaolin/banruo6",
    name = "般若堂六部",
    ways = {["south"] = "shaolin/banruo5", ["north"] = "shaolin/banruo7"},
    objs = {["澄信"] = "chengxin luohan"}
}
Room {
    id = "shaolin/banruo7",
    name = "般若堂七部",
    ways = {["south"] = "shaolin/banruo6", ["north"] = "shaolin/banruo8"},
    objs = {["澄灵"] = "chengling luohan"}
}
Room {
    id = "shaolin/banruo8",
    name = "般若堂八部",
    ways = {["south"] = "shaolin/banruo7", ["north"] = "shaolin/banruo9"},
    objs = {["澄欲"] = "chengyu luohan"}
}
Room {
    id = "shaolin/banruo9",
    name = "般若堂九部",
    ways = {["south"] = "shaolin/banruo8"},
    objs = {["澄尚"] = "chengshang luohan"}
}
Room {
    id = "shaolin/brtang",
    name = "般若堂",
    ways = {["east"] = "shaolin/lwc16", ["west"] = "shaolin/stoneroad3"},
    objs = {["玄难大师"] = "xuannan dashi"}
}
Room {
    id = "shaolin/bydian",
    name = "白衣殿",
    ways = {["west"] = "shaolin/kchang"}
}
Room {
    id = "shaolin/cdian-1",
    name = "东侧殿",
    ways = {["west"] = "shaolin/gchang-3"}
}
Room {
    id = "shaolin/cdian-2",
    name = "西侧殿",
    ways = {["east"] = "shaolin/gchang-2"}
}
Room {
    id = "shaolin/celang-1",
    name = "西侧廊",
...
Room {
    ...
    objs = {["玄澄大师"] = "xuancheng dashi"}
}
Room {
    id = "shaolin/chanfang-2",
    name = "禅房",
    no_fight = true,
    ways = {["south"] = "shaolin/chanfang-1"}
}
Room {
    id = "shaolin/chanfang-3",
    name = "禅房",
    no_fight = true,
    ways = {["north"] = "shaolin/chanfang-1"},
    objs = {["阿含经"] = "shu"}
}
Room {
    id = "shaolin/chufang1",
    name = "香积厨",
    ways = {["south"] = "shaolin/chufang2", ["west"] = "shaolin/fanting1"},
...
Room {
    id = "shaolin/cjlou",
    name = "藏经阁一楼",
    ways = {["out"] = "shaolin/xiaoxi1", ["up"] = "shaolin/cjlou1"},
    blocks = {
        ["up"] = {
            {
                id = "daoyi chanshi",
                ...
                cond = function()
                    if score.master and
                        (score.master == "无名老僧" or score.master ==
                            "慕容博") then
                        return true
                    else
                        return false
...
Room {
    ...
    nolooks = {["push chuang;jump chuang"] = true},
    objs = {["慧真尊者"] = "huizhen zunzhe"}
}
Room {
    id = "shaolin/cyzi-1",
    name = "菜园子",
...
Room {
    id = "shaolin/cyzi-2",
    name = "菜园子",
    ways = {["east"] = "shaolin/cyzi-3", ["north"] = "shaolin/cyzi-1"},
    room_relative = "菜园子｜菜园子----菜园子菜园子"
}
Room {
    id = "shaolin/cyzi-3",
    name = "菜园子",
    ways = {["north"] = "shaolin/cyzi-4", ["west"] = "shaolin/cyzi-2"},
    room_relative = "菜园子｜菜园子----菜园子菜园子"
}
Room {
    id = "shaolin/cyzi-4",
    name = "菜园子",
    ways = {["south"] = "shaolin/cyzi-3", ["west"] = "shaolin/cyzi-1"},
    room_relative = "菜园子----菜园子｜菜园子菜园子"
}
Room {
    id = "shaolin/czan",
    name = "初祖庵",
    ways = {["south"] = "shaolin/shanlu4", ["north"] = "shaolin/shanlu5"}
}
Room {
    id = "shaolin/dabeidia",
    name = "大悲殿",
    ...
    objs = {["道正禅师"] = "daozheng chanshi", ["木鱼槌"] = "muyu chui"}
}
Room {
    id = "shaolin/damodong",
    name = "达摩洞",
    ways = {["out"] = "shaolin/bamboo1"}
}
Room {
    id = "shaolin/daxiong",
    name = "大雄宝殿",
    no_fight = true,
    ways = {["south"] = "shaolin/pingtai", ["north"] = "shaolin/stoneroad1"}
}
Room {
    id = "shaolin/dmyuan",
    name = "达摩院",
    no_fight = true,
    ways = {["south"] = "shaolin/huilang4", ["north"] = "shaolin/dmyuan2"},
    objs = {["玄悲大师"] = "xuanbei dashi"}
}
Room {
    id = "shaolin/dmyuan2",
    name = "达摩院后殿",
    no_fight = true,
    ways = {["south"] = "shaolin/dmyuan"}
}
Room {
    id = "shaolin/duanya",
    name = "断崖坪",
...
Room {
    id = "shaolin/dxshijie",
    name = "台阶",
    ways = {["northup"] = "shaolin/pingtai", ["south"] = "shaolin/stoneroad2"}
}
Room {
    id = "shaolin/dzdian",
    name = "地藏殿",
    ways = {["east"] = "shaolin/kchang"}
}
Room {
    id = "shaolin/entrance",
    name = "木人巷入口",
    ways = {["north"] = "shaolin/murenxiang"}
}
Room {
    id = "shaolin/fangjuku",
    name = "防具库",
    ways = {["north"] = "shaolin/lshuyuan"},
    objs = {["道相禅师"] = "daoxiang chanshi"}
}
Room {
    id = "shaolin/fanting1",
    name = "饭厅",
...
Room {
    id = "shaolin/fanting2",
    name = "饭厅",
    ways = {["south"] = "shaolin/fanting1"},
    room_relative = "饭厅｜饭厅饭厅"
}
Room {
    id = "shaolin/fanting3",
    name = "饭厅",
    ways = {["north"] = "shaolin/fanting1", ["east"] = "shaolin/chufang2"},
...
Room {
    id = "shaolin/fota1",
    name = "佛塔一层",
    ways = {["out"] = "shaolin/fotaout", ["up"] = "shaolin/fota2"}
}
Room {
    id = "shaolin/fota2",
    name = "圣僧塔",
    ways = {["down"] = "shaolin/fota1", ["up"] = "shaolin/fota3"}
}
Room {
    id = "shaolin/fota3",
    name = "佛塔三层",
    ways = {["down"] = "shaolin/fota2"}
}
Room {
    id = "shaolin/fotaout",
    name = "古佛舍利塔",
...
Room {
    id = "shaolin/fumoquan",
    name = "金刚伏魔圈",
    ways = {["out"] = "shaolin/qyping"},
    objs = {["渡难"] = "du nan", ["渡劫"] = "du jie", ["渡厄"] = "du e"}
}
Room {
    id = "shaolin/fxjing",
    name = "佛心井",
    ways = {["westdown"] = "shaolin/shijie9"}
}
Room {
    id = "shaolin/fzjs",
    name = "方丈精舍",
    ways = {["east"] = "shaolin/xiaolu7", ["up"] = "shaolin/fzjs1"}
}
Room {
    id = "shaolin/fzjs1",
    name = "茶室",
    ways = {["north"] = "shaolin/fzjs2", ["down"] = "shaolin/fzjs"},
    objs = {["清乐比丘"] = "qingle biqiu"}
}
Room {
    id = "shaolin/fzjs2",
    name = "方丈室",
    ways = {["south"] = "shaolin/fzjs1"},
    objs = {["玄慈大师"] = "xuanci dashi"}
}
Room {
    id = "shaolin/gchang-1",
    name = "广场",
...
Room {
    id = "shaolin/gchange",
    name = "寺前广场",
    ways = {["west"] = "shaolin/guangchang"},
    objs = {["清无比丘"] = "qingwu biqiu"}
}
Room {
    id = "shaolin/gchangw",
    name = "寺前广场",
    ways = {["east"] = "shaolin/guangchang"},
    objs = {["清为比丘"] = "qingwei biqiu"}
}
Room {
...
Room {
    id = "shaolin/gulou",
    name = "鼓楼小院",
    ways = {["enter"] = "shaolin/gulou1", ["east"] = "shaolin/celang-1"}
}
Room {
    id = "shaolin/gulou1",
    name = "鼓楼一层",
    ways = {["up"] = "shaolin/gulou2", ["out"] = "shaolin/gulou"}
}
Room {
    id = "shaolin/gulou2",
    name = "鼓楼二层",
    ways = {["down"] = "shaolin/gulou1", ["up"] = "shaolin/gulou3"}
}
Room {
    id = "shaolin/gulou3",
    name = "鼓楼三层",
    ways = {["down"] = "shaolin/gulou2", ["up"] = "shaolin/gulou4"}
}
Room {
    id = "shaolin/gulou4",
    name = "鼓楼四层",
    ways = {["down"] = "shaolin/gulou3", ["up"] = "shaolin/gulou5"}
}
Room {
    id = "shaolin/gulou5",
    name = "鼓楼五层",
    ways = {["down"] = "shaolin/gulou4", ["up"] = "shaolin/gulou6"}
}
Room {
    id = "shaolin/gulou6",
    name = "鼓楼六层",
    ways = {["down"] = "shaolin/gulou5", ["up"] = "shaolin/gulou7"}
}
Room {
    id = "shaolin/gulou7",
    name = "鼓楼七层",
    ways = {["down"] = "shaolin/gulou6"},
    objs = {["清闻比丘"] = "qingwen biqiu"}
}
Room {
    id = "shaolin/gygu",
    name = "归元谷",
    ways = {["southeast"] = "shaolin/xclang", ["northwest"] = "shaolin/gygu"}
}
Room {
    id = "shaolin/hguangz1",
    name = "后殿广场",
...
Room {
    id = "shaolin/hguangz4",
    name = "后殿广场",
    ways = {["south"] = "shaolin/hguangz1", ["east"] = "shaolin/houdian"},
    room_relative = "后殿广场---后殿｜后殿广场后殿广场"
}
Room {
    id = "shaolin/hguangz5",
    name = "后殿广场",
    ways = {["south"] = "shaolin/hguangz3", ["west"] = "shaolin/houdian"},
...
Room {
    id = "shaolin/houshand",
    name = "山洞",
    ways = {["out"] = "shaolin/yading"}
}
Room {
    id = "shaolin/houyuan",
    name = "小屋",
    ways = {["enter"] = "shaolin/liwu", ["north"] = "shaolin/xiaojin1"},
    objs = {["慕容博"] = "murong bo"}
}
Room {
    id = "shaolin/huaishu1",
    name = "槐树林",
    ways = {["east"] = "shaolin/huaishu2", ["west"] = "shaolin/putiyuan"},
...
Room {
    ...
    name = "晦智圣座",
    ways = {["out"] = "shaolin/fota2"}
}
Room {id = "shaolin/jianyu", name = "监狱"}
Room {
    id = "shaolin/jianyu1",
    name = "监狱",
    ways = {["north"] = "shaolin/jianyu"}
}
Room {
    id = "shaolin/jieluyua",
    name = "戒律院",
    no_fight = true,
    ways = {["west"] = "shaolin/songshu4"}
}
Room {
    id = "shaolin/jietan1",
    name = "戒坛",
...
Room {
    id = "shaolin/jiulou1",
    name = "迎宾楼",
    ways = {["east"] = "shaolin/nanyang", ["up"] = "shaolin/jiulou2"}
}
Room {
    id = "shaolin/jiulou2",
    name = "迎宾楼二楼",
    ways = {["down"] = "shaolin/jiulou1"}
}
Room {
    id = "shaolin/jnlwang",
    name = "紧那罗王殿",
    ways = {["west"] = "shaolin/pingtai"},
    objs = {["木鱼槌"] = "muyu chui", ["道品禅师"] = "daopin chanshi"}
}
Room {
    id = "shaolin/jxzhuang",
    name = "聚贤庄",
    ways = {["west"] = "shaolin/yidao2"}
}
Room {
    id = "shaolin/kchang",
    name = "空场",
...
Room {
    id = "shaolin/kedian1",
    name = "悦来客栈",
    ways = {["west"] = "shaolin/nanyang", ["up"] = "shaolin/kedian2"}
}
Room {
    id = "shaolin/kedian2",
    name = "客店二楼",
    ways = {["down"] = "shaolin/kedian1"}
}
Room {
...
Room {
    id = "shaolin/lhtang",
    name = "罗汉堂",
    ways = {["east"] = "shaolin/stoneroad4", ["west"] = "shaolin/lwc"},
    objs = {["玄苦大师"] = "xuanku dashi"}
}
Room {
    id = "shaolin/liuzu",
    name = "六祖殿",
    ways = {["east"] = "shaolin/pingtai"},
    objs = {["木鱼槌"] = "muyu chui", ["道成禅师"] = "daocheng chanshi"}
}
Room {
    id = "shaolin/liwu",
    name = "里屋",
    ways = {["out"] = "shaolin/houyuan"},
    objs = {["无名老僧"] = "wuming laoseng"}
}
Room {
    id = "shaolin/lshuyuan",
    name = "龙树院",
...
Room {
    id = "shaolin/luohan1",
    name = "罗汉堂一部",
    ways = {["north"] = "shaolin/luohan2"},
    objs = {["澄观"] = "chengguan luohan"}
}
Room {
    id = "shaolin/luohan2",
    name = "罗汉堂二部",
    ways = {["south"] = "shaolin/luohan1", ["north"] = "shaolin/luohan3"},
    objs = {["澄知"] = "chengzhi luohan"}
}
Room {
    id = "shaolin/luohan3",
    name = "罗汉堂三部",
    ways = {["south"] = "shaolin/luohan2", ["north"] = "shaolin/luohan4"},
    objs = {["澄明"] = "chengming luohan"}
}
Room {
    id = "shaolin/luohan4",
    name = "罗汉堂四部",
    ways = {["south"] = "shaolin/luohan3", ["north"] = "shaolin/luohan5"},
    objs = {["澄净"] = "chengjing luohan"}
}
Room {
    id = "shaolin/luohan5",
    name = "罗汉堂五部",
    ...
    objs = {["澄坚"] = "chengjian luohan"}
}
Room {
    id = "shaolin/luohan6",
    name = "罗汉堂六部",
    ways = {["south"] = "shaolin/luohan5", ["north"] = "shaolin/luohan7"},
    objs = {["澄行"] = "chengxing luohan"}
}
Room {
    id = "shaolin/luohan7",
    name = "罗汉堂七部",
    ways = {["south"] = "shaolin/luohan6", ["north"] = "shaolin/luohan8"},
    objs = {["澄寂"] = "chengji luohan"}
}
Room {
    id = "shaolin/luohan8",
    name = "罗汉堂八部",
    ways = {["south"] = "shaolin/luohan7", ["north"] = "shaolin/luohan9"},
    objs = {["澄灭"] = "chengmie luohan"}
}
Room {
    id = "shaolin/luohan9",
    name = "罗汉堂九部",
    ways = {["south"] = "shaolin/luohan8"},
    objs = {["澄和"] = "chenghe luohan"}
}
Room {
    id = "shaolin/lwc",
    name = "练武场",
...
Room {
    id = "shaolin/lwc12",
    name = "练武场",
    ways = {["south"] = "shaolin/lwc11", ["west"] = "shaolin/lwc13"},
    objs = {["木人"] = "mu ren"}
}
Room {
    id = "shaolin/lwc13",
    ...
    objs = {["梅花桩"] = "meihua zhuang"}
}
Room {
    id = "shaolin/lwc14",
    name = "练武场",
    ways = {["south"] = "shaolin/lwc16", ["east"] = "shaolin/lwc13"},
    objs = {["铜人"] = "tong ren"}
}
Room {
    id = "shaolin/lwc15",
...
Room {
    id = "shaolin/lwc17",
    name = "练武场",
    ways = {["east"] = "shaolin/lwc18", ["north"] = "shaolin/lwc16"},
    objs = {["木人"] = "mu ren"}
}
Room {
    id = "shaolin/lwc18",
...
Room {
    id = "shaolin/lwc19",
    name = "练武场",
    ways = {["north"] = "shaolin/lwc11", ["west"] = "shaolin/lwc18"},
    objs = {["铜人"] = "tong ren"}
}
Room {
    id = "shaolin/lwc2",
    name = "练武场",
    ways = {["south"] = "shaolin/lwc", ["west"] = "shaolin/lwc3"},
    objs = {["木人"] = "mu ren"}
}
Room {
    id = "shaolin/lwc3",
...
Room {
    id = "shaolin/lwc4",
    name = "练武场",
    ways = {["south"] = "shaolin/lwc6", ["east"] = "shaolin/lwc3"},
    objs = {["铜人"] = "tong ren"}
}
Room {
    id = "shaolin/lwc5",
...
Room {
    id = "shaolin/lwc7",
    name = "练武场",
    ways = {["east"] = "shaolin/lwc8", ["north"] = "shaolin/lwc6"},
    objs = {["木人"] = "mu ren"}
}
Room {
    id = "shaolin/lwc8",
...
Room {
    id = "shaolin/lwc9",
    name = "练武场",
    ways = {["north"] = "shaolin/lwc", ["west"] = "shaolin/lwc8"},
    objs = {["铜人"] = "tong ren"}
}
Room {
    id = "shaolin/lxting",
    name = "立雪亭",
    ways = {["north"] = "shaolin/sblu-2", ["southdown"] = "shaolin/taijie"},
    objs = {["慧光尊者"] = "huiguang zunzhe"}
}
Room {
...
Room {
    id = "shaolin/putiyuan",
    name = "菩提院",
    ways = {["east"] = "shaolin/huaishu1"},
    objs = {["玄渡大师"] = "xuandu dashi"}
}
Room {
    id = "shaolin/qdian",
    name = "前殿",
    ways = {["south"] = "shaolin/gchang-1", ["north"] = "shaolin/twdian"},
    objs = {["清善比丘"] = "qingshan biqiu"}
}
Room {
    id = "shaolin/qfdian",
    name = "千佛殿",
    ways = {["south"] = "shaolin/kchang", ["north"] = "shaolin/shanlu1"},
    objs = {["清观比丘"] = "qingguan biqiu"}
}
Room {
    id = "shaolin/qyping",
    name = "青云坪",
    ...
    nolooks = {["southdown"] = true, ["sd;w;e;n;e;s;n;e;w;s"] = true}
}
Room {
    id = "shaolin/rukou",
    name = "五行洞入口",
    ways = {["north"] = "shaolin/andao1"}
}
Room {
    id = "shaolin/ruzhou",
    name = "汝州城",
    ways = {["south"] = "nanyang/yidao3", ["west"] = "shaolin/shijie1"}
}
Room {
    id = "shaolin/sblu-1",
    name = "石板路",
...
Room {
    id = "shaolin/shanlu1",
    name = "山路",
    ways = {["south"] = "shaolin/qfdian", ["north"] = "shaolin/shanlu2"},
    room_relative = "山路｜山路｜千佛殿山路"
}
Room {
    id = "shaolin/shanlu2",
    name = "山路",
    ways = {["northup"] = "shaolin/shanlu3", ["south"] = "shaolin/shanlu1"},
    room_relative = "山路↑山路｜山路山路"
}
Room {
    id = "shaolin/shanlu3",
    name = "山路",
    ways = {["north"] = "shaolin/shanlu4", ["southdown"] = "shaolin/shanlu2"},
    room_relative = "山路｜山路↑山路山路"
}
Room {
    id = "shaolin/shanlu4",
    name = "山路",
    ways = {["south"] = "shaolin/shanlu3", ["north"] = "shaolin/czan"},
    room_relative = "初祖庵｜山路｜山路山路"
}
Room {
    id = "shaolin/shanlu5",
    name = "山路",
    ways = {["northup"] = "shaolin/shanlu6", ["south"] = "shaolin/czan"},
...
Room {
    ...
    nolooks = {["east"] = true, ["e;w;e;s;e;n;n;e;w;s"] = true},
    room_relative = "山路-----松树林↙山路山路"
}
Room {
    id = "shaolin/shifang",
    name = "石坊",
    ways = {["south"] = "shaolin/shijie11", ["north"] = "shaolin/guangchang"}
}
Room {
    id = "shaolin/shijie1",
    name = "石阶",
...
Room {
    id = "shaolin/shijie10",
    name = "石阶",
    ways = {["northup"] = "shaolin/shijie11", ["eastdown"] = "shaolin/shijie9"},
    room_relative = "石阶↑石阶←石阶石阶"
}
Room {
    id = "shaolin/shijie11",
    name = "石阶",
    ways = {["north"] = "shaolin/shifang", ["southdown"] = "shaolin/shijie10"},
    room_relative = "石坊｜石阶↑石阶石阶"
}
Room {
    id = "shaolin/shijie2",
    name = "石阶",
    ways = {["westup"] = "shaolin/shijie3", ["southdown"] = "shaolin/shijie1"},
    room_relative = "石阶←石阶↑石阶石阶"
}
Room {
    id = "shaolin/shijie3",
    name = "石阶",
    ways = {["northup"] = "shaolin/shijie4", ["eastdown"] = "shaolin/shijie2"},
    room_relative = "石阶↑石阶←石阶石阶"
}
Room {
    id = "shaolin/shijie4",
    name = "石阶",
    ways = {["northup"] = "shaolin/shijie5", ["southdown"] = "shaolin/shijie3"},
    objs = {["方天劳"] = "fang tianlao"},
    room_relative = "石阶↑石阶↑石阶石阶"
}
Room {
    id = "shaolin/shijie5",
    name = "石阶",
    ways = {["northup"] = "shaolin/shijie6", ["southdown"] = "shaolin/shijie4"},
    room_relative = "石阶↑石阶↑石阶石阶"
}
Room {
    id = "shaolin/shijie6",
    ...
    objs = {["潘天耕"] = "pan tiangeng"},
    room_relative = "山路〓石阶←石阶↑石阶石阶"
}
Room {
    id = "shaolin/shijie7",
    name = "石阶",
    ways = {["eastdown"] = "shaolin/shijie6", ["westup"] = "shaolin/shijie8"},
    room_relative = "石阶←石阶←石阶石阶"
}
Room {
    id = "shaolin/shijie8",
    name = "石阶",
    ways = {["northup"] = "shaolin/ting", ["eastdown"] = "shaolin/shijie7"},
...
Room {
    id = "shaolin/shiting1",
    name = "石亭",
    ways = {["north"] = "shaolin/shiting2"}
}
Room {
    id = "shaolin/shiting2",
    name = "石亭",
    ways = {["south"] = "shaolin/shiting1", ["north"] = "shaolin/shiting3"}
}
Room {
    id = "shaolin/shiting3",
    name = "石亭",
    ways = {["south"] = "shaolin/shiting2", ["north"] = "shaolin/shiting4"}
}
Room {
    id = "shaolin/shiting4",
    name = "石亭",
    ways = {["south"] = "shaolin/shiting3", ["north"] = "shaolin/shiting5"}
}
Room {
    id = "shaolin/shiting5",
    name = "石亭",
    ways = {["south"] = "shaolin/shiting4", ["north"] = "shaolin/shiting6"}
}
Room {
    id = "shaolin/shiting6",
    name = "石亭",
    ways = {["south"] = "shaolin/shiting5", ["north"] = "shaolin/shiting7"}
}
Room {
    id = "shaolin/shiting7",
    name = "石亭",
    ways = {["south"] = "shaolin/shiting6"}
}
Room {
    id = "shaolin/slyuan",
    name = "舍利院",
    ...
    precmds = {["west"] = "open door"},
    lengths = {["open door;w;ne;n;nw;sw;w;ne;w;s;nw;sw;n"] = 13}
}
Room {
    id = "shaolin/talin1",
    name = "塔林",
    ways = {["east"] = "shaolin/slyuan", ["northeast"] = "shaolin/talin2"},
    precmds = {["east"] = "open door"}
}
Room {
    id = "shaolin/talin2",
    name = "塔林",
    ways = {["north"] = "shaolin/talin3", ["southeast"] = "shaolin/talin1"}
}
Room {
    id = "shaolin/talin3",
    name = "塔林",
    ways = {["south"] = "shaolin/talin2", ["northwest"] = "shaolin/talin4"}
}
Room {
    id = "shaolin/talin4",
    name = "塔林",
    ways = {["southeast"] = "shaolin/talin3", ["southwest"] = "shaolin/talin5"}
}
Room {
    id = "shaolin/talin5",
    name = "塔林",
    ways = {["northeast"] = "shaolin/talin4", ["west"] = "shaolin/talin6"}
}
Room {
    id = "shaolin/talin6",
    name = "塔林",
    ways = {["northeast"] = "shaolin/talin7", ["east"] = "shaolin/talin5"}
}
Room {
    id = "shaolin/talin7",
    name = "塔林",
    ways = {["west"] = "shaolin/talin8", ["southwest"] = "shaolin/talin6"}
}
Room {
    id = "shaolin/talin8",
    name = "塔林",
    ways = {["south"] = "shaolin/talin9", ["east"] = "shaolin/talin7"}
}
Room {
    id = "shaolin/talin9",
    name = "塔林",
    ways = {["northwest"] = "shaolin/talin10", ["north"] = "shaolin/talin8"}
}
Room {
    id = "shaolin/talin10",
    name = "塔林",
    ways = {["southeast"] = "shaolin/talin9", ["southwest"] = "shaolin/talin11"}
}
Room {
    id = "shaolin/talin11",
    name = "塔林",
    ways = {["northeast"] = "shaolin/talin10", ["north"] = "shaolin/fotaout"}
}
Room {
    id = "shaolin/smdian",
    name = "山门殿",
    ways = {["south"] = "shaolin/guangchang", ["north"] = "shaolin/gchang-1"},
    nolooks = {["south"] = true},
    precmds = {["south"] = "open gate"}
}
Room {
    id = "shaolin/songshu1",
    name = "松树林",
...
Room {
    id = "shaolin/songshu4",
    name = "松树林",
    ways = {["east"] = "shaolin/jieluyua", ["west"] = "shaolin/songshu3"},
    lengths = {
...
Room {
    id = "shaolin/taijie",
    name = "台阶",
    ways = {["northup"] = "shaolin/lxting", ["south"] = "shaolin/houdian"}
}
...
Room {
    id = "shaolin/twdian",
    name = "天王殿",
    ways = {["south"] = "shaolin/qdian", ["north"] = "shaolin/sblu-1"},
    objs = {["道果禅师"] = "daoguo chanshi"}
}
Room {
    id = "shaolin/woshi",
    name = "卧室",
    ways = {["south"] = "shaolin/xiaowu"}
}
Room {
    id = "shaolin/wstang1",
    name = "武僧堂",
    ways = {["south"] = "shaolin/wstang2", ["east"] = "shaolin/yanwutang"},
    objs = {["圆音和尚"] = "yuanyin heshang"}
}
Room {
    id = "shaolin/wstang2",
    name = "武僧堂",
    ways = {["south"] = "shaolin/wstang3", ["north"] = "shaolin/wstang1"},
    objs = {["圆心和尚"] = "yuanxin heshang"}
}
Room {
    id = "shaolin/wstang3",
    name = "武僧堂",
    ways = {["south"] = "shaolin/wstang4", ["north"] = "shaolin/wstang2"},
    objs = {["圆业和尚"] = "yuanye heshang"}
}
Room {
    id = "shaolin/wstang4",
    name = "武僧堂",
    ways = {["south"] = "shaolin/wstang5", ["north"] = "shaolin/wstang3"},
    objs = {["圆觉和尚"] = "yuanjue heshang"}
}
Room {
    id = "shaolin/wstang5",
    name = "武僧堂",
    ways = {["south"] = "shaolin/wstang6", ["north"] = "shaolin/wstang4"},
    objs = {["圆慧和尚"] = "yuanhui heshang"}
}
Room {
    id = "shaolin/wstang6",
    name = "武僧堂",
    ways = {["north"] = "shaolin/wstang5"},
    objs = {["圆灭和尚"] = "yuanmie heshang"}
}
Room {
    id = "shaolin/wuqiku",
    name = "武器库",
    ways = {["south"] = "shaolin/lshuyuan"},
    objs = {["道尘禅师"] = "daochen chanshi"}
}
Room {
    id = "shaolin/wusetai",
    name = "无色台",
...
Room {
    id = "shaolin/xclang",
    name = "石廊",
    ways = {["northwest"] = "shaolin/gygu", ["east"] = "shaolin/xctang"}
}
Room {
    id = "shaolin/xcping",
    name = "心禅坪",
    ways = {["north"] = "shaolin/xctang", ["west"] = "shaolin/fatang"},
    lengths = {
        ["north"] = "if score.party and score.party=='少林派' then return 1 else return false end"
    },
    objs = {["慧云尊者"] = "huiyun zunzhe"}
}
Room {
    id = "shaolin/xctang",
    name = "心禅堂",
    ...
    objs = {["方生大师"] = "fangsheng dashi"}
}
Room {
    id = "shaolin/xianglu",
    name = "香炉",
    ways = {["south"] = "shaolin/sblu-1", ["north"] = "shaolin/stoneroad2"}
}
Room {
    id = "shaolin/xiaojin1",
    name = "小径",
    ways = {["south"] = "shaolin/houyuan", ["jump out"] = "shaolin/cjlou1"},
    nolooks = {["jump out"] = true}
}
Room {
...
Room {
    id = "shaolin/xiaolu-1",
    name = "小路",
    ways = {["southeast"] = "shaolin/xiaolu-2", ["north"] = "shaolin/chufang2"},
    room_relative = "香积厨｜小路↘小路小路"
}
Room {
    id = "shaolin/xiaolu-2",
    name = "小路",
    ways = {["south"] = "shaolin/xiaolu-3", ["northwest"] = "shaolin/xiaolu-1"},
    room_relative = "小路↖小路｜小路小路"
}
Room {
    id = "shaolin/xiaolu-3",
    name = "小路",
    ways = {["south"] = "shaolin/cyzi-1", ["north"] = "shaolin/xiaolu-2"},
    room_relative = "小路｜小路｜菜园子小路"
}
Room {
    id = "shaolin/xiaolu1",
    name = "林中小路",
    ways = {["east"] = "shaolin/xiaolu2", ["west"] = "shaolin/sblu-2"},
    room_relative = "石板路---林中小路---林中小路林中小路"
}
Room {
    id = "shaolin/xiaolu2",
    name = "林中小路",
    ways = {["northeast"] = "shaolin/xiaolu3", ["west"] = "shaolin/xiaolu1"},
...
Room {
    id = "shaolin/xiaolu4",
    name = "林中小路",
    ways = {["northwest"] = "shaolin/xiaolu3", ["east"] = "shaolin/xiaoxi"},
    room_relative = "林中小路↖林中小路---小溪林中小路"
}
Room {
    id = "shaolin/xiaolu5",
    name = "林中小路",
    ways = {["east"] = "shaolin/sblu-2", ["west"] = "shaolin/xiaolu6"},
    room_relative = "林中小路---林中小路---石板路林中小路"
}
Room {
    id = "shaolin/xiaolu6",
    name = "林中小路",
    ways = {["east"] = "shaolin/xiaolu5", ["west"] = "shaolin/xiaolu7"},
    room_relative = "林中小路---林中小路---林中小路林中小路"
}
Room {
    id = "shaolin/xiaolu7",
    name = "林中小路",
    ways = {["east"] = "shaolin/xiaolu6", ["west"] = "shaolin/fzjs"},
    room_relative = "方丈精舍---林中小路---林中小路林中小路"
}
Room {
    id = "shaolin/xiaowu",
    name = "小土屋",
    ways = {["south"] = "shaolin/houshan", ["north"] = "shaolin/woshi"}
}
Room {
    id = "shaolin/xiaoxi",
    name = "小溪",
    ways = {["west"] = "shaolin/xiaolu4", ["jump river"] = "shaolin/xiaoxi1"},
    nolooks = {["jump river"] = true}
}
Room {
    id = "shaolin/xiaoxi1",
    name = "溪旁空地",
    ways = {["enter"] = "shaolin/cjlou", ["jump river"] = "shaolin/xiaoxi"},
    nolooks = {["jump river"] = true}
}
Room {
    id = "shaolin/xjchu",
    name = "粥室",
    no_fight = true,
    ways = {["south"] = "shaolin/zhaitang"}
}
Room {
    id = "shaolin/xumidian",
    name = "须弥殿",
    ways = {["east"] = "shaolin/dabeidia"},
    objs = {["木鱼槌"] = "muyu chui"}
}
Room {
    id = "shaolin/yading",
    name = "崖顶",
    ways = {["enter"] = "shaolin/houshand", ["down"] = "shaolin/duanya"}
}
Room {
    id = "shaolin/yanwutang",
    name = "演武堂",
    ways = {["east"] = "shaolin/luohan5", ["west"] = "shaolin/wstang1"},
    lengths = {
...
Room {
    id = "shaolin/yaowang",
    name = "药王院",
    ways = {["west"] = "shaolin/songshu1"},
    objs = {["道象禅师"] = "daoxiang chanshi"}
}
Room {
    id = "shaolin/zdyuan",
    name = "证道院",
    ways = {["east"] = "shaolin/celang-2", ["west"] = "shaolin/chanfang-1"},
    objs = {
...
Room {
    ...
    objs = {["慧洁尊者"] = "huijie zunzhe"}
}
Room {
    id = "shaolin/zhlou1",
    name = "钟楼一层",
    ways = {["out"] = "shaolin/zhonglou", ["up"] = "shaolin/zhlou2"}
}
Room {
    id = "shaolin/zhlou2",
    name = "钟楼二层",
    ways = {["down"] = "shaolin/zhlou1", ["up"] = "shaolin/zhlou3"}
}
Room {
    id = "shaolin/zhlou3",
    name = "钟楼三层",
    ways = {["down"] = "shaolin/zhlou2", ["up"] = "shaolin/zhlou4"}
}
Room {
    id = "shaolin/zhlou4",
    name = "钟楼四层",
    ways = {["down"] = "shaolin/zhlou3", ["up"] = "shaolin/zhlou5"}
}
Room {
    id = "shaolin/zhlou5",
    name = "钟楼五层",
    ways = {["down"] = "shaolin/zhlou4", ["up"] = "shaolin/zhlou6"}
}
Room {
    id = "shaolin/zhlou6",
    name = "钟楼六层",
    ways = {["down"] = "shaolin/zhlou5", ["up"] = "shaolin/zhlou7"}
}
Room {
    id = "shaolin/zhlou7",
    name = "钟楼七层",
    ways = {["down"] = "shaolin/zhlou6"},
    objs = {["清晓比丘"] = "qingxiao biqiu"}
}
Room {
    id = "shaolin/zhonglou",
    name = "钟楼小院",
    ways = {["enter"] = "shaolin/zhlou1", ["west"] = "shaolin/celang-3"}
}
Room {
    id = "shaolin/zhushe",
    name = "猪舍",
    ways = {["southeast"] = "shaolin/houshan"}
}
Room {
    id = "sld/blm",
    name = "白龙门议事厅",
    ...
    objs = {["钟志灵"] = "zhong zhiling", ["白龙门弟子"] = "white dizi"}
}
Room {
    id = "sld/blmlgf",
    name = "练功房",
...
Room {id = "sld/cf", name = "厨房", ways = {["west"] = "sld/th"}}
Room {
    id = "sld/clm",
    name = "赤龙门议事厅",
    ways = {
    ...
    objs = {["无根道人"] = "wugen daoren", ["赤龙门弟子"] = "red dizi"}
}
Room {id = "sld/clmlgf", name = "练功房", ways = {["east"] = "sld/clm"}}
Room {
    id = "sld/clmws",
    name = "卧室",
    no_fight = true,
...
Room {
    id = "sld/dt",
    name = "大厅",
    ways = {["south"] = "sld/slj", ["north"] = "sld/th"},
    objs = {
        ["瘦头陀"] = "shou toutuo",
        ["洪安通"] = "hong antong",
        ["总坛弟子"] = "shenlong dizi",
...
Room {
    id = "sld/haitan",
    name = "海滩",
    ways = {["southwest"] = "sld/xiaolu", ["#toSld"] = "sld/dukou"},
    nolooks = {["#toSld"] = true},
    lengths = {["#toSld"] = 100}
}
Room {
    ...
    objs = {["张淡月"] = "zhang danyue", ["黑龙门弟子"] = "black dizi"}
}
Room {id = "sld/hlmlgf", name = "练功房", ways = {["east"] = "sld/hlm"}}
Room {
    id = "sld/hlmws",
    name = "卧室",
    no_fight = true,
...
Room {id = "sld/ht", name = "后厅", ways = {["south"] = "sld/th"}}
Room {
    id = "sld/hulm",
    name = "黄龙门议事厅",
    ways = {
    ...
    objs = {["殷锦"] = "yin jin", ["黄龙门弟子"] = "yellow dizi"}
}
Room {id = "sld/hulmlgf", name = "练功房", ways = {["east"] = "sld/hulm"}}
Room {
    id = "sld/hulmws",
    name = "卧室",
    no_fight = true,
...
Room {id = "sld/jitan", name = "祭坛", ways = {["out"] = "sld/pt"}}
Room {
    id = "sld/kongdi",
    name = "林间空地",
    ways = {
...
Room {id = "sld/lgxws", name = "卧室", ways = {["south"] = "sld/lgxroom"}}
Room {
    id = "sld/lgxys",
    name = "药室",
    ways = {["west"] = "sld/lgxroom"},
    objs = {["药柜"] = "yaogui"}
}
Room {
    id = "sld/pt",
    name = "平台",
    ways = {["enter"] = "sld/jitan", ["east"] = "sld/zl2"}
}
Room {
    id = "sld/qlm",
    name = "青龙门议事厅",
    ...
    objs = {["许雪亭"] = "xu xueting", ["青龙门弟子"] = "green dizi"}
}
Room {id = "sld/qlmlgf", name = "练功房", ways = {["east"] = "sld/qlm"}}
Room {
    id = "sld/qlmws",
    name = "卧室",
    no_fight = true,
...
Room {
    id = "sld/road1",
    name = "走廊",
    ways = {["south"] = "sld/ws", ["east"] = "sld/slj", ["west"] = "sld/road2"},
    room_relative = "走廊-----走廊-----走廊｜卧室走廊"
}
Room {
    id = "sld/road2",
    name = "走廊",
    ways = {["east"] = "sld/road1", ["north"] = "sld/lgf", ["west"] = "sld/tz"},
...
Room {
    id = "sld/sanpo2",
    name = "山坡",
    ways = {["westdown"] = "sld/sanroad4", ["enter"] = "sld/hlm"},
    room_relative = "黑龙门议事厅∧山路→山坡山坡"
}
Room {
    id = "sld/sanpo3",
    name = "山坡",
    ways = {["southup"] = "sld/sanroad7", ["enter"] = "sld/clm"},
    room_relative = "赤龙门议事厅∧山坡↓山路山坡"
}
Room {
    id = "sld/sanpo4",
    name = "山坡",
    ways = {["enter"] = "sld/hulm", ["southdown"] = "sld/sanroad9"},
    room_relative = "黄龙门议事厅∧山坡↑山路山坡"
}
Room {
    id = "sld/sanpo5",
    name = "山坡",
    ways = {["southup"] = "sld/sanroad8", ["enter"] = "sld/qlm"},
...
Room {
    id = "sld/sanroad1",
    name = "山路",
    ways = {["southdown"] = "sld/kongdi", ["up"] = "sld/sanroad2"},
...
Room {
    id = "sld/sanroad3",
    name = "山路",
    ways = {["eastup"] = "sld/sanroad4", ["southdown"] = "sld/sanroad2"},
    room_relative = "山路→山路↑山路山路"
}
Room {
    id = "sld/sanroad4",
    name = "山路",
    ways = {["westdown"] = "sld/sanroad3", ["eastup"] = "sld/sanpo2"},
...
Room {
    id = "sld/sanroad6",
    name = "山路",
    ways = {["south"] = "sld/sanpo1", ["northdown"] = "sld/sanroad7"},
    room_relative = "山路↓山路｜山坡山路"
}
Room {
    id = "sld/sanroad7",
    name = "山路",
    ways = {["southup"] = "sld/sanroad6", ["northdown"] = "sld/sanpo3"},
...
Room {
    id = "sld/sanroada",
    name = "山路",
    ways = {["south"] = "sld/sanpo6", ["up"] = "sld/sanroadb"},
    room_relative = "山路〓山路｜山坡山路"
}
Room {
    id = "sld/sanroadb",
    name = "山路",
    ways = {["down"] = "sld/sanroada", ["up"] = "sld/sfd"},
    room_relative = "山峰顶〓山路〓山路山路"
}
Room {
    id = "sld/sfd",
    name = "山峰顶",
    ways = {["enter"] = "sld/slj", ["down"] = "sld/sanroadb"}
}
Room {
    id = "sld/sanpo7",
    name = "山崖",
    ways = {["westdown"] = "sld/sanroad9", ["#Insldsk"] = "sld/sheku"},
    nolooks = {["#Insldsk"] = true},
    lengths = {
...
Room {
    id = "sld/sheku",
    name = "蛇窟",
    ways = {["#Outsldsk"] = "sld/treen1"},
    nolooks = {["#Outsldsk"] = true},
    objs = {["五彩神龙"] = "shen long", ["毒蛇"] = "du she"}
}
Room {
    id = "sld/slj",
    name = "走廊",
    ways = {["north"] = "sld/dt", ["west"] = "sld/road1", ["out"] = "sld/sfd"},
    room_relative = "大厅｜走廊-----走廊∨山峰顶走廊"
}
Room {
    id = "sld/th",
    name = "厅后",
    ways = {["south"] = "sld/dt", ["north"] = "sld/ht", ["east"] = "sld/cf"}
}
Room {
    id = "sld/treee1",
    name = "树林",
...
Room {
    id = "sld/tz",
    name = "走廊",
    ways = {["east"] = "sld/road2", ["out"] = "sld/zl1"},
...
Room {
    ...
    name = "卧室",
    no_fight = true,
    ways = {["north"] = "sld/road1"}
}
Room {
    id = "sld/xiaolu",
    name = "小路",
    ways = {["southwest"] = "tanggu/gangkou", ["northeast"] = "sld/haitan"}
}
Room {
    id = "sld/yaopu1",
    name = "药圃",
...
Room {
    id = "sld/yaopu3",
    name = "药圃",
    ways = {["south"] = "sld/yaopu2", ["west"] = "sld/yaopu4"}
}
Room {
    id = "sld/yaopu4",
    name = "药圃",
...
Room {
    id = "sld/yaopu7",
    name = "药圃",
    ways = {["north"] = "sld/yaopu8", ["east"] = "sld/yaopu6"}
}
Room {
    id = "sld/yaopu8",
    name = "药圃",
...
Room {
    id = "sld/yaopu9",
    name = "药圃",
    ways = {["south"] = "sld/yaopu8", ["east"] = "sld/yaopu4"}
}
Room {
    id = "sld/zl1",
    name = "竹林",
    ways = {["enter"] = "sld/tz", ["west"] = "sld/zl2"}
}
Room {
    id = "sld/zl2",
    name = "竹林",
    ways = {["east"] = "sld/zl1", ["west"] = "sld/pt"}
}
Room {
    id = "songshan/cangshu-ge",
    name = "藏书阁",
    ways = {["south"] = "songshan/yushu-lou"}
}
Room {
    id = "songshan/chanyuan",
    name = "峻极禅院",
    ways = {["south"] = "songshan/damen", ["north"] = "songshan/shidao1"},
    objs = {["丁勉"] = "ding mian"}
}
Room {
    id = "songshan/ctmen",
...
Room {
    ...
    name = "峻极宫大门",
    no_fight = true,
    ways = {["south"] = "songshan/kuangdi", ["north"] = "songshan/chanyuan"},
    objs = {["史登达"] = "shi dengda", ["韩雄万"] = "han xiongwang"}
}
Room {
    id = "songshan/dtlxia",
    name = "大铁梁峡",
    ways = {["northup"] = "songshan/xtlxia", ["southdown"] = "songshan/qgping"},
    objs = {["乐厚"] = "le hou"}
}
Room {
...
Room {
    ...
    name = "观日峰",
    ways = {["west"] = "songshan/fengchantai"}
}
Room {
...
Room {
    id = "songshan/jiange",
    name = "轩辕剑阁",
    ways = {["north"] = "songshan/yushu-lou"},
    objs = {["秦顺昌"] = "qin shunchang"}
}
Room {
...
Room {
    id = "songshan/kuangdi",
    name = "旷地",
    ways = {["south"] = "songshan/taishi-que", ["north"] = "songshan/damen"}
}
Room {
    id = "songshan/nan-room",
    name = "休息室",
    no_fight = true,
    ways = {["north"] = "songshan/qindian"}
}
Room {
    id = "songshan/nv-room",
    name = "休息室",
    no_fight = true,
    ways = {["south"] = "songshan/qindian"}
}
Room {
...
Room {
    id = "songshan/qgfeng",
    name = "青岗峰",
    ways = {["northup"] = "songshan/qgping", ["southdown"] = "songshan/shanlu3"},
    objs = {["狄修"] = "di xiu"}
}
Room {
    id = "songshan/qgping",
    name = "青岗坪",
    ways = {["northup"] = "songshan/dtlxia", ["southdown"] = "songshan/qgfeng"}
}
Room {
    id = "songshan/qindian",
    name = "寝殿",
...
Room {
    ...
    name = "膳房",
    no_fight = true,
    ways = {["west"] = "songshan/suishilu1"},
    objs = {["厨子"] = "chu zi"}
}
Room {
    id = "songshan/shanlu1",
    name = "山路",
    ways = {["down"] = "shaolin/shijie6", ["west"] = "songshan/shanlu2"},
    room_relative = "山路-----山路〓石阶山路"
}
Room {
    id = "songshan/shanlu2",
    name = "山路",
    ways = {["northwest"] = "songshan/gsfxia", ["east"] = "songshan/shanlu1"},
...
Room {
    id = "songshan/shanlu4",
    name = "山路",
    ways = {["southeast"] = "songshan/xtlxia", ["northwest"] = "songshan/ctmen"},
    objs = {["余进"] = "yu jin", ["王祥"] = "wang xiang"}
}
Room {
    id = "songshan/shanlu5",
    name = "山路",
...
Room {
    id = "songshan/shidao1",
    name = "石道",
    ways = {["south"] = "songshan/chanyuan", ["north"] = "songshan/yaocan-ting"},
...
Room {
    id = "songshan/shufang",
    name = "掌门书房",
    ways = {["east"] = "songshan/yushu-lou"}
}
Room {
    id = "songshan/suishilu1",
    name = "碎石路",
    ways = {["east"] = "songshan/shanfang", ["west"] = "songshan/tianzhong-ge"},
    room_relative = "天中阁----碎石路----膳房碎石路"
}
Room {
    id = "songshan/suishilu2",
    name = "碎石路",
    ways = {["east"] = "songshan/tianzhong-ge", ["west"] = "songshan/yaofang"},
    room_relative = "药房----碎石路----天中阁碎石路"
}
Room {
    id = "songshan/suishilu3",
    name = "碎石路",
    ways = {["east"] = "songshan/qindian", ["west"] = "songshan/junji-dian"},
    room_relative = "峻极殿----碎石路----寝殿碎石路"
}
Room {
    id = "songshan/suishilu4",
    name = "碎石路",
    ways = {["east"] = "songshan/junji-dian", ["west"] = "songshan/yushu-lou"},
    room_relative = "御书楼----碎石路----峻极殿碎石路"
}
Room {
    id = "songshan/taishi-que",
    name = "太室阙",
    ways = {["north"] = "songshan/kuangdi", ["southdown"] = "songshan/shanlu5"},
    objs = {["万大平"] = "wan daping"}
}
Room {
...
Room {
    ...
    name = "遥参亭",
    ways = {["south"] = "songshan/shidao1", ["north"] = "songshan/tianzhong-ge"},
    objs = {["卜沉"] = "bu chen"}
}
Room {
    id = "songshan/yaofang",
...
Room {
    ...
    objs = {["邓八公"] = "deng bagong"}
}
Room {
    id = "songshan/zmwshi",
    name = "掌门卧室",
    ways = {["west"] = "songshan/qindian"}
}
Room {
    id = "suzhou/bailianchi",
    name = "白莲池",
    ways = {["south"] = "suzhou/erxianting"}
}
Room {
    id = "suzhou/baiyunquan",
    name = "白云泉",
    ways = {["westdown"] = "suzhou/tianpingshan"}
}
Room {
...
Room {
    id = "suzhou/bingyin",
    name = "兵营",
    ways = {["north"] = "suzhou/bingyindamen"}
}
Room {
    id = "suzhou/bingyindamen",
    name = "兵营大门",
    ways = {["south"] = "suzhou/bingyin", ["north"] = "suzhou/xidajie1"},
    blocks = {["south"] = {{id = "guan bing", exp = 10000}}}
}
Room {
    id = "suzhou/bingying",
    name = "北门兵营",
    ways = {["east"] = "suzhou/northgate", ["west"] = "suzhou/jail"},
    blocks = {["west"] = {{id = "zhao liangdong", exp = 450000}}}
}
Room {
    id = "suzhou/bishuiting",
    name = "碧水亭",
    ways = {["south"] = "suzhou/huzhongdao"}
}
Room {
    id = "suzhou/caixiangjing",
    name = "采香径",
    ways = {["northwest"] = "suzhou/shuiwa", ["northeast"] = "suzhou/shuiwa1"}
}
Room {
    id = "suzhou/caizhu",
    name = "翰林府门",
    ways = {["south"] = "suzhou/wjszhuang", ["north"] = "suzhou/dayuan1"},
    objs = {["恶犬"] = "e quan"}
}
Room {
    id = "suzhou/cangjingge",
    name = "藏经阁",
    ways = {["south"] = "suzhou/dxbdian"}
}
Room {
...
Room {
    id = "suzhou/caoebei",
    name = "曹娥碑",
    ways = {["east"] = "suzhou/nongshe", ["north"] = "suzhou/jiangbian"}
}
Room {
    id = "suzhou/chaguan",
    name = "茶馆",
    ways = {["southwest"] = "suzhou/nandajie1"}
}
Room {
    id = "suzhou/chitang",
    name = "池塘",
    ways = {["northeast"] = "suzhou/gumujiaohe"}
}
Room {
    id = "suzhou/chunzailou",
    name = "春在楼",
    ways = {["west"] = "suzhou/beidajie2"}
}
Room {
    id = "suzhou/datiepu",
    name = "打铁铺",
    ways = {["north"] = "suzhou/dongdajie2"}
}
Room {
    id = "suzhou/dayuan1",
    name = "翰林府院",
    ways = {["south"] = "suzhou/caizhu", ["north"] = "suzhou/houyuan"}
}
Room {
...
Room {
    id = "suzhou/dongting",
    name = "衙门东厅",
    ways = {["west"] = "suzhou/ymzhengting"}
}
Room {
    id = "suzhou/dongxiang",
    name = "闺房",
    ways = {["south"] = "suzhou/houyuan", ["west"] = "suzhou/huayuan"},
    precmds = {["west"] = "ask ling shuanghua about 丁典;#walkBusy"}
}
Room {
    id = "suzhou/dxbdian",
    name = "大雄宝殿",
    ways = {["north"] = "suzhou/cangjingge", ["out"] = "suzhou/lingyansi"}
}
Room {
    id = "suzhou/eastgate",
    name = "东门",
    ways = {["west"] = "suzhou/dongdajie2"}
}
Room {
    id = "suzhou/erxianting",
    name = "二仙亭",
    ways = {["north"] = "suzhou/bailianchi", ["west"] = "suzhou/qianrenshi"}
}
Room {
    id = "suzhou/fengqiao",
    name = "枫桥",
    ways = {["south"] = "suzhou/hanshidian", ["north"] = "suzhou/tielingguan"}
}
Room {
    id = "suzhou/gumujiaohe",
    name = "古木交诃",
    ways = {["southwest"] = "suzhou/chitang", ["east"] = "suzhou/hehuating"}
}
Room {
    id = "suzhou/hanhanquan",
    name = "憨憨泉",
    ways = {["eastdown"] = "suzhou/wjszhuang"},
    objs = {["大石头"] = "da shitou"}
}
Room {
    id = "suzhou/hanshansi",
    name = "寒山寺门",
    ways = {["southeast"] = "suzhou/qsgdao5", ["enter"] = "suzhou/zhengdian"}
}
Room {
    id = "suzhou/hanshidian",
    name = "寒拾殿",
    ways = {["west"] = "suzhou/zhengdian", ["out"] = "suzhou/fengqiao"}
}
Room {
    id = "suzhou/hehuating",
    name = "荷花厅",
    ways = {["east"] = "suzhou/liuyuan", ["west"] = "suzhou/gumujiaohe"}
}
Room {
    id = "suzhou/houtang",
    name = "后堂",
    ways = {["out"] = "suzhou/shuchang"}
}
Room {
    id = "suzhou/houyuan",
    name = "后院",
    ways = {["south"] = "suzhou/dayuan1", ["#inguifang"] = "suzhou/dongxiang"},
    objs = {["凌退思"] = "ling tuisi"},
    lengths = {
...
Room {
    id = "suzhou/huayuan",
    name = "花园",
    ways = {["east"] = "suzhou/dongxiang"}
}
Room {
    id = "suzhou/hubiandadao",
    name = "湖边大道",
    ways = {["north"] = "suzhou/qingshidadao2", ["west"] = "thd/guiyun/road1"}
}
Room {
    id = "suzhou/huqiushan",
    name = "虎丘山",
    ways = {["south"] = "suzhou/toushanmen", ["northeast"] = "suzhou/qsgdao6"},
    objs = {["小树枝"] = "xiao shuzhi", ["大树干"] = "da shugan"}
}
Room {
    id = "suzhou/hutong",
    name = "胡同",
    ways = {["south"] = "suzhou/dongdajie3", ["northeast"] = "suzhou/hutong1"},
    room_relative = "胡同↗胡同｜东大街胡同"
}
Room {
    id = "suzhou/hutong1",
    name = "胡同",
    ways = {["southwest"] = "suzhou/hutong", ["east"] = "suzhou/hutong2"},
    room_relative = "胡同-----胡同↙胡同胡同"
}
Room {
    id = "suzhou/hutong2",
    name = "胡同",
    ways = {["southeast"] = "suzhou/dongdajie2", ["west"] = "suzhou/hutong1"},
    room_relative = "胡同-----胡同↘东大街胡同"
}
Room {
    id = "suzhou/huzhongdao",
    name = "湖中岛",
    ways = {["north"] = "suzhou/bishuiting"}
}
Room {
    id = "suzhou/jail",
    name = "监狱",
    ways = {["east"] = "suzhou/bingying"},
    objs = {["丁典"] = "ding dian"}
}
Room {
    id = "suzhou/jiangbian",
    name = "江边",
    ways = {["south"] = "suzhou/caoebei", ["northeast"] = "group/entry/sztulu2"}
}
Room {
    id = "suzhou/jubaozhai",
    name = "聚宝斋",
    ways = {["east"] = "suzhou/nandajie1"},
    objs = {["孙老板"] = "sun laoban"}
}
Room {
    id = "suzhou/kedian",
    name = "客店",
    ways = {["#szkdout"] = "suzhou/beidajie1", ["#szkedian"] = "suzhou/kedian2"},
    nolooks = {["#szkedian"] = true},
    lengths = {["#szkedian"] = 3}
}
Room {
    id = "suzhou/kedian2",
    name = "客店二楼",
    ways = {["enter"] = "suzhou/kedian3", ["down"] = "suzhou/kedian"}
}
Room {
    id = "suzhou/kedian3",
    name = "客店二楼",
    no_fight = true,
    ways = {["out"] = "suzhou/kedian2"}
}
Room {
    id = "suzhou/lichuntang",
    name = "立春堂",
    ways = {["south"] = "suzhou/dongdajie2"}
}
Room {
    ...
    objs = {["小树枝"] = "xiao shuzhi", ["大石头"] = "da shitou"}
}
Room {
    id = "suzhou/lingyansi",
    name = "灵岩寺",
...
Room {
    id = "suzhou/lingyanta",
    name = "灵岩塔",
    ways = {["west"] = "suzhou/lingyansi"}
}
Room {
    id = "suzhou/liuyuan",
    name = "留园",
    ways = {["east"] = "suzhou/nandajie2", ["west"] = "suzhou/hehuating"}
}
Room {
    id = "suzhou/lixuetang",
    name = "立雪堂",
    ways = {["north"] = "suzhou/wenmeige"}
}
Room {
    id = "suzhou/majiu",
    name = "马厩",
    ways = {["south"] = "suzhou/xiyuanzi", ["east"] = "suzhou/beidajie1"}
}
Room {
    id = "suzhou/mubei",
    name = "坟墓",
    ways = {["northeast"] = "suzhou/shiyuan"}
}
Room {
    id = "suzhou/muniangmu",
    name = "真娘墓",
    ways = {["southwest"] = "suzhou/shijianshi", ["north"] = "suzhou/sunwuting"}
}
Room {
    id = "suzhou/nandajie1",
    name = "南大街",
...
Room {
    id = "suzhou/neizhai",
    name = "衙门内宅",
    ways = {["south"] = "suzhou/ymzhengting"}
}
Room {
    id = "suzhou/nongshe",
    name = "农舍",
    ways = {["west"] = "suzhou/caoebei"},
    objs = {["阿祥"] = "a xiang"}
}
Room {
    id = "suzhou/northgate",
...
Room {
    id = "suzhou/qsgdao",
    name = "青石官道",
    ways = {["southwest"] = "suzhou/tianpingshan", ["north"] = "suzhou/qsgdao1"},
    room_relative = "青石官道｜青石官道↙天平山青石官道"
}
Room {
    id = "suzhou/qsgdao1",
    name = "青石官道",
    ways = {["southwest"] = "suzhou/qsgdao2", ["south"] = "suzhou/qsgdao"},
...
Room {
    id = "suzhou/qsgdao3",
    name = "西门官道",
    ways = {["east"] = "suzhou/qsgdao4", ["west"] = "suzhou/qsgdao5"}
}
Room {
    id = "suzhou/qsgdao4",
    name = "西门外官道",
    ways = {["east"] = "suzhou/westgate", ["west"] = "suzhou/qsgdao3"}
}
Room {
    id = "suzhou/qsgdao5",
    name = "枫桥镇",
...
Room {
    id = "suzhou/shihu",
    name = "石湖",
    ways = {["south"] = "suzhou/tianpingshan", ["west"] = "suzhou/xingchunqiao"}
}
Room {
...
Room {
    id = "suzhou/shuchang",
    name = "书场",
    ways = {["south"] = "suzhou/xidajie2", ["enter"] = "suzhou/houtang"},
    nolooks = {["enter"] = true},
    precmds = {["enter"] = "open door"}
}
Room {
...
Room {
    id = "suzhou/shuyuan",
    name = "书院",
    ways = {["northeast"] = "suzhou/nandajie1"}
}
Room {
    id = "suzhou/southgate",
    name = "南门",
    ways = {["south"] = "suzhou/qsgdao2", ["north"] = "suzhou/nandajie2"}
}
Room {
    id = "suzhou/sunwuting",
    name = "孙武亭",
    ways = {["south"] = "suzhou/muniangmu"}
}
Room {
...
Room {
    ...
    name = "铁玲关",
    ways = {["south"] = "suzhou/fengqiao", ["north"] = "suzhou/nanlin"}
}
Room {
    id = "suzhou/nanlin",
    name = "南林",
    ways = {["south"] = "suzhou/tielingguan"}
}

Room {
    id = "suzhou/tingyuxuan",
    name = "听雨轩",
    ways = {["west"] = "suzhou/nandajie2"}
}
Room {
    id = "suzhou/toushanmen",
    name = "头门山",
    ways = {["north"] = "suzhou/huqiushan", ["west"] = "suzhou/wjszhuang"}
}
Room {
    id = "suzhou/tulu1",
    name = "土路",
...
Room {
    id = "suzhou/wenmeige",
    name = "问梅阁",
    ways = {["south"] = "suzhou/lixuetang", ["west"] = "suzhou/zhenquting"}
}
Room {
    id = "suzhou/westgate",
    name = "西门",
    ways = {["east"] = "suzhou/xidajie2", ["west"] = "suzhou/qsgdao4"}
}
Room {
    id = "suzhou/wjszhuang",
    name = "万景山庄",
...
Room {
    ...
    name = "行春桥",
    ways = {["east"] = "suzhou/shihu"}
}
Room {
    id = "suzhou/xiting",
    name = "衙门西厅",
    ways = {["east"] = "suzhou/ymzhengting"}
}
Room {
    id = "suzhou/xiyuanzi",
    name = "戏园子",
    ways = {["north"] = "suzhou/majiu", ["northeast"] = "suzhou/beidajie1"}
}
Room {
    id = "suzhou/xuanmiaoguan",
    name = "玄妙观",
    ways = {["north"] = "suzhou/xidajie2"}
}
Room {
    id = "suzhou/yamen",
    name = "衙门大门",
    ways = {["south"] = "suzhou/xidajie1", ["north"] = "suzhou/ymzhengting"},
    blocks = {["north"] = {{id = "ya yi", exp = 7500}}}
}
Room {
    id = "suzhou/yanyutang",
    name = "燕誉堂",
    ways = {["southeast"] = "suzhou/zhenquting", ["west"] = "suzhou/shizilin"}
}
Room {
    id = "suzhou/yingxiaoting",
    name = "迎笑亭",
    ways = {["southup"] = "suzhou/shiyuan", ["westdown"] = "suzhou/lingyanshan"}
}
Room {
    ...
    objs = {["赵知仁"] = "zhao zhiren", ["师爷"] = "shi ye"}
}
Room {
    id = "suzhou/zhengdian",
    name = "寒山寺正殿",
    ways = {["east"] = "suzhou/hanshidian", ["out"] = "suzhou/hanshansi"}
}
Room {
    id = "suzhou/zhenquting",
    name = "真趣亭",
    ways = {["northwest"] = "suzhou/yanyutang", ["east"] = "suzhou/wenmeige"}
}
Room {
    id = "suzhou/zhenshi",
    name = "枕石",
    ways = {["south"] = "suzhou/shijianshi"}
}
Room {
    id = "suzhou/zhibaixuan",
    name = "揖峰指柏轩",
    ways = {["southwest"] = "suzhou/shizilin"}
}
Room {
    id = "suzhou/zhishuangge",
    name = "致爽阁",
    ways = {["southeast"] = "suzhou/qianrenshi"}
}
Room {
    id = "suzhou/zhonglou",
    name = "钟楼小院",
    ways = {["east"] = "suzhou/lingyansi"}
}
Room {
    id = "suzhou/zijinan",
    name = "紫金庵",
    ways = {["east"] = "suzhou/beidajie2"},
    objs = {["慈善箱"] = "cishan xiang"}
}
Room {
    id = "taishan/baihe",
    name = "白鹤泉",
    ways = {["northup"] = "taishan/yitian", ["southdown"] = "taishan/daizong"}
}
Room {
    id = "taishan/baozang",
    name = "宝藏岭",
    ways = {["westup"] = "taishan/weipin"}
}
Room {
    id = "taishan/jyzj",
    name = "记忆之间",
    ways = {["down"] = "taishan/beitian"}
}
Room {
    id = "taishan/beitian",
    name = "北天门",
    ways = {["southdown"] = "taishan/zhangren", ["up"] = "taishan/jyzj"}
}
Room {
    id = "taishan/bixia",
    name = "碧霞祠",
    ways = {["eastdown"] = "taishan/baozang", ["west"] = "taishan/weipin"}
}
Room {
    id = "taishan/daizong",
    name = "岱宗坊",
...
Room {
    id = "taishan/dongtian",
    name = "东天门",
    ways = {["west"] = "taishan/tanhai"}
}
Room {
    id = "taishan/doumo",
    name = "斗母宫",
    ways = {["eastup"] = "taishan/shijin", ["southdown"] = "taishan/yitian"}
}
Room {
    id = "taishan/ertian",
    name = "二天门",
    ways = {["northup"] = "taishan/wudafu", ["southdown"] = "taishan/huima"},
    objs = {
        ["天柏道人"] = "tianbai daoren",
...
Room {
    id = "taishan/fengchan",
    name = "封禅台",
    ways = {["down"] = "taishan/yuhuang"}
}
Room {
    id = "taishan/haitan",
    name = "海滩",
    ways = {["west"] = "taishan/daizong"}
}
Room {
    id = "taishan/hsroad2",
    name = "青石大道",
    ways = {["east"] = "taishan/yidao2", ["west"] = "huanghe/tiandi4"},
    room_relative = "田地---青石大道---大驿道青石大道"
}
Room {
    id = "taishan/huima",
    name = "回马岭",
    ways = {["northup"] = "taishan/ertian", ["southdown"] = "taishan/shijin"}
}
Room {
    id = "taishan/lianhua",
    name = "莲花峰",
    ways = {["northup"] = "taishan/shixin", ["westup"] = "taishan/tianjie"}
}
Room {
    id = "taishan/longmen",
    name = "龙门",
    ways = {["northup"] = "taishan/shengxian", ["southdown"] = "taishan/wudafu"},
    objs = {["迟百城"] = "chi baicheng"}
}
Room {
    id = "taishan/nantian",
    name = "南天门",
    ...
    objs = {["亲兵队长"] = "qinbing duizhang"}
}
Room {
    id = "taishan/riguan",
    name = "日观峰",
    ways = {["eastup"] = "taishan/tanhai", ["westup"] = "taishan/yuhuang"}
}
Room {
    id = "taishan/shengxian",
    name = "升仙坊",
    ways = {["northup"] = "taishan/nantian", ["southdown"] = "taishan/longmen"},
    objs = {["玉玑子"] = "yuji zi", ["建除道人"] = "jianchu daoren"}
}
Room {
    id = "taishan/shijin",
    name = "石经峪",
    ways = {["northup"] = "taishan/huima", ["westdown"] = "taishan/doumo"}
}
Room {
    id = "taishan/shixin",
    name = "试心石",
    ways = {["southdown"] = "taishan/lianhua"}
}
Room {
    id = "taishan/shulin1",
    name = "杨树林",
    ways = {["southeast"] = "taishan/yidao2", ["north"] = "taishan/sjzhuang"},
    objs = {
        ["单小山"] = "shan xiaoshan",
        ["单叔山"] = "shan shushan",
        ["单伯山"] = "shan boshan",
...
Room {
    id = "taishan/sjzhuang",
    name = "单家庄",
    ways = {["south"] = "taishan/shulin1"},
    objs = {["单正"] = "shan zheng"}
}
Room {
    id = "taishan/tanhai",
    name = "探海石",
    ways = {["westdown"] = "taishan/riguan", ["east"] = "taishan/dongtian"},
    objs = {["玉音子"] = "yuyin zi"}
}
Room {
    id = "taishan/tianjie",
...
Room {
    id = "taishan/weipin",
    name = "围屏山",
    ways = {["westdown"] = "taishan/tianjie", ["east"] = "taishan/bixia"}
}
Room {
    id = "taishan/wudafu",
    name = "五大夫松",
    ways = {["northup"] = "taishan/longmen", ["southdown"] = "taishan/ertian"}
}
Room {
    id = "taishan/xitian",
    name = "西天门",
    ways = {["southdown"] = "taishan/yueguan"}
}
Room {
    id = "taishan/yidao2",
    name = "大驿道",
...
Room {
    id = "taishan/yitian",
    name = "一天门",
    ways = {["northup"] = "taishan/doumo", ["southdown"] = "taishan/baihe"}
}
Room {
    id = "taishan/yueguan",
    name = "月观峰",
    ways = {["northup"] = "taishan/xitian", ["east"] = "taishan/nantian"}
}
Room {
    id = "taishan/yuhuang",
    name = "玉皇顶",
    ...
    objs = {["天门道人"] = "tianmen daoren"}
}
Room {
    id = "taishan/zhangren",
    name = "丈人峰",
    ways = {["northup"] = "taishan/beitian", ["east"] = "taishan/yuhuang"},
    objs = {["玉磬子"] = "yuqing zi"}
}
Room {
    id = "tanggu/beimen",
    name = "北城门",
    ways = {["south"] = "tanggu/stbeijie2"}
}
Room {
    id = "tanggu/center",
    name = "中心广场",
...
Room {
    ...
    name = "万福典当",
    no_fight = true,
    ways = {["west"] = "tanggu/stbeijie1"},
    objs = {["殷老板"] = "yin laoban"}
}
Room {
    id = "tanggu/dizangmiao",
    name = "地藏庙",
    ways = {["west"] = "tanggu/stbeijie2"}
}
Room {
    id = "tanggu/gangkou",
    name = "港口",
    ways = {["northeast"] = "sld/xiaolu", ["west"] = "tanggu/stdongjie1"},
    objs = {["施琅"] = "shi lang"}
}
Room {
    id = "tanggu/jiuguan",
    name = "小酒馆",
    ways = {["south"] = "tanggu/stxijie2"}
}
Room {
    id = "tanggu/kedian",
    name = "喜发客栈",
...
Room {
    id = "tanggu/kedian2",
    name = "客店二楼",
    ways = {["enter"] = "tanggu/sleeproom", ["down"] = "tanggu/kedian"}
}
Room {
    id = "tanggu/kongchangdi",
    name = "广场空地",
    no_fight = true,
    ways = {["northwest"] = "tanggu/center"},
    objs = {["穆念慈"] = "mu nianci"}
}
Room {
    id = "tanggu/mingju",
    name = "普通人家",
    ways = {["east"] = "tanggu/stnanjie1"},
    room_relative = "普通人家---石头南街普通人家"
}
Room {
    id = "tanggu/mingju1",
    name = "普通人家",
    ways = {["west"] = "tanggu/stnanjie1"},
    room_relative = "石头南街---普通人家普通人家"
}
Room {
    id = "tanggu/muqidian",
    name = "木器店",
    ways = {["north"] = "tanggu/stxijie2"}
}
Room {
    id = "tanggu/nanmen",
    name = "南城门",
    ways = {["north"] = "tanggu/stnanjie1"}
}
Room {
    id = "tanggu/qianyunge",
    name = "纤云阁",
    ways = {["north"] = "tanggu/stdongjie1"}
}
Room {
    id = "tanggu/qianzhuang",
    name = "钱庄",
    ways = {["east"] = "tanggu/stnanjie2"},
    objs = {["朱富"] = "zhu fu"}
}
Room {
    id = "tanggu/sleeproom",
...
Room {
    id = "tanggu/wroad1",
    name = "大驿道",
    ways = {["southwest"] = "tanggu/wroad2", ["east"] = "tanggu/ximen"},
    room_relative = "大驿道----西城门↙大驿道大驿道"
}
Room {
    id = "tanggu/wroad2",
    name = "大驿道",
    ways = {["northeast"] = "tanggu/wroad1", ["west"] = "tanggu/wroad3"},
    room_relative = "大驿道↗大驿道----大驿道大驿道"
}
Room {
    id = "tanggu/wroad3",
    name = "大驿道",
    ways = {["east"] = "tanggu/wroad2", ["west"] = "tanggu/wroad4"},
    room_relative = "大驿道----大驿道----大驿道大驿道"
}
Room {
    id = "tanggu/wroad4",
    name = "大驿道",
    ways = {["southwest"] = "cangzhou/eroad4", ["east"] = "tanggu/wroad3"},
    room_relative = "大驿道----大驿道↙大驿道大驿道"
}
Room {
    id = "tanggu/wuqipu",
    name = "武器铺",
    ways = {["east"] = "tanggu/stbeijie1"}
}
Room {
    id = "tanggu/xianjialou",
    name = "仙家楼",
    ways = {["east"] = "tanggu/stbeijie2"}
}
Room {
    id = "tanggu/ximen",
    name = "西城门",
    ways = {["east"] = "tanggu/stxijie2", ["west"] = "tanggu/wroad1"}
}
Room {
    id = "tanggu/yaofang",
    name = "大药房",
    ways = {["south"] = "tanggu/stxijie1"}
}
Room {
    id = "tanggu/zhahuopu",
    name = "杂货铺",
    ways = {["south"] = "tanggu/stdongjie1"}
}
Room {
    id = "tanggu/zhubaohang",
    name = "金银珠宝行",
    ways = {["west"] = "tanggu/stnanjie2"},
    objs = {["龙三爷"] = "long sanye"}
}

Room {id = "thd/bookroom", name = "书房", ways = {["west"] = "thd/shilu"}}
Room {
    id = "thd/caodi",
    name = "草地",
    ways = {
...
Room {
    id = "thd/cave",
    name = "岩洞",
    ways = {["out"] = "thd/dongkou"},
    objs = {["周伯通"] = "zhou botong"}
}
Room {
    id = "thd/chafang1",
    name = "茶房",
    no_fight = true,
    ways = {["east"] = "thd/fanting1"}
}
Room {
    id = "thd/chufang",
    name = "厨房",
    ways = {["south"] = "thd/fanting", ["east"] = "thd/neishi2"},
    objs = {["猪肉"] = "rou", ["米饭"] = "mi fan"}
}
Room {
    id = "thd/chufang1",
    name = "厨房",
    ways = {["south"] = "thd/fanting1"},
    objs = {["猪肉"] = "rou", ["米饭"] = "mi fan"}
}
Room {
    id = "thd/dongkou",
    name = "洞口",
    ways = {["enter"] = "thd/cave", ["west"] = "thd/shangang"},
    lengths = {
...
Room {
    id = "thd/fanting",
    name = "饭厅",
    ways = {["east"] = "thd/neishi1", ["north"] = "thd/chufang"}
}
Room {
    id = "thd/fanting1",
    name = "饭厅",
...
Room {
    ...
    name = "草地",
    ways = {["north"] = "thd/guiyun/shulin2", ["east"] = "thd/guiyun/caodi1"}
}
Room {
    id = "thd/guiyun/caodi3",
    name = "草地",
    ways = {["north"] = "thd/guiyun/shulin3", ["west"] = "thd/guiyun/caodi1"}
}
Room {
    id = "thd/guiyun/chafang",
    name = "茶房",
    no_fight = true,
    ways = {["stand;east"] = "thd/guiyun/fanting"}
}
Room {
    id = "thd/guiyun/chufang",
    name = "厨房",
    ways = {["west"] = "thd/guiyun/fanting"},
    objs = {["猪肉"] = "rou", ["米饭"] = "mi fan"}
}
Room {
...
Room {
    ...
    name = "客房",
    no_fight = true,
    ways = {["south"] = "thd/guiyun/zoulang2"}
}
Room {
...
Room {
    ...
    name = "前厅",
    ways = {["east"] = "thd/guiyun/shiqiao", ["west"] = "thd/guiyun/zhongting"},
    objs = {
        ["归云庄访客留言板"] = "board",
        ["陆冠英"] = "lu guanying"
    }
...
Room {
    ...
    nolooks = {["e;w;ask lao zhe about 裘千丈;jump river;#walkBusy"] = true},
    lengths = {["e;w;ask lao zhe about 裘千丈;jump river;#walkBusy"] = 10}
}
Room {
    ...
    nolooks = {["w;e;ask lao zhe about 裘千丈;jump river;#walkBusy"] = true},
    lengths = {["w;e;ask lao zhe about 裘千丈;jump river;#walkBusy"] = 10}
}
Room {
    id = "thd/guiyun/road1",
    name = "湖滨小路",
    ways = {["east"] = "suzhou/hubiandadao", ["west"] = "thd/guiyun/rivere"}
}
Room {
    id = "thd/guiyun/road2",
    name = "湖滨小路",
...
Room {
    ...
    name = "大石桥",
    ways = {["east"] = "thd/guiyun/road4", ["west"] = "thd/guiyun/qianting"}
}
Room {
    id = "thd/guiyun/shufang",
    name = "书房",
    ways = {["west"] = "thd/guiyun/houting"},
    objs = {
        ["陆乘风"] = "lu chengfeng",
        ["『箫技入门』"] = "flute's book"
    }
...
Room {
    ...
    name = "树林",
    ways = {["south"] = "thd/guiyun/caodi2", ["east"] = "thd/guiyun/shulin1"},
    objs = {["蜜蜂"] = "bee"}
}
Room {
...
Room {
    ...
    name = "树林深处",
    ways = {["west"] = "thd/guiyun/shulin4"}
}
Room {
    id = "thd/guiyun/shulin7",
    name = "树林深处",
    ways = {["south"] = "thd/guiyun/shulin5"},
    objs = {["毒蛇"] = "snake"}
}
Room {
    id = "thd/guiyun/shushang",
    name = "树上",
    ways = {["down"] = "thd/guiyun/shulin5"}
}
Room {
    id = "thd/guiyun/wofang",
    name = "卧房",
    ways = {["east"] = "thd/guiyun/houting"}
}
Room {
    id = "thd/guiyun/wofang1",
    name = "卧房",
    ways = {["south"] = "thd/guiyun/zoulang3"},
    objs = {["程瑶迦"] = "cheng yaojia"}
}
Room {
    id = "thd/guiyun/xiuxishi-f",
    name = "女休息室",
    no_fight = true,
    ways = {["west"] = "thd/guiyun/lianwuchang"}
}
Room {
    id = "thd/guiyun/xiuxishi-m",
    name = "男休息室",
    no_fight = true,
    ways = {["east"] = "thd/guiyun/lianwuchang"}
}
Room {
...
Room {
    ...
    name = "走廊",
    ways = {["south"] = "thd/guiyun/zoulang6", ["east"] = "thd/guiyun/zoulang4"},
...
Room {
    ...
    blocks = {
        ["south"] = {{id = "zhuang ding", exp = 5000, party = "桃花岛"}}
    }
}
Room {
    id = "thd/haibin",
    name = "海滨",
    ways = {["west"] = "thd/niujia/jiangpan3", ["#toThd"] = "thd/shore"},
    lengths = {
...
Room {
    id = "thd/hall",
    name = "方厅",
    ways = {["east"] = "thd/shilu", ["west"] = "thd/zoulang1"}
}
Room {
    id = "thd/hetang",
    name = "河塘",
    ways = {["north"] = "thd/shidi", ["s"] = "thd/jicui"},
    lengths = {
...
Room {
    id = "thd/hill",
    name = "小山",
    ways = {["eastup"] = "thd/hill1", ["nd"] = "thd/shangang"},
    nolooks = {["nd"] = true},
    lengths = {
...
Room {
    id = "thd/hill1",
    name = "山脊",
    ways = {["northup"] = "thd/hill2", ["westdown"] = "thd/hill"}
}
Room {
    id = "thd/hill2",
    name = "山顶",
    ways = {["east"] = "thd/entrance", ["southdown"] = "thd/hill1"}
}
Room {
    id = "thd/huo",
    name = "火",
...
Room {
    id = "thd/jingshe",
    name = "精舍",
    ways = {["south"] = "thd/shilu"},
    objs = {["布阵箱"] = "array box"}
}
Room {id = "thd/kefang", name = "客房", ways = {["west"] = "thd/jicui"}}
Room {
    id = "thd/kefang1",
    name = "客房",
    ways = {["south"] = "thd/shijian-ting"}
}
Room {
    id = "thd/liandanfang",
    name = "炼丹房",
    ways = {["out"] = "thd/jingshe"}
}
Room {
    id = "thd/liangyi",
    name = "两仪",
...
Room {
    id = "thd/mudao1",
    name = "墓道",
    ways = {["down"] = "thd/mudao2", ["out"] = "thd/tomb"}
}
Room {
    id = "thd/mudao2",
    name = "墓道",
...
Room {id = "thd/mudao4", name = "墓道", ways = {["down"] = "thd/mushi"}}
Room {id = "thd/mushi", name = "墓中圹室", ways = {["up"] = "thd/mudao4"}}
Room {
    id = "thd/neishi1",
    name = "内室",
    ways = {
...
Room {
    id = "thd/niujia/bay",
    name = "小渔港",
    ways = {["west"] = "thd/niujia/hbroad"},
    objs = {["船老大"] = "lao da"}
}
Room {
    id = "thd/niujia/guojia",
    name = "民房",
    ways = {["south"] = "thd/niujia/njroad2"}
}
Room {
...
Room {
    ...
    name = "江畔",
    ways = {["west"] = "thd/niujia/jiangpan2", ["east"] = "thd/haibin"},
    room_relative = "江畔-----江畔-----海滨江畔"
}
Room {
    id = "thd/niujia/kezhan",
    name = "归来客栈",
    ways = {["south"] = "thd/niujia/hbroad"}
}
Room {
    id = "thd/niujia/mishi",
    name = "密室",
    ways = {["out"] = "thd/niujia/xiaodian"}
}
Room {
...
Room {
    ...
    name = "民房",
    ways = {["south"] = "thd/niujia/njroad3"}
}

Room {
    id = "thd/niujia/njroad4",
    name = "村中小路",
    ways = {["south"] = "thd/niujia/njroad5", ["north"] = "thd/niujia/njroad3"},
...
Room {
    ...
    name = "村口",
    ways = {["northwest"] = "thd/niujia/road2", ["east"] = "thd/niujia/njroad1"}
}
Room {
    id = "thd/niujia/road",
    name = "土路",
...
Room {id = "thd/room", name = "箫房", ways = {["out"] = "thd/jicui"}}
Room {
    id = "thd/shangang",
    name = "山冈",
    ways = {
...
Room {
    id = "thd/shanjiao",
    name = "试剑峰山脚",
    ways = {["westdown"] = "thd/caodi", ["up"] = "thd/shanlu1"}
}
Room {
    id = "thd/shanlu1",
    name = "山路",
    ways = {["northup"] = "thd/shanlu2", ["down"] = "thd/shanjiao"}
}
Room {
    id = "thd/shanlu2",
    name = "山路",
    ways = {["eastup"] = "thd/shanyao", ["southdown"] = "thd/shanlu1"}
}
Room {id = "thd/shanya", name = "断崖", ways = {["westdown"] = "thd/shanyao"}}
Room {
    id = "thd/shanyao",
    name = "半山腰",
    ways = {["eastup"] = "thd/shanya", ["westdown"] = "thd/shanlu2"}
}
Room {
    id = "thd/shaoyang",
    name = "少阳",
    ways = {["east"] = "thd/sixiang", ["down"] = "thd/jin"}
}
Room {
    id = "thd/shaoyin",
    name = "少阴",
    ways = {["down"] = "thd/mu", ["west"] = "thd/sixiang"}
}
Room {
    id = "thd/shidi",
    name = "小石堤",
    ways = {["south"] = "thd/hetang", ["north"] = "thd/shilu"}
}
Room {
    id = "thd/shijian-ting",
    name = "试剑亭",
    ways = {["north"] = "thd/kefang1", ["east"] = "thd/caodi"}
}
Room {
    id = "thd/shilu",
    name = "石路",
...
Room {id = "thd/shore", name = "岸边", ways = {["northup"] = "thd/hill"}}
Room {
    id = "thd/shui",
    name = "水",
    ways = {
...
Room {id = "thd/taiji", name = "太极", ways = {["down"] = "thd/liangyi"}}
Room {
    id = "thd/taiyang",
    name = "太阳",
    ways = {["north"] = "thd/sixiang", ["down"] = "thd/huo"}
}
Room {
    id = "thd/taiyin",
    name = "太阴",
    ways = {["south"] = "thd/sixiang", ["down"] = "thd/shui"}
}
Room {id = "thd/taohua1", name = "桃花阵"}
...
Room {id = "thd/woshi1", name = "卧室", ways = {["west"] = "thd/neishi1"}}
Room {id = "thd/woshi2", name = "卧室", ways = {["west"] = "thd/neishi2"}}
Room {
    id = "thd/xiaoyuan",
    name = "小院",
    ways = {["south"] = "thd/taohua1", ["north"] = "thd/jicui"}
}
Room {
    id = "thd/xiuxishi-f",
    name = "女休息室",
    no_fight = true,
    ways = {["north"] = "thd/lianwuchang"}
}
Room {
    id = "thd/xiuxishi-m",
    name = "男休息室",
    no_fight = true,
    ways = {["south"] = "thd/lianwuchang"}
}
Room {id = "thd/yang", name = "阳", ways = {["northeast"] = "thd/liangyi"}}
Room {id = "thd/yin", name = "阴", ways = {["southwest"] = "thd/liangyi"}}
Room {
    id = "thd/zoulang1",
    name = "回廊",
    ways = {
...
Room {
    id = "thd/zoulang2",
    name = "回廊",
    ways = {["south"] = "thd/zoulang1", ["north"] = "thd/neishi1"}
}
Room {
    id = "thd/zoulang3",
    name = "回廊",
    ways = {["east"] = "thd/zoulang1", ["west"] = "thd/lianwuchang"}
}
Room {
    id = "tianshan/banshan",
    name = "半山",
    ways = {["southdown"] = "tianshan/shanlu4", ["west"] = "tianshan/duanhunya"},
    objs = {["陈正德"] = "chen zhengde", ["关明梅"] = "guan mingmei"}
}
Room {
    id = "tianshan/bctang",
    name = "百草堂",
    ways = {["south"] = "tianshan/zoulang3"}
}
Room {
    id = "tianshan/bqshi",
    name = "兵器室",
    ways = {["north"] = "tianshan/zoulang2"}
}
Room {
...
Room {
    id = "tianshan/chtbu",
    name = "成天部",
    ways = {["eastdown"] = "tianshan/dadao9"}
}
Room {
    id = "tianshan/chufang",
    name = "厨房",
    ways = {["east"] = "tianshan/qiandian"},
    objs = {["青葫芦"] = "qing hulu", ["米饭"] = "mi fan"}
}
Room {
    id = "tianshan/ctbu",
    name = "赤天部",
...
Room {
    id = "tianshan/dadao1",
    name = "青石大道",
    ways = {["southup"] = "tianshan/pmfeng", ["north"] = "tianshan/dadao2"},
...
Room {
    id = "tianshan/dadao2",
    name = "青石大道",
    ways = {["northup"] = "tianshan/ctbu", ["south"] = "tianshan/dadao1"},
...
Room {
    id = "tianshan/fjshi",
    name = "防具室",
    ways = {["south"] = "tianshan/zoulang2"}
}
Room {
    id = "tianshan/fqzong",
    name = "封器冢",
    ways = {["south"] = "tianshan/zoulang5"}
}
Room {
    id = "tianshan/gyting",
    name = "观雨亭",
    ways = {["south"] = "tianshan/houyuan", ["north"] = "tianshan/dsqiao"}
}
Room {
    id = "tianshan/houyuan",
    name = "后园",
    ways = {["south"] = "tianshan/zoulang6", ["north"] = "tianshan/gyting"}
}
Room {
    id = "tianshan/htbu",
    name = "昊天部",
    ways = {["westdown"] = "tianshan/dadao5"},
    objs = {["余婆婆"] = "yu popo"}
}
Room {
    id = "tianshan/huayuan",
    name = "花园",
    ways = {["east"] = "tianshan/dsqiao"}
}
Room {
    id = "tianshan/jiashan",
    name = "假山",
    ways = {["west"] = "tianshan/dsqiao"}
}
Room {
    id = "tianshan/jtbu",
    name = "钧天部",
    ...
    objs = {["程青霜"] = "cheng qingshuang"}
}
Room {
    id = "tianshan/kefang",
    name = "客房",
    no_fight = true,
    ways = {["south"] = "tianshan/zoulang4"}
}
Room {
    id = "tianshan/kongchang",
    name = "空场",
    ways = {["east"] = "xingxiu/tianshan", ["west"] = "tianshan/shanlu1"}
}
Room {
    id = "tianshan/lgfang",
    name = "练功房",
    ways = {["north"] = "tianshan/zoulang3"}
}
Room {
    id = "tianshan/ljgong",
    name = "灵鹫宫",
    ways = {["north"] = "tianshan/qiandian", ["out"] = "tianshan/jtbu"}
}
Room {
    id = "tianshan/longtan",
    name = "龙潭",
    no_fight = true,
    ways = {["up"] = "tianshan/duanhunya"}
}
Room {
    id = "tianshan/lxzai",
    name = "灵心斋",
    ways = {["north"] = "tianshan/zoulang4"}
}
Room {
    id = "tianshan/pmfeng",
    name = "缥缈峰",
...
Room {
    id = "tianshan/qinshi",
    name = "寝室",
    ways = {["north"] = "tianshan/zoulang5"}
}
Room {
    id = "tianshan/rtbu",
    name = "鸾天部",
    ways = {["southwest"] = "tianshan/dadao6"}
}
Room {
...
Room {
    ...
    name = "山径",
    ways = {["northup"] = "tianshan/shanjin2", ["southdown"] = "tianshan/xcmen"},
    room_relative = "山径↑山径↑仙愁门山径"
}
Room {
    id = "tianshan/shanjin2",
    name = "山径",
    ways = {["east"] = "tianshan/shanjin3", ["southdown"] = "tianshan/shanjin1"}
}
Room {
    id = "tianshan/shanjin3",
    name = "山径",
    ways = {["east"] = "tianshan/shanjin4", ["west"] = "tianshan/shanjin2"}
}
Room {
    id = "tianshan/shanjin4",
    name = "山径",
    ways = {["east"] = "tianshan/shanjin5", ["west"] = "tianshan/shanjin3"}
}
Room {
    id = "tianshan/shanjin5",
    name = "山径",
    ways = {["northup"] = "tianshan/shanjin6", ["west"] = "tianshan/shanjin4"}
}
Room {
...
Room {
    id = "tianshan/shanlu1",
    name = "天山山路",
    ways = {["northup"] = "tianshan/shanlu2", ["east"] = "tianshan/kongchang"}
}
Room {
    id = "tianshan/shanlu2",
    name = "山路",
...
Room {
    ...
    nolooks = {["jump duimian;#walkBusy"] = true},
    lengths = {["jump duimian;#walkBusy"] = 10}
}
Room {
    id = "tianshan/xtbu",
    name = "玄天部",
    ways = {["southdown"] = "tianshan/dadao7"}
}
Room {
    id = "tianshan/youtbu",
    name = "幽天部",
    ways = {["southeast"] = "tianshan/dadao8"}
}
Room {
    id = "tianshan/ytbu",
    name = "阳天部",
    ways = {["northwest"] = "tianshan/dadao4"}
}
Room {
    id = "tianshan/zhtbu",
    name = "朱天部",
    ways = {["northeast"] = "tianshan/dadao10"},
    objs = {["石嫂"] = "shi sao"}
}
Room {
    id = "tianshan/zoulang1",
    name = "走廊",
    ways = {["south"] = "tianshan/qiandian", ["north"] = "tianshan/dadian"}
}
Room {
...
Room {
    ...
    name = "走廊",
    ways = {["south"] = "tianshan/dadian", ["north"] = "tianshan/houyuan"}
}
Room {
    id = "tiezhang/bqshi",
    name = "兵器室",
    ways = {["south"] = "tiezhang/zoulang-1"},
    objs = {["兵器架"] = "bingqi jia"}
}
Room {
    id = "tiezhang/chufang",
    name = "厨房",
    no_fight = true,
    ways = {["south"] = "tiezhang/zoulang-3"}
}
Room {
    id = "tiezhang/dashishi",
    name = "大石室",
    ways = {["out"] = "tiezhang/taijie-2"}
}
Room {
    id = "tiezhang/dezj",
    name = "第二指节",
    ...
    objs = {["凌震天"] = "ling zhentian", ["黄令天"] = "huang lingtian"}
}
Room {
    id = "tiezhang/dong-1",
    name = "山洞",
    ways = {["enter"] = "tiezhang/dong-2", ["out"] = "tiezhang/dezj"},
    room_relative = "山洞∧山洞∨第二指节山洞"
}
Room {
    id = "tiezhang/dong-2",
    name = "山洞",
    ways = {["enter"] = "tiezhang/dong-3", ["out"] = "tiezhang/dong-1"},
    room_relative = "山洞∧山洞∨山洞山洞"
}
Room {
    id = "tiezhang/dong-3",
    name = "山洞",
    ways = {["enter"] = "tiezhang/trdx", ["out"] = "tiezhang/dong-2"},
...
Room {
    id = "tiezhang/hclu",
    name = "荒草路",
    ways = {["northup"] = "tiezhang/hclu-2", ["southeast"] = "tiezhang/pingtai"},
    room_relative = "荒草路↑荒草路↘山间平台荒草路"
}
Room {
    id = "tiezhang/hclu-2",
    name = "荒草路",
    ways = {["northwest"] = "tiezhang/hclu-3", ["southdown"] = "tiezhang/hclu"},
    room_relative = "荒草路↖荒草路↑荒草路荒草路"
}
Room {
    id = "tiezhang/hclu-3",
    name = "荒草路",
    ways = {["northup"] = "tiezhang/hclu-4", ["southeast"] = "tiezhang/hclu-2"},
    room_relative = "荒草路↑荒草路↘荒草路荒草路"
}
Room {
    id = "tiezhang/hclu-4",
    name = "荒草路",
    ways = {["northup"] = "tiezhang/hclu-5", ["southdown"] = "tiezhang/hclu-3"},
    room_relative = "荒草路↑荒草路↑荒草路荒草路"
}
Room {
    id = "tiezhang/hclu-5",
...
Room {
    id = "tiezhang/hclu-6",
    name = "荒草路",
    ways = {["northup"] = "tiezhang/wmfeng", ["southeast"] = "tiezhang/hclu-5"},
    room_relative = "无名峰↑荒草路↘荒草路荒草路"
}
Room {
    id = "tiezhang/hhyang-2",
    name = "花圃",
    ways = {["west"] = "tiezhang/hhyuan-1"}
}
Room {
...
Room {
    ...
    name = "假山",
    ways = {["east"] = "tiezhang/hhyuan-1"}
}
Room {
    id = "tiezhang/hxfang",
    name = "后厢房",
    ways = {["south"] = "tiezhang/wztang", ["north"] = "tiezhang/hhyuan-1"},
    objs = {["裘千仞"] = "qiu qianren"}
}
Room {
    id = "tiezhang/juebi-1",
    name = "绝壁",
    ways = {["southwest"] = "tiezhang/shangu-2"}
}
Room {
    id = "tiezhang/kedian",
    name = "客店",
...
Room {
    id = "tiezhang/kedian2",
    name = "客店二楼",
    ways = {["enter"] = "tiezhang/kedian3", ["down"] = "tiezhang/kedian"}
}
Room {
    id = "tiezhang/kedian3",
    name = "客店二楼",
    no_fight = true,
    ways = {["out"] = "tiezhang/kedian2"}
}
Room {
    id = "tiezhang/lgfang",
    name = "练功房",
    ways = {["east"] = "tiezhang/guangchang"},
...
Room {
    id = "tiezhang/mishi",
    name = "密室",
    ways = {["out"] = "tiezhang/hhyuan-3"}
}
Room {
    id = "tiezhang/mzfeng",
    name = "拇指峰",
    ways = {["southdown"] = "tiezhang/sslu-3"}
}
Room {
    id = "tiezhang/pingtai",
    name = "山间平台",
...
Room {
    id = "tiezhang/pubu",
    name = "瀑布",
    ways = {["northup"] = "tiezhang/xzfeng", ["eastdown"] = "tiezhang/sblu-1"}
}
Room {
    id = "tiezhang/road-1",
    name = "黄土路",
    ways = {["southwest"] = "tiezhang/road-2", ["northeast"] = "tiezhang/lx"},
    room_relative = "泸溪↗黄土路↙黄土路黄土路"
}
Room {
    id = "tiezhang/road-2",
    name = "黄土路",
    ways = {["northeast"] = "tiezhang/road-1", ["west"] = "tiezhang/road-3"},
    room_relative = "黄土路↗黄土路----黄土路黄土路"
}
Room {
    id = "tiezhang/road-3",
    name = "黄土路",
    ways = {["northwest"] = "tiezhang/shanjiao", ["east"] = "tiezhang/road-2"},
    room_relative = "山脚下↖黄土路----黄土路黄土路"
}
Room {
    id = "tiezhang/sblu-1",
    name = "石板路",
    ways = {["eastdown"] = "tiezhang/shanlu-5", ["westup"] = "tiezhang/pubu"},
...
Room {
    ...
    name = "山脚下",
    ways = {["northup"] = "tiezhang/shanmen", ["southeast"] = "tiezhang/road-3"}
}
Room {
    id = "tiezhang/shanlu-1",
    name = "山路",
    ways = {["north"] = "tiezhang/shanlu-2", ["southdown"] = "tiezhang/shanmen"},
    room_relative = "山路｜山路↑山门山路"
}
Room {
    id = "tiezhang/shanlu-2",
    name = "山路",
    ways = {["south"] = "tiezhang/shanlu-1", ["north"] = "tiezhang/guangchang"},
    room_relative = "广场｜山路｜山路山路"
}
Room {
    id = "tiezhang/shanlu-3",
    name = "山路",
    ways = {["northup"] = "tiezhang/shanlu-4", ["south"] = "tiezhang/hhyuan-1"},
...
Room {
    ...
    name = "石板路",
    ways = {["eastdown"] = "tiezhang/pingtai", ["westup"] = "tiezhang/sblu-1"},
...
Room {
    ...
    name = "山路",
    ways = {["north"] = "tiezhang/sslin-1", ["southdown"] = "tiezhang/shanlu-6"},
    room_relative = "松树林｜山路↑山路山路"
}
Room {
    id = "tiezhang/shanlu-8",
    name = "山路",
    ways = {["northup"] = "tiezhang/shanlu-9", ["southdown"] = "tiezhang/dezj"},
...
Room {
    ...
    name = "石阶",
    ways = {["eastdown"] = "tiezhang/shijie-2", ["out"] = "tiezhang/wmfeng"},
...
Room {
    ...
    name = "石阶",
    ways = {["southup"] = "tiezhang/shijie-2", ["westdown"] = "tiezhang/shishi"},
    room_relative = "石室→石阶↓石阶石阶"
}
Room {
    id = "tiezhang/shishi",
    name = "石室",
    ways = {["eastup"] = "tiezhang/shijie-3"},
    objs = {["上官剑南"] = "shangguan jiannan"}
}
Room {
    id = "tiezhang/shufang",
    name = "书房",
    ways = {["south"] = "tiezhang/zoulang-2"}
}
Room {
    id = "tiezhang/shuijing",
    name = "蝴蝶泉",
    ways = {["northwest"] = "tiezhang/guajia"}
}
Room {
    id = "tiezhang/sslin-1",
    name = "松树林",
    ways = {["south"] = "tiezhang/shanlu-7", ["east"] = "tiezhang/sslin-2"},
    room_relative = "松树林｜松树林----松树林----松树林｜山路松树林"
}
Room {
    id = "tiezhang/sslin-2",
    name = "松树林",
    ways = {["north"] = "tiezhang/sslin-3", ["west"] = "tiezhang/sslin-1"}
}
Room {
    id = "tiezhang/sslin-3",
    name = "松树林",
    ways = {["south"] = "tiezhang/sslin-2", ["west"] = "tiezhang/sslin-4"},
    objs = {["虎皮"] = "hu pi", ["老虎"] = "lao hu"}
}
Room {
    id = "tiezhang/sslin-4",
    name = "松树林",
    ways = {["north"] = "tiezhang/sslin-5", ["east"] = "tiezhang/sslin-3"}
}
Room {
    id = "tiezhang/sslin-5",
    name = "松树林",
    ways = {["south"] = "tiezhang/sslin-4", ["north"] = "tiezhang/dezj"}
}
Room {
    id = "tiezhang/sslu-1",
    name = "碎石路",
    ways = {["eastup"] = "tiezhang/sslu-2", ["westdown"] = "tiezhang/pingtai"},
    room_relative = "山间平台→碎石路→碎石路碎石路"
}
Room {
    id = "tiezhang/sslu-2",
    name = "碎石路",
    ways = {["eastup"] = "tiezhang/sslu-3", ["westdown"] = "tiezhang/sslu-1"},
    room_relative = "碎石路→碎石路→碎石路碎石路"
}
Room {
    id = "tiezhang/sslu-3",
    name = "碎石路",
    ways = {["northup"] = "tiezhang/mzfeng", ["westdown"] = "tiezhang/sslu-2"},
    room_relative = "拇指峰↑碎石路→碎石路碎石路"
}
Room {
    id = "tiezhang/taijie-1",
    name = "石阶",
    ways = {["westdown"] = "tiezhang/taijie-2", ["out"] = "tiezhang/trdx"}
}
Room {
    id = "tiezhang/taijie-2",
    name = "石阶",
    ways = {["eastup"] = "tiezhang/taijie-1"}
}
Room {
    id = "tiezhang/trdx",
    name = "天然洞穴",
    ways = {["out"] = "tiezhang/dong-3"}
}
Room {
    id = "tiezhang/wmfeng",
    name = "无名峰",
    ...
    nolooks = {["#PoutShangguan"] = true},
    lengths = {["#PoutShangguan"] = 10}
}
Room {
    id = "tiezhang/wztang",
    name = "五指堂",
    ...
    postcmds = {["southdown"] = "halt"},
    objs = {["洪啸天"] = "hong xiaotian"}
}
Room {
    id = "tiezhang/xxsnan",
    name = "男休息室",
    no_fight = true,
    ways = {["south"] = "tiezhang/zoulang-4"}
}
Room {
    id = "tiezhang/xxsnv",
    name = "女休息室",
    no_fight = true,
    ways = {["north"] = "tiezhang/zoulang-4"}
}
Room {
    id = "tiezhang/xzfeng",
    name = "小指峰",
    ways = {["southdown"] = "tiezhang/pubu"}
}
Room {
    id = "tiezhang/zhaigou1",
    name = "寨沟",
    ways = {["east"] = "tiezhang/shanmen", ["west"] = "tiezhang/zhaigou2"},
    room_relative = "寨沟-----寨沟-----山门寨沟"
}
Room {
    id = "tiezhang/zhaigou2",
    name = "寨沟",
    ways = {["east"] = "tiezhang/zhaigou1"}
}
Room {
    id = "tiezhang/zhaigou3",
    name = "寨沟",
    ways = {["east"] = "tiezhang/zhaigou4", ["west"] = "tiezhang/shanmen"},
    room_relative = "山门-----寨沟-----寨沟寨沟"
}
Room {
    id = "tiezhang/zhaigou4",
    name = "寨沟",
    ways = {["west"] = "tiezhang/zhaigou3"}
}
Room {
...
Room {
    ...
    name = "走廊",
    ways = {["east"] = "tiezhang/zoulang-2", ["north"] = "tiezhang/chufang"},
...
Room {
    id = "tiezhang/zzfeng",
    name = "中指峰",
    ways = {["southdown"] = "tiezhang/shanlu-9"}
}
Room {
    id = "tls/3wg",
    name = "三无宫",
...
Room {
    ...
    objs = {["了修禅师"] = "liaoxiu chanshi"}
}
Room {id = "tls/banruo1", name = "般若台", ways = {["west"] = "tls/banruo"}}
Room {
    id = "tls/baodian",
    name = "大雄宝殿",
    ways = {
...
Room {id = "tls/bingqi", name = "兵器房", ways = {["west"] = "tls/cby"}}
Room {
    id = "tls/bzq",
    name = "百丈桥",
    ways = {["south"] = "tls/bzqs", ["north"] = "tls/bzqn"}
}
Room {
    id = "tls/bzqn",
    name = "百丈桥",
    ways = {["south"] = "tls/bzq", ["east"] = "tls/wxj", ["north"] = "tls/fqg"}
}
Room {
    id = "tls/bzqs",
    name = "百丈桥边",
    ways = {["south"] = "tls/road5", ["north"] = "tls/bzq"},
    objs = {["了宽禅师"] = "liaokuan chanshi"}
}
Room {
    id = "tls/cby",
    name = "慈悲院",
...
Room {
    ...
    no_fight = true,
    ways = {["east"] = "tls/zt1"},
    objs = {["米饭"] = "rice", ["大碗"] = "da wan"}
}
Room {
    id = "tls/dc1",
    name = "点苍十九峰",
    ways = {["north"] = "tls/ylf1", ["southdown"] = "tls/dc2"}
}
Room {
    id = "tls/dc2",
    name = "点苍十九峰",
    ways = {["northup"] = "tls/dc1", ["eastdown"] = "tls/dc3"}
}
Room {
    id = "tls/dc3",
    name = "点苍十九峰",
    ways = {["westup"] = "tls/dc2", ["southdown"] = "tls/diancang"}
}
Room {
    id = "tls/diancang",
    name = "点苍山",
...
Room {
    id = "tls/dmg",
    name = "斗母宫",
    ways = {["north"] = "tls/road6", ["east"] = "tls/road4"}
}
Room {
    id = "tls/fqg",
    name = "飞泉沟",
    ways = {["northup"] = "tls/wxt", ["south"] = "tls/bzqn"}
}
Room {
    id = "tls/gate",
    name = "崇圣寺",
    ways = {["south"] = "tls/shanlu", ["enter"] = "tls/road"}
}
Room {
    id = "tls/gfd",
    name = "光佛宝殿",
    ...
    objs = {["本因大师"] = "benyin dashi"}
}
Room {
    id = "tls/gmd",
    name = "大光明殿",
    ways = {["south"] = "tls/sjt", ["east"] = "tls/yz3"}
}
Room {
    id = "tls/goudi",
    name = "百丈桥底",
    ways = {["eastup"] = "tls/road5"}
}
Room {id = "tls/guanchong", name = "关冲"}
Room {
    id = "tls/gulou",
    name = "鼓楼",
    ways = {
...
Room {
    id = "tls/lang",
    name = "长廊",
    ways = {["east"] = "tls/songlin", ["west"] = "tls/road3"}
}
Room {
    id = "tls/lang2",
    name = "长廊",
...
Room {
    id = "tls/longxiang2",
    name = "西练武场-龙象台",
    ways = {["southdown"] = "tls/longxiang1"}
}
Room {
    id = "tls/longxiang3",
    name = "西练武场-龙象台",
    ways = {["northup"] = "tls/longxiang1"}
}
Room {
    id = "tls/longxiang4",
    name = "西练武场-龙象台",
    ways = {["east"] = "tls/longxiang1", ["west"] = "tls/shanlu-1"},
    objs = {["了行禅师"] = "liaoxing chanshi"}
}
Room {
    id = "tls/lsy",
    name = "龙树院",
    ways = {["out"] = "tls/songlin-1"},
    objs = {["枯荣长老"] = "kurong zhanglao"}
}
Room {
    id = "tls/men1",
    name = "瑞鹤门",
...
Room {
    id = "tls/men3",
    name = "晃天门",
    ways = {["east"] = "tls/yaotai", ["west"] = "tls/yz4"},
    nolooks = {["south"] = true, ["east"] = true},
    precmds = {["east"] = "open door"}
}
Room {
...
Room {
    ...
    name = "商阳",
    ways = {["south"] = "tls/pyd/pyd"}
}
Room {
    id = "tls/pyd/shaochong",
    name = "少冲",
    ways = {["northwest"] = "tls/pyd/shaochong"}
}
Room {
    id = "tls/pyd/shaoshang",
    name = "少商",
    ways = {["southdown"] = "tls/pyd/pyd"}
}
Room {
    id = "tls/pyd/shaoze",
    name = "少泽",
    ways = {["northeast"] = "tls/pyd/shaoze"}
}
Room {
    id = "tls/pyd/zhongchong",
    name = "中冲",
    ways = {["southwest"] = "tls/pyd/pyd"}
}
Room {
    id = "tls/qxg",
    name = "清心阁",
    no_fight = true,
    ways = {["east"] = "tls/shiyuan"}
}
Room {
    id = "tls/road",
    name = "白石路",
    ...
    objs = {["无量功德碑"] = "board", ["了惑禅师"] = "liaohuo chanshi"}
}
Room {
    id = "tls/road1",
    name = "白石路",
...
Room {
    id = "tls/road3",
    name = "白石路",
    ways = {["east"] = "tls/lang", ["west"] = "tls/wwj"}
}
Room {
    id = "tls/road4",
    name = "白石路",
...
Room {
    id = "tls/road5",
    name = "石板路",
    ways = {["south"] = "tls/shiyuan", ["north"] = "tls/bzqs"}
}
Room {id = "tls/road6", name = "白石阶", ways = {["southdown"] = "tls/dmg"}}
Room {
    id = "tls/road7",
    name = "石板路",
    ways = {["south"] = "tls/yuhua1", ["north"] = "tls/songlin-1"}
}
Room {id = "tls/shangyang", name = "商阳"}
Room {
    id = "tls/shanlu",
    name = "山路",
    ways = {["south"] = "tls/ylf2", ["north"] = "tls/gate"},
    objs = {["段永"] = "nan dizi", ["段刚"] = "nan dizi"}
}
Room {
    id = "tls/shanlu-1",
    name = "石板路",
    ways = {["east"] = "tls/longxiang4", ["west"] = "tls/shanlu-2"}
}
Room {
    id = "tls/shanlu-2",
    name = "石板路",
    ways = {["east"] = "tls/shanlu-1", ["west"] = "tls/shanlu-3"}
}
Room {
    id = "tls/shanlu-3",
    name = "石板路",
    ways = {["east"] = "tls/shanlu-2", ["west"] = "tls/shanlu-4"}
}
Room {
    id = "tls/shanlu-4",
    name = "石板路",
    ways = {["east"] = "tls/shanlu-3", ["west"] = "tls/talin"}
}
Room {id = "tls/shaochong", name = "少冲"}
Room {id = "tls/shaoshang", name = "少商"}
Room {id = "tls/shaoze", name = "少泽"}
Room {
    id = "tls/shiyuan",
    name = "兜率大士院",
    ways = {
...
Room {
    ...
    name = "诵经堂",
    no_fight = true,
    ways = {["east"] = "tls/yz6", ["north"] = "tls/gmd"}
}
Room {
    id = "tls/songlin",
    name = "松树林",
...
Room {
    id = "tls/songlin1",
    name = "松树林",
    ways = {["north"] = "tls/songlin2"}
}
Room {
    id = "tls/songlin2",
    name = "松树林",
    ways = {["north"] = "tls/songlin1", ["west"] = "tls/songlin-3"}
}
Room {
    id = "tls/songlin-1",
    name = "松树林",
...
Room {
    id = "tls/songlin-2",
    name = "松树林",
    ways = {["east"] = "tls/songlin-4", ["west"] = "tls/songlin-3"}
}
Room {
    id = "tls/songlin-3",
    name = "松树林",
...
Room {
    ...
    name = "休息室",
    no_fight = true,
    ways = {["south"] = "tls/road4", ["east"] = "tls/sroom"}
}
Room {
    id = "tls/sroom2",
    name = "休息室",
    no_fight = true,
    ways = {["south"] = "tls/road4", ["west"] = "tls/sroom"}
}
Room {
    id = "tls/ta1",
    name = "千寻宝塔",
    ways = {["south"] = "tls/yz6", ["north"] = "tls/yz3"}
}
Room {id = "tls/ta2", name = "无相宝塔", ways = {["south"] = "tls/yz4"}}
Room {id = "tls/ta3", name = "无住宝塔", ways = {["south"] = "tls/yz5"}}
Room {id = "tls/talin", name = "灵塔林", ways = {["east"] = "tls/shanlu-4"}}
Room {
    id = "tls/twd",
    name = "天王殿",
    ways = {["northdown"] = "tls/road1", ["southdown"] = "tls/road"}
}
Room {
    id = "tls/wfd",
    name = "万佛洞",
    ways = {["enter"] = "tls/wfd2", ["up"] = "tls/wxt"}
}
Room {
    id = "tls/wfd2",
    name = "万佛洞",
    ways = {["north"] = "tls/wfd3", ["out"] = "tls/wfd"}
}
Room {
    id = "tls/wfd3",
    name = "万佛洞内洞",
...
Room {id = "tls/wuping", name = "物品房", ways = {["south"] = "tls/cby"}}
Room {
    id = "tls/wuwoge",
    name = "无我阁",
    no_fight = true,
...
Room {id = "tls/wxj", name = "无心井", ways = {["west"] = "tls/bzqn"}}
Room {
    id = "tls/wxt",
    name = "忘雪亭",
    ways = {["down"] = "tls/wfd", ["southdown"] = "tls/fqg"}
}
Room {id = "tls/xdt", name = "小洞天", ways = {["west"] = "tls/songlin-2"}}
Room {
    id = "tls/xiuxishi1",
    name = "休息室",
    no_fight = true,
...
Room {
    id = "tls/xmd",
    name = "须弥殿",
    ways = {["south"] = "tls/ytd", ["west"] = "tls/yz3"}
}
Room {
    id = "tls/yaofang",
    name = "药房",
    ways = {["north"] = "tls/yaotai"},
    objs = {["了明禅师"] = "liaoming chanshi"}
}
Room {
    id = "tls/yaoshidian",
    name = "药师殿",
...
Room {
    ...
    nolooks = {["west"] = true},
    precmds = {["west"] = "open door"},
    objs = {["了清禅师"] = "liaoqing chanshi"}
}
Room {
    id = "tls/ylf",
    name = "应乐峰",
    ways = {["northdown"] = "tls/ylf2", ["southdown"] = "tls/ylf1"}
}
Room {
    id = "tls/ylf1",
    name = "应乐峰南",
    ways = {["northup"] = "tls/ylf", ["south"] = "tls/dc1"}
}
Room {
    id = "tls/ylf2",
    name = "应乐峰北",
    ways = {["southup"] = "tls/ylf", ["north"] = "tls/shanlu"},
    objs = {["黄鹿"] = "huang lu", ["野猪"] = "ye zhu"}
}
Room {
    id = "tls/ytd",
    name = "圆通殿",
    ways = {["north"] = "tls/xmd", ["west"] = "tls/yz6"}
}
Room {
    id = "tls/yuhua",
    name = "雨花院",
...
Room {
    ...
    objs = {["了思禅师"] = "liaosi chanshi"}
}
Room {
    id = "tls/yz1",
    name = "松树院",
    ways = {["north"] = "tls/zt1", ["east"] = "tls/road"}
}
Room {
    id = "tls/yz2",
    name = "斑竹院",
    ways = {["north"] = "tls/zt", ["west"] = "tls/road"}
}
Room {
    id = "tls/yz3",
    name = "青竹院",
...
Room {id = "tls/zhongchong", name = "中冲"}
Room {
    id = "tls/zhonglou",
    name = "钟楼",
    ways = {
...
Room {
    ...
    name = "天龙寺斋堂",
    no_fight = true,
    ways = {["south"] = "tls/yz2", ["north"] = "tls/gulou"},
    objs = {["大碗"] = "da wan"}
}
Room {
    id = "tls/zt1",
    ...
    objs = {["青菜"] = "qing cai", ["大碗"] = "da wan", ["米饭"] = "rice"}
}
Room {
    id = "village/caidi",
    name = "菜地",
    ways = {["#hscaidi"] = "village/zhongxin"},
    nolooks = {
        ["#hscaidi"] = true,
        ["south"] = true,
        ["north"] = true,
...
Room {
    id = "village/eexit",
    name = "东村口",
    ways = {["east"] = "huashan/path1", ["west"] = "village/shilu6"}
}
Room {
    id = "village/hsroad3",
    name = "黄土路",
    ways = {["south"] = "xiangyang/shanxiroad2", ["north"] = "village/sexit"}
}
Room {
    id = "village/jiusi",
    name = "酒肆",
    ways = {["south"] = "village/shilu3"}
}
Room {
    id = "village/miaoyu",
    name = "玄坛庙",
    ways = {["north"] = "village/shilu5"}
}
Room {
    id = "village/minfang1",
    name = "民房",
    ways = {["east"] = "village/shilu1"},
    room_relative = "民房-----碎石路民房"
}
Room {
    id = "village/minfang2",
    name = "民房",
    ways = {["north"] = "village/shilu6"},
    room_relative = "碎石路｜民房民房"
}
Room {
    id = "village/sexit",
    name = "南村口",
    ways = {["south"] = "village/hsroad3", ["north"] = "village/shilu1"}
}
Room {
    id = "village/shilu1",
    name = "碎石路",
...
Room {
    ...
    name = "铁匠铺",
    ways = {["west"] = "village/shilu2"}
}
Room {
    id = "village/zahuopu",
    name = "杂货铺",
    ways = {["south"] = "village/shilu4"}
}
Room {
    id = "village/zhongxin",
    name = "村中心",
    ...
    postcmds = {["northwest"] = "#walkBusy", ["northeast"] = "#walkBusy"},
    lengths = {["northwest"] = 10, ["northeast"] = 10}
}
...
Room {
    id = "wizard/lt1a",
    name = "风云门东看台",
    ways = {["west"] = "wizard/lt1"}
}
Room {
    id = "wizard/lt1b",
    name = "风云门东看台",
    ways = {["east"] = "wizard/lt1"}
}
Room {
    id = "wizard/lt1c",
    name = "风云门东看台",
    ways = {["north"] = "wizard/lt1"}
}
Room {
    id = "wizard/lt1d",
    name = "风云门东看台",
    ways = {["south"] = "wizard/lt1"}
}
Room {
    id = "wizard/lt2",
    name = "龙虎门",
...
Room {
    id = "wizard/lt2a",
    name = "龙虎门东看台",
    ways = {["west"] = "wizard/lt2"}
}
Room {
    id = "wizard/lt2b",
    name = "龙虎门东看台",
    ways = {["east"] = "wizard/lt2"}
}
Room {
    id = "wizard/lt2c",
    name = "龙虎门东看台",
    ways = {["north"] = "wizard/lt2"}
}
Room {
    id = "wizard/lt2d",
    name = "龙虎门东看台",
    ways = {["south"] = "wizard/lt2"}
}
Room {
    id = "wizard/lta",
    name = "天地门东看台",
...
Room {
    id = "wizard/ltc",
    name = "天地门南看台",
    ways = {["north"] = "wizard/lt"}
}
Room {
    id = "wizard/ltd",
    name = "天地门北看台",
    ways = {["south"] = "wizard/lt"}
}
Room {
    id = "wizard/wizard_meet",
    name = "巫师会议室",
    ways = {["down"] = "wizard/guest_room", ["west"] = "wizard/wizard_room"}
}
Room {
    id = "wizard/wizard_room",
    name = "巫师休息室",
    ways = {["down"] = "wizard/guest_room", ["up"] = "wizard/zoulang"}
}
Room {id = "wizard/zoulang", name = "走廊"}
Room {
    id = "wudang/caihong",
    name = "雨后彩虹",
    ways = {["northup"] = "wudang/wangbei", ["southup"] = "wudang/shibapan"}
}
Room {
    id = "wudang/chating",
    name = "茶亭",
    ways = {["northwest"] = "wudang/wdroad8"},
    objs = {["桃花姑娘"] = "tao hua"}
}
Room {
    id = "wudang/chufang",
    name = "厨房",
    no_fight = true,
    ways = {["west"] = "wudang/donglang2"},
    objs = {["大碗茶"] = "dawan cha", ["香茶"] = "xiang cha"}
}
Room {
    id = "wudang/donglang1",
    name = "西厢走廊",
...
Room {
    id = "wudang/feisheng",
    name = "飞升崖",
    ways = {["northeast"] = "wudang/zhenqing"}
}
Room {
    id = "wudang/fuzhen",
    name = "复真观",
    ...
    objs = {["谷虚道长"] = "guxu daozhang"}
}
Room {
    id = "wudang/gchang",
    name = "武当广场",
    ways = {["south"] = "wudang/zhenqing", ["north"] = "wudang/nanyan"}
}
Room {
    id = "wudang/gsdao1",
    name = "古神道",
    ways = {["southup"] = "wudang/yuanhe", ["northdown"] = "wudang/shijie1"},
    room_relative = "石阶↓古神道↓元和观古神道"
}
Room {
    id = "wudang/gsdao2",
    name = "古神道",
    ways = {["southup"] = "wudang/yuzhen", ["northdown"] = "wudang/yuanhe"},
    room_relative = "元和观↓古神道↓遇真宫古神道"
}
Room {
    id = "wudang/gsdao3",
    name = "古神道",
    ways = {["southwest"] = "wudang/leishen", ["east"] = "wudang/zhanqi"},
    room_relative = "天乙真庆宫↓古神道↓石阶古神道"
}
Room {
    id = "wudang/gsdao4",
    name = "古神道",
    ways = {["southup"] = "wudang/shijie4", ["northdown"] = "wudang/zhenqing"},
    room_relative = "天乙真庆宫↓古神道↓石阶古神道"
}
Room {
    id = "wudang/gsdao5",
    name = "古神道",
    ways = {["southup"] = "wudang/langmei", ["northdown"] = "wudang/shijie4"},
    room_relative = "石阶↓古神道↓榔梅祠古神道"
}
Room {
    id = "wudang/gsdao6",
    name = "古神道",
    ways = {["westdown"] = "wudang/qtguan", ["eastup"] = "wudang/hldong"},
    room_relative = "琼台观→古神道→黄龙洞古神道"
}
Room {
    id = "wudang/hldong",
    name = "黄龙洞",
    ways = {["southup"] = "wudang/taihe", ["westdown"] = "wudang/gsdao6"}
}
Room {
...
Room {
    ...
    name = "茅屋",
    ways = {["north"] = "wudang/houshan/taoyuan3"}
}
Room {
...
Room {
    ...
    name = "谷底",
    ways = {["southeast"] = "wudang/houshan/clbinyuan1"}
}
Room {
    ...
    nolooks = {["zuan conglin"] = true},
    room_relative = "谷底↖丛林边缘丛林边缘"
}
Room {
    id = "wudang/houshan/conglinlh",
    name = "烈火丛林",
    ways = {["#outWdcllh"] = "wudang/houshan/conglinly"},
    nolooks = {["#outWdcllh"] = true}
}
Room {
    id = "wudang/houshan/conglinly",
    name = "落叶丛林",
    ways = {["#outWdclly"] = "wudang/houshan/conglinjx"},
    nolooks = {["#outWdclly"] = true}
    -- blocks = {
    --	["#outWdclly"] = {
    --		{id = "du she", exp = 10000},
...
Room {
    ...
    name = "积雪丛林",
    ways = {["#outWdcljx"] = "wudang/houshan/conglinky"},
    nolooks = {["#outWdcljx"] = true}
    -- blocks = {
    --	["#outWdcljx"] = {
...
Room {
    ...
    name = "阔叶丛林",
    ways = {["#outWdclky"] = "wudang/houshan/clbianyuan2"},
    nolooks = {["#outWdclky"] = true}
}
Room {
    id = "wudang/houshan/clbianyuan2",
    name = "丛林边缘",
    ways = {["#wdclToHsda"] = "xiangyang/hanshui2"},
    nolooks = {["#wdclToHsda"] = true},
...
Room {
    id = "wudang/houyuan",
    name = "后山小院",
    ways = {["north"] = "wudang/yuanmen"},
    nolooks = {["north"] = true},
    precmds = {["north"] = "open door"},
    objs = {["张三丰"] = "zhang sanfeng"}
}
Room {
    id = "wudang/jindian",
    name = "金殿",
    ways = {["east"] = "wudang/taihe"}
}
Room {
    id = "wudang/jingge",
    name = "藏经阁",
    ways = {["east"] = "wudang/donglang1"},
    objs = {["道德经「第一章」"] = "jing"}
}
Room {
    id = "wudang/langmei",
...
Room {
    id = "wudang/laojun",
    name = "老君岩",
    ways = {["east"] = "wudang/fuzhen"}
}
Room {
    id = "wudang/ldfang",
    name = "炼丹房",
    ways = {["west"] = "wudang/zoulang2"},
    objs = {["俞岱岩"] = "yu daiyan"}
}
Room {
    id = "wudang/leishen",
    name = "雷神洞",
    ways = {["northeast"] = "wudang/gsdao3"}
}
Room {
    id = "wudang/lgfang",
    name = "练功房",
    ways = {["south"] = "wudang/zoulang1"},
    objs = {["芙蓉金针"] = "furong jinzhen"}
}
Room {
    id = "wudang/lwhole",
    name = "石壁岩洞",
    no_fight = true,
    ways = {["out"] = "wudang/wanniansong"}
}
Room {
    id = "wudang/mozhen",
    name = "磨针井",
...
Room {
    id = "wudang/nanyan",
    name = "大圣南岩宫",
    ways = {["south"] = "wudang/gchang", ["northdown"] = "wudang/zixia"},
    objs = {["陈运清"] = "chen yunqing"}
}
Room {
    id = "wudang/qtguan",
    name = "琼台观",
    ways = {["eastdown"] = "wudang/langmei", ["eastup"] = "wudang/gsdao6"}
}
Room {
    id = "wudang/sanqing",
    name = "三清殿",
    ...
    objs = {["宋远桥"] = "song yuanqiao", ["太极八卦图"] = "board"}
}
Room {
    id = "wudang/shanlu1",
    name = "山路",
    ways = {["westup"] = "wudang/yuxu", ["northdown"] = "wudang/wdbolin"},
...
Room {
    ...
    objs = {["采药道长"] = "caiyao daozhang"},
    room_relative = "榔梅祠-----山路↘小路山路",
    nolooks = {["give caiyao yao chu"] = true},
    lengths = {
...
Room {
    ...
    name = "古道",
    ways = {["southup"] = "wudang/houshan/gudao2"},
    objs = {["野兔"] = "ye tu"},
...
Room {
    ...
    name = "猢狲愁",
    ways = {["northdown"] = "wudang/houshan/gudao2"},
    objs = {["猴子"] = "hou zi"}
}
----------------------------------
Room {
    id = "wudang/shanlu3",
    name = "灌木丛",
    ways = {["west"] = "wudang/shanlu2"}
}
Room {
    id = "wudang/shibapan",
    name = "十八盘",
    ways = {["southup"] = "wudang/fuzhen", ["northdown"] = "wudang/caihong"}
}
Room {
    id = "wudang/shijie1",
    name = "石阶",
    ways = {["southup"] = "wudang/gsdao1", ["northdown"] = "wudang/xuanyue"},
    room_relative = "玄岳门↓石阶↓古神道石阶"
}
Room {
    id = "wudang/shijie2",
    name = "石阶",
    ways = {["southup"] = "wudang/zhanqi", ["eastdown"] = "wudang/fuzhen"},
    room_relative = "石阶←复真观↓展旗峰石阶"
}
Room {
    id = "wudang/shijie3",
    name = "石阶",
    ways = {["southup"] = "wudang/zxgdamen", ["northdown"] = "wudang/zhanqi"},
    room_relative = "展旗峰↓石阶↓紫霄宫大门石阶"
}
Room {
    id = "wudang/shijie4",
    name = "石阶",
    ways = {["southup"] = "wudang/gsdao5", ["northdown"] = "wudang/gsdao4"}
}
Room {
    id = "wudang/taihe",
    name = "大岳太和宫",
    ways = {["northdown"] = "wudang/hldong", ["west"] = "wudang/jindian"}
}
Room {
    id = "wudang/wangbei",
    name = "望背坡",
    ways = {["northdown"] = "wudang/mozhen", ["southdown"] = "wudang/caihong"}
}
Room {
    id = "wudang/wanniansong",
    name = "万年松",
    ways = {["enter"] = "wudang/lwhole"}
}
Room {
    id = "wudang/wdbolin",
    name = "武当柏林",
    ways = {["southup"] = "wudang/shanlu1", ["eastdown"] = "wudang/yuzhen"}
}

Room {
    id = "wudang/wdroad6",
    name = "黄土路",
    ways = {["east"] = "xiangyang/hanshui2", ["west"] = "group/entry/wdroad7"},
    objs = {
        ["泉建男"] = "quan jiannan",
        ["青龙帮弟子"] = "qinglong dizi"
    },
...
Room {
    ...
    name = "男休息室",
    no_fight = true,
    ways = {["north"] = "wudang/donglang2"}
}
Room {
    id = "wudang/xiuxishi2",
    name = "女休息室",
    no_fight = true,
    ways = {["north"] = "wudang/donglang1"}
}
Room {
    id = "wudang/xuanyue",
    name = "玄岳门",
    ways = {["southup"] = "wudang/shijie1", ["east"] = "wudang/wdroad8"}
}
Room {
    id = "wudang/yaofang",
    name = "药房",
    no_fight = true,
    ways = {["east"] = "wudang/zoulang3"},
    objs = {["丹炉"] = "dan lu"}
}
Room {
    id = "wudang/yuanhe",
...
Room {
    id = "wudang/yuxu",
    name = "玉虚宫",
    ways = {["southup"] = "wudang/mozhen", ["eastdown"] = "wudang/shanlu1"}
}
Room {
    id = "wudang/yuxuyan",
    name = "玉虚岩",
    ways = {["westdown"] = "wudang/mozhen"}
}
Room {
    id = "wudang/yuzhen",
    name = "遇真宫",
    ways = {["westup"] = "wudang/wdbolin", ["northdown"] = "wudang/gsdao2"},
    objs = {["知客道长"] = "zhike daozhang", ["功德箱"] = "gongde xiang"}
}
Room {
    id = "wudang/yxyan",
    name = "隐仙岩",
    ways = {["southeast"] = "wudang/langmei", ["westup"] = "wudang/wulong"}
}
Room {
    id = "wudang/zhanqi",
    name = "展旗峰",
...
Room {
    id = "wudang/zixia",
    name = "紫霄宫",
    ways = {["southup"] = "wudang/nanyan", ["out"] = "wudang/zxgdamen"},
    objs = {["万青里"] = "wan qingli"}
}
Room {
    id = "wudang/zoulang1",
...
Room {
    id = "wudang/zoulang2",
    name = "东厢走廊",
    ways = {["east"] = "wudang/ldfang", ["west"] = "wudang/zoulang1"},
    room_relative = "走廊---东厢走廊---炼丹房东厢走廊"
}
Room {
    id = "wudang/zoulang3",
    name = "西厢走廊",
    ways = {["east"] = "wudang/zoulang1", ["west"] = "wudang/yaofang"},
    room_relative = "药房---西厢走廊---走廊西厢走廊"
}
Room {
    id = "wudang/zxgdamen",
    name = "紫霄宫大门",
    ways = {["enter"] = "wudang/zixia", ["northdown"] = "wudang/shijie3"},
    objs = {["风松道长"] = "fengsong daozhang"}
}
Room {
    id = "wuguan/bingqiku",
    name = "兵器库",
    ways = {["north"] = "wuguan/wuchang3"}
}
Room {
    id = "wuguan/caidi",
    name = "菜地",
    ways = {["south"] = "wuguan/houyuan"}
}
Room {
    id = "wuguan/caiyuan",
    name = "菜园",
    ways = {["west"] = "wuguan/houyuan"}
}
Room {
    id = "wuguan/chaifang",
    name = "柴房",
    ways = {["east"] = "wuguan/houyuan"}
}
Room {
    id = "wuguan/chufang",
    name = "厨房",
    ways = {["east"] = "wuguan/zoulang1"}
}
Room {
    id = "wuguan/citang",
    name = "破祠堂",
    ways = {["southwest"] = "wuguan/houhuayuan"}
}
Room {
    id = "wuguan/dating",
    name = "武馆大厅",
...
Room {
    ...
    name = "后花园",
    ways = {["south"] = "wuguan/xiaojing1", ["northeast"] = "wuguan/citang"}
}
Room {
    id = "wuguan/houyuan",
    name = "后院",
...
Room {
    id = "wuguan/huilang",
    name = "回廊",
    ways = {["east"] = "wuguan/xiaojing2", ["west"] = "wuguan/zoulang7"}
}
Room {
    id = "wuguan/jiashan",
    name = "假山",
    ways = {["south"] = "wuguan/zhulin1", ["north"] = "wuguan/wxting"}
}
Room {id = "wuguan/jiashan1", name = "假山"}
Room {
    id = "wuguan/liangong",
    name = "练功房",
    ways = {["north"] = "wuguan/shilu4"}
}
Room {
    id = "wuguan/mafang",
    name = "马厩",
    ways = {["north"] = "wuguan/shilu2"}
}
Room {
    id = "wuguan/menlang",
    name = "门廊",
...
Room {
    id = "wuguan/mishi",
    name = "密室",
    ways = {["out"] = "wuguan/jiashan1"}
}
Room {
    id = "wuguan/mufang",
    name = "木房",
    ways = {["east"] = "wuguan/shilu2"}
}
Room {
    id = "wuguan/pianting1",
    name = "偏厅",
    ways = {["south"] = "wuguan/zoulang5"}
}
Room {
    id = "wuguan/qianting",
    name = "武馆前厅",
    ways = {["south"] = "wuguan/menlang", ["north"] = "wuguan/dayuan"}
}
Room {
    id = "wuguan/shilu1",
    name = "白石路",
    ways = {["south"] = "wuguan/zoulang1", ["north"] = "wuguan/houyuan"}
}
Room {
    id = "wuguan/shilu2",
    name = "小路",
...
Room {
    id = "wuguan/shilu3",
    name = "小石路",
    ways = {["east"] = "wuguan/dayuan", ["west"] = "wuguan/wuchang2"}
}
Room {
    id = "wuguan/shilu4",
    name = "碎石路",
...
Room {
    id = "wuguan/shufang",
    name = "书房",
    ways = {["south"] = "wuguan/zoulang6"}
}
Room {
    id = "wuguan/shuifang",
    name = "水房",
    ways = {["west"] = "wuguan/shilu2"}
}
Room {
    id = "wuguan/woshi",
    name = "冬暖阁",
    ways = {["south"] = "wuguan/zoulang3"}
}
Room {
    id = "wuguan/wuchang1",
    name = "西武场",
    ways = {["east"] = "wuguan/wuchang2"}
}
Room {
    id = "wuguan/wuchang2",
    name = "西练武场",
...
Room {
    id = "wuguan/wuchang4",
    name = "东武场",
    ways = {["west"] = "wuguan/wuchang3"}
}
Room {
    id = "wuguan/wupinfang",
    name = "物品房",
    ways = {["northwest"] = "wuguan/dating"}
}
Room {
    id = "wuguan/wxting",
    name = "文霞亭",
    ways = {["south"] = "wuguan/jiashan", ["west"] = "wuguan/xiaojing2"}
}
Room {
    id = "wuguan/xiangfang1",
    name = "东厢房",
    ways = {["east"] = "wuguan/xiangfang2", ["west"] = "wuguan/zoulang3"}
}
Room {
    id = "wuguan/xiangfang2",
    name = "睡房",
    ways = {["west"] = "wuguan/xiangfang1"}
}
Room {
    id = "wuguan/xiaojing1",
    name = "小径",
    ways = {["south"] = "wuguan/xiaojing2", ["north"] = "wuguan/houhuayuan"}
}
Room {
    id = "wuguan/xiaojing2",
    name = "石径",
...
Room {
    id = "wuguan/xxshi1",
    name = "男休息室",
    ways = {["south"] = "wuguan/zoulang7"}
}
Room {
    id = "wuguan/xxshi2",
    name = "女休息室",
    ways = {["north"] = "wuguan/zoulang7"}
}
Room {
    id = "wuguan/yiguan",
    name = "驿馆",
    ways = {["east"] = "wuguan/menlang"}
}
Room {
    id = "wuguan/zhangfang",
    name = "帐房",
    ways = {["north"] = "wuguan/zoulang6"}
}
Room {
    id = "wuguan/zhulin1",
    name = "竹林",
...
Room {
    id = "wuguan/zoulang2",
    name = "西廊",
    ways = {["eastup"] = "wuguan/dating", ["west"] = "wuguan/zoulang1"}
}
Room {
    id = "wuguan/zoulang3",
    name = "走廊",
...
Room {
    id = "wuguan/zoulang4",
    name = "走廊",
    ways = {["north"] = "wuguan/zoulang3", ["out"] = "wuguan/dating"}
}
Room {
    id = "wuguan/zoulang5",
    name = "东廊",
...
Room {
    id = "xiakedao/dongmen",
    name = "洞门",
    ways = {["enter"] = "xiakedao/yingbin", ["west"] = "xiakedao/shidong1"}
}
Room {
    id = "xiakedao/haigang",
    name = "渔港",
    ways = {["east"] = "xiakedao/xkroad4"}
}
Room {
    id = "xiakedao/haitan",
    name = "海滩",
    ways = {["south"] = "xiakedao/lin1"}
}
Room {
    id = "xiakedao/lin1",
    name = "树林",
...
Room {
    id = "xiakedao/lin8",
    name = "树林",
    ways = {["south"] = "xiakedao/shanmen", ["north"] = "xiakedao/lin7"}
}
Room {
    id = "xiakedao/midao1",
    name = "秘密通道",
...
Room {
    id = "xiakedao/midao4",
    name = "密道",
    ways = {["east"] = "xiakedao/midao3"}
}
Room {
    id = "xiakedao/midao5",
    name = "秘密通道",
    ways = {["east"] = "xiakedao/midao4", ["out"] = "xiakedao/neiting"}
}
Room {
    id = "xiakedao/midao6",
    name = "石洞",
    ways = {["west"] = "xiakedao/midao7"}
}
Room {
    id = "xiakedao/midao7",
    name = "秘密通道",
...
Room {id = "xiakedao/midao8", name = "密道"}
Room {
    id = "xiakedao/mtdating",
    name = "大厅",
    ways = {["down"] = "xiakedao/mtyadi", ["east"] = "xiakedao/mtxiaowu"}
}
Room {
    id = "xiakedao/mtroad",
    name = "山路",
    ways = {["south"] = "xiakedao/mtyadi", ["east"] = "xiakedao/mtroad1"}
}
Room {
    id = "xiakedao/mtroad1",
    name = "树林",
...
Room {
    ...
    name = "木屋",
    ways = {["west"] = "xiakedao/mtdating"}
}
Room {
    id = "xiakedao/mtyadi",
    name = "崖底",
    ways = {["north"] = "xiakedao/mtroad"}
}
Room {
    id = "xiakedao/neiting",
    name = "内厅",
...
Room {
    id = "xiakedao/pubu",
    name = "瀑布",
    ways = {["northdown"] = "xiakedao/road4"}
}
Room {
    id = "xiakedao/road1",
    name = "山路",
    ways = {["southup"] = "xiakedao/road2", ["northdown"] = "xiakedao/shanmen"}
}
Room {
    id = "xiakedao/road2",
    name = "山路",
    ways = {["southup"] = "xiakedao/road3", ["northdown"] = "xiakedao/road1"}
}
Room {
    id = "xiakedao/road3",
    name = "山路",
    ways = {["southup"] = "xiakedao/road4", ["northdown"] = "xiakedao/road2"}
}
Room {
    id = "xiakedao/road4",
    name = "山路",
    ways = {["southup"] = "xiakedao/pubu", ["northdown"] = "xiakedao/road3"}
}
Room {
    id = "xiakedao/road5",
    name = "山路",
    ways = {["southup"] = "xiakedao/road6", ["north"] = "xiakedao/shidong8"}
}
Room {
    id = "xiakedao/road6",
    name = "山路",
    ways = {["southup"] = "xiakedao/road7", ["northdown"] = "xiakedao/road5"}
}
Room {
    id = "xiakedao/road7",
    name = "夹鳖石",
    ways = {["southup"] = "xiakedao/road8", ["northdown"] = "xiakedao/road6"}
}
Room {
    id = "xiakedao/road8",
    name = "一线天",
    ways = {["southup"] = "xiakedao/wangyun", ["northdown"] = "xiakedao/road7"}
}
Room {
    id = "xiakedao/shanmen",
    name = "山门",
    ways = {["southup"] = "xiakedao/road1", ["north"] = "xiakedao/lin8"}
}
Room {
    id = "xiakedao/shibi",
    name = "石壁",
...
Room {
    ...
    name = "石洞",
    ways = {["east"] = "xiakedao/shidong9", ["out"] = "xiakedao/dating"}
}
Room {
...
Room {
    ...
    name = "石洞",
    ways = {["south"] = "xiakedao/shidong7", ["north"] = "xiakedao/shidong1"}
}
Room {
    id = "xiakedao/shidong7",
    name = "石洞",
    ways = {["north"] = "xiakedao/shidong6", ["west"] = "xiakedao/shidong8"}
}
Room {
    id = "xiakedao/shidong8",
    name = "石洞",
    ways = {["east"] = "xiakedao/shidong7"}
}
Room {
    id = "xiakedao/shidong9",
    name = "石洞",
    ways = {["east"] = "xiakedao/yadi", ["west"] = "xiakedao/shidong10"}
}
Room {
...
Room {
    id = "xiakedao/shimen",
    name = "石门",
    ways = {["enter"] = "xiakedao/shibi", ["north"] = "xiakedao/yongdao3"}
}
Room {
    id = "xiakedao/shiroom01",
    name = "石室",
    ways = {["south"] = "xiakedao/shihole1"}
}
Room {
    id = "xiakedao/shiroom02",
    name = "石室",
    ways = {["north"] = "xiakedao/shihole1"}
}
Room {
    id = "xiakedao/shiroom03",
    name = "石室",
    ways = {["west"] = "xiakedao/shihole1"}
}
Room {id = "xiakedao/shiroom04", name = "石室"}
Room {
    id = "xiakedao/shiroom05",
    name = "石室",
    ways = {["south"] = "xiakedao/shihole2"}
}
Room {
    id = "xiakedao/shiroom06",
    name = "石室",
    ways = {["north"] = "xiakedao/shihole2"}
}
Room {
    id = "xiakedao/shiroom07",
    name = "石室",
    ways = {["west"] = "xiakedao/shihole2"}
}
Room {
    id = "xiakedao/shiroom08",
    name = "石室",
    ways = {["east"] = "xiakedao/shihole2"}
}
Room {
    id = "xiakedao/shiroom09",
    name = "石室",
    ways = {["south"] = "xiakedao/shihole3"}
}
Room {
    id = "xiakedao/shiroom10",
    name = "石室",
    ways = {["north"] = "xiakedao/shihole3"}
}
Room {
    id = "xiakedao/shiroom11",
    name = "石室",
    ways = {["west"] = "xiakedao/shihole3"}
}
Room {
    id = "xiakedao/shiroom12",
    name = "石室",
    ways = {["east"] = "xiakedao/shihole3"}
}
Room {
    id = "xiakedao/shiroom13",
    name = "石室",
    ways = {["south"] = "xiakedao/shihole4"}
}
Room {
    id = "xiakedao/shiroom14",
    name = "石室",
    ways = {["north"] = "xiakedao/shihole4"}
}
Room {
    id = "xiakedao/shiroom15",
    name = "石室",
    ways = {["west"] = "xiakedao/shihole4"}
}
Room {
    id = "xiakedao/shiroom16",
    name = "石室",
    ways = {["east"] = "xiakedao/shihole4"}
}
Room {
    id = "xiakedao/shiroom17",
    name = "石室",
    ways = {["south"] = "xiakedao/shihole5"}
}
Room {
    id = "xiakedao/shiroom18",
    name = "石室",
    ways = {["north"] = "xiakedao/shihole5"}
}
Room {
    id = "xiakedao/shiroom19",
    name = "石室",
    ways = {["west"] = "xiakedao/shihole5"}
}
Room {
    id = "xiakedao/shiroom20",
    name = "石室",
    ways = {["east"] = "xiakedao/shihole5"}
}
Room {
    id = "xiakedao/shiroom21",
    name = "石室",
    ways = {["south"] = "xiakedao/shihole6"}
}
Room {
    id = "xiakedao/shiroom22",
    name = "石室",
    ways = {["north"] = "xiakedao/shihole6"}
}
Room {
    id = "xiakedao/shiroom23",
    name = "石室",
    ways = {["west"] = "xiakedao/shihole6"}
}
Room {
    id = "xiakedao/shiroom24",
    name = "石室",
    ways = {["east"] = "xiakedao/shihole6"}
}
Room {id = "xiakedao/shufang", name = "书房"}
Room {
    id = "xiakedao/wangyun",
    name = "望云台",
    ways = {["northdown"] = "xiakedao/road8"}
}
Room {
    id = "xiakedao/wuchang",
    name = "武场",
    ways = {["west"] = "xiakedao/shibi"}
}
Room {
    id = "xiakedao/wuqiku",
    name = "武器库",
    ways = {["east"] = "xiakedao/dating"}
}
Room {
    id = "xiakedao/xiaodian",
    name = "小吃店",
    ways = {["west"] = "xiakedao/yingbin"}
}
Room {
    id = "xiakedao/xiaowu",
    name = "石室",
    ways = {["north"] = "xiakedao/shibi"}
}
Room {
    id = "xiakedao/xiuxis",
    name = "休息室",
    ways = {["east"] = "xiakedao/yingbin"}
}
Room {
    id = "xiakedao/xiuxis2",
    name = "休息室",
    ways = {["south"] = "xiakedao/neiting"}
}
Room {
    id = "xiakedao/xkroad1",
    name = "南岭山口",
    ways = {["south"] = "xiakedao/xkroad2"}
}
Room {
    id = "xiakedao/xkroad2",
    name = "佛山",
    ways = {["south"] = "xiakedao/xkroad3", ["north"] = "xiakedao/xkroad1"}
}
Room {
    id = "xiakedao/xkroad3",
    name = "平原小路",
    ways = {["south"] = "xiakedao/xkroad4"}
}
Room {
    id = "xiakedao/xkroad4",
    name = "南海渔村",
...
Room {
    id = "xiakedao/xkroad5",
    name = "渔村晒网场",
    ways = {["north"] = "xiakedao/xkroad6", ["west"] = "xiakedao/xkroad4"}
}
Room {
    id = "xiakedao/xkroad6",
    name = "渔村小屋",
    ways = {["south"] = "xiakedao/xkroad5"}
}
Room {id = "xiakedao/yadi", name = "崖底"}
Room {
    id = "xiakedao/yingbin",
    name = "迎宾馆",
    ways = {
...
Room {
    ...
    name = "甬道",
    ways = {["south"] = "xiakedao/yongdao2", ["out"] = "xiakedao/pubu"}
}
Room {
    id = "xiakedao/yongdao2",
    name = "甬道",
    ways = {["south"] = "xiakedao/shidong1", ["north"] = "xiakedao/yongdao1"}
}
Room {
    id = "xiakedao/yongdao3",
    name = "甬道",
    ways = {["south"] = "xiakedao/shimen", ["north"] = "xiakedao/dating"}
}
Room {
    id = "xiangyang/baihumen",
    name = "白虎门",
    ways = {["east"] = "xiangyang/bhmnj", ["west"] = "xiangyang/outwroad1"}
}
Room {
    id = "xiangyang/bank",
    name = "宝龙斋",
    ways = {["east"] = "xiangyang/njie3"},
    objs = {["钱善人"] = "qian shanren"}
}
Room {
    id = "xiangyang/baozipu",
    name = "包子铺",
    ways = {["east"] = "xiangyang/xcx4"},
    objs = {["包子王"] = "baozi wang"}
}
Room {
    id = "xiangyang/bcx1",
    name = "北城巷",
    ways = {["east"] = "xiangyang/bjie1", ["west"] = "xiangyang/bcx2"},
...
Room {
    ...
    name = "蔡邕墓",
    ways = {["south"] = "xiangyang/caiyongmanor"}
}
Room {
    id = "xiangyang/chalou",
    name = "天香楼",
    ways = {["west"] = "xiangyang/bjie2", ["up"] = "xiangyang/chalou2"}
}
Room {
    id = "xiangyang/chalou2",
    name = "茶楼二楼",
    ways = {["down"] = "xiangyang/chalou"}
}
Room {
    id = "xiangyang/chayedian",
    name = "茶叶店",
    ways = {["east"] = "xiangyang/xcx1"}
}
Room {
    id = "xiangyang/chemahang",
    name = "车马行",
    ways = {["south"] = "xiangyang/ncx2"}
}
Room {
    id = "xiangyang/chengyipu",
    name = "成衣铺",
    ways = {["west"] = "xiangyang/dcx3"},
    objs = {["于三娘"] = "yu sanniang"}
}
Room {
    id = "xiangyang/chucshi",
    name = "储藏室",
    ways = {["north"] = "xiangyang/yamen"}
}
Room {
...
Room {
    ...
    precmds = {["eastdown"] = "halt", ["westup"] = "halt"},
    lengths = {
...
Room {
    ...
    name = "武馆大门",
    no_fight = true,
    ways = {["south"] = "xiangyang/eroad1", ["enter"] = "wuguan/menlang"},
    lengths = {
...
Room {
    ...
    name = "当铺",
    no_fight = true,
    ways = {["south"] = "xiangyang/djie1"},
    objs = {["崔老板"] = "cui laoban"}
}
Room {
    id = "xiangyang/datiepu",
    name = "打铁铺",
    ways = {["west"] = "xiangyang/ncx5"}
}
Room {
    id = "xiangyang/dcx1",
    name = "东城巷",
...
Room {
    id = "xiangyang/dcx5",
    name = "东城巷",
    ways = {["south"] = "xiangyang/djie2", ["north"] = "xiangyang/dcx4"},
...
Room {
    ...
    name = "豆腐坊",
    ways = {["east"] = "xiangyang/xcx2"}
}
Room {
    id = "xiangyang/dpailou",
    name = "东牌楼",
    ways = {["south"] = "xiangyang/cross2", ["north"] = "xiangyang/bjie3"}
}
Room {
    id = "xiangyang/duchang",
    name = "万金赌坊",
    no_fight = true,
    ways = {["west"] = "xiangyang/bjie1"}
}
Room {
    id = "xiangyang/eroad1",
    name = "青龙门内街",
...
Room {
    ...
    name = "废宅",
    ways = {["west"] = "xiangyang/dcx1"},
    objs = {["徐小五"] = "xu xiaowu", ["项长老"] = "xiang zhanglao"}
}
Room {
    id = "xiangyang/guangc",
    name = "擂台前广场",
...
Room {
    ...
    nolooks = {["dujiang"] = true}
}
Room {
    id = "xiangyang/hanshui2",
    name = "汉水西岸",
    ways = {["west"] = "wudang/wdroad6", ["dujiang"] = "xiangyang/hanshui1"},
    nolooks = {["dujiang"] = true}
}
Room {
...
Room {
    ...
    name = "土路",
    ways = {["southwest"] = "xiangyang/henanroad1", ["north"] = "nanyang/yidao"},
...
Room {
    ...
    name = "花园",
    ways = {["south"] = "xiangyang/lzz/houyuan"}
}
Room {
    id = "xiangyang/lzz/jiuguan",
    name = "四季小吃店",
    ways = {["east"] = "xiangyang/lzz/liuzz"}
}
Room {
...
Room {
    ...
    name = "小路",
    ways = {["south"] = "xiangyang/xiaolu1", ["north"] = "xiangyang/lzz/liuzz"}
}
Room {
...
Room {
    ...
    name = "药房",
    ways = {["north"] = "xiangyang/lzz/chelang1"}
}
Room {
    id = "xiangyang/lzz/zhengt",
    name = "正厅",
    ways = {["south"] = "xiangyang/lzz/tjing"}
}
Room {
    id = "xiangyang/mujiangpu",
    name = "木匠铺",
    ways = {["west"] = "xiangyang/ncx4"},
    objs = {["木匠"] = "mu jiang"}
}
Room {
    id = "xiangyang/ncx1",
...
Room {
    id = "xiangyang/njie2",
    name = "南街",
    ways = {["south"] = "xiangyang/njie3", ["north"] = "xiangyang/njie1"},
    room_relative = "南街｜南街｜南街南街",
    objs = {["完颜萍"] = "wanyan ping"}
}
Room {
    id = "xiangyang/njie3",
    name = "南街",
...
Room {
    ...
    name = "东门外",
    ways = {["east"] = "city/wroad3", ["west"] = "xiangyang/qinglongmen"}
}
Room {
...
Room {
    ...
    name = "青龙门",
    ways = {["east"] = "xiangyang/outeroad1", ["west"] = "xiangyang/eroad1"}
}
Room {
...
Room {
    ...
    name = "山间小路",
    ways = {["northeast"] = "xiangyang/shanlu2"},
...
Room {
    ...
    objs = {["独行大侠"] = "duxing daxia"}
}
Room {
    id = "xiangyang/shaobingpu",
    name = "烧饼铺",
    ways = {["east"] = "xiangyang/xcx3"},
    objs = {["烧饼刘"] = "shaobing liu"}
}
Room {
    id = "xiangyang/shuoshug",
    name = "说书馆",
    ways = {["south"] = "xiangyang/ncx1"}
}
Room {
    id = "xiangyang/sishu",
    name = "私塾",
    ways = {["north"] = "xiangyang/xcx5"}
}
Room {
    id = "xiangyang/tanxi",
    name = "檀溪",
...
Room {
    ...
    name = "温府大门",
    ways = {["south"] = "xiangyang/wen/shidetang", ["north"] = "xiangyang/ncx3"}
}
Room {
    id = "xiangyang/wen/guifang",
    name = "吟淼阁",
    ways = {["west"] = "xiangyang/wen/tianjing"},
    objs = {["温仪"] = "wen yi"}
}
Room {
    id = "xiangyang/wen/houhuayuan",
    name = "后花园",
    ways = {["north"] = "xiangyang/wen/tianjing"},
    objs = {["温方义"] = "wen fangyi"}
}
Room {
    id = "xiangyang/wen/lianwu",
    name = "练武场",
    ways = {["east"] = "xiangyang/wen/tianjing"},
    objs = {["温方达"] = "wen fangda"}
}
Room {
...
Room {
    ...
    objs = {["温方施"] = "wen fangshi"}
}
Room {
    id = "xiangyang/wen/wofang1",
    name = "卧房",
    ways = {["east"] = "xiangyang/wen/shidetang"},
    objs = {["温方山"] = "wen fangshan"}
}
Room {
    id = "xiangyang/wen/wofang2",
    name = "卧房",
    ways = {["west"] = "xiangyang/wen/shidetang"},
    objs = {["温方悟"] = "wen fangwu"},
...
Room {
    id = "xiangyang/xiyuan",
    name = "戏院",
    ways = {["west"] = "xiangyang/dcx4"}
}
Room {
    id = "xiangyang/xjie",
    name = "西街",
    ways = {["east"] = "xiangyang/cross1", ["west"] = "xiangyang/bhmnj"}
}
Room {
    id = "xiangyang/xpailou",
    name = "西牌楼",
    ways = {["south"] = "xiangyang/njie1", ["north"] = "xiangyang/cross1"}
}
Room {
    id = "xiangyang/xuanwumen",
    name = "玄武门",
    ways = {["south"] = "xiangyang/nroad1", ["north"] = "xiangyang/outnroad1"}
}
Room {
    id = "xiangyang/xyudian",
    name = "鲜鱼店",
    ways = {["east"] = "xiangyang/bcx3"},
    objs = {["李二嫂"] = "li ersao"}
}
Room {
    id = "xiangyang/yamen",
    ...
    blocks = {
        ["north"] = {{id = "ya yi", exp = 7500}},
        ["south"] = {{id = "ya yi", exp = 7500}}
    }
}
Room {
    id = "xiangyang/yaopu",
...
Room {
    ...
    name = "营帐中",
    no_fight = true,
    ways = {["out"] = "xiangyang/junying"},
    objs = {["蒙哥"] = "meng ge"}
}
Room {
    id = "xiangyang/ymzhengting",
    name = "正厅",
    ways = {["south"] = "xiangyang/yamen"}
}
Room {
    id = "xiangyang/zahuopu",
    name = "杂货铺",
    ways = {["west"] = "xiangyang/dcx2", ["up"] = "xiangyang/qnbank"},
    objs = {["牛老板"] = "niu laoban"}
}
Room {
    id = "xiangyang/qnbank",
    name = "潜能银行",
    ways = {["down"] = "xiangyang/zahuopu"}
}

Room {
    id = "xiangyang/zhuquemen",
    name = "朱雀门",
    ways = {["south"] = "xiangyang/outsroad1", ["north"] = "xiangyang/zqmnj"}
}
Room {
    id = "xiangyang/zqmnj",
    name = "朱雀门内街",
...
Room {
    id = "xiangyang/zrdian",
    name = "猪肉店",
    ways = {["south"] = "xiangyang/bcx2"},
    objs = {["猪肉荣"] = "zhurou rong"}
}
Room {
    id = "xingxiu/bank",
    name = "万宝斋",
    ways = {["east"] = "xingxiu/silk8"},
    objs = {["马掌柜"] = "ma zhanggui"}
}
Room {
...
Room {
    ...
    name = "密室",
    ways = {["out"] = "xingxiu/baozang/shuku"}
}
Room {
...
Room {
    id = "xingxiu/cave",
    name = "山洞",
    ways = {["out"] = "xingxiu/shanshi", ["zuan"] = "xingxiu/cave2"},
    objs = {["巨蟒"] = "ju mang", ["毒蛇"] = "du she"},
    precmds = {["zuan"] = "use fire;#walkBusy"},
    lengths = {
...
Room {
    id = "xingxiu/cave2",
    name = "山洞",
    ways = {["zuan out"] = "xingxiu/cave"},
    objs = {["飘然子"] = "piaoran zi"},
    precmds = {["zuan out"] = "use fire;#walkBusy"},
    lengths = {
...
Room {
    ...
    name = "厨房",
    no_fight = true,
    ways = {["east"] = "xingxiu/xx3"},
    objs = {["青葫芦"] = "qing hulu", ["小厨子"] = "xiao chuzi"}
}
Room {
    id = "xingxiu/daliao/liangcang",
    name = "后仓",
    ways = {["south"] = "xingxiu/daliao/zhongying"}
}
Room {
...
Room {
    ...
    name = "右营",
    ways = {["west"] = "xingxiu/daliao/zhongying"}
}
Room {
...
Room {
    ...
    name = "左营",
    ways = {["east"] = "xingxiu/daliao/zhongying"}
}
Room {
    id = "xingxiu/fangpan",
    name = "大方盘城",
    ways = {["east"] = "xingxiu/road4", ["west"] = "xingxiu/road5"}
}
Room {id = "xingxiu/jushi", name = "巨石", ways = {["down"] = "xingxiu/xx4"}}
Room {
    id = "xingxiu/jyg",
    name = "雁门关",
    ways = {
...
Room {
    ...
    name = "天阁斋分店",
    no_fight = true,
    ways = {["north"] = "xingxiu/jyg"},
    objs = {["黄真"] = "huang zhen"}
}
Room {
    id = "xingxiu/jyge",
    name = "嘉峪关东城门",
    ways = {["eastup"] = "xingxiu/road5", ["west"] = "xingxiu/jyg"},
    precmds = {["eastup"] = "#wipe guan bing", ["west"] = "#wipe guan bing"},
    room_relative = "雁门关--嘉峪关东城门→万里长城嘉峪关东城门"
}
Room {
    id = "xingxiu/jygw",
    name = "嘉峪关西城门",
    ways = {["east"] = "xingxiu/jyg", ["west"] = "xingxiu/silk"},
    precmds = {["east"] = "#wipe guan bing", ["west"] = "#wipe guan bing"}
}
Room {
    id = "xingxiu/mogaoku",
    name = "莫高窟",
    ways = {["out"] = "xingxiu/silk3c"},
    objs = {
        ["波罗蜜多心经"] = "shu",
        ["阿含经"] = "shu",
        ["般若经"] = "shu"
...
Room {
    id = "xingxiu/road4",
    name = "万里长城",
    ways = {["southeast"] = "lanzhou/wuwei", ["west"] = "xingxiu/fangpan"}
}
Room {
    id = "xingxiu/road5",
    name = "万里长城",
    ways = {["westdown"] = "xingxiu/jyge", ["east"] = "xingxiu/fangpan"}
}
Room {
    id = "xingxiu/rukou",
    name = "虫谷入口",
    ways = {["southwest"] = "xingxiu/xx1"},
    objs = {["看守"] = "kan shou"}
}
Room {
    id = "xingxiu/ryd",
    name = "日月洞",
    ways = {["south"] = "xingxiu/ryd1", ["north"] = "xingxiu/yaolu"},
    lengths = {
        ["north"] = "if score.party and score.party=='星宿派' then return 1 else return false end"
    },
    objs = {["丁春秋"] = "ding chunqiu", ["摘星子"] = "zhaixing zi"}
}
Room {
    id = "xingxiu/ryd1",
    name = "日月洞口",
...
Room {
    ...
    lengths = {["w;w;w;w;w;w;w;w;w;w"] = 10, ["e;e;e;e;e;e;e;e;e;e"] = 10}
}
Room {
    id = "xingxiu/shamo1",
    name = "大沙漠",
    ways = {["north"] = "xingxiu/shamo2"}
}
Room {
    id = "xingxiu/shamo2",
    name = "大沙漠",
    ways = {["north"] = "xingxiu/shamo3"}
}
Room {
    id = "xingxiu/shamo3",
    name = "大沙漠",
    ways = {["north"] = "xingxiu/shamo4"}
}
Room {
    id = "xingxiu/shamo4",
    name = "大沙漠",
    ways = {["north"] = "xingxiu/shamo5"}
}
Room {
    id = "xingxiu/shamo5",
    name = "大沙漠",
    ways = {["north"] = "xingxiu/shamo6"}
}
Room {
    id = "xingxiu/shamo6",
    name = "大沙漠",
    ways = {["north"] = "xingxiu/shamo7"}
}
Room {
    id = "xingxiu/shamo7",
    name = "大沙漠",
    ways = {["north"] = "xingxiu/shamo8"}
}
Room {
    id = "xingxiu/shamo8",
    name = "大沙漠",
    ways = {["north"] = "xingxiu/shamo9"}
}
Room {
    id = "xingxiu/shamo9",
    name = "大沙漠",
    ways = {["north"] = "xingxiu/shamo10"}
}
Room {
    id = "xingxiu/shamo10",
    name = "大沙漠",
    ways = {["north"] = "xingxiu/shamo11"}
}
Room {
    id = "xingxiu/shamo11",
    name = "大沙漠",
    ways = {["north"] = "xingxiu/shamo12"}
}
Room {
    id = "xingxiu/shamo12",
    name = "大沙漠",
    ways = {["north"] = "xingxiu/shamo13"}
}
Room {
    id = "xingxiu/shamo13",
    name = "大沙漠",
...
Room {
    ...
    blocks = {
        ["southeast"] = {{id = "xingxiu dizi", exp = 2000, party = "星宿派"}},
        ["southwest"] = {{id = "xingxiu dizi", exp = 2000, party = "星宿派"}},
        ["east"] = {{id = "xingxiu dizi", exp = 2000, party = "星宿派"}},
        ["north"] = {{id = "xingxiu dizi", exp = 2000, party = "星宿派"}}
    }
}
Room {
    id = "xingxiu/shanshi",
    name = "山石",
    ways = {["eastdown"] = "xingxiu/xx6", ["#xingxiushandong"] = "xingxiu/cave"},
    nolooks = {["#xingxiushandong"] = true},
    objs = {["狮吼子"] = "shihou zi"}
}
Room {
    id = "xingxiu/silk",
...
Room {
    id = "xingxiu/silk10",
    name = "丝绸之路",
    ways = {["south"] = "xingxiu/silk8", ["north"] = "yili/yilih"},
    room_relative = "惠远｜丝绸之路｜吐谷浑伏俟城丝绸之路"
}
Room {
    id = "xingxiu/silk1a",
    name = "水帘洞",
    ways = {["southeast"] = "xingxiu/silk1b", ["northeast"] = "xingxiu/silk1"}
}
Room {
    id = "xingxiu/silk1b",
    name = "仙人崖",
    ways = {["northwest"] = "xingxiu/silk1a", ["northeast"] = "xingxiu/silk"}
}
Room {
    id = "xingxiu/silk2",
    name = "丝绸之路",
    ways = {["westup"] = "xingxiu/silk3", ["south"] = "xingxiu/silk1"},
...
Room {
    id = "xingxiu/silk3a",
    name = "鸣沙山",
    ways = {["south"] = "xingxiu/silk3", ["west"] = "xingxiu/silk3b"}
}
Room {
    id = "xingxiu/silk3b",
    name = "万象洞",
    ways = {["northwest"] = "xingxiu/silk3c", ["east"] = "xingxiu/silk3a"}
}
Room {
    id = "xingxiu/silk3c",
    name = "月牙泉",
...
Room {
    id = "xingxiu/tianshan",
    name = "天山山路",
    ways = {["southeast"] = "hj/senlinn", ["west"] = "tianshan/kongchang"}
}
Room {
    id = "xingxiu/wenquan",
    name = "清水温泉",
    ways = {["northeast"] = "xingxiu/silk8"}
}
Room {
    id = "xingxiu/xiaowu",
    name = "星宿小屋",
    ways = {["south"] = "xingxiu/jyg"},
    objs = {["马光佐"] = "ma guangzuo"}
}
Room {
    id = "xingxiu/xiaoyao",
    name = "逍遥洞",
    no_fight = true,
    ways = {["out"] = "xingxiu/xx3"}
}
Room {
    id = "xingxiu/xx1",
    name = "山前荒地",
...
Room {
    ...
    blocks = {["enter"] = {{id = "chuchen zi", exp = 200000}}},
    objs = {["出尘子"] = "chuchen zi"},
    room_relative = "天然石洞∧石道----星宿海↘山前荒地星宿海"
}
Room {
    id = "xingxiu/xx3",
    name = "石道",
    ...
    blocks = {
        ["enter"] = {{id = "caihua zi", exp = 25000, party = "星宿派"}}
    }
}
Room {
    id = "xingxiu/xx4",
    ...
    objs = {["天狼子"] = "tianlang zi"}
}
Room {
    id = "xingxiu/xx5",
    name = "山壁",
    ways = {["southdown"] = "xingxiu/xx4"}
}
Room {
    id = "xingxiu/xx6",
    name = "海边荒路",
...
Room {
    id = "xingxiu/xxh1",
    name = "星宿海",
    ways = {["east"] = "xingxiu/xxh2"}
}
Room {
    id = "xingxiu/xxh2",
    name = "星宿海",
    ways = {["north"] = "xingxiu/xxh3"}
}
Room {
    id = "xingxiu/xxh3",
    name = "星宿海",
    ways = {["west"] = "xingxiu/xxh4"}
}
Room {
    id = "xingxiu/xxh4",
    name = "星宿海",
...
Room {id = "xingxiu/yaolu", name = "药庐", ways = {["south"] = "xingxiu/ryd"}}
Room {
    id = "yili/house",
    name = "巴依家院",
    ways = {["west"] = "yili/yili2"}
}
Room {
    id = "yili/kezhan",
    name = "客栈",
    ways = {["southeast"] = "yili/yili2", ["up"] = "yili/kezhan2"},
    objs = {["阿拉木罕"] = "alamuhan"}
}
Room {
    id = "yili/kezhan2",
    name = "客栈二楼",
    ways = {["down"] = "yili/kezhan"}
}
Room {
    id = "yili/store",
    name = "商铺",
    ways = {["east"] = "yili/yili2"},
    objs = {["买卖提"] = "maimaiti"}
}
Room {
    id = "yili/store1",
    name = "铁铺",
    ways = {["south"] = "yili/yili2"},
    objs = {["薛烛"] = "xue zhu"}
}
Room {
    id = "yili/yilih",
...
Room {
    id = "yili/yilihe",
    name = "伊犁河",
    ways = {["south"] = "yili/yilih", ["north"] = "yili/yili1"}
}
Room {
    id = "xueshan/anshi",
    name = "暗室",
    ways = {["south"] = "xueshan/fatang2"}
}
Room {
    id = "xueshan/binglinfeng",
    name = "冰林峰",
    ways = {["east"] = "xueshan/shanpo"}
}
Room {
    id = "xueshan/boluomiyuan",
    name = "波罗蜜院",
    ways = {["west"] = "xueshan/huilang8"}
}
Room {
    id = "xueshan/caishichang",
    name = "采石场",
    ways = {["eastdown"] = "xueshan/cunluo1", ["west"] = "xueshan/tianyunmc"},
    objs = {["色楞"] = "se leng"}
}
Room {
    id = "xueshan/caoyuan/caohai1",
    name = "草海",
    ways = {["south"] = "hj/caoyuan2", ["west"] = "xueshan/caoyuan/caohain"},
    nolooks = {["north"] = true, ["east"] = true}
}
Room {
    ...
    nolooks = {["e;n"] = true, ["north"] = true, ["south"] = true},
    find = {path = {"e", "n;n;w;e;s;w"}}
}
Room {
...
Room {
    ...
    name = "牛皮大帐",
    ways = {["south"] = "xueshan/caoyuan/shenfeng"},
    objs = {
        ["忽必烈"] = "hu bilie",
        ["达尔巴"] = "daer ba",
        ["金轮法王"] = "jinlun fawang",
...
Room {
    ...
    name = "沼泽",
    ways = {["w;n"] = "xueshan/caoyuan/caohai5"},
    nolooks = {
        ["w;n"] = true,
        ["east"] = true,
        ["west"] = true,
    ...
    find = {path = {"w", "s"}, count = 10}
}
Room {
    id = "xueshan/chiyangmen",
    name = "炽阳门",
    ways = {["enter"] = "xueshan/qingxinshe", ["west"] = "xueshan/rimulundian"}
}
Room {
    id = "xueshan/chufang",
    name = "厨房",
    ways = {["south"] = "xueshan/zhaitang"}
}
Room {
    id = "xueshan/cunluo1",
    name = "藏民部落",
...
Room {
    ...
    nolooks = {["enter"] = true},
    objs = {["李招财"] = "li zhaocai"},
    precmds = {["enter"] = "give li 5 silver"},
    -- Bag[l_name].cnt
    lengths = {
...
Room {
    ...
    objs = {["灵智上人"] = "lingzhi shangren"}
}
Room {
    id = "xueshan/daritang",
    name = "大日法堂",
    ways = {["west"] = "xueshan/luoweitang"},
    objs = {["哲布尊巴丹"] = "huo fo"}
}
Room {
    id = "xueshan/fanyinge",
    ...
    nolooks = {["northwest"] = true},
    precmds = {["northwest"] = "open door"},
    blocks = {
        ["northwest"] = {{id = "hufa lama", exp = 600000, party = "大轮寺"}}
    }
}
Room {
    id = "xueshan/fatang",
    name = "萨迦法堂",
    ways = {["south"] = "xueshan/fanyinge", ["up"] = "xueshan/fatang2"},
    blocks = {["up"] = {{id = "zayi lama", exp = 30000, party = "大轮寺"}}}
}
Room {
    id = "xueshan/fatang2",
    name = "法堂二楼",
    ways = {["down"] = "xueshan/fatang"},
    objs = {["鸠摩智"] = "jiumo zhi"}
}
Room {
...
Room {
    id = "xueshan/fotang",
    name = "镜庐佛堂",
    ways = {["southeast"] = "xueshan/fanyinge", ["west"] = "xueshan/lingtalin"}
}
Room {
    id = "xueshan/fozhaomen",
    name = "佛照门",
    ways = {["east"] = "xueshan/zanpugc", ["west"] = "xueshan/xiaolu3"},
...
Room {
    ...
    nolooks = {["southdown"] = true},
    precmds = {["southdown"] = "pull gate"},
    objs = {["黑林钵夫"] = "heilin bofu", ["大轮寺辩经板"] = "board"}
}
Room {
    id = "xueshan/gulou",
    name = "鼓楼",
    ways = {["west"] = "xueshan/huilang2"}
}
Room {
    id = "xueshan/houzidong",
    name = "猴子洞",
    ways = {["southeast"] = "xueshan/jiaopan", ["westup"] = "xueshan/shanlu7"}
}
Room {
    id = "xueshan/huanggong",
    name = "皇宫",
    ways = {["west"] = "xueshan/zanpugc"},
    room_relative = "赞普广场-----皇宫皇宫"
}
Room {
    id = "xueshan/hubian",
    name = "湖边",
    ways = {["south"] = "xueshan/xiaolu3"},
...
Room {
    id = "xueshan/jiaopan",
    name = "绞盘",
    ways = {["northwest"] = "xueshan/houzidong"}
}
Room {
    id = "xueshan/jiedao1",
    name = "街道",
...
Room {
    ...
    name = "结缘堂",
    ways = {["east"] = "xueshan/huilang3"}
}
Room {
    id = "xueshan/jifengying",
    name = "疾风营",
    ways = {["south"] = "xueshan/yingmen", ["north"] = "xueshan/shenfengying"}
}
Room {
    id = "xueshan/jingangyuan",
    name = "金刚院",
    ways = {["south"] = "xueshan/kuxiuzhacang", ["east"] = "xueshan/fanyinge"}
}
Room {
    id = "xueshan/jingjinzhacang",
    name = "精进扎仓",
    ways = {["north"] = "xueshan/jingtang", ["west"] = "xueshan/hufazhacang"},
    objs = {["善勇"] = "shan yong"}
}
Room {
    id = "xueshan/jingtang",
    name = "大经堂",
    ways = {["south"] = "xueshan/jingjinzhacang", ["west"] = "xueshan/fanyinge"}
}
Room {
    id = "xueshan/jishantang",
    name = "积善堂",
    ways = {["east"] = "xueshan/huilang5"}
}
Room {
    id = "xueshan/jlshan",
    name = "积雷山",
    ways = {["southdown"] = "xueshan/tianxi"}
}
Room {
    id = "xueshan/juechenyuan",
    name = "绝尘院",
    no_fight = true,
    ways = {["out"] = "xueshan/yueliangmen"}
}
Room {
    id = "xueshan/jueding",
    name = "绝顶",
    ways = {["down"] = "xueshan/shanpo"}
}
Room {
    id = "xueshan/jushuimen",
    name = "巨水门",
    ways = {["south"] = "xueshan/jiedao3", ["north"] = "xueshan/tianyunmc"},
    room_relative = "天云马场｜巨水门｜街道巨水门"
}
Room {
    id = "xueshan/kuxiuzhacang",
    name = "苦修扎仓",
    ways = {["north"] = "xueshan/jingangyuan", ["east"] = "xueshan/hufazhacang"},
    objs = {["胜谛"] = "sheng di"}
}
Room {
    id = "xueshan/laifu",
    name = "来福杂货",
    no_fight = true,
    ways = {["east"] = "xueshan/jiedao3"},
    objs = {["江来福"] = "jiang laifu"}
}
Room {
...
Room {
    id = "xueshan/baota1",
    name = "玲珑舍利塔",
    ways = {["out"] = "xueshan/lingtalin"}
}
Room {
    id = "xueshan/luofenggang",
    name = "落风岗",
    ways = {["east"] = "xueshan/fengjiantai", ["tiao down"] = "xueshan/xuegu"},
    nolooks = {["tiao down"] = true}
}
Room {
    id = "xueshan/luoweitang",
    name = "洛微堂",
    ways = {["east"] = "xueshan/daritang", ["west"] = "xueshan/huilang4"},
    objs = {["哲罗星"] = "zheluo xing"}
}
Room {
    id = "xueshan/menghuying",
    name = "猛虎营",
    ways = {["east"] = "xueshan/jiedao1"},
    room_relative = "猛虎营----街道猛虎营"
}
Room {
    id = "xueshan/mingxiamen",
    name = "明霞门",
    ways = {["east"] = "xueshan/tulu3", ["north"] = "xueshan/jiedao1"},
...
Room {
    ...
    name = "牛皮大帐",
    ways = {["south"] = "xueshan/shenfengying"}
}
Room {
    id = "xueshan/qingxinshe",
    name = "清心舍",
    no_fight = true,
    ways = {["out"] = "xueshan/chiyangmen"}
}
Room {
...
Room {
    ...
    blocks = {
        ["southeast"] = {{id = "hufa lama", exp = 100000, party = "大轮寺"}},
        ["east"] = {{id = "hufa lama", exp = 100000, party = "大轮寺"}}
    }
}
Room {
    id = "xueshan/shanlu1",
    name = "善禅渡",
    ways = {["northwest"] = "xueshan/shanlu2", ["east"] = "xueshan/tianhu"}
}
Room {
    id = "xueshan/shanlu2",
    name = "千步岭",
    ways = {["southeast"] = "xueshan/shanlu1", ["westup"] = "xueshan/shanlu3"},
    room_relative = "千步岭←千步岭↘善禅渡千步岭"
}
Room {
    id = "xueshan/shanlu3",
    name = "千步岭",
    ways = {["eastdown"] = "xueshan/shanlu2", ["westdown"] = "xueshan/shanlu4"},
    room_relative = "入幽口→千步岭←千步岭千步岭"
}
Room {
    id = "xueshan/shanlu4",
    name = "入幽口",
    ways = {["eastup"] = "xueshan/shanlu3", ["westup"] = "xueshan/fengjiantai"},
    precmds = {["eastup"] = "#walkBusy", ["westup"] = "#walkBusy"},
    objs = {["宝象"] = "bao xiang"}
}
Room {
    id = "xueshan/shanlu5",
    ...
    objs = {["雪豹皮"] = "bao pi", ["雪豹"] = "xue bao"}
}
Room {
    id = "xueshan/shanlu6",
    name = "雪积古道",
    ways = {["eastup"] = "xueshan/shanlu7", ["northwest"] = "xueshan/shanlu5"}
}
Room {
    id = "xueshan/shanlu7",
    name = "雪积古道",
...
Room {
    ...
    nolooks = {["northup"] = true},
    precmds = {["northup"] = "knock gate;#walkBusy"}
}
Room {
    id = "xueshan/shanpo",
    name = "问天台",
    ways = {["southdown"] = "xueshan/xuelu3", ["east"] = "xueshan/binglinfeng"}
}
Room {
...
Room {
    ...
    objs = {["支麻鸭"] = "zhima ya", ["斑头雁"] = "bantou yan"}
}
Room {
    id = "xueshan/tianxi",
    name = "天溪",
    ways = {["south"] = "xueshan/tianhu"}
}
Room {
    id = "xueshan/tianyunmc",
    name = "天云马场",
    ways = {["south"] = "xueshan/jushuimen", ["east"] = "xueshan/caishichang"}
}
Room {
    id = "xueshan/tulu1",
    name = "川西土路",
    ways = {["southwest"] = "group/entry/xstulu2", ["east"] = "chengdu/wroad2"}
}
Room {
    id = "xueshan/tulu3",
    name = "藏边土路",
...
Room {
    id = "xueshan/wangdali",
    name = "王大力记",
    ways = {["west"] = "xueshan/jiedao3"},
    objs = {["王三力"] = "wang sanli"}
}
Room {
    id = "xueshan/xiaodian",
    name = "湖边小店",
    ways = {["north"] = "xueshan/tianhu"},
    objs = {
        ["大丑"] = "da chou",
        ["三丑"] = "san chou",
        ["二丑"] = "er chou",
...
Room {
    ...
    precmds = {["enter"] = "open door"},
    blocks = {
        ["enter"] = {{id = "hufa lama", exp = 100000, party = "大轮寺"}}
    },
    objs = {["桑结"] = "sang jie"}
}
Room {
...
Room {
    id = "xueshan/quanshui",
    name = "泉水中",
    ways = {["tiao out"] = "xueshan/xuelingquan"}
}
Room {
    id = "xueshan/xuelu1",
    name = "积雪小路",
    ways = {["northup"] = "xueshan/xuelu2", ["eastdown"] = "xueshan/lingtalin"}
}
Room {
    id = "xueshan/xuelu2",
    name = "积雪小路",
    ways = {["southdown"] = "xueshan/xuelu1", ["westup"] = "xueshan/xuelu3"}
}
Room {
    id = "xueshan/xuelu3",
    name = "积雪小路",
    ways = {["eastdown"] = "xueshan/xuelu2", ["northup"] = "xueshan/shanpo"}
}
Room {
    id = "xueshan/yimogong",
    name = "怡摩宫",
    ways = {["west"] = "xueshan/huilang6"},
    objs = {["波罗星"] = "boluo xing"}
}
Room {
    id = "xueshan/yingmen",
    name = "营门",
    ways = {["south"] = "xueshan/caohai1", ["north"] = "xueshan/jifengying"}
}
Room {
    id = "xueshan/yixianglou",
    name = "溢香楼",
    ways = {["west"] = "xueshan/jiedao2"},
    objs = {["胡贵"] = "hu gui"}
}
Room {
    id = "xueshan/yueliangmen",
    name = "月亮门",
    ways = {["enter"] = "xueshan/juechenyuan", ["east"] = "xueshan/rimulundian"}
}
Room {
    id = "xueshan/yushengdian",
    name = "御圣殿",
    ways = {["east"] = "xueshan/huilang7"}
}
Room {
    id = "xueshan/zanpugc",
    name = "赞普广场",
...
Room {
    ...
    name = "正房",
    no_fight = true,
    ways = {["out"] = "xueshan/dachedian"}
}
Room {
    id = "xueshan/zhonglou",
    name = "钟楼",
    ways = {["east"] = "xueshan/huilang1"}
}
Room {
...
Room {
    ...
    objs = {["火炉"] = "huo lu", ["韩铁匠"] = "han tiejiang"}
}
Room {
    id = "zhiye/caifengpu1",
    name = "裁缝铺",
...
Room {
    ...
    name = "采矿场",
    ways = {["out"] = "zhiye/caikuang-chang1"}
}
Room {
    id = "zhiye/caikuang-chang12",
    name = "采矿场",
    ways = {["out"] = "zhiye/caikuang-chang2"}
}
Room {
    id = "zhiye/caikuang-chang13",
    name = "采矿场",
    ways = {["out"] = "zhiye/caikuang-chang3"}
}
Room {
...
Room {
    ...
    name = "高山脚下",
    outdoor = "成都郊外",
    ways = {["west"] = "chengdu/road1"},
    nolooks = {["northup"] = true, ["southup"] = true, ["eastup"] = true}
}
Room {
    id = "zhiye/gaoshan1",
    name = "山崖",
    ways = {["southdown"] = "zhiye/gaoshan0"}
}
Room {
    id = "zhiye/gaoshan2",
    name = "山崖",
    ways = {["northdown"] = "zhiye/gaoshan0"}
}
Room {
    id = "zhiye/gaoshan3",
    name = "山崖",
    ways = {["westdown"] = "zhiye/gaoshan0"}
}
Room {
    id = "zhiye/jiaoliushi1",
    name = "陈列室",
    outdoor = "扬州城",
    ways = {["east"] = "zhiye/jimaidian1"},
    objs = {["经验交流版"] = "board"}
}
Room {
    id = "zhiye/jimaidian1",
...
Room {
    id = "zhiye/nongtian11",
    name = "农田",
    ways = {["out"] = "zhiye/nongtian1"}
}
Room {
    id = "zhiye/nongtian12",
    name = "农田",
    ways = {["out"] = "zhiye/nongtian2"}
}
Room {
    id = "zhiye/nongtian13",
    name = "农田",
    ways = {["out"] = "zhiye/nongtian3"}
}
Room {
    id = "zhiye/nongtian2",
    name = "田埂",
...
Room {
    id = "zhiye/sanglin11",
    name = "桑林",
    ways = {["out"] = "zhiye/sanglin1"}
}
Room {
    id = "zhiye/sanglin12",
    name = "桑林",
    ways = {["out"] = "zhiye/sanglin2"}
}
Room {
    id = "zhiye/sanglin13",
    name = "桑林",
    ways = {["out"] = "zhiye/sanglin3"}
}
Room {
    id = "zhiye/sanglin2",
    name = "桑林小路",

...
function xuncheng_askagain()
    exe("ask zhu danchen about 巡城")
end
...
function xuncheng_task_wait()
    wait.make(
        function()
            if hp.exp and hp.exp > 300000 and hp.jingli_max >= hp.jingli_lim and hp.neili_max >= hp.neili_lim then
            ...
            elseif hp.exp and hp.exp > 300000 and hp.neili_max >= hp.neili_lim and hp.neili > hp.neili_max * 0.4 then
